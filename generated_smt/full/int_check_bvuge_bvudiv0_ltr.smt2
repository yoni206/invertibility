...
;more place-holders   ;
;;;;;;;;;;;;;;;;;;;;;;;
(define-fun inv_syntax_a ((k Int) (s Int) (t Int)) Int (intnot k 0))
(define-fun inv_syntax_g ((k Int) (s Int) (t Int)) Int (intnot k 0))
(define-fun inv_syntax_r ((k Int) (s Int) (t Int)) Int (intnot k 0))
