...
;more place-holders   ;
;;;;;;;;;;;;;;;;;;;;;;;
(define-fun inv_syntax_a ((k Int) (s Int) (t Int)) Int (intadd k (intadd k (intmul k s t) (intmaxs k)) s))
(define-fun inv_syntax_g ((k Int) (s Int) (t Int)) Int (intshl k (intmaxs k) s))
(define-fun inv_syntax_r ((k Int) (s Int) (t Int)) Int (intor k (intneg k s) (intmaxs k)))
