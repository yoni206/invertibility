...
;<BEGIN_LTR>
(define-fun inv_syntax_g ((k Int) (s Int) (t Int)) Int (intadd k (intadd k (intmaxs k) s) (intmins k)))
(define-fun inv_syntax_a ((k Int) (s Int) (t Int)) Int (intsub k s (intmul k (intmaxs k) (intmaxs k))))
(define-fun inv_syntax_r ((k Int) (s Int) (t Int)) Int (intnot k (intneg k s)))
