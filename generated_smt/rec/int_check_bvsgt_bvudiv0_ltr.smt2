...
;<BEGIN_LTR>
(define-fun inv_syntax_g ((k Int) (s Int) (t Int)) Int (intor k (intsub k (intlshr k (intneg k s) s) (intmaxs k)) (intmaxs k)))
(define-fun inv_syntax_a ((k Int) (s Int) (t Int)) Int (intadd k (intmul k t s) s))
(define-fun inv_syntax_r ((k Int) (s Int) (t Int)) Int (intor k (intor k (intneg k (intnot k (intneg k s))) s) (intmaxs k)))
