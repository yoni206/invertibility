...
;<BEGIN_LTR>
(define-fun inv_syntax_g ((k Int) (s Int) (t Int)) Int (intsub k (intadd k s t) (intmaxs k)))
(define-fun inv_syntax_a ((k Int) (s Int) (t Int)) Int (intadd k (intadd k (intmaxs k) s) t))
(define-fun inv_syntax_r ((k Int) (s Int) (t Int)) Int (intand k (intor k (intnot k s) t) (intor k (intnot k t) s)))
