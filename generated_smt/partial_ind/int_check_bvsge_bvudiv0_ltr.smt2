...
;<BEGIN_LTR>
(define-fun inv_syntax_g ((k Int) (s Int) (t Int)) Int (intor k (intlshr k (intmins k) (intand k (intlshr k (intmaxs k) s) s)) (intmaxs k)))
(define-fun inv_syntax_a ((k Int) (s Int) (t Int)) Int (intmul k t s))
(define-fun inv_syntax_r ((k Int) (s Int) (t Int)) Int (intor k (intor k (intneg k (intnot k (intneg k s))) s) t))
