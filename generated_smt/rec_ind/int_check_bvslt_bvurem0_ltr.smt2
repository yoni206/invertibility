...
(define-fun two_to_the_is_ok ((b Int)) Bool (two_to_the_is_ok_rec b))
...
(define-fun or_is_ok ((k Int) (a Int)) Bool (or_is_ok_rec k a))
...
(define-fun and_is_ok ((k Int) (a Int)) Bool (and_is_ok_rec k a))
