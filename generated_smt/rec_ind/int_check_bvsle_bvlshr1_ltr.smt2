...
;<BEGIN_LTR>
(define-fun inv_syntax_g ((k Int) (s Int) (t Int)) Int (intsub k (intmins k) (intand k s (intmins k))))
(define-fun inv_syntax_r ((k Int) (s Int) (t Int)) Int (intand k (intnot k t) (intmins k)))
