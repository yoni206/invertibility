...
(define-fun two_to_the_is_ok ((b Int)) Bool (two_to_the_is_ok_full b))
...
(define-fun or_is_ok ((k Int) (a Int)) Bool (or_is_ok_full k a))
...
(define-fun and_is_ok ((k Int) (a Int)) Bool (and_is_ok_full k a))
...
;more place-holders   ;
;;;;;;;;;;;;;;;;;;;;;;;
(define-fun inv_syntax_g ((k Int) (s Int) (t Int)) Int (intand k (intsub k (intmins k) s) (intmins k)))
(define-fun inv_syntax_r ((k Int) (s Int) (t Int)) Int (intand k (intnot k (intneg k s)) (intmins k)))
(define-fun l_part ((k Int) (s Int) (t Int)) Bool (or (l k (inv_syntax_r k s t) s t) (l k (inv_syntax_g k s t) s t)))
