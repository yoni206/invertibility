...
;more place-holders   ;
;;;;;;;;;;;;;;;;;;;;;;;
(define-fun inv_syntax_a ((k Int) (s Int) (t Int)) Int (intmul k (intnot k t) t))
(define-fun inv_syntax_g ((k Int) (s Int) (t Int)) Int (intlshr k t (intsub k s t)))
(define-fun l_part ((k Int) (s Int) (t Int)) Bool (or (l k (inv_syntax_g k s t) s t) (l k (inv_syntax_a k s t) s t)))
