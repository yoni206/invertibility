...
;more place-holders   ;
;;;;;;;;;;;;;;;;;;;;;;;
(define-fun inv_syntax_a ((k Int) (s Int) (t Int)) Int (intneg k s))
(define-fun inv_syntax_g ((k Int) (s Int) (t Int)) Int (intneg k s))
(define-fun inv_syntax_r ((k Int) (s Int) (t Int)) Int (intneg k s))
