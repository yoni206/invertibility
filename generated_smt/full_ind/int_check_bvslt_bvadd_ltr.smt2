...
;more place-holders   ;
;;;;;;;;;;;;;;;;;;;;;;;
(define-fun inv_syntax_a ((k Int) (s Int) (t Int)) Int (intsub k (intmins k) s))
(define-fun inv_syntax_g ((k Int) (s Int) (t Int)) Int (intsub k (intmins k) s))
(define-fun inv_syntax_r ((k Int) (s Int) (t Int)) Int (intneg k (intand k (intor k (intnot k s) (intmaxs k)) (intor k s (intmins k)))))
