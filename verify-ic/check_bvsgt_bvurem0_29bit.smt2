...
(and (and (=> (bvsgt s (_ bv0 29)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 29)) (distinct t max))) (or (distinct t (_ bv0 29)) (distinct s (_ bv1 29))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 29))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 29))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
