...
(or (distinct s (_ bv0 21)) (distinct t (bvnot (_ bv0 21))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 21))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 21))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
