...
(or (distinct s (_ bv0 37)) (distinct t (bvnot (_ bv0 37))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 37))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 37))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
