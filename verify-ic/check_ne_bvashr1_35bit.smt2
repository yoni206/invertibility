...
(and (or (not (= t (_ bv0 35))) (not (= s (_ bv0 35)))) (or (not (= t (bvnot (_ bv0 35)))) (not (= s (bvnot (_ bv0 35))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 35))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 35))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
