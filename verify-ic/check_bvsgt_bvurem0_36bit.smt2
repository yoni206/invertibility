...
(and (and (=> (bvsgt s (_ bv0 36)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 36)) (distinct t max))) (or (distinct t (_ bv0 36)) (distinct s (_ bv1 36))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 36))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 36))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
