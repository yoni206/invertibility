...
(and (or (not (= t (_ bv0 33))) (not (= s (_ bv0 33)))) (or (not (= t (bvnot (_ bv0 33)))) (not (= s (bvnot (_ bv0 33))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 33))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 33))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
