...
(or (distinct s (_ bv0 32)) (distinct t (bvnot (_ bv0 32))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 32))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 32))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
