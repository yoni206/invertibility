...
(and (=> (bvult s (_ bv56 56)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv56 56)) (or (= t (bvnot (_ bv0 56))) (= t (_ bv0 56)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 56))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 56))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
