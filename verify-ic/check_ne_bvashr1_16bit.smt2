...
(and (or (not (= t (_ bv0 16))) (not (= s (_ bv0 16)))) (or (not (= t (bvnot (_ bv0 16)))) (not (= s (bvnot (_ bv0 16))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 16))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 16))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
