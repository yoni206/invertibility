...
(or (distinct s (_ bv0 57)) (distinct t (bvnot (_ bv0 57))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 57))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 57))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
