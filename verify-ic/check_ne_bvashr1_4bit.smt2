...
(and (or (not (= t (_ bv0 4))) (not (= s (_ bv0 4)))) (or (not (= t (bvnot (_ bv0 4)))) (not (= s (bvnot (_ bv0 4))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 4))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 4))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
