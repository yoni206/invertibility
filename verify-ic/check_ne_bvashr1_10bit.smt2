...
(and (or (not (= t (_ bv0 10))) (not (= s (_ bv0 10)))) (or (not (= t (bvnot (_ bv0 10)))) (not (= s (bvnot (_ bv0 10))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 10))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 10))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
