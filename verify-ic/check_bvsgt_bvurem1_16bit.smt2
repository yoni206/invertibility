...
(and (=> (bvsge s (_ bv0 16)) (bvsgt s t)) (=> (bvslt s (_ bv0 16)) (bvsgt (bvlshr (bvsub s (_ bv1 16)) (_ bv1 16)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 16))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 16))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
