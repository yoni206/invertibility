...
(and (=> (bvsge s (_ bv0 65)) (bvsge s t)) (=> (bvslt s (_ bv0 65)) (bvsge (bvlshr s (_ bv1 65)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 65))) (bvsge (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 65))) (bvsge (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
