...
(and (=> (bvult s (_ bv49 49)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv49 49)) (or (= t (bvnot (_ bv0 49))) (= t (_ bv0 49)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 49))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 49))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
