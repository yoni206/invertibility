...
(and (or (not (= t (_ bv0 37))) (not (= s (_ bv0 37)))) (or (not (= t (bvnot (_ bv0 37)))) (not (= s (bvnot (_ bv0 37))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 37))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 37))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
