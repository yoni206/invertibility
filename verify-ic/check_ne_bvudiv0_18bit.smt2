...
(or (distinct s (_ bv0 18)) (distinct t (bvnot (_ bv0 18))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 18))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 18))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
