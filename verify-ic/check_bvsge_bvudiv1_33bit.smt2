...
(and (=> (bvsge s (_ bv0 33)) (bvsge s t)) (=> (bvslt s (_ bv0 33)) (bvsge (bvlshr s (_ bv1 33)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 33))) (bvsge (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 33))) (bvsge (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
