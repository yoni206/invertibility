...
(or (distinct s (_ bv0 44)) (distinct t (bvnot (_ bv0 44))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 44))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 44))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
