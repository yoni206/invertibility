...
(or  (bvugt (bvshl s (_ bv0 3)) t) (bvugt (bvshl s (_ bv1 3)) t) (bvugt (bvshl s (_ bv2 3)) t) (bvugt (bvshl s (_ bv3 3)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 3))) (bvugt (bvshl s x) t)))
  (=> (exists ((x (_ BitVec 3))) (bvugt (bvshl s x) t)) (SC s t))
  )
 )
)
(check-sat)
