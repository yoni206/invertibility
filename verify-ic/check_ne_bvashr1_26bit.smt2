...
(and (or (not (= t (_ bv0 26))) (not (= s (_ bv0 26)))) (or (not (= t (bvnot (_ bv0 26)))) (not (= s (bvnot (_ bv0 26))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 26))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 26))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
