...
(and (and (=> (bvsgt s (_ bv0 35)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 35)) (distinct t max))) (or (distinct t (_ bv0 35)) (distinct s (_ bv1 35))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 35))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 35))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
