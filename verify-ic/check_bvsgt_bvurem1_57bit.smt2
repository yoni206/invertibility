...
(and (=> (bvsge s (_ bv0 57)) (bvsgt s t)) (=> (bvslt s (_ bv0 57)) (bvsgt (bvlshr (bvsub s (_ bv1 57)) (_ bv1 57)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 57))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 57))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
