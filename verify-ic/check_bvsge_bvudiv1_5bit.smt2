...
(and (=> (bvsge s (_ bv0 5)) (bvsge s t)) (=> (bvslt s (_ bv0 5)) (bvsge (bvlshr s (_ bv1 5)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 5))) (bvsge (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 5))) (bvsge (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
