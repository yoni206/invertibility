...
(and (=> (bvult s (_ bv46 46)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv46 46)) (or (= t (bvnot (_ bv0 46))) (= t (_ bv0 46)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 46))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 46))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
