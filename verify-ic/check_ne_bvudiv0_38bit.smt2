...
(or (distinct s (_ bv0 38)) (distinct t (bvnot (_ bv0 38))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 38))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 38))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
