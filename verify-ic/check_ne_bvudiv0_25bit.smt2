...
(or (distinct s (_ bv0 25)) (distinct t (bvnot (_ bv0 25))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 25))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 25))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
