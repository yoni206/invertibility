...
(and (=> (bvult s (_ bv42 42)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv42 42)) (or (= t (bvnot (_ bv0 42))) (= t (_ bv0 42)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 42))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 42))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
