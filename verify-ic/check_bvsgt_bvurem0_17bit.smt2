...
(and (and (=> (bvsgt s (_ bv0 17)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 17)) (distinct t max))) (or (distinct t (_ bv0 17)) (distinct s (_ bv1 17))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 17))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 17))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
