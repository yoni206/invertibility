...
(and (=> (bvult s (_ bv33 33)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv33 33)) (or (= t (bvnot (_ bv0 33))) (= t (_ bv0 33)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 33))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 33))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
