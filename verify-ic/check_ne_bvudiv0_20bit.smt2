...
(or (distinct s (_ bv0 20)) (distinct t (bvnot (_ bv0 20))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 20))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 20))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
