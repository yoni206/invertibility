...
(and (=> (bvsge s (_ bv0 11)) (bvsgt s t)) (=> (bvslt s (_ bv0 11)) (bvsgt (bvlshr (bvsub s (_ bv1 11)) (_ bv1 11)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 11))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 11))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
