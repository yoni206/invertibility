...
(and (or (not (= t (_ bv0 49))) (not (= s (_ bv0 49)))) (or (not (= t (bvnot (_ bv0 49)))) (not (= s (bvnot (_ bv0 49))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 49))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 49))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
