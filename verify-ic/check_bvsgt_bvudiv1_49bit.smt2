...
(and (=> (bvsge s (_ bv0 49)) (bvsgt s t)) (=> (bvslt s (_ bv0 49)) (bvsgt (bvlshr s (_ bv1 49)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 49))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 49))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
