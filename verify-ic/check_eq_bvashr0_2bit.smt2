...
(and (=> (bvult s (_ bv2 2)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv2 2)) (or (= t (bvnot (_ bv0 2))) (= t (_ bv0 2)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 2))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 2))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
