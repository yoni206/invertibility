...
(or (distinct s (_ bv0 35)) (distinct t (bvnot (_ bv0 35))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 35))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 35))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
