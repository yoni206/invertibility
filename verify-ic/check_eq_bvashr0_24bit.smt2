...
(and (=> (bvult s (_ bv24 24)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv24 24)) (or (= t (bvnot (_ bv0 24))) (= t (_ bv0 24)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 24))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 24))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
