...
(and (=> (bvsge s (_ bv0 61)) (bvsgt s t)) (=> (bvslt s (_ bv0 61)) (bvsgt (bvlshr (bvsub s (_ bv1 61)) (_ bv1 61)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 61))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 61))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
