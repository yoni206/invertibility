...
(and (=> (bvult s (_ bv58 58)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv58 58)) (or (= t (bvnot (_ bv0 58))) (= t (_ bv0 58)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 58))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 58))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
