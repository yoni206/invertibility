...
(and (or (not (= t (_ bv0 50))) (not (= s (_ bv0 50)))) (or (not (= t (bvnot (_ bv0 50)))) (not (= s (bvnot (_ bv0 50))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 50))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 50))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
