...
(and (or (not (= t (_ bv0 13))) (not (= s (_ bv0 13)))) (or (not (= t (bvnot (_ bv0 13)))) (not (= s (bvnot (_ bv0 13))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 13))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 13))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
