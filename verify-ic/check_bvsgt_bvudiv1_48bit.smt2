...
(and (=> (bvsge s (_ bv0 48)) (bvsgt s t)) (=> (bvslt s (_ bv0 48)) (bvsgt (bvlshr s (_ bv1 48)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 48))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 48))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
