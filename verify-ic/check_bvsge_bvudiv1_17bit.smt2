...
(and (=> (bvsge s (_ bv0 17)) (bvsge s t)) (=> (bvslt s (_ bv0 17)) (bvsge (bvlshr s (_ bv1 17)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 17))) (bvsge (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 17))) (bvsge (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
