...
(and (=> (bvsge s (_ bv0 18)) (bvsgt s t)) (=> (bvslt s (_ bv0 18)) (bvsgt (bvlshr (bvsub s (_ bv1 18)) (_ bv1 18)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 18))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 18))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
