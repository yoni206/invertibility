...
(and (=> (bvult s (_ bv39 39)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv39 39)) (or (= t (bvnot (_ bv0 39))) (= t (_ bv0 39)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 39))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 39))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
