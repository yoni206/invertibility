...
(and (and (=> (bvsgt s (_ bv0 58)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 58)) (distinct t max))) (or (distinct t (_ bv0 58)) (distinct s (_ bv1 58))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 58))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 58))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
