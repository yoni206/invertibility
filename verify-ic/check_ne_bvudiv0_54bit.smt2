...
(or (distinct s (_ bv0 54)) (distinct t (bvnot (_ bv0 54))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 54))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 54))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
