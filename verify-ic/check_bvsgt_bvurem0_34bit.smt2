...
(and (and (=> (bvsgt s (_ bv0 34)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 34)) (distinct t max))) (or (distinct t (_ bv0 34)) (distinct s (_ bv1 34))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 34))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 34))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
