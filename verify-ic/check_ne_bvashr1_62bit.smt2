...
(and (or (not (= t (_ bv0 62))) (not (= s (_ bv0 62)))) (or (not (= t (bvnot (_ bv0 62)))) (not (= s (bvnot (_ bv0 62))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 62))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 62))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
