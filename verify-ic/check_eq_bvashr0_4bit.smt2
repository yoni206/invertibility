...
(and (=> (bvult s (_ bv4 4)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv4 4)) (or (= t (bvnot (_ bv0 4))) (= t (_ bv0 4)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 4))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 4))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
