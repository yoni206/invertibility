...
(and (=> (bvsge s (_ bv0 47)) (bvsgt s t)) (=> (bvslt s (_ bv0 47)) (bvsgt (bvlshr s (_ bv1 47)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 47))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 47))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
