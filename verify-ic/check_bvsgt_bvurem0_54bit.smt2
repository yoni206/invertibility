...
(and (and (=> (bvsgt s (_ bv0 54)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 54)) (distinct t max))) (or (distinct t (_ bv0 54)) (distinct s (_ bv1 54))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 54))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 54))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
