...
(and (=> (bvult s (_ bv17 17)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv17 17)) (or (= t (bvnot (_ bv0 17))) (= t (_ bv0 17)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 17))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 17))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
