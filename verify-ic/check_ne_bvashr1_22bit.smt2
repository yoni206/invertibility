...
(and (or (not (= t (_ bv0 22))) (not (= s (_ bv0 22)))) (or (not (= t (bvnot (_ bv0 22)))) (not (= s (bvnot (_ bv0 22))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 22))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 22))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
