...
(and (=> (bvslt s (_ bv0 55)) (bvsge (bvlshr s (_ bv1 55)) t)) (=> (bvsge s (_ bv0 55)) (bvsge s t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 55))) (bvsge (bvlshr s x) t)))
  (=> (exists ((x (_ BitVec 55))) (bvsge (bvlshr s x) t)) (SC s t))
  )
 )
)
(check-sat)
