...
(and (or (not (= t (_ bv0 5))) (not (= s (_ bv0 5)))) (or (not (= t (bvnot (_ bv0 5)))) (not (= s (bvnot (_ bv0 5))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 5))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 5))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
