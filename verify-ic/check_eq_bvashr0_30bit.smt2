...
(and (=> (bvult s (_ bv30 30)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv30 30)) (or (= t (bvnot (_ bv0 30))) (= t (_ bv0 30)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 30))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 30))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
