...
(and (=> (bvsge s (_ bv0 27)) (bvsge s t)) (=> (bvslt s (_ bv0 27)) (bvsge (bvlshr s (_ bv1 27)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 27))) (bvsge (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 27))) (bvsge (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
