...
(and (or (not (= t (_ bv0 32))) (not (= s (_ bv0 32)))) (or (not (= t (bvnot (_ bv0 32)))) (not (= s (bvnot (_ bv0 32))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 32))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 32))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
