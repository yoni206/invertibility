...
(and (=> (bvsge s (_ bv0 2)) (bvsgt s t)) (=> (bvslt s (_ bv0 2)) (bvsgt (bvlshr s (_ bv1 2)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 2))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 2))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
