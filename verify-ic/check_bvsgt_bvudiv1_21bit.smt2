...
(and (=> (bvsge s (_ bv0 21)) (bvsgt s t)) (=> (bvslt s (_ bv0 21)) (bvsgt (bvlshr s (_ bv1 21)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 21))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 21))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
