...
(and (or (not (= t (_ bv0 61))) (not (= s (_ bv0 61)))) (or (not (= t (bvnot (_ bv0 61)))) (not (= s (bvnot (_ bv0 61))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 61))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 61))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
