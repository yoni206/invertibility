...
(and (or (not (= t (_ bv0 23))) (not (= s (_ bv0 23)))) (or (not (= t (bvnot (_ bv0 23)))) (not (= s (bvnot (_ bv0 23))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 23))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 23))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
