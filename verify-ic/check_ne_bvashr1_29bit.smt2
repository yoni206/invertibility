...
(and (or (not (= t (_ bv0 29))) (not (= s (_ bv0 29)))) (or (not (= t (bvnot (_ bv0 29)))) (not (= s (bvnot (_ bv0 29))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 29))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 29))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
