...
(and (or (not (= t (_ bv0 54))) (not (= s (_ bv0 54)))) (or (not (= t (bvnot (_ bv0 54)))) (not (= s (bvnot (_ bv0 54))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 54))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 54))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
