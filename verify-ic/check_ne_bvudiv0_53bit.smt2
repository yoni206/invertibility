...
(or (distinct s (_ bv0 53)) (distinct t (bvnot (_ bv0 53))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 53))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 53))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
