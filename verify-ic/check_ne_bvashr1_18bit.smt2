...
(and (or (not (= t (_ bv0 18))) (not (= s (_ bv0 18)))) (or (not (= t (bvnot (_ bv0 18)))) (not (= s (bvnot (_ bv0 18))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 18))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 18))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
