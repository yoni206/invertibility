...
(and (=> (bvult s (_ bv19 19)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv19 19)) (or (= t (bvnot (_ bv0 19))) (= t (_ bv0 19)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 19))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 19))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
