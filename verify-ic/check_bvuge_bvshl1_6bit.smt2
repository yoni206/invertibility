...
(or  (bvuge (bvshl s (_ bv0 6)) t) (bvuge (bvshl s (_ bv1 6)) t) (bvuge (bvshl s (_ bv2 6)) t) (bvuge (bvshl s (_ bv3 6)) t) (bvuge (bvshl s (_ bv4 6)) t) (bvuge (bvshl s (_ bv5 6)) t) (bvuge (bvshl s (_ bv6 6)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 6))) (bvuge (bvshl s x) t)))
  (=> (exists ((x (_ BitVec 6))) (bvuge (bvshl s x) t)) (SC s t))
  )
 )
)
(check-sat)
