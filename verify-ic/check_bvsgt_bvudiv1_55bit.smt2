...
(and (=> (bvsge s (_ bv0 55)) (bvsgt s t)) (=> (bvslt s (_ bv0 55)) (bvsgt (bvlshr s (_ bv1 55)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 55))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 55))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
