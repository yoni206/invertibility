...
(and (=> (bvult s (_ bv54 54)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv54 54)) (or (= t (bvnot (_ bv0 54))) (= t (_ bv0 54)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 54))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 54))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
