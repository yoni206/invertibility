...
(and (=> (bvsge s (_ bv0 44)) (bvsge s t)) (=> (bvslt s (_ bv0 44)) (bvsge (bvlshr s (_ bv1 44)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 44))) (bvsge (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 44))) (bvsge (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
