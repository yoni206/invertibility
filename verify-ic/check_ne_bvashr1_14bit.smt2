...
(and (or (not (= t (_ bv0 14))) (not (= s (_ bv0 14)))) (or (not (= t (bvnot (_ bv0 14)))) (not (= s (bvnot (_ bv0 14))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 14))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 14))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
