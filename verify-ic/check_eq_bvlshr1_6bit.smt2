...
(or  (= (bvlshr s (_ bv0 6)) t) (= (bvlshr s (_ bv1 6)) t) (= (bvlshr s (_ bv2 6)) t) (= (bvlshr s (_ bv3 6)) t) (= (bvlshr s (_ bv4 6)) t) (= (bvlshr s (_ bv5 6)) t) (= (bvlshr s (_ bv6 6)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 6))) (= (bvlshr s x) t)))
  (=> (exists ((x (_ BitVec 6))) (= (bvlshr s x) t)) (SC s t))
  )
 )
)
(check-sat)
