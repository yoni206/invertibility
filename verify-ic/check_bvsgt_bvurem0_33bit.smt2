...
(and (and (=> (bvsgt s (_ bv0 33)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 33)) (distinct t max))) (or (distinct t (_ bv0 33)) (distinct s (_ bv1 33))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 33))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 33))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
