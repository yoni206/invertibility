...
(or (distinct s (_ bv0 45)) (distinct t (bvnot (_ bv0 45))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 45))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 45))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
