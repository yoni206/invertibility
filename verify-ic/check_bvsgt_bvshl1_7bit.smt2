...
(or  (bvsgt (bvshl s (_ bv0 7)) t) (bvsgt (bvshl s (_ bv1 7)) t) (bvsgt (bvshl s (_ bv2 7)) t) (bvsgt (bvshl s (_ bv3 7)) t) (bvsgt (bvshl s (_ bv4 7)) t) (bvsgt (bvshl s (_ bv5 7)) t) (bvsgt (bvshl s (_ bv6 7)) t) (bvsgt (bvshl s (_ bv7 7)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 7))) (bvsgt (bvshl s x) t)))
  (=> (exists ((x (_ BitVec 7))) (bvsgt (bvshl s x) t)) (SC s t))
  )
 )
)
(check-sat)
