...
(and (=> (bvsge s (_ bv0 26)) (bvsgt s t)) (=> (bvslt s (_ bv0 26)) (bvsgt (bvlshr (bvsub s (_ bv1 26)) (_ bv1 26)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 26))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 26))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
