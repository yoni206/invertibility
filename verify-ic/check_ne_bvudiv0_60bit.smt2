...
(or (distinct s (_ bv0 60)) (distinct t (bvnot (_ bv0 60))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 60))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 60))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
