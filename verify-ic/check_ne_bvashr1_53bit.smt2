...
(and (or (not (= t (_ bv0 53))) (not (= s (_ bv0 53)))) (or (not (= t (bvnot (_ bv0 53)))) (not (= s (bvnot (_ bv0 53))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 53))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 53))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
