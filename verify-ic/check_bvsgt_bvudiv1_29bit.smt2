...
(and (=> (bvsge s (_ bv0 29)) (bvsgt s t)) (=> (bvslt s (_ bv0 29)) (bvsgt (bvlshr s (_ bv1 29)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 29))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 29))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
