...
(or (distinct s (_ bv0 49)) (distinct t (bvnot (_ bv0 49))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 49))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 49))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
