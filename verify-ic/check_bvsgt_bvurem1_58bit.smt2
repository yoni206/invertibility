...
(and (=> (bvsge s (_ bv0 58)) (bvsgt s t)) (=> (bvslt s (_ bv0 58)) (bvsgt (bvlshr (bvsub s (_ bv1 58)) (_ bv1 58)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 58))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 58))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
