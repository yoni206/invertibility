...
(and (=> (bvult s (_ bv13 13)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv13 13)) (or (= t (bvnot (_ bv0 13))) (= t (_ bv0 13)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 13))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 13))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
