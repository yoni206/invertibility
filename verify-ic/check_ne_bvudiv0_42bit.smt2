...
(or (distinct s (_ bv0 42)) (distinct t (bvnot (_ bv0 42))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 42))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 42))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
