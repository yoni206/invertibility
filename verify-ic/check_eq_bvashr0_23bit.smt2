...
(and (=> (bvult s (_ bv23 23)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv23 23)) (or (= t (bvnot (_ bv0 23))) (= t (_ bv0 23)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 23))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 23))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
