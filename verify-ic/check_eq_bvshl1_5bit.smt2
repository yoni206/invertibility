...
(or  (= (bvshl s (_ bv0 5)) t) (= (bvshl s (_ bv1 5)) t) (= (bvshl s (_ bv2 5)) t) (= (bvshl s (_ bv3 5)) t) (= (bvshl s (_ bv4 5)) t) (= (bvshl s (_ bv5 5)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 5))) (= (bvshl s x) t)))
  (=> (exists ((x (_ BitVec 5))) (= (bvshl s x) t)) (SC s t))
  )
 )
)
(check-sat)
