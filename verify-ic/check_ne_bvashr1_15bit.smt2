...
(and (or (not (= t (_ bv0 15))) (not (= s (_ bv0 15)))) (or (not (= t (bvnot (_ bv0 15)))) (not (= s (bvnot (_ bv0 15))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 15))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 15))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
