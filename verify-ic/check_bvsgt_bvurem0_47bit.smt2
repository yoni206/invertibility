...
(and (and (=> (bvsgt s (_ bv0 47)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 47)) (distinct t max))) (or (distinct t (_ bv0 47)) (distinct s (_ bv1 47))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 47))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 47))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
