...
(and (or (not (= t (_ bv0 36))) (not (= s (_ bv0 36)))) (or (not (= t (bvnot (_ bv0 36)))) (not (= s (bvnot (_ bv0 36))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 36))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 36))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
