...
(and (=> (bvult s (_ bv53 53)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv53 53)) (or (= t (bvnot (_ bv0 53))) (= t (_ bv0 53)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 53))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 53))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
