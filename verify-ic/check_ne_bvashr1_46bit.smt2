...
(and (or (not (= t (_ bv0 46))) (not (= s (_ bv0 46)))) (or (not (= t (bvnot (_ bv0 46)))) (not (= s (bvnot (_ bv0 46))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 46))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 46))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
