...
(and (=> (bvslt s (_ bv0 17)) (bvsgt (bvlshr s (_ bv1 17)) t)) (=> (bvsge s (_ bv0 17)) (bvsgt s t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 17))) (bvsgt (bvlshr s x) t)))
  (=> (exists ((x (_ BitVec 17))) (bvsgt (bvlshr s x) t)) (SC s t))
  )
 )
)
(check-sat)
