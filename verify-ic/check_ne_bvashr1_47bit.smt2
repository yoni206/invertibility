...
(and (or (not (= t (_ bv0 47))) (not (= s (_ bv0 47)))) (or (not (= t (bvnot (_ bv0 47)))) (not (= s (bvnot (_ bv0 47))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 47))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 47))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
