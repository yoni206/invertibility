...
(or  (= (bvashr s (_ bv0 11)) t) (= (bvashr s (_ bv1 11)) t) (= (bvashr s (_ bv2 11)) t) (= (bvashr s (_ bv3 11)) t) (= (bvashr s (_ bv4 11)) t) (= (bvashr s (_ bv5 11)) t) (= (bvashr s (_ bv6 11)) t) (= (bvashr s (_ bv7 11)) t) (= (bvashr s (_ bv8 11)) t) (= (bvashr s (_ bv9 11)) t) (= (bvashr s (_ bv10 11)) t) (= (bvashr s (_ bv11 11)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 11))) (= (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 11))) (= (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
