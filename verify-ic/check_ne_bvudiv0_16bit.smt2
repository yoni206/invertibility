...
(or (distinct s (_ bv0 16)) (distinct t (bvnot (_ bv0 16))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 16))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 16))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
