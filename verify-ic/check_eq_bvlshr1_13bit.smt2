...
(or  (= (bvlshr s (_ bv0 13)) t) (= (bvlshr s (_ bv1 13)) t) (= (bvlshr s (_ bv2 13)) t) (= (bvlshr s (_ bv3 13)) t) (= (bvlshr s (_ bv4 13)) t) (= (bvlshr s (_ bv5 13)) t) (= (bvlshr s (_ bv6 13)) t) (= (bvlshr s (_ bv7 13)) t) (= (bvlshr s (_ bv8 13)) t) (= (bvlshr s (_ bv9 13)) t) (= (bvlshr s (_ bv10 13)) t) (= (bvlshr s (_ bv11 13)) t) (= (bvlshr s (_ bv12 13)) t) (= (bvlshr s (_ bv13 13)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 13))) (= (bvlshr s x) t)))
  (=> (exists ((x (_ BitVec 13))) (= (bvlshr s x) t)) (SC s t))
  )
 )
)
(check-sat)
