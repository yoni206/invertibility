...
(or (distinct s (_ bv0 31)) (distinct t (bvnot (_ bv0 31))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 31))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 31))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
