...
(and (or (not (= t (_ bv0 24))) (not (= s (_ bv0 24)))) (or (not (= t (bvnot (_ bv0 24)))) (not (= s (bvnot (_ bv0 24))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 24))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 24))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
