...
(or (distinct s (_ bv0 19)) (distinct t (bvnot (_ bv0 19))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 19))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 19))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
