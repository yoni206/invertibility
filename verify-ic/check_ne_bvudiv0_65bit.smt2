...
(or (distinct s (_ bv0 65)) (distinct t (bvnot (_ bv0 65))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 65))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 65))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
