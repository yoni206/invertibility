...
(or  (= (bvshl s (_ bv0 14)) t) (= (bvshl s (_ bv1 14)) t) (= (bvshl s (_ bv2 14)) t) (= (bvshl s (_ bv3 14)) t) (= (bvshl s (_ bv4 14)) t) (= (bvshl s (_ bv5 14)) t) (= (bvshl s (_ bv6 14)) t) (= (bvshl s (_ bv7 14)) t) (= (bvshl s (_ bv8 14)) t) (= (bvshl s (_ bv9 14)) t) (= (bvshl s (_ bv10 14)) t) (= (bvshl s (_ bv11 14)) t) (= (bvshl s (_ bv12 14)) t) (= (bvshl s (_ bv13 14)) t) (= (bvshl s (_ bv14 14)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 14))) (= (bvshl s x) t)))
  (=> (exists ((x (_ BitVec 14))) (= (bvshl s x) t)) (SC s t))
  )
 )
)
(check-sat)
