...
(and (=> (bvult s (_ bv15 15)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv15 15)) (or (= t (bvnot (_ bv0 15))) (= t (_ bv0 15)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 15))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 15))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
