...
(and (=> (bvsge s (_ bv0 58)) (bvsge s t)) (=> (bvslt s (_ bv0 58)) (bvsge (bvlshr s (_ bv1 58)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 58))) (bvsge (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 58))) (bvsge (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
