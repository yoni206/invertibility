...
(and (or (not (= t (_ bv0 60))) (not (= s (_ bv0 60)))) (or (not (= t (bvnot (_ bv0 60)))) (not (= s (bvnot (_ bv0 60))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 60))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 60))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
