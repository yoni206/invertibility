...
(and (and (=> (bvsgt s (_ bv0 26)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 26)) (distinct t max))) (or (distinct t (_ bv0 26)) (distinct s (_ bv1 26))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 26))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 26))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
