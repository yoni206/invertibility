...
(and (=> (bvult s (_ bv21 21)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv21 21)) (or (= t (bvnot (_ bv0 21))) (= t (_ bv0 21)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 21))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 21))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
