...
(and (=> (bvult s (_ bv28 28)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv28 28)) (or (= t (bvnot (_ bv0 28))) (= t (_ bv0 28)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 28))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 28))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
