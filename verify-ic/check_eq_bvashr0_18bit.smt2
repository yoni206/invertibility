...
(and (=> (bvult s (_ bv18 18)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv18 18)) (or (= t (bvnot (_ bv0 18))) (= t (_ bv0 18)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 18))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 18))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
