...
(and (=> (bvult s (_ bv62 62)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv62 62)) (or (= t (bvnot (_ bv0 62))) (= t (_ bv0 62)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 62))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 62))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
