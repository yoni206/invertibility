...
(and (=> (bvsge s (_ bv0 32)) (bvsge s t)) (=> (bvslt s (_ bv0 32)) (bvsge (bvlshr s (_ bv1 32)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 32))) (bvsge (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 32))) (bvsge (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
