...
(or  (= (bvshl s (_ bv0 9)) t) (= (bvshl s (_ bv1 9)) t) (= (bvshl s (_ bv2 9)) t) (= (bvshl s (_ bv3 9)) t) (= (bvshl s (_ bv4 9)) t) (= (bvshl s (_ bv5 9)) t) (= (bvshl s (_ bv6 9)) t) (= (bvshl s (_ bv7 9)) t) (= (bvshl s (_ bv8 9)) t) (= (bvshl s (_ bv9 9)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 9))) (= (bvshl s x) t)))
  (=> (exists ((x (_ BitVec 9))) (= (bvshl s x) t)) (SC s t))
  )
 )
)
(check-sat)
