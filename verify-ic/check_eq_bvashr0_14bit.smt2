...
(and (=> (bvult s (_ bv14 14)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv14 14)) (or (= t (bvnot (_ bv0 14))) (= t (_ bv0 14)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 14))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 14))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
