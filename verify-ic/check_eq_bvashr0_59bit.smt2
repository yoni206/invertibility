...
(and (=> (bvult s (_ bv59 59)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv59 59)) (or (= t (bvnot (_ bv0 59))) (= t (_ bv0 59)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 59))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 59))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
