...
(or (distinct s (_ bv0 55)) (distinct t (bvnot (_ bv0 55))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 55))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 55))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
