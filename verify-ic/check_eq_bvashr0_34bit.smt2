...
(and (=> (bvult s (_ bv34 34)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv34 34)) (or (= t (bvnot (_ bv0 34))) (= t (_ bv0 34)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 34))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 34))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
