...
(and (=> (bvsge s (_ bv0 62)) (bvsgt s t)) (=> (bvslt s (_ bv0 62)) (bvsgt (bvlshr (bvsub s (_ bv1 62)) (_ bv1 62)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 62))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 62))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
