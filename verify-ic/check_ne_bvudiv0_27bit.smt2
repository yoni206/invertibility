...
(or (distinct s (_ bv0 27)) (distinct t (bvnot (_ bv0 27))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 27))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 27))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
