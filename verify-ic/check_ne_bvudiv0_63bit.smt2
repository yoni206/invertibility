...
(or (distinct s (_ bv0 63)) (distinct t (bvnot (_ bv0 63))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 63))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 63))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
