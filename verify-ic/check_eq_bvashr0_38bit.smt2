...
(and (=> (bvult s (_ bv38 38)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv38 38)) (or (= t (bvnot (_ bv0 38))) (= t (_ bv0 38)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 38))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 38))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
