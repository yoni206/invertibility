...
(and (=> (bvsge s (_ bv0 3)) (bvsgt s t)) (=> (bvslt s (_ bv0 3)) (bvsgt (bvlshr s (_ bv1 3)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 3))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 3))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
