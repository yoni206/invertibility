...
(and (=> (bvsge s (_ bv0 39)) (bvsgt s t)) (=> (bvslt s (_ bv0 39)) (bvsgt (bvlshr s (_ bv1 39)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 39))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 39))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
