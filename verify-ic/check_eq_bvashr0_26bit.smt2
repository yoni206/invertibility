...
(and (=> (bvult s (_ bv26 26)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv26 26)) (or (= t (bvnot (_ bv0 26))) (= t (_ bv0 26)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 26))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 26))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
