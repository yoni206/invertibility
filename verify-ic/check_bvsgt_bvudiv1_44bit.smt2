...
(and (=> (bvsge s (_ bv0 44)) (bvsgt s t)) (=> (bvslt s (_ bv0 44)) (bvsgt (bvlshr s (_ bv1 44)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 44))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 44))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
