...
(and (=> (bvult s (_ bv64 64)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv64 64)) (or (= t (bvnot (_ bv0 64))) (= t (_ bv0 64)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 64))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 64))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
