...
(and (=> (bvsge s (_ bv0 36)) (bvsgt s t)) (=> (bvslt s (_ bv0 36)) (bvsgt (bvlshr (bvsub s (_ bv1 36)) (_ bv1 36)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 36))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 36))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
