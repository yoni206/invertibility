...
(and (=> (bvslt s (_ bv0 5)) (bvsgt (bvlshr s (_ bv1 5)) t)) (=> (bvsge s (_ bv0 5)) (bvsgt s t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 5))) (bvsgt (bvlshr s x) t)))
  (=> (exists ((x (_ BitVec 5))) (bvsgt (bvlshr s x) t)) (SC s t))
  )
 )
)
(check-sat)
