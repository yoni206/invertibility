...
(and (or (not (= t (_ bv0 56))) (not (= s (_ bv0 56)))) (or (not (= t (bvnot (_ bv0 56)))) (not (= s (bvnot (_ bv0 56))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 56))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 56))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
