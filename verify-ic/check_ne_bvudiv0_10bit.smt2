...
(or (distinct s (_ bv0 10)) (distinct t (bvnot (_ bv0 10))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 10))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 10))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
