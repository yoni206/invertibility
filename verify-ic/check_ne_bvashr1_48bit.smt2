...
(and (or (not (= t (_ bv0 48))) (not (= s (_ bv0 48)))) (or (not (= t (bvnot (_ bv0 48)))) (not (= s (bvnot (_ bv0 48))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 48))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 48))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
