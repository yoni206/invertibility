...
(and (=> (bvsge s (_ bv0 19)) (bvsgt s t)) (=> (bvslt s (_ bv0 19)) (bvsgt (bvlshr (bvsub s (_ bv1 19)) (_ bv1 19)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 19))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 19))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
