...
(or (distinct s (_ bv0 46)) (distinct t (bvnot (_ bv0 46))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 46))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 46))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
