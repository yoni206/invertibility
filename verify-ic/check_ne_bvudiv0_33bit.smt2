...
(or (distinct s (_ bv0 33)) (distinct t (bvnot (_ bv0 33))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 33))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 33))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
