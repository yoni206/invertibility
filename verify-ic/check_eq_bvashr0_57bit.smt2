...
(and (=> (bvult s (_ bv57 57)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv57 57)) (or (= t (bvnot (_ bv0 57))) (= t (_ bv0 57)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 57))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 57))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
