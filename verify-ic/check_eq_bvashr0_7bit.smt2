...
(and (=> (bvult s (_ bv7 7)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv7 7)) (or (= t (bvnot (_ bv0 7))) (= t (_ bv0 7)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 7))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 7))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
