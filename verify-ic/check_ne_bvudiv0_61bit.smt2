...
(or (distinct s (_ bv0 61)) (distinct t (bvnot (_ bv0 61))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 61))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 61))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
