...
(or  (= (bvlshr s (_ bv0 10)) t) (= (bvlshr s (_ bv1 10)) t) (= (bvlshr s (_ bv2 10)) t) (= (bvlshr s (_ bv3 10)) t) (= (bvlshr s (_ bv4 10)) t) (= (bvlshr s (_ bv5 10)) t) (= (bvlshr s (_ bv6 10)) t) (= (bvlshr s (_ bv7 10)) t) (= (bvlshr s (_ bv8 10)) t) (= (bvlshr s (_ bv9 10)) t) (= (bvlshr s (_ bv10 10)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 10))) (= (bvlshr s x) t)))
  (=> (exists ((x (_ BitVec 10))) (= (bvlshr s x) t)) (SC s t))
  )
 )
)
(check-sat)
