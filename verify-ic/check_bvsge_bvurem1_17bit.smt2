...
(and (=> (bvsge s (_ bv0 17)) (bvsge s t)) (=> (and (bvslt s (_ bv0 17)) (bvsge t (_ bv0 17))) (bvugt (bvsub s t) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 17))) (bvsge (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 17))) (bvsge (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
