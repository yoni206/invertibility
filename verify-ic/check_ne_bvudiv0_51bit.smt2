...
(or (distinct s (_ bv0 51)) (distinct t (bvnot (_ bv0 51))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 51))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 51))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
