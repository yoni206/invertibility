...
(and (or (not (= t (_ bv0 65))) (not (= s (_ bv0 65)))) (or (not (= t (bvnot (_ bv0 65)))) (not (= s (bvnot (_ bv0 65))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 65))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 65))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
