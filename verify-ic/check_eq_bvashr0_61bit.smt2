...
(and (=> (bvult s (_ bv61 61)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv61 61)) (or (= t (bvnot (_ bv0 61))) (= t (_ bv0 61)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 61))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 61))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
