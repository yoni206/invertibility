...
(and (=> (bvult s (_ bv45 45)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv45 45)) (or (= t (bvnot (_ bv0 45))) (= t (_ bv0 45)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 45))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 45))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
