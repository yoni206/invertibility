...
(and (=> (bvult s (_ bv29 29)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv29 29)) (or (= t (bvnot (_ bv0 29))) (= t (_ bv0 29)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 29))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 29))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
