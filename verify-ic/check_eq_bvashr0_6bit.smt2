...
(and (=> (bvult s (_ bv6 6)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv6 6)) (or (= t (bvnot (_ bv0 6))) (= t (_ bv0 6)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 6))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 6))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
