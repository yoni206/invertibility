...
(or (distinct s (_ bv0 13)) (distinct t (bvnot (_ bv0 13))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 13))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 13))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
