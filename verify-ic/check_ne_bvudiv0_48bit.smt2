...
(or (distinct s (_ bv0 48)) (distinct t (bvnot (_ bv0 48))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 48))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 48))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
