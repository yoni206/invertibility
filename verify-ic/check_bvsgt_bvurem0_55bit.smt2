...
(and (and (=> (bvsgt s (_ bv0 55)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 55)) (distinct t max))) (or (distinct t (_ bv0 55)) (distinct s (_ bv1 55))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 55))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 55))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
