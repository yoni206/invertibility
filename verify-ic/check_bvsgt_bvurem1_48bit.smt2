...
(and (=> (bvsge s (_ bv0 48)) (bvsgt s t)) (=> (bvslt s (_ bv0 48)) (bvsgt (bvlshr (bvsub s (_ bv1 48)) (_ bv1 48)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 48))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 48))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
