...
(or (distinct s (_ bv0 50)) (distinct t (bvnot (_ bv0 50))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 50))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 50))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
