...
(or (distinct s (_ bv0 43)) (distinct t (bvnot (_ bv0 43))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 43))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 43))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
