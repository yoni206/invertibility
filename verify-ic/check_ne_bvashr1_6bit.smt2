...
(and (or (not (= t (_ bv0 6))) (not (= s (_ bv0 6)))) (or (not (= t (bvnot (_ bv0 6)))) (not (= s (bvnot (_ bv0 6))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 6))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 6))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
