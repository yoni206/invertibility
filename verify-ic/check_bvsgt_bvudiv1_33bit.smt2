...
(and (=> (bvsge s (_ bv0 33)) (bvsgt s t)) (=> (bvslt s (_ bv0 33)) (bvsgt (bvlshr s (_ bv1 33)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 33))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 33))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
