...
(or (distinct s (_ bv0 26)) (distinct t (bvnot (_ bv0 26))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 26))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 26))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
