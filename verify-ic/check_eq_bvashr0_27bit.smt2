...
(and (=> (bvult s (_ bv27 27)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv27 27)) (or (= t (bvnot (_ bv0 27))) (= t (_ bv0 27)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 27))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 27))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
