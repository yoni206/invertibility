...
(and (=> (bvult s (_ bv25 25)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv25 25)) (or (= t (bvnot (_ bv0 25))) (= t (_ bv0 25)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 25))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 25))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
