...
(and (=> (bvult s (_ bv20 20)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv20 20)) (or (= t (bvnot (_ bv0 20))) (= t (_ bv0 20)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 20))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 20))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
