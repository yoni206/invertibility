...
(and (=> (bvsge s (_ bv0 25)) (bvsgt s t)) (=> (bvslt s (_ bv0 25)) (bvsgt (bvlshr s (_ bv1 25)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 25))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 25))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
