...
(and (or (not (= t (_ bv0 43))) (not (= s (_ bv0 43)))) (or (not (= t (bvnot (_ bv0 43)))) (not (= s (bvnot (_ bv0 43))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 43))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 43))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
