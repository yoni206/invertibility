...
(and (or (not (= t (_ bv0 20))) (not (= s (_ bv0 20)))) (or (not (= t (bvnot (_ bv0 20)))) (not (= s (bvnot (_ bv0 20))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 20))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 20))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
