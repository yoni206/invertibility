...
(or (distinct s (_ bv0 24)) (distinct t (bvnot (_ bv0 24))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 24))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 24))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
