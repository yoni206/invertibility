...
(and (=> (bvult s (_ bv60 60)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv60 60)) (or (= t (bvnot (_ bv0 60))) (= t (_ bv0 60)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 60))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 60))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
