...
(and (=> (bvult s (_ bv40 40)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv40 40)) (or (= t (bvnot (_ bv0 40))) (= t (_ bv0 40)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 40))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 40))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
