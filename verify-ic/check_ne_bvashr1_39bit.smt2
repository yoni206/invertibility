...
(and (or (not (= t (_ bv0 39))) (not (= s (_ bv0 39)))) (or (not (= t (bvnot (_ bv0 39)))) (not (= s (bvnot (_ bv0 39))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 39))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 39))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
