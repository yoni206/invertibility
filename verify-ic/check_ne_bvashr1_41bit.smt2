...
(and (or (not (= t (_ bv0 41))) (not (= s (_ bv0 41)))) (or (not (= t (bvnot (_ bv0 41)))) (not (= s (bvnot (_ bv0 41))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 41))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 41))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
