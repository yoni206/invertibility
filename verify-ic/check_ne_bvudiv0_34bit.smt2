...
(or (distinct s (_ bv0 34)) (distinct t (bvnot (_ bv0 34))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 34))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 34))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
