...
(and (=> (bvult s (_ bv31 31)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv31 31)) (or (= t (bvnot (_ bv0 31))) (= t (_ bv0 31)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 31))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 31))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
