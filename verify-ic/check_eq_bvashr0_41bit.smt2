...
(and (=> (bvult s (_ bv41 41)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv41 41)) (or (= t (bvnot (_ bv0 41))) (= t (_ bv0 41)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 41))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 41))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
