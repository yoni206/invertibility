...
(and (=> (bvsge s (_ bv0 54)) (bvsgt s t)) (=> (bvslt s (_ bv0 54)) (bvsgt (bvlshr (bvsub s (_ bv1 54)) (_ bv1 54)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 54))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 54))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
