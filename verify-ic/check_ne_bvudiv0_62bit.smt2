...
(or (distinct s (_ bv0 62)) (distinct t (bvnot (_ bv0 62))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 62))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 62))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
