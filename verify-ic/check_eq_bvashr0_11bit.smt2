...
(and (=> (bvult s (_ bv11 11)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv11 11)) (or (= t (bvnot (_ bv0 11))) (= t (_ bv0 11)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 11))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 11))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
