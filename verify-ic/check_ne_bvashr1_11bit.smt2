...
(and (or (not (= t (_ bv0 11))) (not (= s (_ bv0 11)))) (or (not (= t (bvnot (_ bv0 11)))) (not (= s (bvnot (_ bv0 11))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 11))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 11))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
