...
(and (or (not (= t (_ bv0 57))) (not (= s (_ bv0 57)))) (or (not (= t (bvnot (_ bv0 57)))) (not (= s (bvnot (_ bv0 57))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 57))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 57))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
