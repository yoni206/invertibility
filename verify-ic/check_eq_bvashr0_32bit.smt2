...
(and (=> (bvult s (_ bv32 32)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv32 32)) (or (= t (bvnot (_ bv0 32))) (= t (_ bv0 32)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 32))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 32))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
