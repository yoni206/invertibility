...
(or (distinct s (_ bv0 11)) (distinct t (bvnot (_ bv0 11))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 11))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 11))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
