...
(or (distinct s (_ bv0 12)) (distinct t (bvnot (_ bv0 12))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 12))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 12))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
