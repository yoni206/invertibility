...
(and (=> (bvsge s (_ bv0 4)) (bvsgt s t)) (=> (bvslt s (_ bv0 4)) (bvsgt (bvlshr (bvsub s (_ bv1 4)) (_ bv1 4)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 4))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 4))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
