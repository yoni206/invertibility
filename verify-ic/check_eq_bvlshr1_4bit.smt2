...
(or  (= (bvlshr s (_ bv0 4)) t) (= (bvlshr s (_ bv1 4)) t) (= (bvlshr s (_ bv2 4)) t) (= (bvlshr s (_ bv3 4)) t) (= (bvlshr s (_ bv4 4)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 4))) (= (bvlshr s x) t)))
  (=> (exists ((x (_ BitVec 4))) (= (bvlshr s x) t)) (SC s t))
  )
 )
)
(check-sat)
