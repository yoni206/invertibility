...
(or (distinct s (_ bv0 39)) (distinct t (bvnot (_ bv0 39))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 39))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 39))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
