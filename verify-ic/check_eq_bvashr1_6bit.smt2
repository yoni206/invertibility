...
(or  (= (bvashr s (_ bv0 6)) t) (= (bvashr s (_ bv1 6)) t) (= (bvashr s (_ bv2 6)) t) (= (bvashr s (_ bv3 6)) t) (= (bvashr s (_ bv4 6)) t) (= (bvashr s (_ bv5 6)) t) (= (bvashr s (_ bv6 6)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 6))) (= (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 6))) (= (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
