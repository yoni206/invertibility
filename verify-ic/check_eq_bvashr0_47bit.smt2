...
(and (=> (bvult s (_ bv47 47)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv47 47)) (or (= t (bvnot (_ bv0 47))) (= t (_ bv0 47)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 47))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 47))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
