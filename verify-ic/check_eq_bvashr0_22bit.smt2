...
(and (=> (bvult s (_ bv22 22)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv22 22)) (or (= t (bvnot (_ bv0 22))) (= t (_ bv0 22)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 22))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 22))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
