...
(or  (= (bvshl s (_ bv0 12)) t) (= (bvshl s (_ bv1 12)) t) (= (bvshl s (_ bv2 12)) t) (= (bvshl s (_ bv3 12)) t) (= (bvshl s (_ bv4 12)) t) (= (bvshl s (_ bv5 12)) t) (= (bvshl s (_ bv6 12)) t) (= (bvshl s (_ bv7 12)) t) (= (bvshl s (_ bv8 12)) t) (= (bvshl s (_ bv9 12)) t) (= (bvshl s (_ bv10 12)) t) (= (bvshl s (_ bv11 12)) t) (= (bvshl s (_ bv12 12)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 12))) (= (bvshl s x) t)))
  (=> (exists ((x (_ BitVec 12))) (= (bvshl s x) t)) (SC s t))
  )
 )
)
(check-sat)
