...
(and (or (not (= t (_ bv0 63))) (not (= s (_ bv0 63)))) (or (not (= t (bvnot (_ bv0 63)))) (not (= s (bvnot (_ bv0 63))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 63))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 63))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
