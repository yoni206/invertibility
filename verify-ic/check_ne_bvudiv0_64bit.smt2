...
(or (distinct s (_ bv0 64)) (distinct t (bvnot (_ bv0 64))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 64))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 64))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
