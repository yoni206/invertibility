...
(or (distinct s (_ bv0 59)) (distinct t (bvnot (_ bv0 59))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 59))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 59))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
