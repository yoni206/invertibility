...
(and (and (=> (bvsgt s (_ bv0 49)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 49)) (distinct t max))) (or (distinct t (_ bv0 49)) (distinct s (_ bv1 49))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 49))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 49))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
