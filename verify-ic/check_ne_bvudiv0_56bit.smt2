...
(or (distinct s (_ bv0 56)) (distinct t (bvnot (_ bv0 56))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 56))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 56))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
