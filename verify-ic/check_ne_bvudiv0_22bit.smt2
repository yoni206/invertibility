...
(or (distinct s (_ bv0 22)) (distinct t (bvnot (_ bv0 22))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 22))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 22))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
