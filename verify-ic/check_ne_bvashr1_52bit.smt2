...
(and (or (not (= t (_ bv0 52))) (not (= s (_ bv0 52)))) (or (not (= t (bvnot (_ bv0 52)))) (not (= s (bvnot (_ bv0 52))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 52))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 52))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
