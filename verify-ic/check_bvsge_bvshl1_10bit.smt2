...
(or  (bvsge (bvshl s (_ bv0 10)) t) (bvsge (bvshl s (_ bv1 10)) t) (bvsge (bvshl s (_ bv2 10)) t) (bvsge (bvshl s (_ bv3 10)) t) (bvsge (bvshl s (_ bv4 10)) t) (bvsge (bvshl s (_ bv5 10)) t) (bvsge (bvshl s (_ bv6 10)) t) (bvsge (bvshl s (_ bv7 10)) t) (bvsge (bvshl s (_ bv8 10)) t) (bvsge (bvshl s (_ bv9 10)) t) (bvsge (bvshl s (_ bv10 10)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 10))) (bvsge (bvshl s x) t)))
  (=> (exists ((x (_ BitVec 10))) (bvsge (bvshl s x) t)) (SC s t))
  )
 )
)
(check-sat)
