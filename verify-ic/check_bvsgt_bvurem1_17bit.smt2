...
(and (=> (bvsge s (_ bv0 17)) (bvsgt s t)) (=> (bvslt s (_ bv0 17)) (bvsgt (bvlshr (bvsub s (_ bv1 17)) (_ bv1 17)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 17))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 17))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
