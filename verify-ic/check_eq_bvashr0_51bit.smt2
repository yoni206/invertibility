...
(and (=> (bvult s (_ bv51 51)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv51 51)) (or (= t (bvnot (_ bv0 51))) (= t (_ bv0 51)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 51))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 51))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
