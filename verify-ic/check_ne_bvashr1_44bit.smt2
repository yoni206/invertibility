...
(and (or (not (= t (_ bv0 44))) (not (= s (_ bv0 44)))) (or (not (= t (bvnot (_ bv0 44)))) (not (= s (bvnot (_ bv0 44))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 44))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 44))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
