...
(and (=> (bvult s (_ bv63 63)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv63 63)) (or (= t (bvnot (_ bv0 63))) (= t (_ bv0 63)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 63))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 63))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
