...
(and (=> (bvsge s (_ bv0 47)) (bvsge s t)) (=> (bvslt s (_ bv0 47)) (bvsge (bvlshr s (_ bv1 47)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 47))) (bvsge (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 47))) (bvsge (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
