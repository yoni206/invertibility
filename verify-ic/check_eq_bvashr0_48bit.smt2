...
(and (=> (bvult s (_ bv48 48)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv48 48)) (or (= t (bvnot (_ bv0 48))) (= t (_ bv0 48)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 48))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 48))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
