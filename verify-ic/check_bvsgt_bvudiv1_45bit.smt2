...
(and (=> (bvsge s (_ bv0 45)) (bvsgt s t)) (=> (bvslt s (_ bv0 45)) (bvsgt (bvlshr s (_ bv1 45)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 45))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 45))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
