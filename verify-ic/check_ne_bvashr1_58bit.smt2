...
(and (or (not (= t (_ bv0 58))) (not (= s (_ bv0 58)))) (or (not (= t (bvnot (_ bv0 58)))) (not (= s (bvnot (_ bv0 58))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 58))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 58))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
