...
(and (and (=> (bvsgt s (_ bv0 21)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 21)) (distinct t max))) (or (distinct t (_ bv0 21)) (distinct s (_ bv1 21))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 21))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 21))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
