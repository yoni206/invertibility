...
(and (=> (bvsge s (_ bv0 33)) (bvsgt s t)) (=> (bvslt s (_ bv0 33)) (bvsgt (bvlshr (bvsub s (_ bv1 33)) (_ bv1 33)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 33))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 33))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
