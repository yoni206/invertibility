...
(and (=> (bvsge s (_ bv0 54)) (bvsge s t)) (=> (bvslt s (_ bv0 54)) (bvsge (bvlshr s (_ bv1 54)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 54))) (bvsge (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 54))) (bvsge (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
