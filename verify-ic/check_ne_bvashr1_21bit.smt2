...
(and (or (not (= t (_ bv0 21))) (not (= s (_ bv0 21)))) (or (not (= t (bvnot (_ bv0 21)))) (not (= s (bvnot (_ bv0 21))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 21))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 21))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
