...
(or (distinct s (_ bv0 23)) (distinct t (bvnot (_ bv0 23))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 23))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 23))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
