...
(and (or (not (= t (_ bv0 42))) (not (= s (_ bv0 42)))) (or (not (= t (bvnot (_ bv0 42)))) (not (= s (bvnot (_ bv0 42))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 42))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 42))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
