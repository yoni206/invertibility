...
(and (or (not (= t (_ bv0 28))) (not (= s (_ bv0 28)))) (or (not (= t (bvnot (_ bv0 28)))) (not (= s (bvnot (_ bv0 28))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 28))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 28))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
