...
(and (and (=> (bvsgt s (_ bv0 37)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 37)) (distinct t max))) (or (distinct t (_ bv0 37)) (distinct s (_ bv1 37))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 37))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 37))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
