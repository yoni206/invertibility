...
(and (=> (bvult s (_ bv43 43)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv43 43)) (or (= t (bvnot (_ bv0 43))) (= t (_ bv0 43)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 43))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 43))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
