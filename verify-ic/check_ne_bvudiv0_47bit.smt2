...
(or (distinct s (_ bv0 47)) (distinct t (bvnot (_ bv0 47))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 47))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 47))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
