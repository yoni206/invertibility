...
(and (=> (bvult s (_ bv50 50)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv50 50)) (or (= t (bvnot (_ bv0 50))) (= t (_ bv0 50)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 50))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 50))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
