...
(and (or (not (= t (_ bv0 8))) (not (= s (_ bv0 8)))) (or (not (= t (bvnot (_ bv0 8)))) (not (= s (bvnot (_ bv0 8))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 8))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 8))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
