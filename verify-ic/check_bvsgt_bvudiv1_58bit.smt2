...
(and (=> (bvsge s (_ bv0 58)) (bvsgt s t)) (=> (bvslt s (_ bv0 58)) (bvsgt (bvlshr s (_ bv1 58)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 58))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 58))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
