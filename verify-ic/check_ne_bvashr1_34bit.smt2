...
(and (or (not (= t (_ bv0 34))) (not (= s (_ bv0 34)))) (or (not (= t (bvnot (_ bv0 34)))) (not (= s (bvnot (_ bv0 34))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 34))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 34))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
