...
(and (=> (bvult s (_ bv3 3)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv3 3)) (or (= t (bvnot (_ bv0 3))) (= t (_ bv0 3)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 3))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 3))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
