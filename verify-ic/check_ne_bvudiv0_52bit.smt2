...
(or (distinct s (_ bv0 52)) (distinct t (bvnot (_ bv0 52))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 52))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 52))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
