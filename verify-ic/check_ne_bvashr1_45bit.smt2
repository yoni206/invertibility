...
(and (or (not (= t (_ bv0 45))) (not (= s (_ bv0 45)))) (or (not (= t (bvnot (_ bv0 45)))) (not (= s (bvnot (_ bv0 45))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 45))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 45))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
