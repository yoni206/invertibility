...
(or (distinct s (_ bv0 17)) (distinct t (bvnot (_ bv0 17))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 17))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 17))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
