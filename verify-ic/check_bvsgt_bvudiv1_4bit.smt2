...
(and (=> (bvsge s (_ bv0 4)) (bvsgt s t)) (=> (bvslt s (_ bv0 4)) (bvsgt (bvlshr s (_ bv1 4)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 4))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 4))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
