...
(and (=> (bvult s (_ bv65 65)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv65 65)) (or (= t (bvnot (_ bv0 65))) (= t (_ bv0 65)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 65))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 65))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
