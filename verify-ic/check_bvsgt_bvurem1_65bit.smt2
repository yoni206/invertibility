...
(and (=> (bvsge s (_ bv0 65)) (bvsgt s t)) (=> (bvslt s (_ bv0 65)) (bvsgt (bvlshr (bvsub s (_ bv1 65)) (_ bv1 65)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 65))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 65))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
