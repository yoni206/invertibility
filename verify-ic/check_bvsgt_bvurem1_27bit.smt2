...
(and (=> (bvsge s (_ bv0 27)) (bvsgt s t)) (=> (bvslt s (_ bv0 27)) (bvsgt (bvlshr (bvsub s (_ bv1 27)) (_ bv1 27)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 27))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 27))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
