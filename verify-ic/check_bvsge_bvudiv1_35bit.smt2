...
(and (=> (bvsge s (_ bv0 35)) (bvsge s t)) (=> (bvslt s (_ bv0 35)) (bvsge (bvlshr s (_ bv1 35)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 35))) (bvsge (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 35))) (bvsge (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
