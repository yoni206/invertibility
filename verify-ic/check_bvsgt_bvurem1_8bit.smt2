...
(and (=> (bvsge s (_ bv0 8)) (bvsgt s t)) (=> (bvslt s (_ bv0 8)) (bvsgt (bvlshr (bvsub s (_ bv1 8)) (_ bv1 8)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 8))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 8))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
