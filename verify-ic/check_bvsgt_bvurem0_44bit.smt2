...
(and (and (=> (bvsgt s (_ bv0 44)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 44)) (distinct t max))) (or (distinct t (_ bv0 44)) (distinct s (_ bv1 44))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 44))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 44))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
