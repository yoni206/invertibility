...
(and (or (not (= t (_ bv0 3))) (not (= s (_ bv0 3)))) (or (not (= t (bvnot (_ bv0 3)))) (not (= s (bvnot (_ bv0 3))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 3))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 3))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
