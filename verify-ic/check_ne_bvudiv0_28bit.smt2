...
(or (distinct s (_ bv0 28)) (distinct t (bvnot (_ bv0 28))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 28))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 28))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
