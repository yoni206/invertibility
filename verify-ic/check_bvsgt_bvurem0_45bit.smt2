...
(and (and (=> (bvsgt s (_ bv0 45)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 45)) (distinct t max))) (or (distinct t (_ bv0 45)) (distinct s (_ bv1 45))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 45))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 45))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
