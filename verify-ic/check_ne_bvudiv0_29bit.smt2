...
(or (distinct s (_ bv0 29)) (distinct t (bvnot (_ bv0 29))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 29))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 29))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
