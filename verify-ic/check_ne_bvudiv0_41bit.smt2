...
(or (distinct s (_ bv0 41)) (distinct t (bvnot (_ bv0 41))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 41))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 41))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
