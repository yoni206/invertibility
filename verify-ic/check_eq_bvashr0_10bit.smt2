...
(and (=> (bvult s (_ bv10 10)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv10 10)) (or (= t (bvnot (_ bv0 10))) (= t (_ bv0 10)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 10))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 10))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
