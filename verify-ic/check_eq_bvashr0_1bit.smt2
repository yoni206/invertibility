...
(and (=> (bvult s (_ bv1 1)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv1 1)) (or (= t (bvnot (_ bv0 1))) (= t (_ bv0 1)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 1))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 1))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
