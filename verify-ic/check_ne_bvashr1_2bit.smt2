...
(and (or (not (= t (_ bv0 2))) (not (= s (_ bv0 2)))) (or (not (= t (bvnot (_ bv0 2)))) (not (= s (bvnot (_ bv0 2))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 2))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 2))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
