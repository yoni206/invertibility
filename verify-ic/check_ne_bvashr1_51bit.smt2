...
(and (or (not (= t (_ bv0 51))) (not (= s (_ bv0 51)))) (or (not (= t (bvnot (_ bv0 51)))) (not (= s (bvnot (_ bv0 51))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 51))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 51))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
