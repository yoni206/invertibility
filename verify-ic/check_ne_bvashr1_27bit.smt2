...
(and (or (not (= t (_ bv0 27))) (not (= s (_ bv0 27)))) (or (not (= t (bvnot (_ bv0 27)))) (not (= s (bvnot (_ bv0 27))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 27))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 27))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
