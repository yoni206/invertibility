...
(and (or (not (= t (_ bv0 1))) (not (= s (_ bv0 1)))) (or (not (= t (bvnot (_ bv0 1)))) (not (= s (bvnot (_ bv0 1))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 1))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 1))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
