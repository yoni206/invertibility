...
(and (or (not (= t (_ bv0 55))) (not (= s (_ bv0 55)))) (or (not (= t (bvnot (_ bv0 55)))) (not (= s (bvnot (_ bv0 55))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 55))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 55))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
