...
(and (or (not (= t (_ bv0 40))) (not (= s (_ bv0 40)))) (or (not (= t (bvnot (_ bv0 40)))) (not (= s (bvnot (_ bv0 40))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 40))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 40))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
