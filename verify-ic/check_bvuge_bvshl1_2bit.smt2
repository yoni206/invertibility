...
(or  (bvuge (bvshl s (_ bv0 2)) t) (bvuge (bvshl s (_ bv1 2)) t) (bvuge (bvshl s (_ bv2 2)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 2))) (bvuge (bvshl s x) t)))
  (=> (exists ((x (_ BitVec 2))) (bvuge (bvshl s x) t)) (SC s t))
  )
 )
)
(check-sat)
