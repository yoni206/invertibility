...
(and (and (=> (bvsgt s (_ bv0 3)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 3)) (distinct t max))) (or (distinct t (_ bv0 3)) (distinct s (_ bv1 3))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 3))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 3))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
