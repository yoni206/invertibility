...
(or (distinct s (_ bv0 15)) (distinct t (bvnot (_ bv0 15))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 15))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 15))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
