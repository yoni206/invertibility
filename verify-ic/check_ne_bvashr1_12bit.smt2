...
(and (or (not (= t (_ bv0 12))) (not (= s (_ bv0 12)))) (or (not (= t (bvnot (_ bv0 12)))) (not (= s (bvnot (_ bv0 12))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 12))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 12))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
