...
(and (=> (bvult s (_ bv52 52)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv52 52)) (or (= t (bvnot (_ bv0 52))) (= t (_ bv0 52)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 52))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 52))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
