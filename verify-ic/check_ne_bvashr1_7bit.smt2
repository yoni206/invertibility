...
(and (or (not (= t (_ bv0 7))) (not (= s (_ bv0 7)))) (or (not (= t (bvnot (_ bv0 7)))) (not (= s (bvnot (_ bv0 7))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 7))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 7))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
