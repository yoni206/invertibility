...
(and (=> (bvsge s (_ bv0 32)) (bvsgt s t)) (=> (bvslt s (_ bv0 32)) (bvsgt (bvlshr (bvsub s (_ bv1 32)) (_ bv1 32)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 32))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 32))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
