...
(or  (= (bvshl s (_ bv0 8)) t) (= (bvshl s (_ bv1 8)) t) (= (bvshl s (_ bv2 8)) t) (= (bvshl s (_ bv3 8)) t) (= (bvshl s (_ bv4 8)) t) (= (bvshl s (_ bv5 8)) t) (= (bvshl s (_ bv6 8)) t) (= (bvshl s (_ bv7 8)) t) (= (bvshl s (_ bv8 8)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 8))) (= (bvshl s x) t)))
  (=> (exists ((x (_ BitVec 8))) (= (bvshl s x) t)) (SC s t))
  )
 )
)
(check-sat)
