...
(and (and (=> (bvsgt s (_ bv0 25)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 25)) (distinct t max))) (or (distinct t (_ bv0 25)) (distinct s (_ bv1 25))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 25))) (bvsgt (uremtotal x s) t)))
  (=> (exists ((x (_ BitVec 25))) (bvsgt (uremtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
