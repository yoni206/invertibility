...
(or (distinct s (_ bv0 36)) (distinct t (bvnot (_ bv0 36))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 36))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 36))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
