...
(or  (= (bvashr s (_ bv0 10)) t) (= (bvashr s (_ bv1 10)) t) (= (bvashr s (_ bv2 10)) t) (= (bvashr s (_ bv3 10)) t) (= (bvashr s (_ bv4 10)) t) (= (bvashr s (_ bv5 10)) t) (= (bvashr s (_ bv6 10)) t) (= (bvashr s (_ bv7 10)) t) (= (bvashr s (_ bv8 10)) t) (= (bvashr s (_ bv9 10)) t) (= (bvashr s (_ bv10 10)) t))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 10))) (= (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 10))) (= (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
