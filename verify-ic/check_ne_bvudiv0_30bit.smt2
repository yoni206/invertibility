...
(or (distinct s (_ bv0 30)) (distinct t (bvnot (_ bv0 30))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 30))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 30))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
