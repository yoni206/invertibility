...
(or (distinct s (_ bv0 40)) (distinct t (bvnot (_ bv0 40))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 40))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 40))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
