...
(and (=> (bvult s (_ bv16 16)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv16 16)) (or (= t (bvnot (_ bv0 16))) (= t (_ bv0 16)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 16))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 16))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
