...
(or (distinct s (_ bv0 58)) (distinct t (bvnot (_ bv0 58))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 58))) (distinct (udivtotal x s) t)))
  (=> (exists ((x (_ BitVec 58))) (distinct (udivtotal x s) t)) (SC s t))
  )
 )
)
(check-sat)
