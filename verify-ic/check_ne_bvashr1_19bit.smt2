...
(and (or (not (= t (_ bv0 19))) (not (= s (_ bv0 19)))) (or (not (= t (bvnot (_ bv0 19)))) (not (= s (bvnot (_ bv0 19))))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 19))) (distinct (bvashr s x) t)))
  (=> (exists ((x (_ BitVec 19))) (distinct (bvashr s x) t)) (SC s t))
  )
 )
)
(check-sat)
