...
(and (=> (bvsge s (_ bv0 35)) (bvsgt s t)) (=> (bvslt s (_ bv0 35)) (bvsgt (bvlshr (bvsub s (_ bv1 35)) (_ bv1 35)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 35))) (bvsgt (uremtotal s x) t)))
  (=> (exists ((x (_ BitVec 35))) (bvsgt (uremtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
