...
(and (=> (bvult s (_ bv12 12)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv12 12)) (or (= t (bvnot (_ bv0 12))) (= t (_ bv0 12)))))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 12))) (= (bvashr x s) t)))
  (=> (exists ((x (_ BitVec 12))) (= (bvashr x s) t)) (SC s t))
  )
 )
)
(check-sat)
