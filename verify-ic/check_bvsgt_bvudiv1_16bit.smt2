...
(and (=> (bvsge s (_ bv0 16)) (bvsgt s t)) (=> (bvslt s (_ bv0 16)) (bvsgt (bvlshr s (_ bv1 16)) t)))
)

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 16))) (bvsgt (udivtotal s x) t)))
  (=> (exists ((x (_ BitVec 16))) (bvsgt (udivtotal s x) t)) (SC s t))
  )
 )
)
(check-sat)
