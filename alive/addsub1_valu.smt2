...
(assert (instantiate_me a))
(assert (instantiate_me b))

(assert two_to_the_is_ok)
(assert (range_assumptions k a b))


(assert (= (intadd (+ k 1) b b) (intadd k b b)))
(assert (distinct (intadd k b b) (intshl k b 1)))
