...
#SBATCH --qos=normal
#SBATCH -t 00:00:1200
#SBATCH -D /barrett/scratch/yoniz/git/invertibility/int_IC/300
...
solver="./z3"
solver_options="4000"
benchmarks="/barrett/scratch/yoniz/git/invertibility/int_IC/300/benchmarks"
scrambler=""
...
# set stdout log file
log="/barrett/scratch/yoniz/git/invertibility/int_IC/300/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/invertibility/int_IC/300/${out}.err"
