...
#SBATCH --qos=normal
#SBATCH -t 00:00:1200
#SBATCH -D /barrett/scratch/yoniz/git/invertibility/int_IC/4000
...
solver="./z3"
solver_options="1"
benchmarks="/barrett/scratch/yoniz/git/invertibility/int_IC/4000/benchmarks"
scrambler=""
...
# set stdout log file
log="/barrett/scratch/yoniz/git/invertibility/int_IC/4000/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/invertibility/int_IC/4000/${out}.err"
