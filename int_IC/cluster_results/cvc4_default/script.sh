...
# set stdout log file
log="/barrett/scratch/yoniz/git/invertibility/int_IC/cluster_results/cvc4_default/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/invertibility/int_IC/cluster_results/cvc4_default/${out}.err"
