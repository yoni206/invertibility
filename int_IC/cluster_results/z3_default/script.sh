...
solver="./z3"
solver_options=""
benchmarks="/barrett/scratch/yoniz/git/invertibility/int_IC/cluster_results/z3_default/benchmarks"
scrambler=""
...
# set stdout log file
log="/barrett/scratch/yoniz/git/invertibility/int_IC/cluster_results/z3_default/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/invertibility/int_IC/cluster_results/z3_default/${out}.err"
