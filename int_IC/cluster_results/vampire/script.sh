...
#SBATCH --qos=normal
#SBATCH -t 00:00:1800
#SBATCH -D /barrett/scratch/yoniz/git/invertibility/int_IC/cluster_results/vampire
...
solver="./vampire-wrapper.sh"
solver_options="--ignore_missing on --mode smtcomp"
benchmarks="/barrett/scratch/yoniz/git/invertibility/int_IC/cluster_results/vampire/benchmarks"
scrambler=""
...
# set stdout log file
log="/barrett/scratch/yoniz/git/invertibility/int_IC/cluster_results/vampire/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/invertibility/int_IC/cluster_results/vampire/${out}.err"
