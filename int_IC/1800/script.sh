...
#SBATCH --qos=normal
#SBATCH -t 00:00:1200
#SBATCH -D /barrett/scratch/yoniz/git/invertibility/int_IC/1800
...
solver="./cvc4"
solver_options="4000"
benchmarks="/barrett/scratch/yoniz/git/invertibility/int_IC/1800/benchmarks"
scrambler=""
...
# set stdout log file
log="/barrett/scratch/yoniz/git/invertibility/int_IC/1800/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/invertibility/int_IC/1800/${out}.err"
