...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intsge k (intmodtotal k s x) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (and (=> (intsge k s 0) (intsge k s t)) (=> (and (intslt k s 0) (intsge k t 0)) (> (intsub k s t) t))))
