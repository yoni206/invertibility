...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intsgt k (intmodtotal k x s) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (and (and (=> (intsgt k s 0) (intslt k t (intnot k (intneg k s)))) (=> (intsle k s 0) (distinct t (intmaxs k)))) (or (distinct t 0) (distinct s 1))))
