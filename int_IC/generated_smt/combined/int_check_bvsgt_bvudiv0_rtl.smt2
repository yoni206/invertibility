...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intsgt k (intudivtotal k x s) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (or (intsgt k (intudivtotal k (intmax k) s) t) (intsgt k (intudivtotal k (intmaxs k) s) t)))
