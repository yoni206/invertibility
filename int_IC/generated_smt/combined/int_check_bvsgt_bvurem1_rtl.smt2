...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intsgt k (intmodtotal k s x) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (and (=> (intsge k s 0) (intsgt k s t)) (=> (intslt k s 0) (intsgt k (intlshr k (intsub k s 1) 1) t))))
