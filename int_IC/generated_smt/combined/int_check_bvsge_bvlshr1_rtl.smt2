...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intsge k (intlshr k s x) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (and (=> (intslt k s 0) (intsge k (intlshr k s 1) t)) (=> (intsge k s 0) (intsge k s t))))
