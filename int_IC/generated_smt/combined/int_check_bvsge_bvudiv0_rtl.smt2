...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intsge k (intudivtotal k x s) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (or (intsge k (intudivtotal k (intmax k) s) t) (intsge k (intudivtotal k (intmaxs k) s) t)))
