...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intsle k (intudivtotal k x s) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (or (= (intudivtotal k (intmul k s t) s) t) (=> (intsle k t 0) (intslt k (intudivtotal k (intmins k) s) t))))
