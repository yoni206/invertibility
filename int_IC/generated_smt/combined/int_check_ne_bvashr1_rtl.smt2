...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (distinct (intashr k s x) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (and (or (not (= t 0)) (not (= s 0))) (or (not (= t (intmax k))) (not (= s (intmax k))))))
