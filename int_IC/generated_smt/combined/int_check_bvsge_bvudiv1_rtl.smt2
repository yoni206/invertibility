...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intsge k (intudivtotal k s x) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (and (=> (intsge k s 0) (intsge k s t)) (=> (intslt k s 0) (intsge k (intlshr k s 1) t))))
