...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intslt k (intudivtotal k x s) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (=> (intsle k t 0) (intslt k (intudivtotal k (intmins k) s) t)))
