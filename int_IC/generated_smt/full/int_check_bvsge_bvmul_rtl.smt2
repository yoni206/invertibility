...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intsge k (intmul k x s) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (intsge k (intand k (intor k (intneg k s) s) (intmaxs k)) t))
