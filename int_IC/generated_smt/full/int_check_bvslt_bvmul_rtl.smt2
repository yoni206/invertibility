...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intslt k (intmul k x s) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (intslt k (intand k (intnot k (intneg k t)) (intor k (intneg k s) s)) t))
