...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intsgt k (intashr k s x) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (and (intslt k t (intand k s (intmaxs k))) (intslt k t (intor k s (intmaxs k)))))
