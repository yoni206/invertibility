...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intslt k (intmodtotal k x s) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (intslt k (intnot k t) (intor k (intneg k s) (intneg k t))))
