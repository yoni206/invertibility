...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool  (intsge k (intshl k x s) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (intsge k (intand k (intshl k (intmaxs k) s) (intmaxs k)) t))
