...
(define-fun pow ((a Int) (b Int)) Int (<pow> a b))
(define-fun pow_is_ok ((a Int) (b Int)) Bool (<pow_is_ok> a b))
...
(define-fun or_is_ok ((k Int) (a Int)) Bool (<or_is_ok> k a))
...
(define-fun and_is_ok ((k Int) (a Int)) Bool (<and_is_ok> k a))
