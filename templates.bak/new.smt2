...
(define-fun intshl ((k Int) (a Int) (b Int)) Int (intmodtotal (* a (pow 2 b)) (pow 2 k)))
(define-fun intlshr ((k Int) (a Int) (b Int)) Int (intmodtotal (intdivtotal k a (pow 2 b)) (pow 2 k)))
