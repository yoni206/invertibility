...
#pow_rec_def = "(define-fun-rec two_to_the ((b Int)) Int (ite (<= b 0) 1 (* 2 (two_to_the (- b 1)))))"
pow_dec = "(declare-fun two_to_the (Int) Int)"
...
#and_rec_def = "(define-fun-rec intand ((k Int) (a Int) (b Int)) Int (ite (<= k 1) (intand_helper (lsb k a) (lsb k b)) (+ (intand (- k 1) a b) (* (two_to_the (- k 1)) (intand_helper (bitof k (- k 1) a) (bitof k (- k 1) b))))))"
and_dec = "(declare-fun intand (Int Int Int) Int)"

or_helper = "(define-fun intor_helper ((a Int) (b Int)) Int (ite (and (= a 0) (= b 0) ) 0 1))"
#or_rec_def = "(define-fun-rec intor ((k Int) (a Int) (b Int)) Int (ite (<= k 1) (intor_helper (lsb k a) (lsb k b)) (+ (intor (- k 1) a b) (* (two_to_the (- k 1)) (intor_helper (bitof k (- k 1) a) (bitof k (- k 1) b))))))"
...
#xor_rec_def = "(define-fun-rec intxor ((k Int) (a Int) (b Int)) Int (ite (<= k 1) (intxor_helper (lsb k a) (lsb k b)) (+ (intxor (- k 1) a b) (* (two_to_the (- k 1)) (intxor_helper (bitof k (- k 1) a) (bitof k (- k 1) b))))))"
...
qf_partial_combined_shared_axioms = ["(define-fun base_cases () Bool (and (= (two_to_the 0) 1) (= (two_to_the 1) 2) (= (two_to_the 2) 4) (= (two_to_the 3) 8) ) )"]
...
axioms = { 
#            "rec": [
#            "(define-fun two_to_the_ax () Bool true)",
