...
(define-fun left () Bool (>= (intextract m k 0 (intadd m a b)) (intadd (+ k 1) (intextract m k 0 a) (intextract m k 0 b))))
(define-fun right () Bool (<= (intextract m k 0 (intadd m a b)) (intadd (+ k 1) (intextract m k 0 a) (intextract m k 0 b))))
