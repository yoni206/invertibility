...
(define-fun condition () Bool (or (and (= (intextract (+ n m) (- n 1) (- n 1) c) 0) (= (intextract (+ n m) (- (+ n m) 1) n c) 0) ) (and (= (intextract (+ n m) (- n 1) (- n 1) c) 1) (= (intextract (+ n m) (- (+ n m) 1) n c) (intnot m 0)) )))

(assert (not condition))

(define-fun left () Bool (= (int_sign_extend n x m) c))
(define-fun right () Bool false)
