...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvand (bvsub #b10000000000000 s) #b10000000000000))
(define-fun l ((x (_ BitVec 14))) Bool  (bvslt (uremtotal (inv s t) s) t))
