...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvadd t #b1000000000000000000000000000000))
(define-fun l ((x (_ BitVec 31))) Bool  (distinct (bvashr (inv s t) s) t))
