...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvand (bvadd #b10000000000000000000 t) #b10000000000000000000))
(define-fun l ((x (_ BitVec 20))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 20)) (bvsge t s)))
