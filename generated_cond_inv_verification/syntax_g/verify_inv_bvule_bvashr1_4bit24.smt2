...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvand (bvsub t s) #b100000000000000000000000))
(define-fun l ((x (_ BitVec 24))) Bool  (bvule (bvashr s (inv s t)) t))
