...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvlshr (bvsub #b1000000000000000000000000 #b0111111111111111111111111) t))
(define-fun l ((x (_ BitVec 25))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 25)) (distinct t (_ bv0 25))))
