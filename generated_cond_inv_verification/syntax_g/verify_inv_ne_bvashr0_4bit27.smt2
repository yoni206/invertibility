...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvadd t #b100000000000000000000000000))
(define-fun l ((x (_ BitVec 27))) Bool  (distinct (bvashr (inv s t) s) t))
