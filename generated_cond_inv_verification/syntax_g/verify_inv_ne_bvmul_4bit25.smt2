...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvshl #b0111111111111111111111111 t))
(define-fun l ((x (_ BitVec 25))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 25)) (distinct s (_ bv0 25))))
