...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvlshr (bvsub #b10000000000 #b01111111111) t))
(define-fun l ((x (_ BitVec 11))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 11)) (distinct t (_ bv0 11))))
