...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvand (bvadd #b100000000000 t) #b100000000000))
(define-fun l ((x (_ BitVec 12))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 12)) (bvsge t s)))
