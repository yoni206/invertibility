...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvadd (bvadd #b01111111111111111 s) #b10000000000000000))
(define-fun l ((x (_ BitVec 17))) Bool  (bvugt (uremtotal (inv s t) s) t))
