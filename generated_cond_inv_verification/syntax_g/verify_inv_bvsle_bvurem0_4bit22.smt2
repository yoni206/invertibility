...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvand #b1000000000000000000000 t))
(define-fun l ((x (_ BitVec 22))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 22)) (bvand (bvneg s) t)))
