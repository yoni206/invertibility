...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvand (bvadd #b10000000000000000000000000000 t) #b10000000000000000000000000000))
(define-fun l ((x (_ BitVec 29))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 29)) (bvsge t s)))
