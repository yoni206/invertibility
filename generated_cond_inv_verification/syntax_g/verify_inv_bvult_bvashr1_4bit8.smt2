...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvadd (bvand #b10000000 s) #b10000000))
(define-fun l ((x (_ BitVec 8))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 8)))) (not (= t (_ bv0 8)))))
