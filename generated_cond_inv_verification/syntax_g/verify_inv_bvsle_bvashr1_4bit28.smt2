...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvand (bvadd #b1000000000000000000000000000 t) #b1000000000000000000000000000))
(define-fun l ((x (_ BitVec 28))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 28)) (bvsge t s)))
