...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvsub #b000000000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 18))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 18)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 18)) (distinct t max))) (or (distinct t (_ bv0 18)) (distinct s (_ bv1 18)))))
