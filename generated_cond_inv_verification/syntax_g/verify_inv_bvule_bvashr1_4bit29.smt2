...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvand (bvsub t s) #b10000000000000000000000000000))
(define-fun l ((x (_ BitVec 29))) Bool  (bvule (bvashr s (inv s t)) t))
