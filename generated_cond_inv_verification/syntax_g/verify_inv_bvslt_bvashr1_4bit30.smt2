...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvsub (bvor s #b100000000000000000000000000000) s))
(define-fun l ((x (_ BitVec 30))) Bool  (bvslt (bvashr s (inv s t)) t))
