...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvlshr (bvsub #b1000000000000000 #b0111111111111111) t))
(define-fun l ((x (_ BitVec 16))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 16)) (distinct t (_ bv0 16))))
