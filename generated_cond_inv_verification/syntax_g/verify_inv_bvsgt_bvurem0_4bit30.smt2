...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvsub #b000000000000000000000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 30))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 30)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 30)) (distinct t max))) (or (distinct t (_ bv0 30)) (distinct s (_ bv1 30)))))
