...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvlshr #b1000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 31))) Bool  (bvslt (bvshl (inv s t) s) t))
