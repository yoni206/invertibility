...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvand #b10000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 29))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 29)) (bvand (bvneg s) t)))
