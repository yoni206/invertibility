...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvsub #b100000000000000000000000 (bvand s #b100000000000000000000000)))
(define-fun l ((x (_ BitVec 24))) Bool  (bvsle (bvlshr s (inv s t)) t))
