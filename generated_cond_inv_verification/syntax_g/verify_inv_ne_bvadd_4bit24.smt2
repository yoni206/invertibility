...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvsub (bvadd s t) #b011111111111111111111111))
(define-fun l ((x (_ BitVec 24))) Bool  (distinct (bvadd (inv s t) s) t))
