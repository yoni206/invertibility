...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvsub #b1000000000000000000000000 (bvand s #b1000000000000000000000000)))
(define-fun l ((x (_ BitVec 25))) Bool  (bvsle (bvlshr s (inv s t)) t))
