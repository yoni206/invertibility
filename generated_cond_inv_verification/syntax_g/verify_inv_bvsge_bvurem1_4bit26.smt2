...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvsub (bvor s #b10000000000000000000000000) (bvand #b01111111111111111111111111 t)))
(define-fun l ((x (_ BitVec 26))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 26)) (bvsge s t)) (=> (and (bvslt s (_ bv0 26)) (bvsge t (_ bv0 26))) (bvugt (bvsub s t) t))))
