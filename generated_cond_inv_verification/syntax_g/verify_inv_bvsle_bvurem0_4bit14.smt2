...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvand #b10000000000000 t))
(define-fun l ((x (_ BitVec 14))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 14)) (bvand (bvneg s) t)))
