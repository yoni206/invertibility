...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvadd (bvand #b100000000000000000000 s) #b100000000000000000000))
(define-fun l ((x (_ BitVec 21))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 21)))) (not (= t (_ bv0 21)))))
