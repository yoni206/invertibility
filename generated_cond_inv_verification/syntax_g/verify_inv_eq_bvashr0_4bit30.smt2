...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvor (bvand t #b100000000000000000000000000000) (bvshl t s)))
(define-fun l ((x (_ BitVec 30))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv30 30)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv30 30)) (or (= t (bvnot (_ bv0 30))) (= t (_ bv0 30))))))
