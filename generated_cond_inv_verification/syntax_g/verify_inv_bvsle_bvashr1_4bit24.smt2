...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvand (bvadd #b100000000000000000000000 t) #b100000000000000000000000))
(define-fun l ((x (_ BitVec 24))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 24)) (bvsge t s)))
