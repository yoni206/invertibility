...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvsub #b00000 (bvnot t)))
(define-fun l ((x (_ BitVec 5))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 5)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 5)) (distinct t max))) (or (distinct t (_ bv0 5)) (distinct s (_ bv1 5)))))
