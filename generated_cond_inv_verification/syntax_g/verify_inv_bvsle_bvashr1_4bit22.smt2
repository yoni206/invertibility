...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvand (bvadd #b1000000000000000000000 t) #b1000000000000000000000))
(define-fun l ((x (_ BitVec 22))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 22)) (bvsge t s)))
