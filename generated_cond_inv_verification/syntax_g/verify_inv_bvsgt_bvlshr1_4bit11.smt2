...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvlshr s (bvlshr #b01111111111 (bvsub #b10000000000 #b01111111111))))
(define-fun l ((x (_ BitVec 11))) Bool  (bvsgt (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 11)) (bvsgt (bvlshr s (_ bv1 11)) t)) (=> (bvsge s (_ bv0 11)) (bvsgt s t))))
