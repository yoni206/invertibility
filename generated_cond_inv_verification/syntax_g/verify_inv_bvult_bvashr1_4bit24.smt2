...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvadd (bvand #b100000000000000000000000 s) #b100000000000000000000000))
(define-fun l ((x (_ BitVec 24))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 24)))) (not (= t (_ bv0 24)))))
