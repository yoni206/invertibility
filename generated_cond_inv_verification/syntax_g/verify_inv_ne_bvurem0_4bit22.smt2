...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvlshr (bvsub #b1000000000000000000000 #b0111111111111111111111) t))
(define-fun l ((x (_ BitVec 22))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 22)) (distinct t (_ bv0 22))))
