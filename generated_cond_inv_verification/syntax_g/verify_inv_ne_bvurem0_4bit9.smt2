...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvlshr (bvsub #b100000000 #b011111111) t))
(define-fun l ((x (_ BitVec 9))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 9)) (distinct t (_ bv0 9))))
