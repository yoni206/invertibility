...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvsub (bvor s #b10000000000000000000000000000) s))
(define-fun l ((x (_ BitVec 29))) Bool  (bvslt (bvashr s (inv s t)) t))
