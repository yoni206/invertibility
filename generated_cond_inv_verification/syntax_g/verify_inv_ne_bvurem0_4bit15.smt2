...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvlshr (bvsub #b100000000000000 #b011111111111111) t))
(define-fun l ((x (_ BitVec 15))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 15)) (distinct t (_ bv0 15))))
