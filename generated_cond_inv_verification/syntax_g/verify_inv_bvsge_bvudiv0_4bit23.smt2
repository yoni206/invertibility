...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvor (bvlshr #b10000000000000000000000 (bvand (bvlshr #b01111111111111111111111 s) s)) #b01111111111111111111111))
(define-fun l ((x (_ BitVec 23))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 23)) s) t) (bvsge (udivtotal max s) t)))
