...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvlshr (bvsub #b1000000000000 #b0111111111111) t))
(define-fun l ((x (_ BitVec 13))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 13)) (distinct t (_ bv0 13))))
