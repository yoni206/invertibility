...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvlshr s (bvlshr #b0111111111111111111111111 (bvsub #b1000000000000000000000000 #b0111111111111111111111111))))
(define-fun l ((x (_ BitVec 25))) Bool  (bvsge (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 25)) (bvsge (bvlshr s (_ bv1 25)) t)) (=> (bvsge s (_ bv0 25)) (bvsge s t))))
