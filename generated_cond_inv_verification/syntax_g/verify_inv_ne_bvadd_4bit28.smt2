...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvsub (bvadd s t) #b0111111111111111111111111111))
(define-fun l ((x (_ BitVec 28))) Bool  (distinct (bvadd (inv s t) s) t))
