...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvlshr (bvsub #b1000000 #b0111111) t))
(define-fun l ((x (_ BitVec 7))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 7)) (distinct t (_ bv0 7))))
