...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvsub #b100000000000000000000000000000 (bvand s #b100000000000000000000000000000)))
(define-fun l ((x (_ BitVec 30))) Bool  (bvsle (bvlshr s (inv s t)) t))
