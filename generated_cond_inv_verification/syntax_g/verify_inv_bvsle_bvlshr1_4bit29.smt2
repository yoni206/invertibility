...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvsub #b10000000000000000000000000000 (bvand s #b10000000000000000000000000000)))
(define-fun l ((x (_ BitVec 29))) Bool  (bvsle (bvlshr s (inv s t)) t))
