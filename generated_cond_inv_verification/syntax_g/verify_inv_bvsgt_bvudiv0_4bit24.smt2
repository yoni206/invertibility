...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvor (bvsub (bvlshr (bvneg s) s) #b011111111111111111111111) #b011111111111111111111111))
(define-fun l ((x (_ BitVec 24))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 24)) s) t) (bvsgt (udivtotal max s) t)))
