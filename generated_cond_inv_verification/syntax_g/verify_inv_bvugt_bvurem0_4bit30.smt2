...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvadd (bvadd #b011111111111111111111111111111 s) #b100000000000000000000000000000))
(define-fun l ((x (_ BitVec 30))) Bool  (bvugt (uremtotal (inv s t) s) t))
