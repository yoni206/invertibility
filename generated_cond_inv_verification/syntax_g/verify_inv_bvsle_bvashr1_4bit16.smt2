...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvand (bvadd #b1000000000000000 t) #b1000000000000000))
(define-fun l ((x (_ BitVec 16))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 16)) (bvsge t s)))
