...
(define-fun inv ((s (_ BitVec 4)) (t (_ BitVec 4))) (_ BitVec 4) (bvlshr (bvsub #b1000 #b0111) t))
(define-fun l ((x (_ BitVec 4))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 4)) (distinct t (_ bv0 4))))
