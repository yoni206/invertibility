...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvand (bvadd t #b01111111111111111111111111) #b10000000000000000000000000))
(define-fun l ((x (_ BitVec 26))) Bool  (bvslt (bvlshr s (inv s t)) t))
(define-fun SC () Bool (or (bvslt s t) (bvslt (_ bv0 26) t)))
