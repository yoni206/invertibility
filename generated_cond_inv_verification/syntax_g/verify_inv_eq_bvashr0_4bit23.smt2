...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvor (bvand t #b10000000000000000000000) (bvshl t s)))
(define-fun l ((x (_ BitVec 23))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv23 23)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv23 23)) (or (= t (bvnot (_ bv0 23))) (= t (_ bv0 23))))))
