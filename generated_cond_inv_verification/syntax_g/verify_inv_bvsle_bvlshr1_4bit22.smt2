...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvsub #b1000000000000000000000 (bvand s #b1000000000000000000000)))
(define-fun l ((x (_ BitVec 22))) Bool  (bvsle (bvlshr s (inv s t)) t))
