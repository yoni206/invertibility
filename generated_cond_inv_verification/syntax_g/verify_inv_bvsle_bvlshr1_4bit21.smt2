...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvsub #b100000000000000000000 (bvand s #b100000000000000000000)))
(define-fun l ((x (_ BitVec 21))) Bool  (bvsle (bvlshr s (inv s t)) t))
