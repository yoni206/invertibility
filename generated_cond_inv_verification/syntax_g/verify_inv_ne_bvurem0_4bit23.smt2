...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvlshr (bvsub #b10000000000000000000000 #b01111111111111111111111) t))
(define-fun l ((x (_ BitVec 23))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 23)) (distinct t (_ bv0 23))))
