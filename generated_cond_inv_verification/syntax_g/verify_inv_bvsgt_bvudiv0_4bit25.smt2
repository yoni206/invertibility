...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvor (bvsub (bvlshr (bvneg s) s) #b0111111111111111111111111) #b0111111111111111111111111))
(define-fun l ((x (_ BitVec 25))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 25)) s) t) (bvsgt (udivtotal max s) t)))
