...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvor (bvsub (bvlshr (bvneg s) s) #b01111111111111111111111111111) #b01111111111111111111111111111))
(define-fun l ((x (_ BitVec 29))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 29)) s) t) (bvsgt (udivtotal max s) t)))
