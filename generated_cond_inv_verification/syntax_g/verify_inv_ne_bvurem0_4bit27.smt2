...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvlshr (bvsub #b100000000000000000000000000 #b011111111111111111111111111) t))
(define-fun l ((x (_ BitVec 27))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 27)) (distinct t (_ bv0 27))))
