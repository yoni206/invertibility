...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvand (bvadd t #b011111111111111111111111) #b100000000000000000000000))
(define-fun l ((x (_ BitVec 24))) Bool  (bvslt (bvlshr s (inv s t)) t))
(define-fun SC () Bool (or (bvslt s t) (bvslt (_ bv0 24) t)))
