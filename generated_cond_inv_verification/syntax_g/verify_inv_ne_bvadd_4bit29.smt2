...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvsub (bvadd s t) #b01111111111111111111111111111))
(define-fun l ((x (_ BitVec 29))) Bool  (distinct (bvadd (inv s t) s) t))
