...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvand (bvadd #b10000000000000000000000 t) #b10000000000000000000000))
(define-fun l ((x (_ BitVec 23))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 23)) (bvsge t s)))
