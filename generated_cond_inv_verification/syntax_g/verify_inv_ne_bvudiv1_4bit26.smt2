...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvand #b10000000000000000000000000 t))
(define-fun l ((x (_ BitVec 26))) Bool  (distinct (udivtotal s (inv s t)) t))
