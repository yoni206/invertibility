...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvor (bvlshr #b100000000000000000000000000 (bvand (bvlshr #b011111111111111111111111111 s) s)) #b011111111111111111111111111))
(define-fun l ((x (_ BitVec 27))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 27)) s) t) (bvsge (udivtotal max s) t)))
