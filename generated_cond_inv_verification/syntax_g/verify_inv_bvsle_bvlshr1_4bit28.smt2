...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvsub #b1000000000000000000000000000 (bvand s #b1000000000000000000000000000)))
(define-fun l ((x (_ BitVec 28))) Bool  (bvsle (bvlshr s (inv s t)) t))
