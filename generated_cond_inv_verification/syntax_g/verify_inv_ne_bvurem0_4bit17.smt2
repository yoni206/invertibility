...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvlshr (bvsub #b10000000000000000 #b01111111111111111) t))
(define-fun l ((x (_ BitVec 17))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 17)) (distinct t (_ bv0 17))))
