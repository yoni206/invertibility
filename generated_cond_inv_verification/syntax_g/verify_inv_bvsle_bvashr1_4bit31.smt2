...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvand (bvadd #b1000000000000000000000000000000 t) #b1000000000000000000000000000000))
(define-fun l ((x (_ BitVec 31))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 31)) (bvsge t s)))
