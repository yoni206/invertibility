...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvand (bvsub #b100000000000000000000000000000 s) #b100000000000000000000000000000))
(define-fun l ((x (_ BitVec 30))) Bool  (bvslt (uremtotal (inv s t) s) t))
