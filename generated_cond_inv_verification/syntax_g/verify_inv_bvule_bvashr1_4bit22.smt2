...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvand (bvsub t s) #b1000000000000000000000))
(define-fun l ((x (_ BitVec 22))) Bool  (bvule (bvashr s (inv s t)) t))
