...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvand (bvsub #b1000000000000000000000000000 s) #b1000000000000000000000000000))
(define-fun l ((x (_ BitVec 28))) Bool  (bvslt (uremtotal (inv s t) s) t))
