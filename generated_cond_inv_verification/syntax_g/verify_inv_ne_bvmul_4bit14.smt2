...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvshl #b01111111111111 t))
(define-fun l ((x (_ BitVec 14))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 14)) (distinct s (_ bv0 14))))
