...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvsub #b10000000000000000000 (bvand s #b10000000000000000000)))
(define-fun l ((x (_ BitVec 20))) Bool  (bvsle (bvlshr s (inv s t)) t))
