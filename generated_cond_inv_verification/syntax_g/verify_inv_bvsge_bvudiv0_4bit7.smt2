...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvor (bvlshr #b1000000 (bvand (bvlshr #b0111111 s) s)) #b0111111))
(define-fun l ((x (_ BitVec 7))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 7)) s) t) (bvsge (udivtotal max s) t)))
