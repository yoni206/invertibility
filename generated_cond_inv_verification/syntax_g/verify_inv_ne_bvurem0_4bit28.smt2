...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvlshr (bvsub #b1000000000000000000000000000 #b0111111111111111111111111111) t))
(define-fun l ((x (_ BitVec 28))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 28)) (distinct t (_ bv0 28))))
