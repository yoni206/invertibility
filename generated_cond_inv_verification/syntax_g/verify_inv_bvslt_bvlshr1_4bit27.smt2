...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvand (bvadd t #b011111111111111111111111111) #b100000000000000000000000000))
(define-fun l ((x (_ BitVec 27))) Bool  (bvslt (bvlshr s (inv s t)) t))
(define-fun SC () Bool (or (bvslt s t) (bvslt (_ bv0 27) t)))
