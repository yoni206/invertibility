...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvlshr (bvsub #b100000 #b011111) t))
(define-fun l ((x (_ BitVec 6))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 6)) (distinct t (_ bv0 6))))
