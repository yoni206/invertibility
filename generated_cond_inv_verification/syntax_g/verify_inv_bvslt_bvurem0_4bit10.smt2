...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvand (bvsub #b1000000000 s) #b1000000000))
(define-fun l ((x (_ BitVec 10))) Bool  (bvslt (uremtotal (inv s t) s) t))
