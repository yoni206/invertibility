...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvor (bvand t #b1000000000000000000000000) (bvshl t s)))
(define-fun l ((x (_ BitVec 25))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv25 25)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv25 25)) (or (= t (bvnot (_ bv0 25))) (= t (_ bv0 25))))))
