...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvadd (bvand #b1000000000000000000000000000 s) #b1000000000000000000000000000))
(define-fun l ((x (_ BitVec 28))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 28)))) (not (= t (_ bv0 28)))))
