...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvshl #b01111111 t))
(define-fun l ((x (_ BitVec 8))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 8)) (distinct s (_ bv0 8))))
