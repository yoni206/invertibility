...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvlshr (bvsub #b100000000000 #b011111111111) t))
(define-fun l ((x (_ BitVec 12))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 12)) (distinct t (_ bv0 12))))
