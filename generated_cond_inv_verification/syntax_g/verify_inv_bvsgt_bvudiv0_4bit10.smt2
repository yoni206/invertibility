...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvor (bvsub (bvlshr (bvneg s) s) #b0111111111) #b0111111111))
(define-fun l ((x (_ BitVec 10))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 10)) s) t) (bvsgt (udivtotal max s) t)))
