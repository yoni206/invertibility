...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvsub #b10000000000000000 (bvand s #b10000000000000000)))
(define-fun l ((x (_ BitVec 17))) Bool  (bvsle (bvlshr s (inv s t)) t))
