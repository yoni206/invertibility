...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvand (bvadd #b10000000000 t) #b10000000000))
(define-fun l ((x (_ BitVec 11))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 11)) (bvsge t s)))
