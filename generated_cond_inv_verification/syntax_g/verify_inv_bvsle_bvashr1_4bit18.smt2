...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvand (bvadd #b100000000000000000 t) #b100000000000000000))
(define-fun l ((x (_ BitVec 18))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 18)) (bvsge t s)))
