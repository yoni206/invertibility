...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvlshr (bvsub #b10000000000000 #b01111111111111) t))
(define-fun l ((x (_ BitVec 14))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 14)) (distinct t (_ bv0 14))))
