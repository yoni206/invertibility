...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvlshr (bvsub #b10000 #b01111) t))
(define-fun l ((x (_ BitVec 5))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 5)) (distinct t (_ bv0 5))))
