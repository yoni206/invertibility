...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvadd (bvand #b100000000000000000 s) #b100000000000000000))
(define-fun l ((x (_ BitVec 18))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 18)))) (not (= t (_ bv0 18)))))
