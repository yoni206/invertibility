...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvor (bvlshr #b1000000000000000 (bvand (bvlshr #b0111111111111111 s) s)) #b0111111111111111))
(define-fun l ((x (_ BitVec 16))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 16)) s) t) (bvsge (udivtotal max s) t)))
