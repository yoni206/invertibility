...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvand (bvadd #b1000000000000000000000000 t) #b1000000000000000000000000))
(define-fun l ((x (_ BitVec 25))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 25)) (bvsge t s)))
