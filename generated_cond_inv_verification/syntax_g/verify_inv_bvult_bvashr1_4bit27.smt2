...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvadd (bvand #b100000000000000000000000000 s) #b100000000000000000000000000))
(define-fun l ((x (_ BitVec 27))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 27)))) (not (= t (_ bv0 27)))))
