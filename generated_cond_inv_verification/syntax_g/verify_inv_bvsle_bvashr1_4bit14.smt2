...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvand (bvadd #b10000000000000 t) #b10000000000000))
(define-fun l ((x (_ BitVec 14))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 14)) (bvsge t s)))
