...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvand (bvadd t #b0111111111111111111111111111) #b1000000000000000000000000000))
(define-fun l ((x (_ BitVec 28))) Bool  (bvslt (bvlshr s (inv s t)) t))
