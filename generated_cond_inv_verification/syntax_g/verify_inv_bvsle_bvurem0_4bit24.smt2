...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvand #b100000000000000000000000 t))
(define-fun l ((x (_ BitVec 24))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 24)) (bvand (bvneg s) t)))
