...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvshl #b01111111111 t))
(define-fun l ((x (_ BitVec 11))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 11)) (distinct s (_ bv0 11))))
