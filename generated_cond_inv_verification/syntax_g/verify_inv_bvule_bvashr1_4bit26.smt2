...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvand (bvsub t s) #b10000000000000000000000000))
(define-fun l ((x (_ BitVec 26))) Bool  (bvule (bvashr s (inv s t)) t))
