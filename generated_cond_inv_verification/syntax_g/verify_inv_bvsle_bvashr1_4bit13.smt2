...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvand (bvadd #b1000000000000 t) #b1000000000000))
(define-fun l ((x (_ BitVec 13))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 13)) (bvsge t s)))
