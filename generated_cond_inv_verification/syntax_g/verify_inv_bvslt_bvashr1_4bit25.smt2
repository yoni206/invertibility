...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvsub (bvor s #b1000000000000000000000000) s))
(define-fun l ((x (_ BitVec 25))) Bool  (bvslt (bvashr s (inv s t)) t))
