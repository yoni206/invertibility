...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvand (bvsub #b1000000000000000000000000000000 s) #b1000000000000000000000000000000))
(define-fun l ((x (_ BitVec 31))) Bool  (bvslt (uremtotal (inv s t) s) t))
