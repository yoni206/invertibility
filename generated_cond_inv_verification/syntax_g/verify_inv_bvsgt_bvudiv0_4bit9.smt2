...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvor (bvsub (bvlshr (bvneg s) s) #b011111111) #b011111111))
(define-fun l ((x (_ BitVec 9))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 9)) s) t) (bvsgt (udivtotal max s) t)))
