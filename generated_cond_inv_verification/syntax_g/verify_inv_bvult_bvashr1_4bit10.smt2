...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvadd (bvand #b1000000000 s) #b1000000000))
(define-fun l ((x (_ BitVec 10))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 10)))) (not (= t (_ bv0 10)))))
