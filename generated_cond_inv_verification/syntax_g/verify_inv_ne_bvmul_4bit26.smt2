...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvshl #b01111111111111111111111111 t))
(define-fun l ((x (_ BitVec 26))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 26)) (distinct s (_ bv0 26))))
