...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvand (bvadd t #b011111111111111) #b100000000000000))
(define-fun l ((x (_ BitVec 15))) Bool  (bvslt (bvlshr s (inv s t)) t))
