...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvand (bvsub #b10000000000000000000 s) #b10000000000000000000))
(define-fun l ((x (_ BitVec 20))) Bool  (bvslt (uremtotal (inv s t) s) t))
