...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvadd (bvand #b100000 s) #b100000))
(define-fun l ((x (_ BitVec 6))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 6)))) (not (= t (_ bv0 6)))))
