...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvshl #b0111111111111111 t))
(define-fun l ((x (_ BitVec 16))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 16)) (distinct s (_ bv0 16))))
