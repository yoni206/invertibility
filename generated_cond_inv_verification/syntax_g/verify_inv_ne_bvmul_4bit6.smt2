...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvshl #b011111 t))
(define-fun l ((x (_ BitVec 6))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 6)) (distinct s (_ bv0 6))))
