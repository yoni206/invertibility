...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvsub #b00000000000000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 23))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 23)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 23)) (distinct t max))) (or (distinct t (_ bv0 23)) (distinct s (_ bv1 23)))))
