...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvshl #b0111111 t))
(define-fun l ((x (_ BitVec 7))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 7)) (distinct s (_ bv0 7))))
