...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvand (bvadd #b10000 t) #b10000))
(define-fun l ((x (_ BitVec 5))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 5)) (bvsge t s)))
