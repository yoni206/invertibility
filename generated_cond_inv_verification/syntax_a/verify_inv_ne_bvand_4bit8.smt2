...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvadd s t))
(define-fun l ((x (_ BitVec 8))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 8)) (distinct t (_ bv0 8))))
