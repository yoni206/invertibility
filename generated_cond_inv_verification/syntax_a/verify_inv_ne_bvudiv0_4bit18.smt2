...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvadd (bvadd t #b011111111111111111) #b100000000000000000))
(define-fun l ((x (_ BitVec 18))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 18)) (distinct t (bvnot (_ bv0 18)))))
