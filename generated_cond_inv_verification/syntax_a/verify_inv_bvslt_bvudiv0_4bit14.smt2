...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 14))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 14)) (bvslt (udivtotal min s) t)))
