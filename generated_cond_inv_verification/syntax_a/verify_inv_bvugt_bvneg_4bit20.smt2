...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvmul #b01111111111111111111 #b01111111111111111111))
(define-fun l ((x (_ BitVec 20))) Bool  (bvugt (bvneg (inv s t)) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 20))))
