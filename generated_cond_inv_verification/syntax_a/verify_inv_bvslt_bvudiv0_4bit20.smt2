...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 20))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 20)) (bvslt (udivtotal min s) t)))
