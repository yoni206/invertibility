...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvadd s t))
(define-fun l ((x (_ BitVec 26))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 26)) (distinct t (_ bv0 26))))
