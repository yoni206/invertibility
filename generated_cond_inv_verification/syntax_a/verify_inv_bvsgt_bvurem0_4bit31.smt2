...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvsub #b0000000000000000000000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 31))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 31)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 31)) (distinct t max))) (or (distinct t (_ bv0 31)) (distinct s (_ bv1 31)))))
