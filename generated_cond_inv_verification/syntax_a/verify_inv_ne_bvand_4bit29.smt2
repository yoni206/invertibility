...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvadd s t))
(define-fun l ((x (_ BitVec 29))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 29)) (distinct t (_ bv0 29))))
