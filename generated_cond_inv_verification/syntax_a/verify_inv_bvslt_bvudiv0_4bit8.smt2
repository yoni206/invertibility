...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 8))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 8)) (bvslt (udivtotal min s) t)))
