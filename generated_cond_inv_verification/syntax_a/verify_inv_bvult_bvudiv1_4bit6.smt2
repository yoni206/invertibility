...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvadd #b100000 #b011111))
(define-fun l ((x (_ BitVec 6))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 6) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 6) t)))
