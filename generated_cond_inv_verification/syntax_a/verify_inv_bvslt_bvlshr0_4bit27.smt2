...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvsub t (bvmul #b011111111111111111111111111 #b011111111111111111111111111)))
(define-fun l ((x (_ BitVec 27))) Bool  (bvslt (bvlshr (inv s t) s) t))
