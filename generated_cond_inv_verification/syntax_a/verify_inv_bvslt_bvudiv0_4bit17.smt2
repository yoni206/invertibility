...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 17))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 17)) (bvslt (udivtotal min s) t)))
