...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvsub #b011111111111111111111111111 #b100000000000000000000000000))
(define-fun l ((x (_ BitVec 27))) Bool  (bvuge (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvuge (bvshl (bvnot (_ bv0 27)) s) t))
