...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvadd (bvadd t #b0111111111111111111111111) #b1000000000000000000000000))
(define-fun l ((x (_ BitVec 25))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 25)) (distinct t (bvnot (_ bv0 25)))))
