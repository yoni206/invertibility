...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvsub t (bvmul #b011111111111111111 #b011111111111111111)))
(define-fun l ((x (_ BitVec 18))) Bool  (bvslt (bvlshr (inv s t) s) t))
