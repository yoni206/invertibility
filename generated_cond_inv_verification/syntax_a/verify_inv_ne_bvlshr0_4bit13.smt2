...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvsub (bvadd t #b0111111111111) #b1000000000000))
(define-fun l ((x (_ BitVec 13))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 13)) (bvult s (_ bv13 13))))
