...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvadd #b1000000000 #b0111111111))
(define-fun l ((x (_ BitVec 10))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 10) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 10) t)))
