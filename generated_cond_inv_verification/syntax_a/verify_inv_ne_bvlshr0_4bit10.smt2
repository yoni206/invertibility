...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvsub (bvadd t #b0111111111) #b1000000000))
(define-fun l ((x (_ BitVec 10))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 10)) (bvult s (_ bv10 10))))
