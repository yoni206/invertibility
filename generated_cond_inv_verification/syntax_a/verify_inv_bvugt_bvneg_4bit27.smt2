...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvmul #b011111111111111111111111111 #b011111111111111111111111111))
(define-fun l ((x (_ BitVec 27))) Bool  (bvugt (bvneg (inv s t)) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 27))))
