...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvmul #b01111111111111111111111111111 #b01111111111111111111111111111))
(define-fun l ((x (_ BitVec 29))) Bool  (bvugt (bvneg (inv s t)) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 29))))
