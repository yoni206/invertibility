...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvadd #b100000000000000000000000000 #b011111111111111111111111111))
(define-fun l ((x (_ BitVec 27))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 27) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 27) t)))
