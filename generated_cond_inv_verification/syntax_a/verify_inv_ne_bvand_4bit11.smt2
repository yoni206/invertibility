...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvadd s t))
(define-fun l ((x (_ BitVec 11))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 11)) (distinct t (_ bv0 11))))
