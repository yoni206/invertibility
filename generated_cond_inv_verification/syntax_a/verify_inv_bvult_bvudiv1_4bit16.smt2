...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvadd #b1000000000000000 #b0111111111111111))
(define-fun l ((x (_ BitVec 16))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 16) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 16) t)))
