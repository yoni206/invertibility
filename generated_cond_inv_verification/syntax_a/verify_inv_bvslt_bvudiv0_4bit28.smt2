...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 28))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 28)) (bvslt (udivtotal min s) t)))
