...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvsub #b00000000000000000000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 29))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 29)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 29)) (distinct t max))) (or (distinct t (_ bv0 29)) (distinct s (_ bv1 29)))))
