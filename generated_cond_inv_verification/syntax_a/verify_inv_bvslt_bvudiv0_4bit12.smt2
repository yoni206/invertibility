...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 12))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 12)) (bvslt (udivtotal min s) t)))
