...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvadd (bvadd t #b0111111111) #b1000000000))
(define-fun l ((x (_ BitVec 10))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 10)) (distinct t (bvnot (_ bv0 10)))))
