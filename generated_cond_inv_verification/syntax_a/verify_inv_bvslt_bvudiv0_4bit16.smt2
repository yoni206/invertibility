...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 16))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 16)) (bvslt (udivtotal min s) t)))
