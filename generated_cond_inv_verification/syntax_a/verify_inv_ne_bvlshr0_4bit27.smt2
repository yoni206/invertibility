...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvsub (bvadd t #b011111111111111111111111111) #b100000000000000000000000000))
(define-fun l ((x (_ BitVec 27))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 27)) (bvult s (_ bv27 27))))
