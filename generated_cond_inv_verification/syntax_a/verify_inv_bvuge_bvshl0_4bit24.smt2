...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvsub #b011111111111111111111111 #b100000000000000000000000))
(define-fun l ((x (_ BitVec 24))) Bool  (bvuge (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvuge (bvshl (bvnot (_ bv0 24)) s) t))
