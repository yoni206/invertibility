...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvadd s t))
(define-fun l ((x (_ BitVec 7))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 7)) (distinct t (_ bv0 7))))
