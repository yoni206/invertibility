...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvadd (bvadd t #b011111111111) #b100000000000))
(define-fun l ((x (_ BitVec 12))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 12)) (distinct t (bvnot (_ bv0 12)))))
