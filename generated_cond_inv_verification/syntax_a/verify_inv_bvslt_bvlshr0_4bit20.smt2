...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvsub t (bvmul #b01111111111111111111 #b01111111111111111111)))
(define-fun l ((x (_ BitVec 20))) Bool  (bvslt (bvlshr (inv s t) s) t))
