...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvadd #b10000000000000000 #b01111111111111111))
(define-fun l ((x (_ BitVec 17))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 17) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 17) t)))
