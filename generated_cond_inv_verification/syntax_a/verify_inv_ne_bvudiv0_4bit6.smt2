...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvadd (bvadd t #b011111) #b100000))
(define-fun l ((x (_ BitVec 6))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 6)) (distinct t (bvnot (_ bv0 6)))))
