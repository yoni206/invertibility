...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvsub t (bvmul #b0111111111111111 #b0111111111111111)))
(define-fun l ((x (_ BitVec 16))) Bool  (bvslt (bvlshr (inv s t) s) t))
