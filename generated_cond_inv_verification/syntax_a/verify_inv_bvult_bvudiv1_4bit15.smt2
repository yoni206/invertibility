...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvadd #b100000000000000 #b011111111111111))
(define-fun l ((x (_ BitVec 15))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 15) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 15) t)))
