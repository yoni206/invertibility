...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvadd #b1000000000000000000000 #b0111111111111111111111))
(define-fun l ((x (_ BitVec 22))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 22) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 22) t)))
