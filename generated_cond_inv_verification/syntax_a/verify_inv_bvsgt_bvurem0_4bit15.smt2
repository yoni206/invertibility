...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvsub #b000000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 15)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 15)) (distinct t max))) (or (distinct t (_ bv0 15)) (distinct s (_ bv1 15)))))
