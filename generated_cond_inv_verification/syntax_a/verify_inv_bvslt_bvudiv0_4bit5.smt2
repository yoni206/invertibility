...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 5))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 5)) (bvslt (udivtotal min s) t)))
