...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvadd #b1000000000000000000000000 #b0111111111111111111111111))
(define-fun l ((x (_ BitVec 25))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 25) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 25) t)))
