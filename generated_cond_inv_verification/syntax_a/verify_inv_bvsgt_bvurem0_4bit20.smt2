...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvsub #b00000000000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 20))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 20)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 20)) (distinct t max))) (or (distinct t (_ bv0 20)) (distinct s (_ bv1 20)))))
