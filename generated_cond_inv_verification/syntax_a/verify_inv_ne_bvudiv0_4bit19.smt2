...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvadd (bvadd t #b0111111111111111111) #b1000000000000000000))
(define-fun l ((x (_ BitVec 19))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 19)) (distinct t (bvnot (_ bv0 19)))))
