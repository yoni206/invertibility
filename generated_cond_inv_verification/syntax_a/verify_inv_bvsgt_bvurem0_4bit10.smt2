...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvsub #b0000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 10))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 10)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 10)) (distinct t max))) (or (distinct t (_ bv0 10)) (distinct s (_ bv1 10)))))
