...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvsub #b0111111111111111111111111 #b1000000000000000000000000))
(define-fun l ((x (_ BitVec 25))) Bool  (bvuge (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvuge (bvshl (bvnot (_ bv0 25)) s) t))
