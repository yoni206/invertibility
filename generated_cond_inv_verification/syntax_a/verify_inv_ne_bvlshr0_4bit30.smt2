...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvsub (bvadd t #b011111111111111111111111111111) #b100000000000000000000000000000))
(define-fun l ((x (_ BitVec 30))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 30)) (bvult s (_ bv30 30))))
