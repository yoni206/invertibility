...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvsub (bvadd t #b011111111111111111) #b100000000000000000))
(define-fun l ((x (_ BitVec 18))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 18)) (bvult s (_ bv18 18))))
