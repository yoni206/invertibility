...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvadd (bvmul s t) #b011111))
(define-fun l ((x (_ BitVec 6))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 6))) (bvsge (bvlshr (bvnot (_ bv0 6)) s) t)))
