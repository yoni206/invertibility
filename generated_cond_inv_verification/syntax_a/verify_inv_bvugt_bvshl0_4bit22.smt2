...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvadd #b0111111111111111111111 #b1000000000000000000000))
(define-fun l ((x (_ BitVec 22))) Bool  (bvugt (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvult t (bvshl (bvnot (_ bv0 22)) s)))
