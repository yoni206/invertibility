...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvadd (bvadd #b0111111111111111111111111111111 s) t))
(define-fun l ((x (_ BitVec 31))) Bool  (distinct (bvadd (inv s t) s) t))
