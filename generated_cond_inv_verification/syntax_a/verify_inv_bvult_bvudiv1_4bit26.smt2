...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvadd #b10000000000000000000000000 #b01111111111111111111111111))
(define-fun l ((x (_ BitVec 26))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 26) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 26) t)))
