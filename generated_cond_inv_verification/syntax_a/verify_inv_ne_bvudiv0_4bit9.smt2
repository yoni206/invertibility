...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvadd (bvadd t #b011111111) #b100000000))
(define-fun l ((x (_ BitVec 9))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 9)) (distinct t (bvnot (_ bv0 9)))))
