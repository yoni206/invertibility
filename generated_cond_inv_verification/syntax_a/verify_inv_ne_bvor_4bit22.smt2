...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvnot t))
(define-fun l ((x (_ BitVec 22))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 22))) (distinct t (bvnot (_ bv0 22)))))
