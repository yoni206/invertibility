...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvadd (bvadd (bvmul s t) s) #b01111111111111111111))
(define-fun l ((x (_ BitVec 20))) Bool  (bvsgt (bvlshr (inv s t) s) t))
