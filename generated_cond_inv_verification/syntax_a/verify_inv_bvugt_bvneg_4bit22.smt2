...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvmul #b0111111111111111111111 #b0111111111111111111111))
(define-fun l ((x (_ BitVec 22))) Bool  (bvugt (bvneg (inv s t)) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 22))))
