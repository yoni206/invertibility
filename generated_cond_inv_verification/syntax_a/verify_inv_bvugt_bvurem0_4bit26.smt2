...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvsub s (bvmul #b01111111111111111111111111 #b01111111111111111111111111)))
(define-fun l ((x (_ BitVec 26))) Bool  (bvugt (uremtotal (inv s t) s) t))
