...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvadd #b1000000000000 #b0111111111111))
(define-fun l ((x (_ BitVec 13))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 13) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 13) t)))
