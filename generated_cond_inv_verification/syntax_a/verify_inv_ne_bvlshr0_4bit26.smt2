...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvsub (bvadd t #b01111111111111111111111111) #b10000000000000000000000000))
(define-fun l ((x (_ BitVec 26))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 26)) (bvult s (_ bv26 26))))
