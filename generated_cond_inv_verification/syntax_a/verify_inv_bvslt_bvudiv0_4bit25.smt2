...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 25))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 25)) (bvslt (udivtotal min s) t)))
