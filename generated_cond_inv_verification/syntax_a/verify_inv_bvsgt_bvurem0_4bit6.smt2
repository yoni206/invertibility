...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvsub #b000000 (bvnot t)))
(define-fun l ((x (_ BitVec 6))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 6)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 6)) (distinct t max))) (or (distinct t (_ bv0 6)) (distinct s (_ bv1 6)))))
