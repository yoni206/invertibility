...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvmul #b01111111111111111111111 #b01111111111111111111111))
(define-fun l ((x (_ BitVec 23))) Bool  (bvugt (bvneg (inv s t)) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 23))))
