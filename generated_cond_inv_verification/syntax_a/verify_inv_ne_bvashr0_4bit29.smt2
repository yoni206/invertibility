...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvsub t #b10000000000000000000000000000))
(define-fun l ((x (_ BitVec 29))) Bool  (distinct (bvashr (inv s t) s) t))
