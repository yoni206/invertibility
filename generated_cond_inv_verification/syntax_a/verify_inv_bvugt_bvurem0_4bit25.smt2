...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvsub s (bvmul #b0111111111111111111111111 #b0111111111111111111111111)))
(define-fun l ((x (_ BitVec 25))) Bool  (bvugt (uremtotal (inv s t) s) t))
