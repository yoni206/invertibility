...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvadd (bvadd (bvmul s t) s) #b0111111111111111111111111111111))
(define-fun l ((x (_ BitVec 31))) Bool  (bvsgt (bvlshr (inv s t) s) t))
