...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 9))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 9)) (bvslt (udivtotal min s) t)))
