...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvsub #b01111111111111111111111 #b10000000000000000000000))
(define-fun l ((x (_ BitVec 23))) Bool  (bvuge (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvuge (bvshl (bvnot (_ bv0 23)) s) t))
