...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvmul #b0111111111111111111 #b0111111111111111111))
(define-fun l ((x (_ BitVec 19))) Bool  (bvugt (bvneg (inv s t)) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 19))))
