...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvsub #b000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 12))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 12)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 12)) (distinct t max))) (or (distinct t (_ bv0 12)) (distinct s (_ bv1 12)))))
