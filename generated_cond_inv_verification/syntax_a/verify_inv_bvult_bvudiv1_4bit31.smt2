...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvadd #b1000000000000000000000000000000 #b0111111111111111111111111111111))
(define-fun l ((x (_ BitVec 31))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 31) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 31) t)))
