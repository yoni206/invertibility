...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 22))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 22)) (bvslt (udivtotal min s) t)))
