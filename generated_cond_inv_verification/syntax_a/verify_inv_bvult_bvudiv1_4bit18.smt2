...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvadd #b100000000000000000 #b011111111111111111))
(define-fun l ((x (_ BitVec 18))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 18) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 18) t)))
