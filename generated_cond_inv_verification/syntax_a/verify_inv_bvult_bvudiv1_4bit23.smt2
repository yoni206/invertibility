...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvadd #b10000000000000000000000 #b01111111111111111111111))
(define-fun l ((x (_ BitVec 23))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 23) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 23) t)))
