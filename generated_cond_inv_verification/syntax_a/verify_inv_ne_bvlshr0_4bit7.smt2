...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvsub (bvadd t #b0111111) #b1000000))
(define-fun l ((x (_ BitVec 7))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 7)) (bvult s (_ bv7 7))))
