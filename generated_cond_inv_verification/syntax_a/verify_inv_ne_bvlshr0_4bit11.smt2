...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvsub (bvadd t #b01111111111) #b10000000000))
(define-fun l ((x (_ BitVec 11))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 11)) (bvult s (_ bv11 11))))
