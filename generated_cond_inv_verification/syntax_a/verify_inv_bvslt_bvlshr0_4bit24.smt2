...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvsub t (bvmul #b011111111111111111111111 #b011111111111111111111111)))
(define-fun l ((x (_ BitVec 24))) Bool  (bvslt (bvlshr (inv s t) s) t))
