...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvadd #b100000000000000000000 #b011111111111111111111))
(define-fun l ((x (_ BitVec 21))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 21) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 21) t)))
