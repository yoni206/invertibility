...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvsub #b00000000000000000 s))
(define-fun l ((x (_ BitVec 17))) Bool  (bvult (bvadd (inv s t) s) t))
(define-fun SC () Bool (distinct t (_ bv0 17)))
