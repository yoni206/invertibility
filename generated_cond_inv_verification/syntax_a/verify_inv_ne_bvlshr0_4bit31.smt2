...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvsub (bvadd t #b0111111111111111111111111111111) #b1000000000000000000000000000000))
(define-fun l ((x (_ BitVec 31))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 31)) (bvult s (_ bv31 31))))
