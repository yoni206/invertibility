...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvadd #b0111111111111111 #b1000000000000000))
(define-fun l ((x (_ BitVec 16))) Bool  (bvugt (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvult t (bvshl (bvnot (_ bv0 16)) s)))
