...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvsub t (bvmul #b01111111111111 #b01111111111111)))
(define-fun l ((x (_ BitVec 14))) Bool  (bvslt (bvlshr (inv s t) s) t))
