...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvsub t (bvmul #b011111111111111111111 #b011111111111111111111)))
(define-fun l ((x (_ BitVec 21))) Bool  (bvslt (bvlshr (inv s t) s) t))
