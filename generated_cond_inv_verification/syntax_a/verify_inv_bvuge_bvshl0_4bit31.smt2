...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvsub #b0111111111111111111111111111111 #b1000000000000000000000000000000))
(define-fun l ((x (_ BitVec 31))) Bool  (bvuge (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvuge (bvshl (bvnot (_ bv0 31)) s) t))
