...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvsub #b0111111111111111111111111111 #b1000000000000000000000000000))
(define-fun l ((x (_ BitVec 28))) Bool  (bvuge (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvuge (bvshl (bvnot (_ bv0 28)) s) t))
