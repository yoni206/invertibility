...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvsub (bvadd t #b01111111111111111111) #b10000000000000000000))
(define-fun l ((x (_ BitVec 20))) Bool  (distinct (bvlshr (inv s t) s) t))
