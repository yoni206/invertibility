...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvsub #b0111111111111 #b1000000000000))
(define-fun l ((x (_ BitVec 13))) Bool  (bvuge (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvuge (bvshl (bvnot (_ bv0 13)) s) t))
