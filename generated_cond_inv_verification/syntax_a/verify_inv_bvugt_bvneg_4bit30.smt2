...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvmul #b011111111111111111111111111111 #b011111111111111111111111111111))
(define-fun l ((x (_ BitVec 30))) Bool  (bvugt (bvneg (inv s t)) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 30))))
