...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvadd (bvadd #b0111111111111111111111111 s) t))
(define-fun l ((x (_ BitVec 25))) Bool  (distinct (bvadd (inv s t) s) t))
