...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvneg (bvand (bvor (bvnot s) #b011111111111) (bvor s #b100000000000))))
(define-fun l ((x (_ BitVec 12))) Bool  (bvsle (bvadd (inv s t) s) t))
