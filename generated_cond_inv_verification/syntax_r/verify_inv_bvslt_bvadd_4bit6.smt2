...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvneg (bvor (bvand (bvnot s) #b100000) (bvand s #b011111))))
(define-fun l ((x (_ BitVec 6))) Bool  (bvslt (bvadd (inv s t) s) t))
