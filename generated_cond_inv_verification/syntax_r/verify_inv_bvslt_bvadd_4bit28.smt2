...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvneg (bvor (bvand (bvnot s) #b1000000000000000000000000000) (bvand s #b0111111111111111111111111111))))
(define-fun l ((x (_ BitVec 28))) Bool  (bvslt (bvadd (inv s t) s) t))
