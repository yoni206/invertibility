...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvand (bvor (bvnot s) #b10000000000000) (bvor s #b01111111111111)))
(define-fun l ((x (_ BitVec 14))) Bool  (bvsgt (bvadd (inv s t) s) t))
