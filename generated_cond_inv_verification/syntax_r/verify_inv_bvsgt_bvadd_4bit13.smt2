...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvand (bvor (bvnot s) #b1000000000000) (bvor s #b0111111111111)))
(define-fun l ((x (_ BitVec 13))) Bool  (bvsgt (bvadd (inv s t) s) t))
