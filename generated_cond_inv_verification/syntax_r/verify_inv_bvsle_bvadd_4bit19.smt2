...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvneg (bvand (bvor (bvnot s) #b0111111111111111111) (bvor s #b1000000000000000000))))
(define-fun l ((x (_ BitVec 19))) Bool  (bvsle (bvadd (inv s t) s) t))
