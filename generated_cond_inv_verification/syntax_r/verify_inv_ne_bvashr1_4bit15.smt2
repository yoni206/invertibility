...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvneg (bvand (bvneg (bvnot t)) (bvneg t))))
(define-fun l ((x (_ BitVec 15))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 15))) (not (= s (_ bv0 15)))) (or (not (= t (bvnot (_ bv0 15)))) (not (= s (bvnot (_ bv0 15)))))))
