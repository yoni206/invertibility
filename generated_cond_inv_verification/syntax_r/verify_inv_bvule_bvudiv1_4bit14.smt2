...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvor #b10000000000000 #b01111111111111))
(define-fun l ((x (_ BitVec 14))) Bool  (bvule (udivtotal s (inv s t)) t))
(define-fun SC () Bool (bvult (_ bv0 14) (bvor (bvnot s) t)))
