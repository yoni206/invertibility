...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvneg (bvor (bvand (bvnot s) #b1000000) (bvand s #b0111111))))
(define-fun l ((x (_ BitVec 7))) Bool  (bvslt (bvadd (inv s t) s) t))
