...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvneg (bvand (bvor (bvnot s) #b0111111) (bvor s #b1000000))))
(define-fun l ((x (_ BitVec 7))) Bool  (bvsle (bvadd (inv s t) s) t))
