...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvneg (bvand (bvor (bvnot s) #b011111111) (bvor s #b100000000))))
(define-fun l ((x (_ BitVec 9))) Bool  (bvsle (bvadd (inv s t) s) t))
