...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvneg (bvor (bvand (bvnot s) #b10000000000000000000000000000) (bvand s #b01111111111111111111111111111))))
(define-fun l ((x (_ BitVec 29))) Bool  (bvslt (bvadd (inv s t) s) t))
