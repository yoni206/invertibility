...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvand (bvor (bvnot s) #b100000000000000000000000000000) (bvor s #b011111111111111111111111111111)))
(define-fun l ((x (_ BitVec 30))) Bool  (bvsgt (bvadd (inv s t) s) t))
