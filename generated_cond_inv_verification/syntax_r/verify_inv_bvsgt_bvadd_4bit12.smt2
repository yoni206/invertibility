...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvand (bvor (bvnot s) #b100000000000) (bvor s #b011111111111)))
(define-fun l ((x (_ BitVec 12))) Bool  (bvsgt (bvadd (inv s t) s) t))
