...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvneg (bvand (bvneg (bvnot t)) (bvneg t))))
(define-fun l ((x (_ BitVec 19))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 19))) (not (= s (_ bv0 19)))) (or (not (= t (bvnot (_ bv0 19)))) (not (= s (bvnot (_ bv0 19)))))))
