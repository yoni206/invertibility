...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvneg (bvand (bvor (bvnot s) #b011111111111111) (bvor s #b100000000000000))))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsle (bvadd (inv s t) s) t))
