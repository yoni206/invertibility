...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvor #b1000000000000000000000000000 #b0111111111111111111111111111))
(define-fun l ((x (_ BitVec 28))) Bool  (bvule (udivtotal s (inv s t)) t))
(define-fun SC () Bool (bvult (_ bv0 28) (bvor (bvnot s) t)))
