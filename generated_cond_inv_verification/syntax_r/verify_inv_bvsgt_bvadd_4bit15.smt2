...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvand (bvor (bvnot s) #b100000000000000) (bvor s #b011111111111111)))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsgt (bvadd (inv s t) s) t))
