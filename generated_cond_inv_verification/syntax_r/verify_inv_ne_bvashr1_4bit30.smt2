...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvneg (bvand (bvneg (bvnot t)) (bvneg t))))
(define-fun l ((x (_ BitVec 30))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 30))) (not (= s (_ bv0 30)))) (or (not (= t (bvnot (_ bv0 30)))) (not (= s (bvnot (_ bv0 30)))))))
