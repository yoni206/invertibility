...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvand (bvor (bvnot s) #b100000000000000000000000000) (bvor s #b011111111111111111111111111)))
(define-fun l ((x (_ BitVec 27))) Bool  (bvsgt (bvadd (inv s t) s) t))
