...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvneg (bvor (bvand (bvnot s) #b10000000) (bvand s #b01111111))))
(define-fun l ((x (_ BitVec 8))) Bool  (bvslt (bvadd (inv s t) s) t))
