...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvneg (bvand (bvor (bvnot s) #b011111111111111111) (bvor s #b100000000000000000))))
(define-fun l ((x (_ BitVec 18))) Bool  (bvsle (bvadd (inv s t) s) t))
