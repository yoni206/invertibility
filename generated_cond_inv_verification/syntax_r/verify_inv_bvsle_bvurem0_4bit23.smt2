...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvand #b10000000000000000000000 t))
(define-fun l ((x (_ BitVec 23))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 23)) (bvand (bvneg s) t)))
