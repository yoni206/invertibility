...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvneg (bvand (bvor (bvnot s) #b01111111111111111111111) (bvor s #b10000000000000000000000))))
(define-fun l ((x (_ BitVec 23))) Bool  (bvsle (bvadd (inv s t) s) t))
