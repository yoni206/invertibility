...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvneg (bvand (bvneg (bvnot t)) (bvneg t))))
(define-fun l ((x (_ BitVec 26))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 26))) (not (= s (_ bv0 26)))) (or (not (= t (bvnot (_ bv0 26)))) (not (= s (bvnot (_ bv0 26)))))))
