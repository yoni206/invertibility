...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvor #b011111111111111111111111111111 #b100000000000000000000000000000))
(define-fun l ((x (_ BitVec 30))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 30) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 30) t)))
