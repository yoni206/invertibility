...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvneg (bvand (bvor (bvnot s) #b0111111111111111111111) (bvor s #b1000000000000000000000))))
(define-fun l ((x (_ BitVec 22))) Bool  (bvsle (bvadd (inv s t) s) t))
