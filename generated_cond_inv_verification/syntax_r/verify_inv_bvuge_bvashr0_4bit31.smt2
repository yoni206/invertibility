...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvor t #b1000000000000000000000000000000))
(define-fun l ((x (_ BitVec 31))) Bool  (bvuge (bvashr (inv s t) s) t))
