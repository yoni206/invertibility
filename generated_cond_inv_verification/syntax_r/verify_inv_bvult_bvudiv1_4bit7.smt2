...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvor #b0111111 #b1000000))
(define-fun l ((x (_ BitVec 7))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 7) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 7) t)))
