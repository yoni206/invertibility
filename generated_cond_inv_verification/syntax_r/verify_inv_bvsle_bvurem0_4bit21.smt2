...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvand #b100000000000000000000 t))
(define-fun l ((x (_ BitVec 21))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 21)) (bvand (bvneg s) t)))
