...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvneg (bvand (bvneg (bvnot t)) (bvneg t))))
(define-fun l ((x (_ BitVec 27))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 27))) (not (= s (_ bv0 27)))) (or (not (= t (bvnot (_ bv0 27)))) (not (= s (bvnot (_ bv0 27)))))))
