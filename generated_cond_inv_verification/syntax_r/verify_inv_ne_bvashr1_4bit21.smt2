...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvneg (bvand (bvneg (bvnot t)) (bvneg t))))
(define-fun l ((x (_ BitVec 21))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 21))) (not (= s (_ bv0 21)))) (or (not (= t (bvnot (_ bv0 21)))) (not (= s (bvnot (_ bv0 21)))))))
