...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvand #b100000000 t))
(define-fun l ((x (_ BitVec 9))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 9)) (bvand (bvneg s) t)))
