...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvnot t))
(define-fun l ((x (_ BitVec 17))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 17))) (distinct t (bvnot (_ bv0 17)))))
