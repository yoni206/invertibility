...
(define-fun SC ((s (_ BitVec 91)) (t (_ BitVec 91))) Bool (not (= (bvor (bvshl (_ bv7 91) s) t) (_ bv0 91))))

(define-fun l ((x (_ BitVec 91)) (s (_ BitVec 91)) (t (_ BitVec 91))) Bool (distinct (bvshl x s) t))
