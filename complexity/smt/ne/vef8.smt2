...
(define-fun SC ((s (_ BitVec 8)) (t (_ BitVec 8))) Bool (not (= (bvor (bvshl (_ bv7 8) s) t) (_ bv0 8))))

(define-fun l ((x (_ BitVec 8)) (s (_ BitVec 8)) (t (_ BitVec 8))) Bool (distinct (bvshl x s) t))
