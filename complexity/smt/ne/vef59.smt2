...
(define-fun SC ((s (_ BitVec 59)) (t (_ BitVec 59))) Bool (not (= (bvor (bvshl (_ bv7 59) s) t) (_ bv0 59))))

(define-fun l ((x (_ BitVec 59)) (s (_ BitVec 59)) (t (_ BitVec 59))) Bool (distinct (bvshl x s) t))
