...
(define-fun SC ((s (_ BitVec 34)) (t (_ BitVec 34))) Bool (not (= (bvor (bvshl (_ bv7 34) s) t) (_ bv0 34))))

(define-fun l ((x (_ BitVec 34)) (s (_ BitVec 34)) (t (_ BitVec 34))) Bool (distinct (bvshl x s) t))

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 34))) (l x s t)))
  (=> (exists ((x (_ BitVec 34))) (l x s t)) (SC s t))
  )
 )
)
(check-sat)
