...
(define-fun SC ((s (_ BitVec 71)) (t (_ BitVec 71))) Bool (not (= (bvor (bvshl (_ bv7 71) s) t) (_ bv0 71))))

(define-fun l ((x (_ BitVec 71)) (s (_ BitVec 71)) (t (_ BitVec 71))) Bool (distinct (bvshl x s) t))
