...
(define-fun SC ((s (_ BitVec 52)) (t (_ BitVec 52))) Bool (not (= (bvor (bvshl (_ bv7 52) s) t) (_ bv0 52))))

(define-fun l ((x (_ BitVec 52)) (s (_ BitVec 52)) (t (_ BitVec 52))) Bool (distinct (bvshl x s) t))
