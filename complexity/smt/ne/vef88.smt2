...
(define-fun SC ((s (_ BitVec 88)) (t (_ BitVec 88))) Bool (not (= (bvor (bvshl (_ bv7 88) s) t) (_ bv0 88))))

(define-fun l ((x (_ BitVec 88)) (s (_ BitVec 88)) (t (_ BitVec 88))) Bool (distinct (bvshl x s) t))
