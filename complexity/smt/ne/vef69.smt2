...
(define-fun SC ((s (_ BitVec 69)) (t (_ BitVec 69))) Bool (not (= (bvor (bvshl (_ bv7 69) s) t) (_ bv0 69))))

(define-fun l ((x (_ BitVec 69)) (s (_ BitVec 69)) (t (_ BitVec 69))) Bool (distinct (bvshl x s) t))
