...
(define-fun SC ((s (_ BitVec 83)) (t (_ BitVec 83))) Bool (not (= (bvor (bvshl (_ bv7 83) s) t) (_ bv0 83))))

(define-fun l ((x (_ BitVec 83)) (s (_ BitVec 83)) (t (_ BitVec 83))) Bool (distinct (bvshl x s) t))
