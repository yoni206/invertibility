...
(define-fun SC ((s (_ BitVec 81)) (t (_ BitVec 81))) Bool (not (= (bvor (bvshl (_ bv7 81) s) t) (_ bv0 81))))

(define-fun l ((x (_ BitVec 81)) (s (_ BitVec 81)) (t (_ BitVec 81))) Bool (distinct (bvshl x s) t))
