...
(define-fun SC ((s (_ BitVec 74)) (t (_ BitVec 74))) Bool (not (= (bvor (bvshl (_ bv7 74) s) t) (_ bv0 74))))

(define-fun l ((x (_ BitVec 74)) (s (_ BitVec 74)) (t (_ BitVec 74))) Bool (distinct (bvshl x s) t))
