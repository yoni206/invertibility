...
(define-fun SC ((s (_ BitVec 43)) (t (_ BitVec 43))) Bool (not (= (bvor (bvshl (_ bv7 43) s) t) (_ bv0 43))))

(define-fun l ((x (_ BitVec 43)) (s (_ BitVec 43)) (t (_ BitVec 43))) Bool (distinct (bvshl x s) t))
