...
(define-fun SC ((s (_ BitVec 72)) (t (_ BitVec 72))) Bool (not (= (bvor (bvshl (_ bv7 72) s) t) (_ bv0 72))))

(define-fun l ((x (_ BitVec 72)) (s (_ BitVec 72)) (t (_ BitVec 72))) Bool (distinct (bvshl x s) t))
