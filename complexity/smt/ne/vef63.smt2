...
(define-fun SC ((s (_ BitVec 63)) (t (_ BitVec 63))) Bool (not (= (bvor (bvshl (_ bv7 63) s) t) (_ bv0 63))))

(define-fun l ((x (_ BitVec 63)) (s (_ BitVec 63)) (t (_ BitVec 63))) Bool (distinct (bvshl x s) t))
