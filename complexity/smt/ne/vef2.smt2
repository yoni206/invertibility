...
(define-fun SC ((s (_ BitVec 2)) (t (_ BitVec 2))) Bool (not (= (bvor (bvshl (_ bv7 2) s) t) (_ bv0 2))))

(define-fun l ((x (_ BitVec 2)) (s (_ BitVec 2)) (t (_ BitVec 2))) Bool (distinct (bvshl x s) t))

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 2))) (l x s t)))
  (=> (exists ((x (_ BitVec 2))) (l x s t)) (SC s t))
  )
 )
)
(check-sat)
