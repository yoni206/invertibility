...
(define-fun SC ((s (_ BitVec 46)) (t (_ BitVec 46))) Bool (not (= (bvor (bvshl (_ bv7 46) s) t) (_ bv0 46))))

(define-fun l ((x (_ BitVec 46)) (s (_ BitVec 46)) (t (_ BitVec 46))) Bool (distinct (bvshl x s) t))
