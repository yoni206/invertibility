...
(define-fun SC ((s (_ BitVec 21)) (t (_ BitVec 21))) Bool (not (= (bvor (bvshl (_ bv7 21) s) t) (_ bv0 21))))

(define-fun l ((x (_ BitVec 21)) (s (_ BitVec 21)) (t (_ BitVec 21))) Bool (distinct (bvshl x s) t))
