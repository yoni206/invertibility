...
(define-fun SC ((s (_ BitVec 30)) (t (_ BitVec 30))) Bool (not (= (bvor (bvshl (_ bv7 30) s) t) (_ bv0 30))))

(define-fun l ((x (_ BitVec 30)) (s (_ BitVec 30)) (t (_ BitVec 30))) Bool (distinct (bvshl x s) t))
