...
(define-fun SC ((s (_ BitVec 53)) (t (_ BitVec 53))) Bool (not (= (bvor (bvshl (_ bv7 53) s) t) (_ bv0 53))))

(define-fun l ((x (_ BitVec 53)) (s (_ BitVec 53)) (t (_ BitVec 53))) Bool (distinct (bvshl x s) t))
