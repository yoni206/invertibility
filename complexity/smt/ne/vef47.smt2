...
(define-fun SC ((s (_ BitVec 47)) (t (_ BitVec 47))) Bool (not (= (bvor (bvshl (_ bv7 47) s) t) (_ bv0 47))))

(define-fun l ((x (_ BitVec 47)) (s (_ BitVec 47)) (t (_ BitVec 47))) Bool (distinct (bvshl x s) t))
