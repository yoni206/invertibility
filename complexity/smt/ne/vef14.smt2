...
(define-fun SC ((s (_ BitVec 14)) (t (_ BitVec 14))) Bool (not (= (bvor (bvshl (_ bv7 14) s) t) (_ bv0 14))))

(define-fun l ((x (_ BitVec 14)) (s (_ BitVec 14)) (t (_ BitVec 14))) Bool (distinct (bvshl x s) t))

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 14))) (l x s t)))
  (=> (exists ((x (_ BitVec 14))) (l x s t)) (SC s t))
  )
 )
)
(check-sat)
