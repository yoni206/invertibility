...
(define-fun SC ((s (_ BitVec 58)) (t (_ BitVec 58))) Bool (not (= (bvor (bvshl (_ bv7 58) s) t) (_ bv0 58))))

(define-fun l ((x (_ BitVec 58)) (s (_ BitVec 58)) (t (_ BitVec 58))) Bool (distinct (bvshl x s) t))
