...
(define-fun SC ((s (_ BitVec 98)) (t (_ BitVec 98))) Bool (not (= (bvor (bvshl (_ bv7 98) s) t) (_ bv0 98))))

(define-fun l ((x (_ BitVec 98)) (s (_ BitVec 98)) (t (_ BitVec 98))) Bool (distinct (bvshl x s) t))
