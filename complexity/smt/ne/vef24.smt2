...
(define-fun SC ((s (_ BitVec 24)) (t (_ BitVec 24))) Bool (not (= (bvor (bvshl (_ bv7 24) s) t) (_ bv0 24))))

(define-fun l ((x (_ BitVec 24)) (s (_ BitVec 24)) (t (_ BitVec 24))) Bool (distinct (bvshl x s) t))
