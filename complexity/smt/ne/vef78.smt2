...
(define-fun SC ((s (_ BitVec 78)) (t (_ BitVec 78))) Bool (not (= (bvor (bvshl (_ bv7 78) s) t) (_ bv0 78))))

(define-fun l ((x (_ BitVec 78)) (s (_ BitVec 78)) (t (_ BitVec 78))) Bool (distinct (bvshl x s) t))
