...
(define-fun SC ((s (_ BitVec 12)) (t (_ BitVec 12))) Bool (not (= (bvor (bvshl (_ bv7 12) s) t) (_ bv0 12))))

(define-fun l ((x (_ BitVec 12)) (s (_ BitVec 12)) (t (_ BitVec 12))) Bool (distinct (bvshl x s) t))
