...
(define-fun SC ((s (_ BitVec 25)) (t (_ BitVec 25))) Bool (not (= (bvor (bvshl (_ bv7 25) s) t) (_ bv0 25))))

(define-fun l ((x (_ BitVec 25)) (s (_ BitVec 25)) (t (_ BitVec 25))) Bool (distinct (bvshl x s) t))
