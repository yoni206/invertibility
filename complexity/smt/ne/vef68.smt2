...
(define-fun SC ((s (_ BitVec 68)) (t (_ BitVec 68))) Bool (not (= (bvor (bvshl (_ bv7 68) s) t) (_ bv0 68))))

(define-fun l ((x (_ BitVec 68)) (s (_ BitVec 68)) (t (_ BitVec 68))) Bool (distinct (bvshl x s) t))
