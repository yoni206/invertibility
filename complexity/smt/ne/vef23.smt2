...
(define-fun SC ((s (_ BitVec 23)) (t (_ BitVec 23))) Bool (not (= (bvor (bvshl (_ bv7 23) s) t) (_ bv0 23))))

(define-fun l ((x (_ BitVec 23)) (s (_ BitVec 23)) (t (_ BitVec 23))) Bool (distinct (bvshl x s) t))
