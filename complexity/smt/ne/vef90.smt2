...
(define-fun SC ((s (_ BitVec 90)) (t (_ BitVec 90))) Bool (not (= (bvor (bvshl (_ bv7 90) s) t) (_ bv0 90))))

(define-fun l ((x (_ BitVec 90)) (s (_ BitVec 90)) (t (_ BitVec 90))) Bool (distinct (bvshl x s) t))
