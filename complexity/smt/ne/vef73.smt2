...
(define-fun SC ((s (_ BitVec 73)) (t (_ BitVec 73))) Bool (not (= (bvor (bvshl (_ bv7 73) s) t) (_ bv0 73))))

(define-fun l ((x (_ BitVec 73)) (s (_ BitVec 73)) (t (_ BitVec 73))) Bool (distinct (bvshl x s) t))
