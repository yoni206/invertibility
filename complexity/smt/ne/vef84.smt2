...
(define-fun SC ((s (_ BitVec 84)) (t (_ BitVec 84))) Bool (not (= (bvor (bvshl (_ bv7 84) s) t) (_ bv0 84))))

(define-fun l ((x (_ BitVec 84)) (s (_ BitVec 84)) (t (_ BitVec 84))) Bool (distinct (bvshl x s) t))
