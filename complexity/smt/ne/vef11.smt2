...
(define-fun SC ((s (_ BitVec 11)) (t (_ BitVec 11))) Bool (not (= (bvor (bvshl (_ bv7 11) s) t) (_ bv0 11))))

(define-fun l ((x (_ BitVec 11)) (s (_ BitVec 11)) (t (_ BitVec 11))) Bool (distinct (bvshl x s) t))

(assert
 (not
  (and
  (=> (SC s t) (exists ((x (_ BitVec 11))) (l x s t)))
  (=> (exists ((x (_ BitVec 11))) (l x s t)) (SC s t))
  )
 )
)
(check-sat)
