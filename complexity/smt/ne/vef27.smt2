...
(define-fun SC ((s (_ BitVec 27)) (t (_ BitVec 27))) Bool (not (= (bvor (bvshl (_ bv7 27) s) t) (_ bv0 27))))

(define-fun l ((x (_ BitVec 27)) (s (_ BitVec 27)) (t (_ BitVec 27))) Bool (distinct (bvshl x s) t))
