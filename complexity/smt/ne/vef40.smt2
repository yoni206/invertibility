...
(define-fun SC ((s (_ BitVec 40)) (t (_ BitVec 40))) Bool (not (= (bvor (bvshl (_ bv7 40) s) t) (_ bv0 40))))

(define-fun l ((x (_ BitVec 40)) (s (_ BitVec 40)) (t (_ BitVec 40))) Bool (distinct (bvshl x s) t))
