...
(define-fun SC ((s (_ BitVec 10)) (t (_ BitVec 10))) Bool (not (= (bvor (bvshl (_ bv7 10) s) t) (_ bv0 10))))

(define-fun l ((x (_ BitVec 10)) (s (_ BitVec 10)) (t (_ BitVec 10))) Bool (distinct (bvshl x s) t))
