...
(define-fun SC ((s (_ BitVec 67)) (t (_ BitVec 67))) Bool (not (= (bvor (bvshl (_ bv7 67) s) t) (_ bv0 67))))

(define-fun l ((x (_ BitVec 67)) (s (_ BitVec 67)) (t (_ BitVec 67))) Bool (distinct (bvshl x s) t))
