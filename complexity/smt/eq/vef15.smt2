...
(define-fun SC ((s (_ BitVec 15)) (t (_ BitVec 15))) Bool (= (bvand (bvshl (bvnot (_ bv0000 15)) s) t) t))

(define-fun l ((x (_ BitVec 15)) (s (_ BitVec 15)) (t (_ BitVec 15))) Bool (= (bvshl x s) t))
