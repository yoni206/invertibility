...
(define-fun SC ((s (_ BitVec 34)) (t (_ BitVec 34))) Bool (= (bvand (bvshl (bvnot (_ bv0000 34)) s) t) t))

(define-fun l ((x (_ BitVec 34)) (s (_ BitVec 34)) (t (_ BitVec 34))) Bool (= (bvshl x s) t))
