...
(define-fun SC ((s (_ BitVec 93)) (t (_ BitVec 93))) Bool (= (bvand (bvshl (bvnot (_ bv0000 93)) s) t) t))

(define-fun l ((x (_ BitVec 93)) (s (_ BitVec 93)) (t (_ BitVec 93))) Bool (= (bvshl x s) t))
