...
(define-fun SC ((s (_ BitVec 48)) (t (_ BitVec 48))) Bool (= (bvand (bvshl (bvnot (_ bv0000 48)) s) t) t))

(define-fun l ((x (_ BitVec 48)) (s (_ BitVec 48)) (t (_ BitVec 48))) Bool (= (bvshl x s) t))
