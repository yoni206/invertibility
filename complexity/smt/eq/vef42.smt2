...
(define-fun SC ((s (_ BitVec 42)) (t (_ BitVec 42))) Bool (= (bvand (bvshl (bvnot (_ bv0000 42)) s) t) t))

(define-fun l ((x (_ BitVec 42)) (s (_ BitVec 42)) (t (_ BitVec 42))) Bool (= (bvshl x s) t))
