...
(define-fun SC ((s (_ BitVec 13)) (t (_ BitVec 13))) Bool (= (bvand (bvshl (bvnot (_ bv0000 13)) s) t) t))

(define-fun l ((x (_ BitVec 13)) (s (_ BitVec 13)) (t (_ BitVec 13))) Bool (= (bvshl x s) t))
