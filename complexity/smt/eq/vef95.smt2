...
(define-fun SC ((s (_ BitVec 95)) (t (_ BitVec 95))) Bool (= (bvand (bvshl (bvnot (_ bv0000 95)) s) t) t))

(define-fun l ((x (_ BitVec 95)) (s (_ BitVec 95)) (t (_ BitVec 95))) Bool (= (bvshl x s) t))
