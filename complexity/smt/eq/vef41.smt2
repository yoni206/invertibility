...
(define-fun SC ((s (_ BitVec 41)) (t (_ BitVec 41))) Bool (= (bvand (bvshl (bvnot (_ bv0000 41)) s) t) t))

(define-fun l ((x (_ BitVec 41)) (s (_ BitVec 41)) (t (_ BitVec 41))) Bool (= (bvshl x s) t))
