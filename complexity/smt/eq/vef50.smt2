...
(define-fun SC ((s (_ BitVec 50)) (t (_ BitVec 50))) Bool (= (bvand (bvshl (bvnot (_ bv0000 50)) s) t) t))

(define-fun l ((x (_ BitVec 50)) (s (_ BitVec 50)) (t (_ BitVec 50))) Bool (= (bvshl x s) t))
