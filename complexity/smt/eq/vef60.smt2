...
(define-fun SC ((s (_ BitVec 60)) (t (_ BitVec 60))) Bool (= (bvand (bvshl (bvnot (_ bv0000 60)) s) t) t))

(define-fun l ((x (_ BitVec 60)) (s (_ BitVec 60)) (t (_ BitVec 60))) Bool (= (bvshl x s) t))
