...
(define-fun SC ((s (_ BitVec 32)) (t (_ BitVec 32))) Bool (= (bvand (bvshl (bvnot (_ bv0000 32)) s) t) t))

(define-fun l ((x (_ BitVec 32)) (s (_ BitVec 32)) (t (_ BitVec 32))) Bool (= (bvshl x s) t))
