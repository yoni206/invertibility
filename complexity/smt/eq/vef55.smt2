...
(define-fun SC ((s (_ BitVec 55)) (t (_ BitVec 55))) Bool (= (bvand (bvshl (bvnot (_ bv0000 55)) s) t) t))

(define-fun l ((x (_ BitVec 55)) (s (_ BitVec 55)) (t (_ BitVec 55))) Bool (= (bvshl x s) t))
