...
(define-fun SC ((s (_ BitVec 61)) (t (_ BitVec 61))) Bool (= (bvand (bvshl (bvnot (_ bv0000 61)) s) t) t))

(define-fun l ((x (_ BitVec 61)) (s (_ BitVec 61)) (t (_ BitVec 61))) Bool (= (bvshl x s) t))
