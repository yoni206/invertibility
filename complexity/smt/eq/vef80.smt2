...
(define-fun SC ((s (_ BitVec 80)) (t (_ BitVec 80))) Bool (= (bvand (bvshl (bvnot (_ bv0000 80)) s) t) t))

(define-fun l ((x (_ BitVec 80)) (s (_ BitVec 80)) (t (_ BitVec 80))) Bool (= (bvshl x s) t))
