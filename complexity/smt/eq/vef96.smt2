...
(define-fun SC ((s (_ BitVec 96)) (t (_ BitVec 96))) Bool (= (bvand (bvshl (bvnot (_ bv0000 96)) s) t) t))

(define-fun l ((x (_ BitVec 96)) (s (_ BitVec 96)) (t (_ BitVec 96))) Bool (= (bvshl x s) t))
