...
(define-fun SC ((s (_ BitVec 36)) (t (_ BitVec 36))) Bool (= (bvand (bvshl (bvnot (_ bv0000 36)) s) t) t))

(define-fun l ((x (_ BitVec 36)) (s (_ BitVec 36)) (t (_ BitVec 36))) Bool (= (bvshl x s) t))
