...
(define-fun SC ((s (_ BitVec 29)) (t (_ BitVec 29))) Bool (= (bvand (bvshl (bvnot (_ bv0000 29)) s) t) t))

(define-fun l ((x (_ BitVec 29)) (s (_ BitVec 29)) (t (_ BitVec 29))) Bool (= (bvshl x s) t))
