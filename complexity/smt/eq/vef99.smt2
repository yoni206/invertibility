...
(define-fun SC ((s (_ BitVec 99)) (t (_ BitVec 99))) Bool (= (bvand (bvshl (bvnot (_ bv0000 99)) s) t) t))

(define-fun l ((x (_ BitVec 99)) (s (_ BitVec 99)) (t (_ BitVec 99))) Bool (= (bvshl x s) t))
