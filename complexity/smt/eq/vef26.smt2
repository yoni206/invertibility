...
(define-fun SC ((s (_ BitVec 26)) (t (_ BitVec 26))) Bool (= (bvand (bvshl (bvnot (_ bv0000 26)) s) t) t))

(define-fun l ((x (_ BitVec 26)) (s (_ BitVec 26)) (t (_ BitVec 26))) Bool (= (bvshl x s) t))
