...
(define-fun SC ((s (_ BitVec 89)) (t (_ BitVec 89))) Bool (= (bvand (bvshl (bvnot (_ bv0000 89)) s) t) t))

(define-fun l ((x (_ BitVec 89)) (s (_ BitVec 89)) (t (_ BitVec 89))) Bool (= (bvshl x s) t))
