...
(define-fun SC ((s (_ BitVec 66)) (t (_ BitVec 66))) Bool (= (bvand (bvshl (bvnot (_ bv0000 66)) s) t) t))

(define-fun l ((x (_ BitVec 66)) (s (_ BitVec 66)) (t (_ BitVec 66))) Bool (= (bvshl x s) t))
