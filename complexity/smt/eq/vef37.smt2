...
(define-fun SC ((s (_ BitVec 37)) (t (_ BitVec 37))) Bool (= (bvand (bvshl (bvnot (_ bv0000 37)) s) t) t))

(define-fun l ((x (_ BitVec 37)) (s (_ BitVec 37)) (t (_ BitVec 37))) Bool (= (bvshl x s) t))
