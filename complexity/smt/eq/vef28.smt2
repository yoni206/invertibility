...
(define-fun SC ((s (_ BitVec 28)) (t (_ BitVec 28))) Bool (= (bvand (bvshl (bvnot (_ bv0000 28)) s) t) t))

(define-fun l ((x (_ BitVec 28)) (s (_ BitVec 28)) (t (_ BitVec 28))) Bool (= (bvshl x s) t))
