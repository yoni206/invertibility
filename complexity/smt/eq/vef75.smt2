...
(define-fun SC ((s (_ BitVec 75)) (t (_ BitVec 75))) Bool (= (bvand (bvshl (bvnot (_ bv0000 75)) s) t) t))

(define-fun l ((x (_ BitVec 75)) (s (_ BitVec 75)) (t (_ BitVec 75))) Bool (= (bvshl x s) t))
