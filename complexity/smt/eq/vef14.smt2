...
(define-fun SC ((s (_ BitVec 14)) (t (_ BitVec 14))) Bool (= (bvand (bvshl (bvnot (_ bv0000 14)) s) t) t))

(define-fun l ((x (_ BitVec 14)) (s (_ BitVec 14)) (t (_ BitVec 14))) Bool (= (bvshl x s) t))
