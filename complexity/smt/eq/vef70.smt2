...
(define-fun SC ((s (_ BitVec 70)) (t (_ BitVec 70))) Bool (= (bvand (bvshl (bvnot (_ bv0000 70)) s) t) t))

(define-fun l ((x (_ BitVec 70)) (s (_ BitVec 70)) (t (_ BitVec 70))) Bool (= (bvshl x s) t))
