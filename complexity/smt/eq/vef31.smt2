...
(define-fun SC ((s (_ BitVec 31)) (t (_ BitVec 31))) Bool (= (bvand (bvshl (bvnot (_ bv0000 31)) s) t) t))

(define-fun l ((x (_ BitVec 31)) (s (_ BitVec 31)) (t (_ BitVec 31))) Bool (= (bvshl x s) t))
