...
(define-fun SC ((s (_ BitVec 57)) (t (_ BitVec 57))) Bool (= (bvand (bvshl (bvnot (_ bv0000 57)) s) t) t))

(define-fun l ((x (_ BitVec 57)) (s (_ BitVec 57)) (t (_ BitVec 57))) Bool (= (bvshl x s) t))
