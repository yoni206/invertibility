...
(define-fun SC ((s (_ BitVec 11)) (t (_ BitVec 11))) Bool (= (bvand (bvshl (bvnot (_ bv0000 11)) s) t) t))

(define-fun l ((x (_ BitVec 11)) (s (_ BitVec 11)) (t (_ BitVec 11))) Bool (= (bvshl x s) t))
