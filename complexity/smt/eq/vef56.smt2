...
(define-fun SC ((s (_ BitVec 56)) (t (_ BitVec 56))) Bool (= (bvand (bvshl (bvnot (_ bv0000 56)) s) t) t))

(define-fun l ((x (_ BitVec 56)) (s (_ BitVec 56)) (t (_ BitVec 56))) Bool (= (bvshl x s) t))
