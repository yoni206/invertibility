...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvadd #b01111111111111111111111 #b10000000000000000000000))
(define-fun l ((x (_ BitVec 23))) Bool  (bvugt (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvult t (bvshl (bvnot (_ bv0 23)) s)))
