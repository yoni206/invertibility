...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvadd (bvadd t #b0111111) #b1000000))
(define-fun l ((x (_ BitVec 7))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 7)) (distinct t (bvnot (_ bv0 7)))))
