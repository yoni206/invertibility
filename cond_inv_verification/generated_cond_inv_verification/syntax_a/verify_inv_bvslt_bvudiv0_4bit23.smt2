...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 23))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 23)) (bvslt (udivtotal min s) t)))
