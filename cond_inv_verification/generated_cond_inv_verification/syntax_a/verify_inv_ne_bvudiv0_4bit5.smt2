...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvadd (bvadd t #b01111) #b10000))
(define-fun l ((x (_ BitVec 5))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 5)) (distinct t (bvnot (_ bv0 5)))))
