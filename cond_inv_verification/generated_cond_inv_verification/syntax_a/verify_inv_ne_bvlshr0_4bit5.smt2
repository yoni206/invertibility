...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvsub (bvadd t #b01111) #b10000))
(define-fun l ((x (_ BitVec 5))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 5)) (bvult s (_ bv5 5))))
