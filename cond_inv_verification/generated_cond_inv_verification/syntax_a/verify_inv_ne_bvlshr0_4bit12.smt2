...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvsub (bvadd t #b011111111111) #b100000000000))
(define-fun l ((x (_ BitVec 12))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 12)) (bvult s (_ bv12 12))))
