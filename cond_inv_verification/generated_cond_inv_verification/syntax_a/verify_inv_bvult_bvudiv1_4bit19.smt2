...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvadd #b1000000000000000000 #b0111111111111111111))
(define-fun l ((x (_ BitVec 19))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 19) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 19) t)))
