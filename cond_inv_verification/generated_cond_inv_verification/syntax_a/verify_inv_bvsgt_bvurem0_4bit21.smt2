...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvsub #b000000000000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 21))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 21)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 21)) (distinct t max))) (or (distinct t (_ bv0 21)) (distinct s (_ bv1 21)))))
