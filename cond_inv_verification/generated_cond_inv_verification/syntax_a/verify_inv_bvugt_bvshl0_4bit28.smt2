...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvadd #b0111111111111111111111111111 #b1000000000000000000000000000))
(define-fun l ((x (_ BitVec 28))) Bool  (bvugt (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvult t (bvshl (bvnot (_ bv0 28)) s)))
