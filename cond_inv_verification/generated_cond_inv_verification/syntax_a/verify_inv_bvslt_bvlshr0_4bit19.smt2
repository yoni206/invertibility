...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvsub t (bvmul #b0111111111111111111 #b0111111111111111111)))
(define-fun l ((x (_ BitVec 19))) Bool  (bvslt (bvlshr (inv s t) s) t))
