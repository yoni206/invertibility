...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvsub #b0000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 13))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 13)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 13)) (distinct t max))) (or (distinct t (_ bv0 13)) (distinct s (_ bv1 13)))))
