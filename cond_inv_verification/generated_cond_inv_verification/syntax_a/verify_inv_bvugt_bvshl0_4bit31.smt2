...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvadd #b0111111111111111111111111111111 #b1000000000000000000000000000000))
(define-fun l ((x (_ BitVec 31))) Bool  (bvugt (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvult t (bvshl (bvnot (_ bv0 31)) s)))
