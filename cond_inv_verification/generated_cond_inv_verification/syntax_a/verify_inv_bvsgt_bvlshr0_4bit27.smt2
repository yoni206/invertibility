...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvadd (bvadd (bvmul s t) s) #b011111111111111111111111111))
(define-fun l ((x (_ BitVec 27))) Bool  (bvsgt (bvlshr (inv s t) s) t))
