...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvadd (bvadd #b011111111111111111111 s) t))
(define-fun l ((x (_ BitVec 21))) Bool  (distinct (bvadd (inv s t) s) t))
