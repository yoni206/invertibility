...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvadd (bvmul s t) #b0111111111111111))
(define-fun l ((x (_ BitVec 16))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 16))) (bvsge (bvlshr (bvnot (_ bv0 16)) s) t)))
