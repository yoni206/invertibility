...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvsub t (bvmul #b011111111111111111111111111111 #b011111111111111111111111111111)))
(define-fun l ((x (_ BitVec 30))) Bool  (bvslt (bvlshr (inv s t) s) t))
