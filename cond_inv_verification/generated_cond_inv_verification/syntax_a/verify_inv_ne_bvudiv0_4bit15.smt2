...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvadd (bvadd t #b011111111111111) #b100000000000000))
(define-fun l ((x (_ BitVec 15))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 15)) (distinct t (bvnot (_ bv0 15)))))
