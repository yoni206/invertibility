...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvsub #b00000000 s))
(define-fun l ((x (_ BitVec 8))) Bool  (bvult (bvadd (inv s t) s) t))
(define-fun SC () Bool (distinct t (_ bv0 8)))
