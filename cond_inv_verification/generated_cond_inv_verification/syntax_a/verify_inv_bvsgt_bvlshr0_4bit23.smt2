...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvadd (bvadd (bvmul s t) s) #b01111111111111111111111))
(define-fun l ((x (_ BitVec 23))) Bool  (bvsgt (bvlshr (inv s t) s) t))
