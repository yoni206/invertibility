...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvadd s t))
(define-fun l ((x (_ BitVec 5))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 5)) (distinct t (_ bv0 5))))
