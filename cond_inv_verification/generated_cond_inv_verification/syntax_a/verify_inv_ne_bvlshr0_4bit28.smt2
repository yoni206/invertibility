...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvsub (bvadd t #b0111111111111111111111111111) #b1000000000000000000000000000))
(define-fun l ((x (_ BitVec 28))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 28)) (bvult s (_ bv28 28))))
