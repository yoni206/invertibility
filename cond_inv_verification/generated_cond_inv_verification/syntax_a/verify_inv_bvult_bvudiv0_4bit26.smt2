...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) #b00000000000000000000000000)
(define-fun l ((x (_ BitVec 26))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 26) s) (bvult (_ bv0 26) t)))
