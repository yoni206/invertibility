...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvadd (bvmul s t) #b0111111))
(define-fun l ((x (_ BitVec 7))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 7))) (bvsge (bvlshr (bvnot (_ bv0 7)) s) t)))
