...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvadd s t))
(define-fun l ((x (_ BitVec 6))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 6)) (distinct t (_ bv0 6))))
