...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvsub t (bvmul #b0111111111111 #b0111111111111)))
(define-fun l ((x (_ BitVec 13))) Bool  (bvslt (bvlshr (inv s t) s) t))
