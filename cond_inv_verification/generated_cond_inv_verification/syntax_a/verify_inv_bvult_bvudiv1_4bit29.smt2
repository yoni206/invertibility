...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvadd #b10000000000000000000000000000 #b01111111111111111111111111111))
(define-fun l ((x (_ BitVec 29))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 29) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 29) t)))
