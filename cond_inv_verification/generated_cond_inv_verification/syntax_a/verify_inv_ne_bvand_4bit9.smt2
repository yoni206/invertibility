...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvadd s t))
(define-fun l ((x (_ BitVec 9))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 9)) (distinct t (_ bv0 9))))
