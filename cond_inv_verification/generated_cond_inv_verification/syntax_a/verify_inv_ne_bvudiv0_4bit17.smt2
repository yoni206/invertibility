...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvadd (bvadd t #b01111111111111111) #b10000000000000000))
(define-fun l ((x (_ BitVec 17))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 17)) (distinct t (bvnot (_ bv0 17)))))
