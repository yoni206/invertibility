...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvadd (bvmul s t) #b011111111))
(define-fun l ((x (_ BitVec 9))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 9))) (bvsge (bvlshr (bvnot (_ bv0 9)) s) t)))
