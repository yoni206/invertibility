...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvadd (bvadd (bvmul s t) s) #b01111111111111111))
(define-fun l ((x (_ BitVec 17))) Bool  (bvsgt (bvlshr (inv s t) s) t))
