...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 21))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 21)) (bvslt (udivtotal min s) t)))
