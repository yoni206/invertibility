...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvadd (bvadd (bvmul s t) s) #b01111111111111))
(define-fun l ((x (_ BitVec 14))) Bool  (bvsgt (bvlshr (inv s t) s) t))
