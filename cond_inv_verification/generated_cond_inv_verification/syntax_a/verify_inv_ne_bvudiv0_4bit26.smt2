...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvadd (bvadd t #b01111111111111111111111111) #b10000000000000000000000000))
(define-fun l ((x (_ BitVec 26))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 26)) (distinct t (bvnot (_ bv0 26)))))
