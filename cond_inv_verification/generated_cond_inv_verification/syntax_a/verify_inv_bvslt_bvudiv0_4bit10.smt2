...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 10))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 10)) (bvslt (udivtotal min s) t)))
