...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvsub t (bvmul #b01111111111111111 #b01111111111111111)))
(define-fun l ((x (_ BitVec 17))) Bool  (bvslt (bvlshr (inv s t) s) t))
