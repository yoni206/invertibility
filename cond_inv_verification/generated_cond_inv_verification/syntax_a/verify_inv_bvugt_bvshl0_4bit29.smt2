...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvadd #b01111111111111111111111111111 #b10000000000000000000000000000))
(define-fun l ((x (_ BitVec 29))) Bool  (bvugt (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvult t (bvshl (bvnot (_ bv0 29)) s)))
