...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 29))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 29)) (bvslt (udivtotal min s) t)))
