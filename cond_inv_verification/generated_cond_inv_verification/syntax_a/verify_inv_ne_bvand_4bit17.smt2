...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvadd s t))
(define-fun l ((x (_ BitVec 17))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 17)) (distinct t (_ bv0 17))))
