...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvsub #b00000000 (bvnot t)))
(define-fun l ((x (_ BitVec 8))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 8)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 8)) (distinct t max))) (or (distinct t (_ bv0 8)) (distinct s (_ bv1 8)))))
