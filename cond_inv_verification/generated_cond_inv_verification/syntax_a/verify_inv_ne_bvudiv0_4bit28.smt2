...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvadd (bvadd t #b0111111111111111111111111111) #b1000000000000000000000000000))
(define-fun l ((x (_ BitVec 28))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 28)) (distinct t (bvnot (_ bv0 28)))))
