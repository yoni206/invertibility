...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvadd (bvadd (bvmul s t) s) #b01111111111111111111111111111))
(define-fun l ((x (_ BitVec 29))) Bool  (bvsgt (bvlshr (inv s t) s) t))
