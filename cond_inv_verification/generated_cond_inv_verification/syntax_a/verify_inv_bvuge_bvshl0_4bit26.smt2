...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvsub #b01111111111111111111111111 #b10000000000000000000000000))
(define-fun l ((x (_ BitVec 26))) Bool  (bvuge (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvuge (bvshl (bvnot (_ bv0 26)) s) t))
