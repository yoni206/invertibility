...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvsub t (bvmul #b0111111111111111111111111111111 #b0111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 31))) Bool  (bvslt (bvlshr (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvlshr (bvnot (bvneg t)) s) t))
