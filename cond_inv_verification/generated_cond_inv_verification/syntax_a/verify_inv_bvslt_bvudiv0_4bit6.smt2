...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 6))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 6)) (bvslt (udivtotal min s) t)))
