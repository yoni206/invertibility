...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvadd (bvadd t #b01111111111111111111) #b10000000000000000000))
(define-fun l ((x (_ BitVec 20))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 20)) (distinct t (bvnot (_ bv0 20)))))
