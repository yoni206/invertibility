...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvsub (bvadd t #b0111111111111111111111111) #b1000000000000000000000000))
(define-fun l ((x (_ BitVec 25))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 25)) (bvult s (_ bv25 25))))
