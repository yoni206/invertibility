...
(define-fun inv ((s (_ BitVec 4)) (t (_ BitVec 4))) (_ BitVec 4) (bvsub (bvadd t #b0111) #b1000))
(define-fun l ((x (_ BitVec 4))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 4)) (bvult s (_ bv4 4))))
