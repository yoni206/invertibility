...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvadd (bvadd t #b01111111) #b10000000))
(define-fun l ((x (_ BitVec 8))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 8)) (distinct t (bvnot (_ bv0 8)))))
