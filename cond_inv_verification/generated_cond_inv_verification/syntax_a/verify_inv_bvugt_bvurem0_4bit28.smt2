...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvsub s (bvmul #b0111111111111111111111111111 #b0111111111111111111111111111)))
(define-fun l ((x (_ BitVec 28))) Bool  (bvugt (uremtotal (inv s t) s) t))
