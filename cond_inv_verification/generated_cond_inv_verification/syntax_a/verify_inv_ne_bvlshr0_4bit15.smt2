...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvsub (bvadd t #b011111111111111) #b100000000000000))
(define-fun l ((x (_ BitVec 15))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 15)) (bvult s (_ bv15 15))))
