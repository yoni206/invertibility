...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvmul #b0111111111111111111111111 #b0111111111111111111111111))
(define-fun l ((x (_ BitVec 25))) Bool  (bvugt (bvneg (inv s t)) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 25))))
