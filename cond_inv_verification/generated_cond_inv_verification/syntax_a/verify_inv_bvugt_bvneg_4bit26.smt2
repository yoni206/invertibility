...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvmul #b01111111111111111111111111 #b01111111111111111111111111))
(define-fun l ((x (_ BitVec 26))) Bool  (bvugt (bvneg (inv s t)) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 26))))
