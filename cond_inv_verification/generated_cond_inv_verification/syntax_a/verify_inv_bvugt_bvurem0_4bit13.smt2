...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvsub s (bvmul #b0111111111111 #b0111111111111)))
(define-fun l ((x (_ BitVec 13))) Bool  (bvugt (uremtotal (inv s t) s) t))
