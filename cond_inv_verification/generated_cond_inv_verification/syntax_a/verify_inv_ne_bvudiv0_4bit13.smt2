...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvadd (bvadd t #b0111111111111) #b1000000000000))
(define-fun l ((x (_ BitVec 13))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 13)) (distinct t (bvnot (_ bv0 13)))))
