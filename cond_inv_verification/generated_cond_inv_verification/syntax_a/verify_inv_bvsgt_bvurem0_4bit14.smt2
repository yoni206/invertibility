...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvsub #b00000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 14))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 14)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 14)) (distinct t max))) (or (distinct t (_ bv0 14)) (distinct s (_ bv1 14)))))
