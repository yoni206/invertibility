...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvadd #b011111111111111111111111111111 #b100000000000000000000000000000))
(define-fun l ((x (_ BitVec 30))) Bool  (bvugt (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvult t (bvshl (bvnot (_ bv0 30)) s)))
