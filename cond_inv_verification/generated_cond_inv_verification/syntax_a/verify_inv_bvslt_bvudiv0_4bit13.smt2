...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 13))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 13)) (bvslt (udivtotal min s) t)))
