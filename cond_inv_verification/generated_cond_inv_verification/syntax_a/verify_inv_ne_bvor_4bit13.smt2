...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvnot t))
(define-fun l ((x (_ BitVec 13))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 13))) (distinct t (bvnot (_ bv0 13)))))
