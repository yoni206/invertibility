...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvsub s (bvmul #b011111111111111111111 #b011111111111111111111)))
(define-fun l ((x (_ BitVec 21))) Bool  (bvugt (uremtotal (inv s t) s) t))
