...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvadd #b01111111111111111111111111 #b10000000000000000000000000))
(define-fun l ((x (_ BitVec 26))) Bool  (bvugt (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvult t (bvshl (bvnot (_ bv0 26)) s)))
