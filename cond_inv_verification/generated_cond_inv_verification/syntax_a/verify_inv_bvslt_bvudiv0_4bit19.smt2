...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 19))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 19)) (bvslt (udivtotal min s) t)))
