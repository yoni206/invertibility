...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvsub (bvadd t #b011111) #b100000))
(define-fun l ((x (_ BitVec 6))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 6)) (bvult s (_ bv6 6))))
