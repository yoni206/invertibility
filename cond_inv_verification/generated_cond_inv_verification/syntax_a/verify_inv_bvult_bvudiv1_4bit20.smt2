...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvadd #b10000000000000000000 #b01111111111111111111))
(define-fun l ((x (_ BitVec 20))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 20) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 20) t)))
