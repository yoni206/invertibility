...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvadd s t))
(define-fun l ((x (_ BitVec 14))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 14)) (distinct t (_ bv0 14))))
