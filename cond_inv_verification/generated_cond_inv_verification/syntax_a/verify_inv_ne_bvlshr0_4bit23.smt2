...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvsub (bvadd t #b01111111111111111111111) #b10000000000000000000000))
(define-fun l ((x (_ BitVec 23))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 23)) (bvult s (_ bv23 23))))
