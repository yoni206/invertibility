...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvadd s t))
(define-fun l ((x (_ BitVec 30))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 30)) (distinct t (_ bv0 30))))
