...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvadd #b10000000000 #b01111111111))
(define-fun l ((x (_ BitVec 11))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 11) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 11) t)))
