...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvmul #b0111111111111111111111111111111 #b0111111111111111111111111111111))
(define-fun l ((x (_ BitVec 31))) Bool  (bvugt (bvneg (inv s t)) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 31))))
