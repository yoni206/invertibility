...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvsub t (bvmul #b01111111111111111111111111111 #b01111111111111111111111111111)))
(define-fun l ((x (_ BitVec 29))) Bool  (bvslt (bvlshr (inv s t) s) t))
