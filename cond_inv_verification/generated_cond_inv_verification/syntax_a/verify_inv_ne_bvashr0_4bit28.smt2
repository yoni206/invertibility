...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvsub t #b1000000000000000000000000000))
(define-fun l ((x (_ BitVec 28))) Bool  (distinct (bvashr (inv s t) s) t))
