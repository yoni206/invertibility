...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvsub s (bvmul #b0111111111 #b0111111111)))
(define-fun l ((x (_ BitVec 10))) Bool  (bvugt (uremtotal (inv s t) s) t))
