...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvmul #b011111111111111111111 #b011111111111111111111))
(define-fun l ((x (_ BitVec 21))) Bool  (bvugt (bvneg (inv s t)) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 21))))
