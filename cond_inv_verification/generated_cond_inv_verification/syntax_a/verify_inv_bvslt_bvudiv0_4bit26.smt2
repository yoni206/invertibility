...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 26))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 26)) (bvslt (udivtotal min s) t)))
