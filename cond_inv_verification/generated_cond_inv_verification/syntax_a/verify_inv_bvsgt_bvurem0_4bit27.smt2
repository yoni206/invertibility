...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvsub #b000000000000000000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 27))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 27)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 27)) (distinct t max))) (or (distinct t (_ bv0 27)) (distinct s (_ bv1 27)))))
