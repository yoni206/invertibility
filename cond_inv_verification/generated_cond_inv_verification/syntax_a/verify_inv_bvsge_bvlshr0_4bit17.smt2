...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvadd (bvmul s t) #b01111111111111111))
(define-fun l ((x (_ BitVec 17))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 17))) (bvsge (bvlshr (bvnot (_ bv0 17)) s) t)))
