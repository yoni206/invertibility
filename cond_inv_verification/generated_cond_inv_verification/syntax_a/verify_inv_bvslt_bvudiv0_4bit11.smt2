...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 11))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 11)) (bvslt (udivtotal min s) t)))
