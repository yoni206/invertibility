...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvmul #b0111111111111111111111111111 #b0111111111111111111111111111))
(define-fun l ((x (_ BitVec 28))) Bool  (bvugt (bvneg (inv s t)) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 28))))
