...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvsub t (bvmul #b011111111111111 #b011111111111111)))
(define-fun l ((x (_ BitVec 15))) Bool  (bvslt (bvlshr (inv s t) s) t))
