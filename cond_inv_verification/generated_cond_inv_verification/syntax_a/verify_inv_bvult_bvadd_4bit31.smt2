...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvsub #b0000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 31))) Bool  (bvult (bvadd (inv s t) s) t))
