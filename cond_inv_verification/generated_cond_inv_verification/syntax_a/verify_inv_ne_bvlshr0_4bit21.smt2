...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvsub (bvadd t #b011111111111111111111) #b100000000000000000000))
(define-fun l ((x (_ BitVec 21))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 21)) (bvult s (_ bv21 21))))
