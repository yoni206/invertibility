...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvadd (bvadd t #b01111111111) #b10000000000))
(define-fun l ((x (_ BitVec 11))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 11)) (distinct t (bvnot (_ bv0 11)))))
