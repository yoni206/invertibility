...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 30))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 30)) (bvslt (udivtotal min s) t)))
