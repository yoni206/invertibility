...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 18))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 18)) (bvslt (udivtotal min s) t)))
