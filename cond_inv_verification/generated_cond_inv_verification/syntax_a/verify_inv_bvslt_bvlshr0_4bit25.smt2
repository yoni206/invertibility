...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvsub t (bvmul #b0111111111111111111111111 #b0111111111111111111111111)))
(define-fun l ((x (_ BitVec 25))) Bool  (bvslt (bvlshr (inv s t) s) t))
