...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvsub s (bvmul #b01111111111111 #b01111111111111)))
(define-fun l ((x (_ BitVec 14))) Bool  (bvugt (uremtotal (inv s t) s) t))
