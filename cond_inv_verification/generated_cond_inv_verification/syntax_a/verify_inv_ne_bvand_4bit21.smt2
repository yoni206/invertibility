...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvadd s t))
(define-fun l ((x (_ BitVec 21))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 21)) (distinct t (_ bv0 21))))
