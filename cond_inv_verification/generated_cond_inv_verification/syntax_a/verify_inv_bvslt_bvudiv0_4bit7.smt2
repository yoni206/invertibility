...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 7))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 7)) (bvslt (udivtotal min s) t)))
