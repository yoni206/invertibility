...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvadd (bvadd t #b011111111111111111111111111) #b100000000000000000000000000))
(define-fun l ((x (_ BitVec 27))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 27)) (distinct t (bvnot (_ bv0 27)))))
