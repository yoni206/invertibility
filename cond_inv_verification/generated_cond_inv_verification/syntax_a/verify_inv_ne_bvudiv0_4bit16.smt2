...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvadd (bvadd t #b0111111111111111) #b1000000000000000))
(define-fun l ((x (_ BitVec 16))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 16)) (distinct t (bvnot (_ bv0 16)))))
