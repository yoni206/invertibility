...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvsub (bvadd t #b01111111111111111111111111111) #b10000000000000000000000000000))
(define-fun l ((x (_ BitVec 29))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 29)) (bvult s (_ bv29 29))))
