...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvsub (bvadd t #b0111111111111111111111) #b1000000000000000000000))
(define-fun l ((x (_ BitVec 22))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 22)) (bvult s (_ bv22 22))))
