...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvsub (bvadd t #b01111111111111) #b10000000000000))
(define-fun l ((x (_ BitVec 14))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 14)) (bvult s (_ bv14 14))))
