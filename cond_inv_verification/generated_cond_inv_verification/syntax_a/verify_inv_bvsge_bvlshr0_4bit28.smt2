...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvadd (bvmul s t) #b0111111111111111111111111111))
(define-fun l ((x (_ BitVec 28))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 28))) (bvsge (bvlshr (bvnot (_ bv0 28)) s) t)))
