...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvsub #b0000000000000000000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 28))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 28)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 28)) (distinct t max))) (or (distinct t (_ bv0 28)) (distinct s (_ bv1 28)))))
