...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvsub s (bvmul #b011111111111 #b011111111111)))
(define-fun l ((x (_ BitVec 12))) Bool  (bvugt (uremtotal (inv s t) s) t))
