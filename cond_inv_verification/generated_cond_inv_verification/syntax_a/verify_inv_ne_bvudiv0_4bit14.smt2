...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvadd (bvadd t #b01111111111111) #b10000000000000))
(define-fun l ((x (_ BitVec 14))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 14)) (distinct t (bvnot (_ bv0 14)))))
