...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvadd (bvmul s t) #b011111111111111111111111111111))
(define-fun l ((x (_ BitVec 30))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 30))) (bvsge (bvlshr (bvnot (_ bv0 30)) s) t)))
