...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvnot t))
(define-fun l ((x (_ BitVec 10))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 10))) (distinct t (bvnot (_ bv0 10)))))
