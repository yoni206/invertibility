...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvsub t (bvmul #b01111111111 #b01111111111)))
(define-fun l ((x (_ BitVec 11))) Bool  (bvslt (bvlshr (inv s t) s) t))
