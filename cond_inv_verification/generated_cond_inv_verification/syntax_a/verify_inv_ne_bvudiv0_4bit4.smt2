...
(define-fun inv ((s (_ BitVec 4)) (t (_ BitVec 4))) (_ BitVec 4) (bvadd (bvadd t #b0111) #b1000))
(define-fun l ((x (_ BitVec 4))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 4)) (distinct t (bvnot (_ bv0 4)))))
