...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 15))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 15)) (bvslt (udivtotal min s) t)))
