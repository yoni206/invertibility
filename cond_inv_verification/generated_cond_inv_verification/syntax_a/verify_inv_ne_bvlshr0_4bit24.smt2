...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvsub (bvadd t #b011111111111111111111111) #b100000000000000000000000))
(define-fun l ((x (_ BitVec 24))) Bool  (distinct (bvlshr (inv s t) s) t))
