...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvadd (bvadd t #b01111111111111111111111111111) #b10000000000000000000000000000))
(define-fun l ((x (_ BitVec 29))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 29)) (distinct t (bvnot (_ bv0 29)))))
