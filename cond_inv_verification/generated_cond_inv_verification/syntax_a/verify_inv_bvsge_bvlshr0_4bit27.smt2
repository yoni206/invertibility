...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvadd (bvmul s t) #b011111111111111111111111111))
(define-fun l ((x (_ BitVec 27))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 27))) (bvsge (bvlshr (bvnot (_ bv0 27)) s) t)))
