...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvsub t (bvmul #b01111111111111111111111 #b01111111111111111111111)))
(define-fun l ((x (_ BitVec 23))) Bool  (bvslt (bvlshr (inv s t) s) t))
