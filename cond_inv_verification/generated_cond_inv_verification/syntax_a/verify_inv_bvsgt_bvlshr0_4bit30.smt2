...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvadd (bvadd (bvmul s t) s) #b011111111111111111111111111111))
(define-fun l ((x (_ BitVec 30))) Bool  (bvsgt (bvlshr (inv s t) s) t))
