...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvsub t (bvmul #b0111111111111111111111 #b0111111111111111111111)))
(define-fun l ((x (_ BitVec 22))) Bool  (bvslt (bvlshr (inv s t) s) t))
