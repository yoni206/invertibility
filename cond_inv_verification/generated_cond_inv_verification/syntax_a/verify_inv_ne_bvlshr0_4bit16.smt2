...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvsub (bvadd t #b0111111111111111) #b1000000000000000))
(define-fun l ((x (_ BitVec 16))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 16)) (bvult s (_ bv16 16))))
