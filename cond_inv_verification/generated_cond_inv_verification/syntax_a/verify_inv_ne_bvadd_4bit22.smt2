...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvadd (bvadd #b0111111111111111111111 s) t))
(define-fun l ((x (_ BitVec 22))) Bool  (distinct (bvadd (inv s t) s) t))
