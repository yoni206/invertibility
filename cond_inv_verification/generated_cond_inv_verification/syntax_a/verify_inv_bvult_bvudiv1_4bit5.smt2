...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvadd #b10000 #b01111))
(define-fun l ((x (_ BitVec 5))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 5) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 5) t)))
