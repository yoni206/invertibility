...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvadd (bvadd t #b0111111111111111111111) #b1000000000000000000000))
(define-fun l ((x (_ BitVec 22))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 22)) (distinct t (bvnot (_ bv0 22)))))
