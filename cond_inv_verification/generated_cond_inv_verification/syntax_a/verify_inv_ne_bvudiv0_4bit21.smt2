...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvadd (bvadd t #b011111111111111111111) #b100000000000000000000))
(define-fun l ((x (_ BitVec 21))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 21)) (distinct t (bvnot (_ bv0 21)))))
