...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvadd #b100000000 #b011111111))
(define-fun l ((x (_ BitVec 9))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 9) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 9) t)))
