...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvadd #b0111111111111111111111111 #b1000000000000000000000000))
(define-fun l ((x (_ BitVec 25))) Bool  (bvugt (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvult t (bvshl (bvnot (_ bv0 25)) s)))
