...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvadd (bvmul s t) #b011111111111))
(define-fun l ((x (_ BitVec 12))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 12))) (bvsge (bvlshr (bvnot (_ bv0 12)) s) t)))
