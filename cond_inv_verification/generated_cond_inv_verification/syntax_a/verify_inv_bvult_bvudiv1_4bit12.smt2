...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvadd #b100000000000 #b011111111111))
(define-fun l ((x (_ BitVec 12))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 12) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 12) t)))
