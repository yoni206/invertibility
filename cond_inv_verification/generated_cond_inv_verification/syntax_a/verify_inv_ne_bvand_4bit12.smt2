...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvadd s t))
(define-fun l ((x (_ BitVec 12))) Bool  (distinct (bvand (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 12)) (distinct t (_ bv0 12))))
