...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvsub (bvmul s t) s))
(define-fun l ((x (_ BitVec 24))) Bool  (bvslt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (=> (bvsle t (_ bv0 24)) (bvslt (udivtotal min s) t)))
