...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvadd #b100000000000000000000000 #b011111111111111111111111))
(define-fun l ((x (_ BitVec 24))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 24) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 24) t)))
