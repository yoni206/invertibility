...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvsub (bvadd t #b01111111) #b10000000))
(define-fun l ((x (_ BitVec 8))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 8)) (bvult s (_ bv8 8))))
