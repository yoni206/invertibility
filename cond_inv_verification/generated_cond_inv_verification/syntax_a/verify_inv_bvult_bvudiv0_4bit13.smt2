...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) #b0000000000000)
(define-fun l ((x (_ BitVec 13))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 13) s) (bvult (_ bv0 13) t)))
