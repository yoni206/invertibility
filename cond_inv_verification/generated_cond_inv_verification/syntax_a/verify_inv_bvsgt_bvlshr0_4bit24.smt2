...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvadd (bvadd (bvmul s t) s) #b011111111111111111111111))
(define-fun l ((x (_ BitVec 24))) Bool  (bvsgt (bvlshr (inv s t) s) t))
