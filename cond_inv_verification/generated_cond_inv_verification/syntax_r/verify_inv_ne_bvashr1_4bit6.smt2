...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvneg (bvand (bvneg (bvnot t)) (bvneg t))))
(define-fun l ((x (_ BitVec 6))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 6))) (not (= s (_ bv0 6)))) (or (not (= t (bvnot (_ bv0 6)))) (not (= s (bvnot (_ bv0 6)))))))
