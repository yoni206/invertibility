...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvand (bvor (bvnot s) #b1000000000000000) (bvor s #b0111111111111111)))
(define-fun l ((x (_ BitVec 16))) Bool  (bvsgt (bvadd (inv s t) s) t))
