...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvneg (bvand (bvor (bvnot s) #b01111) (bvor s #b10000))))
(define-fun l ((x (_ BitVec 5))) Bool  (bvsle (bvadd (inv s t) s) t))
