...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvneg (bvor (bvand (bvnot s) #b10000) (bvand s #b01111))))
(define-fun l ((x (_ BitVec 5))) Bool  (bvslt (bvadd (inv s t) s) t))
