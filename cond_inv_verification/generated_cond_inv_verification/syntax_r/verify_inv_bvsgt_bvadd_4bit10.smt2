...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvand (bvor (bvnot s) #b1000000000) (bvor s #b0111111111)))
(define-fun l ((x (_ BitVec 10))) Bool  (bvsgt (bvadd (inv s t) s) t))
