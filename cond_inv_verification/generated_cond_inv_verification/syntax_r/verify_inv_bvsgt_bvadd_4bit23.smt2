...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvand (bvor (bvnot s) #b10000000000000000000000) (bvor s #b01111111111111111111111)))
(define-fun l ((x (_ BitVec 23))) Bool  (bvsgt (bvadd (inv s t) s) t))
