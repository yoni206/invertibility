...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvneg (bvand (bvor (bvnot s) #b01111111111) (bvor s #b10000000000))))
(define-fun l ((x (_ BitVec 11))) Bool  (bvsle (bvadd (inv s t) s) t))
