...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvand (bvor (bvnot s) #b10000000000000000000) (bvor s #b01111111111111111111)))
(define-fun l ((x (_ BitVec 20))) Bool  (bvsgt (bvadd (inv s t) s) t))
