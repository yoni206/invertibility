...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvneg (bvand (bvor (bvnot s) #b011111111111111111111111) (bvor s #b100000000000000000000000))))
(define-fun l ((x (_ BitVec 24))) Bool  (bvsle (bvadd (inv s t) s) t))
