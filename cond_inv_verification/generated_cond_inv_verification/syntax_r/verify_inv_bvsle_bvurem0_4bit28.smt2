...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvand #b1000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 28))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 28)) (bvand (bvneg s) t)))
