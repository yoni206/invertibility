...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvneg (bvand (bvor (bvnot s) #b01111111) (bvor s #b10000000))))
(define-fun l ((x (_ BitVec 8))) Bool  (bvsle (bvadd (inv s t) s) t))
