...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvor #b100000000000000000000000000000 #b011111111111111111111111111111))
(define-fun l ((x (_ BitVec 30))) Bool  (bvugt (bvor (inv s t) s) t))
