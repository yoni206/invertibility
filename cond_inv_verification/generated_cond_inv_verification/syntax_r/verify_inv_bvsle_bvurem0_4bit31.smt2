...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvand #b1000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 31))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 31)) (bvand (bvneg s) t)))
