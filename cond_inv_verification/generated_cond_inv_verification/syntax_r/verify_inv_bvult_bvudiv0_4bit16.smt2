...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) #b0000000000000000)
(define-fun l ((x (_ BitVec 16))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 16) s) (bvult (_ bv0 16) t)))
