...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvneg (bvand (bvor (bvnot s) #b0111111111111) (bvor s #b1000000000000))))
(define-fun l ((x (_ BitVec 13))) Bool  (bvsle (bvadd (inv s t) s) t))
