...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvnot t))
(define-fun l ((x (_ BitVec 28))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 28))) (distinct t (bvnot (_ bv0 28)))))
