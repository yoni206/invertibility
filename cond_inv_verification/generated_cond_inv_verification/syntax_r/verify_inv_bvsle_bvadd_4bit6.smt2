...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvneg (bvand (bvor (bvnot s) #b011111) (bvor s #b100000))))
(define-fun l ((x (_ BitVec 6))) Bool  (bvsle (bvadd (inv s t) s) t))
