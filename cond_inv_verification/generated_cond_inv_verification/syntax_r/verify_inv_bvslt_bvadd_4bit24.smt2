...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvneg (bvor (bvand (bvnot s) #b100000000000000000000000) (bvand s #b011111111111111111111111))))
(define-fun l ((x (_ BitVec 24))) Bool  (bvslt (bvadd (inv s t) s) t))
