...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvneg (bvand (bvor (bvnot s) #b0111111111) (bvor s #b1000000000))))
(define-fun l ((x (_ BitVec 10))) Bool  (bvsle (bvadd (inv s t) s) t))
