...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvneg (bvor (bvand (bvnot s) #b100000000000) (bvand s #b011111111111))))
(define-fun l ((x (_ BitVec 12))) Bool  (bvslt (bvadd (inv s t) s) t))
