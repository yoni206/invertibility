...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) #b0000000000000000000000)
(define-fun l ((x (_ BitVec 22))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 22) s) (bvult (_ bv0 22) t)))
