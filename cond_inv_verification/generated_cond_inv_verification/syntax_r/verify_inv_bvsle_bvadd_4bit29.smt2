...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvneg (bvand (bvor (bvnot s) #b01111111111111111111111111111) (bvor s #b10000000000000000000000000000))))
(define-fun l ((x (_ BitVec 29))) Bool  (bvsle (bvadd (inv s t) s) t))
