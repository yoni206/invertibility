...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvneg (bvor (bvand (bvnot s) #b10000000000) (bvand s #b01111111111))))
(define-fun l ((x (_ BitVec 11))) Bool  (bvslt (bvadd (inv s t) s) t))
