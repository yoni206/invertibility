...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvneg (bvand (bvor (bvnot s) #b01111111111111111111111111) (bvor s #b10000000000000000000000000))))
(define-fun l ((x (_ BitVec 26))) Bool  (bvsle (bvadd (inv s t) s) t))
