...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvneg (bvor (bvand (bvnot s) #b10000000000000000000000000) (bvand s #b01111111111111111111111111))))
(define-fun l ((x (_ BitVec 26))) Bool  (bvslt (bvadd (inv s t) s) t))
