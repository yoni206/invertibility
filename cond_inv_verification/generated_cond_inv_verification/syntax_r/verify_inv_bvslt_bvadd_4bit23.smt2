...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvneg (bvor (bvand (bvnot s) #b10000000000000000000000) (bvand s #b01111111111111111111111))))
(define-fun l ((x (_ BitVec 23))) Bool  (bvslt (bvadd (inv s t) s) t))
