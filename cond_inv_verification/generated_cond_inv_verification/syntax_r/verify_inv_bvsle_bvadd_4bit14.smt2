...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvneg (bvand (bvor (bvnot s) #b01111111111111) (bvor s #b10000000000000))))
(define-fun l ((x (_ BitVec 14))) Bool  (bvsle (bvadd (inv s t) s) t))
