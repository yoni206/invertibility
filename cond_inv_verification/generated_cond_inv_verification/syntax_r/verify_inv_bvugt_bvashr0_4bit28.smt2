...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvor #b0111111111111111111111111111 #b1000000000000000000000000000))
(define-fun l ((x (_ BitVec 28))) Bool  (bvugt (bvashr (inv s t) s) t))
(define-fun SC () Bool (bvult t (bvnot (_ bv0 28))))
