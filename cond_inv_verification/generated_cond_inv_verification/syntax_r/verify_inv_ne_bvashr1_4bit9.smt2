...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvneg (bvand (bvneg (bvnot t)) (bvneg t))))
(define-fun l ((x (_ BitVec 9))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 9))) (not (= s (_ bv0 9)))) (or (not (= t (bvnot (_ bv0 9)))) (not (= s (bvnot (_ bv0 9)))))))
