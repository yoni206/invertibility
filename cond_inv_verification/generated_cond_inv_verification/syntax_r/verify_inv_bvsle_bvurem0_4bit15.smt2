...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvand #b100000000000000 t))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 15)) (bvand (bvneg s) t)))
