...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvneg (bvand (bvor (bvnot s) #b0111111111111111111111111111) (bvor s #b1000000000000000000000000000))))
(define-fun l ((x (_ BitVec 28))) Bool  (bvsle (bvadd (inv s t) s) t))
