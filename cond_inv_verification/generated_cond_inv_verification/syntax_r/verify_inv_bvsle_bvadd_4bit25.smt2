...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvneg (bvand (bvor (bvnot s) #b0111111111111111111111111) (bvor s #b1000000000000000000000000))))
(define-fun l ((x (_ BitVec 25))) Bool  (bvsle (bvadd (inv s t) s) t))
