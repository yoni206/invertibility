...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvneg (bvor (bvand (bvnot s) #b100000000000000000000000000) (bvand s #b011111111111111111111111111))))
(define-fun l ((x (_ BitVec 27))) Bool  (bvslt (bvadd (inv s t) s) t))
