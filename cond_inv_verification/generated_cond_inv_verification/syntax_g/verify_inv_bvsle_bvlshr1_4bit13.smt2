...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvsub #b1000000000000 (bvand s #b1000000000000)))
(define-fun l ((x (_ BitVec 13))) Bool  (bvsle (bvlshr s (inv s t)) t))
