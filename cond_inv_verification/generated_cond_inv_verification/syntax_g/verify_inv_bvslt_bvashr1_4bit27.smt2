...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvsub (bvor s #b100000000000000000000000000) s))
(define-fun l ((x (_ BitVec 27))) Bool  (bvslt (bvashr s (inv s t)) t))
