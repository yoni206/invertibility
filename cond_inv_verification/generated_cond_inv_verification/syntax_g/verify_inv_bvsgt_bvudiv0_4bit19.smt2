...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvor (bvsub (bvlshr (bvneg s) s) #b0111111111111111111) #b0111111111111111111))
(define-fun l ((x (_ BitVec 19))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 19)) s) t) (bvsgt (udivtotal max s) t)))
