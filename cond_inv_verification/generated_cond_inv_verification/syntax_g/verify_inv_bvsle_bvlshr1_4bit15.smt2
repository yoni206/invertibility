...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvsub #b100000000000000 (bvand s #b100000000000000)))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsle (bvlshr s (inv s t)) t))
