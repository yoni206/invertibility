...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvor (bvsub (bvlshr (bvneg s) s) #b011111111111) #b011111111111))
(define-fun l ((x (_ BitVec 12))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 12)) s) t) (bvsgt (udivtotal max s) t)))
