...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvand (bvsub #b100000000000 s) #b100000000000))
(define-fun l ((x (_ BitVec 12))) Bool  (bvslt (uremtotal (inv s t) s) t))
