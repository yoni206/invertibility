...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvand #b1000000000000000 t))
(define-fun l ((x (_ BitVec 16))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 16)) (bvand (bvneg s) t)))
