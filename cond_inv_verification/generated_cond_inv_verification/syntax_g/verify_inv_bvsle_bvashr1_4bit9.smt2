...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvand (bvadd #b100000000 t) #b100000000))
(define-fun l ((x (_ BitVec 9))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 9)) (bvsge t s)))
