...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvor (bvsub (bvlshr (bvneg s) s) #b01111111111111111) #b01111111111111111))
(define-fun l ((x (_ BitVec 17))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 17)) s) t) (bvsgt (udivtotal max s) t)))
