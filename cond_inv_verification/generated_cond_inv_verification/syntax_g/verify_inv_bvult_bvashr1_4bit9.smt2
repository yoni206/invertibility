...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvadd (bvand #b100000000 s) #b100000000))
(define-fun l ((x (_ BitVec 9))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 9)))) (not (= t (_ bv0 9)))))
