...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvor (bvsub (bvlshr (bvneg s) s) #b011111111111111111111111111) #b011111111111111111111111111))
(define-fun l ((x (_ BitVec 27))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 27)) s) t) (bvsgt (udivtotal max s) t)))
