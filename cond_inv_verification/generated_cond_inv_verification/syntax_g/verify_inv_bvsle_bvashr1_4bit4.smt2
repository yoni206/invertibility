...
(define-fun inv ((s (_ BitVec 4)) (t (_ BitVec 4))) (_ BitVec 4) (bvand (bvadd #b1000 t) #b1000))
(define-fun l ((x (_ BitVec 4))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 4)) (bvsge t s)))
