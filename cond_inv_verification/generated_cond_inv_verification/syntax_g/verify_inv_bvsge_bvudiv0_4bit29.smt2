...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvor (bvlshr #b10000000000000000000000000000 (bvand (bvlshr #b01111111111111111111111111111 s) s)) #b01111111111111111111111111111))
(define-fun l ((x (_ BitVec 29))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 29)) s) t) (bvsge (udivtotal max s) t)))
