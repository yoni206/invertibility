...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvsub (bvadd s t) #b01111111111111111111111111))
(define-fun l ((x (_ BitVec 26))) Bool  (distinct (bvadd (inv s t) s) t))
