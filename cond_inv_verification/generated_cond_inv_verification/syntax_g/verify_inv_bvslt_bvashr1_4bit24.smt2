...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvsub (bvor s #b100000000000000000000000) s))
(define-fun l ((x (_ BitVec 24))) Bool  (bvslt (bvashr s (inv s t)) t))
