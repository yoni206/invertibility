...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvsub #b1000000000000000 (bvand s #b1000000000000000)))
(define-fun l ((x (_ BitVec 16))) Bool  (bvsle (bvlshr s (inv s t)) t))
