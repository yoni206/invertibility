...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvor (bvsub (bvlshr (bvneg s) s) #b01111111111111111111111111) #b01111111111111111111111111))
(define-fun l ((x (_ BitVec 26))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 26)) s) t) (bvsgt (udivtotal max s) t)))
