...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvand (bvsub #b10000000000000000000000000000 s) #b10000000000000000000000000000))
(define-fun l ((x (_ BitVec 29))) Bool  (bvslt (uremtotal (inv s t) s) t))
