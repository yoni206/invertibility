...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvsub #b00000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 11))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 11)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 11)) (distinct t max))) (or (distinct t (_ bv0 11)) (distinct s (_ bv1 11)))))
