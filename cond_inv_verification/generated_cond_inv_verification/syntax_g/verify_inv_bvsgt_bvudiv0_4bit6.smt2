...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvor (bvsub (bvlshr (bvneg s) s) #b011111) #b011111))
(define-fun l ((x (_ BitVec 6))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 6)) s) t) (bvsgt (udivtotal max s) t)))
