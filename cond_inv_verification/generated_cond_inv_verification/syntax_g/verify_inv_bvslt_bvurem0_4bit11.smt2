...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvand (bvsub #b10000000000 s) #b10000000000))
(define-fun l ((x (_ BitVec 11))) Bool  (bvslt (uremtotal (inv s t) s) t))
