...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvor (bvlshr #b100000000000000000 (bvand (bvlshr #b011111111111111111 s) s)) #b011111111111111111))
(define-fun l ((x (_ BitVec 18))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 18)) s) t) (bvsge (udivtotal max s) t)))
