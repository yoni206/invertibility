...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvadd (bvand #b1000000 s) #b1000000))
(define-fun l ((x (_ BitVec 7))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 7)))) (not (= t (_ bv0 7)))))
