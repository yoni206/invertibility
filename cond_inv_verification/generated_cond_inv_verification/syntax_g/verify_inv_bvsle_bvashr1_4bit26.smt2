...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvand (bvadd #b10000000000000000000000000 t) #b10000000000000000000000000))
(define-fun l ((x (_ BitVec 26))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 26)) (bvsge t s)))
