...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvand (bvsub t s) #b1000000000000000000000000000))
(define-fun l ((x (_ BitVec 28))) Bool  (bvule (bvashr s (inv s t)) t))
