...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvand (bvsub #b1000000000000 s) #b1000000000000))
(define-fun l ((x (_ BitVec 13))) Bool  (bvslt (uremtotal (inv s t) s) t))
