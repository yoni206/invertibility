...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvand (bvsub #b100000000000000 s) #b100000000000000))
(define-fun l ((x (_ BitVec 15))) Bool  (bvslt (uremtotal (inv s t) s) t))
