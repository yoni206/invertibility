...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvsub #b10000000000000000000000 (bvand s #b10000000000000000000000)))
(define-fun l ((x (_ BitVec 23))) Bool  (bvsle (bvlshr s (inv s t)) t))
