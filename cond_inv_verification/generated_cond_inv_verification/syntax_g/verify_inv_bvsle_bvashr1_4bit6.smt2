...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvand (bvadd #b100000 t) #b100000))
(define-fun l ((x (_ BitVec 6))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 6)) (bvsge t s)))
