...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvnot #b00000000000000))
(define-fun l ((x (_ BitVec 14))) Bool  (bvugt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (bvugt (udivtotal (bvnot (_ bv0 14)) s) t))
