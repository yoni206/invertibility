...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvand (bvadd #b100000000000000000000000000000 t) #b100000000000000000000000000000))
(define-fun l ((x (_ BitVec 30))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 30)) (bvsge t s)))
