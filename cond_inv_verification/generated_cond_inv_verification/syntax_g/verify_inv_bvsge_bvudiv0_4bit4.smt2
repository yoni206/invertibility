...
(define-fun inv ((s (_ BitVec 4)) (t (_ BitVec 4))) (_ BitVec 4) (bvor (bvlshr #b1000 (bvand (bvlshr #b0111 s) s)) #b0111))
(define-fun l ((x (_ BitVec 4))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 4)) s) t) (bvsge (udivtotal max s) t)))
