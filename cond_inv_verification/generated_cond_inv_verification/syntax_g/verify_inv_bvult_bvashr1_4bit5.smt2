...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvadd (bvand #b10000 s) #b10000))
(define-fun l ((x (_ BitVec 5))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 5)))) (not (= t (_ bv0 5)))))
