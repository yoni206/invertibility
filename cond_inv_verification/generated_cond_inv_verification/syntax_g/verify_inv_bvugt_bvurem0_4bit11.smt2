...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvadd (bvadd #b01111111111 s) #b10000000000))
(define-fun l ((x (_ BitVec 11))) Bool  (bvugt (uremtotal (inv s t) s) t))
