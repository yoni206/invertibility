...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvand (bvadd #b1000000000000000000 t) #b1000000000000000000))
(define-fun l ((x (_ BitVec 19))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 19)) (bvsge t s)))
