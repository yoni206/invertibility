...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvand (bvsub #b10000000000000000 s) #b10000000000000000))
(define-fun l ((x (_ BitVec 17))) Bool  (bvslt (uremtotal (inv s t) s) t))
