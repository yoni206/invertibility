...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvsub (bvor s #b1000000000000000000000000) (bvand #b0111111111111111111111111 t)))
(define-fun l ((x (_ BitVec 25))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 25)) (bvsge s t)) (=> (and (bvslt s (_ bv0 25)) (bvsge t (_ bv0 25))) (bvugt (bvsub s t) t))))
