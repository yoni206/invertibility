...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvand (bvadd t #b0111111111111111111111111) #b1000000000000000000000000))
(define-fun l ((x (_ BitVec 25))) Bool  (bvslt (bvlshr s (inv s t)) t))
(define-fun SC () Bool (or (bvslt s t) (bvslt (_ bv0 25) t)))
