...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvsub #b100000000000 (bvand s #b100000000000)))
(define-fun l ((x (_ BitVec 12))) Bool  (bvsle (bvlshr s (inv s t)) t))
