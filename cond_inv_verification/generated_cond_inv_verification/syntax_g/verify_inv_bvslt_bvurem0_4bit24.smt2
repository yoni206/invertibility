...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvand (bvsub #b100000000000000000000000 s) #b100000000000000000000000))
(define-fun l ((x (_ BitVec 24))) Bool  (bvslt (uremtotal (inv s t) s) t))
