...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvadd (bvand #b1000000000000000000000 s) #b1000000000000000000000))
(define-fun l ((x (_ BitVec 22))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 22)))) (not (= t (_ bv0 22)))))
