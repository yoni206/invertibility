...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvlshr (bvsub #b1000000000 #b0111111111) t))
(define-fun l ((x (_ BitVec 10))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 10)) (distinct t (_ bv0 10))))
