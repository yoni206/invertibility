...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvor (bvlshr #b1000000000000000000000 (bvand (bvlshr #b0111111111111111111111 s) s)) #b0111111111111111111111))
(define-fun l ((x (_ BitVec 22))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 22)) s) t) (bvsge (udivtotal max s) t)))
