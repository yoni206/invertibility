...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvand (bvsub t s) #b10000000000000000000000))
(define-fun l ((x (_ BitVec 23))) Bool  (bvule (bvashr s (inv s t)) t))
