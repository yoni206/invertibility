...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvadd (bvadd #b0111111111111111111 s) #b1000000000000000000))
(define-fun l ((x (_ BitVec 19))) Bool  (bvugt (uremtotal (inv s t) s) t))
