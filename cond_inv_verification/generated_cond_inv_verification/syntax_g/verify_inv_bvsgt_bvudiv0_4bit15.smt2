...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvor (bvsub (bvlshr (bvneg s) s) #b011111111111111) #b011111111111111))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 15)) s) t) (bvsgt (udivtotal max s) t)))
