...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvlshr s (bvlshr #b011111111111111111111111 (bvsub #b100000000000000000000000 #b011111111111111111111111))))
(define-fun l ((x (_ BitVec 24))) Bool  (bvsgt (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 24)) (bvsgt (bvlshr s (_ bv1 24)) t)) (=> (bvsge s (_ bv0 24)) (bvsgt s t))))
