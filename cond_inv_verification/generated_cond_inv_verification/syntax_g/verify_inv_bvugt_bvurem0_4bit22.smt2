...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvadd (bvadd #b0111111111111111111111 s) #b1000000000000000000000))
(define-fun l ((x (_ BitVec 22))) Bool  (bvugt (uremtotal (inv s t) s) t))
