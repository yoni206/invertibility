...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvlshr (bvsub #b100000000000000000000 #b011111111111111111111) t))
(define-fun l ((x (_ BitVec 21))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 21)) (distinct t (_ bv0 21))))
