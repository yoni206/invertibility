...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvadd (bvadd #b011111111111111 s) #b100000000000000))
(define-fun l ((x (_ BitVec 15))) Bool  (bvugt (uremtotal (inv s t) s) t))
