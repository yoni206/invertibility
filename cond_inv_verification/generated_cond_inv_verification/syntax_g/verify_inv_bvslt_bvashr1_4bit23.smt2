...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvsub (bvor s #b10000000000000000000000) s))
(define-fun l ((x (_ BitVec 23))) Bool  (bvslt (bvashr s (inv s t)) t))
