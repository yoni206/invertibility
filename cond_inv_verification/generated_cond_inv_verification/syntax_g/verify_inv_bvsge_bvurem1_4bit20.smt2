...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvsub (bvor s #b10000000000000000000) (bvand #b01111111111111111111 t)))
(define-fun l ((x (_ BitVec 20))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 20)) (bvsge s t)) (=> (and (bvslt s (_ bv0 20)) (bvsge t (_ bv0 20))) (bvugt (bvsub s t) t))))
