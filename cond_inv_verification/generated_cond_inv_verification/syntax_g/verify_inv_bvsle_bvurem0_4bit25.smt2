...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvand #b1000000000000000000000000 t))
(define-fun l ((x (_ BitVec 25))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 25)) (bvand (bvneg s) t)))
