...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvsub #b100000000000000000000000000 (bvand s #b100000000000000000000000000)))
(define-fun l ((x (_ BitVec 27))) Bool  (bvsle (bvlshr s (inv s t)) t))
