...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvand (bvsub #b100000000000000000000000000 s) #b100000000000000000000000000))
(define-fun l ((x (_ BitVec 27))) Bool  (bvslt (uremtotal (inv s t) s) t))
