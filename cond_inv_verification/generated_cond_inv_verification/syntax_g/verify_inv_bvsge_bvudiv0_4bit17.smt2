...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvor (bvlshr #b10000000000000000 (bvand (bvlshr #b01111111111111111 s) s)) #b01111111111111111))
(define-fun l ((x (_ BitVec 17))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 17)) s) t) (bvsge (udivtotal max s) t)))
