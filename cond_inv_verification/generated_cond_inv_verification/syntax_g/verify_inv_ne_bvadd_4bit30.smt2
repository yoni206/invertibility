...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvsub (bvadd s t) #b011111111111111111111111111111))
(define-fun l ((x (_ BitVec 30))) Bool  (distinct (bvadd (inv s t) s) t))
