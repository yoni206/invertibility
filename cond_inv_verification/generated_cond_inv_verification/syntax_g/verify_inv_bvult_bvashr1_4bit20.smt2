...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvadd (bvand #b10000000000000000000 s) #b10000000000000000000))
(define-fun l ((x (_ BitVec 20))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 20)))) (not (= t (_ bv0 20)))))
