...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvor (bvsub (bvlshr (bvneg s) s) #b0111111111111111111111111111111) #b0111111111111111111111111111111))
(define-fun l ((x (_ BitVec 31))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 31)) s) t) (bvsgt (udivtotal max s) t)))
