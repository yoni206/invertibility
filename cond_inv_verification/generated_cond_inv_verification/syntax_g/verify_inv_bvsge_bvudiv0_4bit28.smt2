...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvor (bvlshr #b1000000000000000000000000000 (bvand (bvlshr #b0111111111111111111111111111 s) s)) #b0111111111111111111111111111))
(define-fun l ((x (_ BitVec 28))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 28)) s) t) (bvsge (udivtotal max s) t)))
