...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvsub #b100000000000000000 (bvand s #b100000000000000000)))
(define-fun l ((x (_ BitVec 18))) Bool  (bvsle (bvlshr s (inv s t)) t))
