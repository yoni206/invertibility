...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvand (bvadd #b10000000000000000 t) #b10000000000000000))
(define-fun l ((x (_ BitVec 17))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 17)) (bvsge t s)))
