...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvshl #b01111111111111111111111 t))
(define-fun l ((x (_ BitVec 23))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 23)) (distinct s (_ bv0 23))))
