...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvand (bvsub #b100000000000000000000 s) #b100000000000000000000))
(define-fun l ((x (_ BitVec 21))) Bool  (bvslt (uremtotal (inv s t) s) t))
