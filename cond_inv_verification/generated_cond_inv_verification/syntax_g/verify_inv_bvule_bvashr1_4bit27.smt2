...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvand (bvsub t s) #b100000000000000000000000000))
(define-fun l ((x (_ BitVec 27))) Bool  (bvule (bvashr s (inv s t)) t))
