...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvsub #b0000000000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 19))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 19)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 19)) (distinct t max))) (or (distinct t (_ bv0 19)) (distinct s (_ bv1 19)))))
