...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvlshr (bvsub #b1000000000000000000000000000000 #b0111111111111111111111111111111) t))
(define-fun l ((x (_ BitVec 31))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 31)) (distinct t (_ bv0 31))))
