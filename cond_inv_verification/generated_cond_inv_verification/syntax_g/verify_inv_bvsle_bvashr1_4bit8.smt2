...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvand (bvadd #b10000000 t) #b10000000))
(define-fun l ((x (_ BitVec 8))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 8)) (bvsge t s)))
