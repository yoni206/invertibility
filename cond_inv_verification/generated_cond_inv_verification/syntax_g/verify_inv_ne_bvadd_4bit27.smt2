...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvsub (bvadd s t) #b011111111111111111111111111))
(define-fun l ((x (_ BitVec 27))) Bool  (distinct (bvadd (inv s t) s) t))
