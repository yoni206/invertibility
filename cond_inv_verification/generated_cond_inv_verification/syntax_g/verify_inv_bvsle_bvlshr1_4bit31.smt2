...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvsub #b1000000000000000000000000000000 (bvand s #b1000000000000000000000000000000)))
(define-fun l ((x (_ BitVec 31))) Bool  (bvsle (bvlshr s (inv s t)) t))
