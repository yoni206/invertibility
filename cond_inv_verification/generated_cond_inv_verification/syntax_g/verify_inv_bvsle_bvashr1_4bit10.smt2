...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvand (bvadd #b1000000000 t) #b1000000000))
(define-fun l ((x (_ BitVec 10))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 10)) (bvsge t s)))
