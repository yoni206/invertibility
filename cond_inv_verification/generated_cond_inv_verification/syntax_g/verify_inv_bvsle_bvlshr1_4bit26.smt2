...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvsub #b10000000000000000000000000 (bvand s #b10000000000000000000000000)))
(define-fun l ((x (_ BitVec 26))) Bool  (bvsle (bvlshr s (inv s t)) t))
