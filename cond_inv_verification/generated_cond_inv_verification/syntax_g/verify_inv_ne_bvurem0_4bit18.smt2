...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvlshr (bvsub #b100000000000000000 #b011111111111111111) t))
(define-fun l ((x (_ BitVec 18))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 18)) (distinct t (_ bv0 18))))
