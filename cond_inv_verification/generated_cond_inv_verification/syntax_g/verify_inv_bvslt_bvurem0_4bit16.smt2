...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvand (bvsub #b1000000000000000 s) #b1000000000000000))
(define-fun l ((x (_ BitVec 16))) Bool  (bvslt (uremtotal (inv s t) s) t))
