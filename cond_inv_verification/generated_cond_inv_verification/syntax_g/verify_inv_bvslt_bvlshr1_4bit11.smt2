...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvand (bvadd t #b01111111111) #b10000000000))
(define-fun l ((x (_ BitVec 11))) Bool  (bvslt (bvlshr s (inv s t)) t))
