...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvand (bvadd t #b0111111111111111111111111111111) #b1000000000000000000000000000000))
(define-fun l ((x (_ BitVec 31))) Bool  (bvslt (bvlshr s (inv s t)) t))
