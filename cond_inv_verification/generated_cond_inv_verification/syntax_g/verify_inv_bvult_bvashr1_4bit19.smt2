...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvadd (bvand #b1000000000000000000 s) #b1000000000000000000))
(define-fun l ((x (_ BitVec 19))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 19)))) (not (= t (_ bv0 19)))))
