...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvor (bvlshr #b1000000000 (bvand (bvlshr #b0111111111 s) s)) #b0111111111))
(define-fun l ((x (_ BitVec 10))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 10)) s) t) (bvsge (udivtotal max s) t)))
