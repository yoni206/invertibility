...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvand (bvadd #b100000000000000 t) #b100000000000000))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 15)) (bvsge t s)))
