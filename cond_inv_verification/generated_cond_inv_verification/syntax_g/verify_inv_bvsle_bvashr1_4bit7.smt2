...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvand (bvadd #b1000000 t) #b1000000))
(define-fun l ((x (_ BitVec 7))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 7)) (bvsge t s)))
