...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvor (bvsub (bvlshr (bvneg s) s) #b0111111) #b0111111))
(define-fun l ((x (_ BitVec 7))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 7)) s) t) (bvsgt (udivtotal max s) t)))
