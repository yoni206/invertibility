...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvand (bvadd #b100000000000000000000 t) #b100000000000000000000))
(define-fun l ((x (_ BitVec 21))) Bool  (bvsle (bvashr s (inv s t)) t))
(define-fun SC () Bool (or (bvsge t (_ bv0 21)) (bvsge t s)))
