...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvadd (bvadd #b01111111111111111111111111111 s) #b10000000000000000000000000000))
(define-fun l ((x (_ BitVec 29))) Bool  (bvugt (uremtotal (inv s t) s) t))
