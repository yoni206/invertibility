...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvor (bvsub (bvlshr (bvneg s) s) #b01111) #b01111))
(define-fun l ((x (_ BitVec 5))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 5)) s) t) (bvsgt (udivtotal max s) t)))
