...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvand (bvsub #b1000000000000000000 s) #b1000000000000000000))
(define-fun l ((x (_ BitVec 19))) Bool  (bvslt (uremtotal (inv s t) s) t))
