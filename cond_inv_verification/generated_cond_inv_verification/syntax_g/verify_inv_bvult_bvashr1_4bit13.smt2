...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvadd (bvand #b1000000000000 s) #b1000000000000))
(define-fun l ((x (_ BitVec 13))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 13)))) (not (= t (_ bv0 13)))))
