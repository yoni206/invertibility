...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvadd (bvadd #b011111111111111111 s) #b100000000000000000))
(define-fun l ((x (_ BitVec 18))) Bool  (bvugt (uremtotal (inv s t) s) t))
