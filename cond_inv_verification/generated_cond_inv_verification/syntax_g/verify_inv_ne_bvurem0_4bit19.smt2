...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvlshr (bvsub #b1000000000000000000 #b0111111111111111111) t))
(define-fun l ((x (_ BitVec 19))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 19)) (distinct t (_ bv0 19))))
