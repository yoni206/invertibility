...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvlshr s (bvlshr #b011111111111111 (bvsub #b100000000000000 #b011111111111111))))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsgt (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 15)) (bvsgt (bvlshr s (_ bv1 15)) t)) (=> (bvsge s (_ bv0 15)) (bvsgt s t))))
