...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvand (bvsub t s) #b1000000000000000000000000))
(define-fun l ((x (_ BitVec 25))) Bool  (bvule (bvashr s (inv s t)) t))
