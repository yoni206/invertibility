...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvlshr (bvsub #b100000000000000000000000 #b011111111111111111111111) t))
(define-fun l ((x (_ BitVec 24))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 24)) (distinct t (_ bv0 24))))
