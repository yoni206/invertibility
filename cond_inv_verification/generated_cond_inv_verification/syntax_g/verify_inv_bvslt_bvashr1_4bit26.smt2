...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvsub (bvor s #b10000000000000000000000000) s))
(define-fun l ((x (_ BitVec 26))) Bool  (bvslt (bvashr s (inv s t)) t))
