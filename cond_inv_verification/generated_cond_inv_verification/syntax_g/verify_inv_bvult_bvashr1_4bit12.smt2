...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvadd (bvand #b100000000000 s) #b100000000000))
(define-fun l ((x (_ BitVec 12))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 12)))) (not (= t (_ bv0 12)))))
