...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvadd (bvand #b1000000000000000 s) #b1000000000000000))
(define-fun l ((x (_ BitVec 16))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 16)))) (not (= t (_ bv0 16)))))
