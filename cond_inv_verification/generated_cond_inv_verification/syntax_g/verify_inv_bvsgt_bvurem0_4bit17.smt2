...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvsub #b00000000000000000 (bvnot t)))
(define-fun l ((x (_ BitVec 17))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 17)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 17)) (distinct t max))) (or (distinct t (_ bv0 17)) (distinct s (_ bv1 17)))))
