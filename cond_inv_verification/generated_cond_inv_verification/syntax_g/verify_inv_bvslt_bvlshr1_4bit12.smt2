...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvand (bvadd t #b011111111111) #b100000000000))
(define-fun l ((x (_ BitVec 12))) Bool  (bvslt (bvlshr s (inv s t)) t))
