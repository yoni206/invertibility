...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvsub #b10000000000000 (bvand s #b10000000000000)))
(define-fun l ((x (_ BitVec 14))) Bool  (bvsle (bvlshr s (inv s t)) t))
