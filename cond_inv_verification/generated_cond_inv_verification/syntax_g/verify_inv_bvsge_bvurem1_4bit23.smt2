...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvsub (bvor s #b10000000000000000000000) (bvand #b01111111111111111111111 t)))
(define-fun l ((x (_ BitVec 23))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 23)) (bvsge s t)) (=> (and (bvslt s (_ bv0 23)) (bvsge t (_ bv0 23))) (bvugt (bvsub s t) t))))
