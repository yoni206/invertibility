...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) #b0000000)
(define-fun l ((x (_ BitVec 7))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 7) s) (bvult (_ bv0 7) t)))
