...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvor (bvlshr #b100000 (bvand (bvlshr #b011111 s) s)) #b011111))
(define-fun l ((x (_ BitVec 6))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 6)) s) t) (bvsge (udivtotal max s) t)))
