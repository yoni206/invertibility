...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvor (bvlshr #b100000000000000000000000 (bvand (bvlshr #b011111111111111111111111 s) s)) #b011111111111111111111111))
(define-fun l ((x (_ BitVec 24))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 24)) s) t) (bvsge (udivtotal max s) t)))
