...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvlshr (bvsub #b10000000 #b01111111) t))
(define-fun l ((x (_ BitVec 8))) Bool  (distinct (uremtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv1 8)) (distinct t (_ bv0 8))))
