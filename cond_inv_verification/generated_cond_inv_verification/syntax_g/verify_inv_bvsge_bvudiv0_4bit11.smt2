...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvor (bvlshr #b10000000000 (bvand (bvlshr #b01111111111 s) s)) #b01111111111))
(define-fun l ((x (_ BitVec 11))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 11)) s) t) (bvsge (udivtotal max s) t)))
