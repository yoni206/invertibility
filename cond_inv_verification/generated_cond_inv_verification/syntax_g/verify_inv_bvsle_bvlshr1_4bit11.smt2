...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvsub #b10000000000 (bvand s #b10000000000)))
(define-fun l ((x (_ BitVec 11))) Bool  (bvsle (bvlshr s (inv s t)) t))
