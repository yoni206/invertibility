...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvor (bvlshr #b10000 (bvand (bvlshr #b01111 s) s)) #b01111))
(define-fun l ((x (_ BitVec 5))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 5)) s) t) (bvsge (udivtotal max s) t)))
