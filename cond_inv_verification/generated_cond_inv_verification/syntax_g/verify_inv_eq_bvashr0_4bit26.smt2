...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvor (bvand t #b10000000000000000000000000) (bvshl t s)))
(define-fun l ((x (_ BitVec 26))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv26 26)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv26 26)) (or (= t (bvnot (_ bv0 26))) (= t (_ bv0 26))))))
