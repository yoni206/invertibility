...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvor (bvsub (bvlshr (bvneg s) s) #b0111111111111) #b0111111111111))
(define-fun l ((x (_ BitVec 13))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 13)) s) t) (bvsgt (udivtotal max s) t)))
