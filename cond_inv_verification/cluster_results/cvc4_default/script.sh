...
# set stdout log file
log="/barrett/scratch/yoniz/git/invertibility/cond_inv_verification/cluster_results/cvc4_default/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/invertibility/cond_inv_verification/cluster_results/cvc4_default/${out}.err"
