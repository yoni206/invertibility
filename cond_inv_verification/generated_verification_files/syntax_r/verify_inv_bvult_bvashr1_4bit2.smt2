...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvnot (bvor s #b01)))
(define-fun l ((x (_ BitVec 2))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 2)))) (not (= t (_ bv0 2)))))
