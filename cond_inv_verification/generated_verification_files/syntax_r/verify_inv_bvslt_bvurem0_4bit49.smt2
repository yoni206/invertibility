...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvnot (bvor #b0111111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 49))) Bool  (bvslt (uremtotal (inv s t) s) t))
