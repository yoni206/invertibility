...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) (bvnot (bvor #b011111111111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 54))) Bool  (bvslt (uremtotal (inv s t) s) t))
