...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvnot (bvor s #b0111111111111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 55))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 55)))) (not (= t (_ bv0 55)))))
