...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvor s (bvor #b01111111111111111111111111111111111111 (bvneg (bvnot (bvneg s))))))
(define-fun l ((x (_ BitVec 38))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 38)) s) t) (bvsgt (udivtotal max s) t)))
