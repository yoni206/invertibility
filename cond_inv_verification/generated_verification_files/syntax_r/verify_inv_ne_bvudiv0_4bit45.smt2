...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 45))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 45)) (distinct t (bvnot (_ bv0 45)))))
