...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) #b000000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 48))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 48) s) (bvult (_ bv0 48) t)))
