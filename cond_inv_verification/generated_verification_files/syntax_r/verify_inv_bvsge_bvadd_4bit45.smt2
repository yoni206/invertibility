...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 45))) Bool  (bvsge (bvadd (inv s t) s) t))
