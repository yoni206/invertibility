...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvneg (bvand (bvor s #b10000000000000000000000000000000000000000000000000000) (bvnot (bvand s #b10000000000000000000000000000000000000000000000000000)))))
(define-fun l ((x (_ BitVec 53))) Bool  (bvslt (bvadd (inv s t) s) t))
