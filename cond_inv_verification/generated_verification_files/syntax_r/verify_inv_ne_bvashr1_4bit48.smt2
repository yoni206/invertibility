...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 48))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 48))) (not (= s (_ bv0 48)))) (or (not (= t (bvnot (_ bv0 48)))) (not (= s (bvnot (_ bv0 48)))))))
