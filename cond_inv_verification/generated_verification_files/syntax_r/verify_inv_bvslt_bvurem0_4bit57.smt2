...
(define-fun inv ((s (_ BitVec 57)) (t (_ BitVec 57))) (_ BitVec 57) (bvnot (bvor #b011111111111111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 57))) Bool  (bvslt (uremtotal (inv s t) s) t))
