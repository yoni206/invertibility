...
(define-fun inv ((s (_ BitVec 1)) (t (_ BitVec 1))) (_ BitVec 1) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 1))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 1)) (distinct t (bvnot (_ bv0 1)))))
