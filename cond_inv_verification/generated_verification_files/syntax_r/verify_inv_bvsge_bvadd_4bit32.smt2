...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 32))) Bool  (bvsge (bvadd (inv s t) s) t))
