...
(define-fun inv ((s (_ BitVec 57)) (t (_ BitVec 57))) (_ BitVec 57) (bvnot (bvor s #b011111111111111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 57))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 57)))) (not (= t (_ bv0 57)))))
