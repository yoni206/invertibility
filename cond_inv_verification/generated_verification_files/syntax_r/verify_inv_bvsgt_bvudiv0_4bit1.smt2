...
(define-fun inv ((s (_ BitVec 1)) (t (_ BitVec 1))) (_ BitVec 1) (bvor s (bvor #b0 (bvneg (bvnot (bvneg s))))))
(define-fun l ((x (_ BitVec 1))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 1)) s) t) (bvsgt (udivtotal max s) t)))
