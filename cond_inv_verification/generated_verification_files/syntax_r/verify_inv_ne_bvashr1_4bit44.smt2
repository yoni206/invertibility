...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 44))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 44))) (not (= s (_ bv0 44)))) (or (not (= t (bvnot (_ bv0 44)))) (not (= s (bvnot (_ bv0 44)))))))
