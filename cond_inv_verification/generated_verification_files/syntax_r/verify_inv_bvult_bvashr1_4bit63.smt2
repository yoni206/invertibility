...
(define-fun inv ((s (_ BitVec 63)) (t (_ BitVec 63))) (_ BitVec 63) (bvnot (bvor s #b011111111111111111111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 63))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 63)))) (not (= t (_ bv0 63)))))
