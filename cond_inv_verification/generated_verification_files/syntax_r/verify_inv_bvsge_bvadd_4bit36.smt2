...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 36))) Bool  (bvsge (bvadd (inv s t) s) t))
