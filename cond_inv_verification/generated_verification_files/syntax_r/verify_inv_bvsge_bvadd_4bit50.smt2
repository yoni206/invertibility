...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 50))) Bool  (bvsge (bvadd (inv s t) s) t))
