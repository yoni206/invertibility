...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 42))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 42))) (not (= s (_ bv0 42)))) (or (not (= t (bvnot (_ bv0 42)))) (not (= s (bvnot (_ bv0 42)))))))
