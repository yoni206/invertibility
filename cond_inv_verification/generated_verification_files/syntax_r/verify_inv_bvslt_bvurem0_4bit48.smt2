...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvnot (bvor #b011111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 48))) Bool  (bvslt (uremtotal (inv s t) s) t))
