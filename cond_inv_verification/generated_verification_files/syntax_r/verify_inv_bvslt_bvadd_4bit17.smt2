...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvneg (bvand (bvor s #b10000000000000000) (bvnot (bvand s #b10000000000000000)))))
(define-fun l ((x (_ BitVec 17))) Bool  (bvslt (bvadd (inv s t) s) t))
