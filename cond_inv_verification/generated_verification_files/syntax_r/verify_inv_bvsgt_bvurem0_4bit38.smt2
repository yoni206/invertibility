...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 38))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 38)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 38)) (distinct t max))) (or (distinct t (_ bv0 38)) (distinct s (_ bv1 38)))))
