...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvnot (bvor s #b01111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 38))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 38)))) (not (= t (_ bv0 38)))))
