...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvneg (bvand (bvor s #b100000000000000000000000000000000000000000000) (bvnot (bvand s #b100000000000000000000000000000000000000000000)))))
(define-fun l ((x (_ BitVec 45))) Bool  (bvslt (bvadd (inv s t) s) t))
