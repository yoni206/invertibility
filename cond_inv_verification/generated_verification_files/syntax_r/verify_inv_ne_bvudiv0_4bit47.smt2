...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 47))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 47)) (distinct t (bvnot (_ bv0 47)))))
