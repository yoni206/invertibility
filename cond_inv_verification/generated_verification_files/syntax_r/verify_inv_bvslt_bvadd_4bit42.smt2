...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvneg (bvand (bvor s #b100000000000000000000000000000000000000000) (bvnot (bvand s #b100000000000000000000000000000000000000000)))))
(define-fun l ((x (_ BitVec 42))) Bool  (bvslt (bvadd (inv s t) s) t))
