...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvand t #b1000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 46))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 46)) (bvand (bvneg s) t)))
