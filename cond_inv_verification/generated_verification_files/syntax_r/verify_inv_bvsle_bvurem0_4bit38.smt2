...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvand t #b10000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 38))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 38)) (bvand (bvneg s) t)))
