...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 12))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 12))) (not (= s (_ bv0 12)))) (or (not (= t (bvnot (_ bv0 12)))) (not (= s (bvnot (_ bv0 12)))))))
