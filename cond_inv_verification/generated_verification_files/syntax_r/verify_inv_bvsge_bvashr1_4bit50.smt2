...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvand s #b10000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 50))) Bool  (bvsge (bvashr s (inv s t)) t))
