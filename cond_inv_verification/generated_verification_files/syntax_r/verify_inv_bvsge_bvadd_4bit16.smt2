...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111))))
(define-fun l ((x (_ BitVec 16))) Bool  (bvsge (bvadd (inv s t) s) t))
