...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) #b000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 39))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 39) s) (bvult (_ bv0 39) t)))
