...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 56))) Bool  (bvsge (bvadd (inv s t) s) t))
