...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvnot (bvor #b01111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 44))) Bool  (bvslt (uremtotal (inv s t) s) t))
