...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) #b000000)
(define-fun l ((x (_ BitVec 6))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 6) s) (bvult (_ bv0 6) t)))
