...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 40))) Bool  (bvsge (bvadd (inv s t) s) t))
