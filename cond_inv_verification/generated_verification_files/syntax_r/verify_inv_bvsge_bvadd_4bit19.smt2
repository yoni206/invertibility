...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111))))
(define-fun l ((x (_ BitVec 19))) Bool  (bvsge (bvadd (inv s t) s) t))
