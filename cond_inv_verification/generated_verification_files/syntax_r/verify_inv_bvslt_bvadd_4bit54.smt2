...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) (bvneg (bvand (bvor s #b100000000000000000000000000000000000000000000000000000) (bvnot (bvand s #b100000000000000000000000000000000000000000000000000000)))))
(define-fun l ((x (_ BitVec 54))) Bool  (bvslt (bvadd (inv s t) s) t))
