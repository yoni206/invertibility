...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvnot t))
(define-fun l ((x (_ BitVec 24))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 24))) (distinct t (bvnot (_ bv0 24)))))
