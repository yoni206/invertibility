...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 51))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 51))) (not (= s (_ bv0 51)))) (or (not (= t (bvnot (_ bv0 51)))) (not (= s (bvnot (_ bv0 51)))))))
