...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 34))) Bool  (bvsge (bvadd (inv s t) s) t))
