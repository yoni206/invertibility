...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvand t #b10000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 35))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 35)) (bvand (bvneg s) t)))
