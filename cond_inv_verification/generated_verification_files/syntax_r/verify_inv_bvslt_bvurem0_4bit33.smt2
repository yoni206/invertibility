...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvnot (bvor #b011111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 33))) Bool  (bvslt (uremtotal (inv s t) s) t))
