...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 49))) Bool  (bvsge (bvadd (inv s t) s) t))
