...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 8))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 8))) (not (= s (_ bv0 8)))) (or (not (= t (bvnot (_ bv0 8)))) (not (= s (bvnot (_ bv0 8)))))))
