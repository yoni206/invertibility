...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvnot #b0000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 49))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 49) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 49) t)))
