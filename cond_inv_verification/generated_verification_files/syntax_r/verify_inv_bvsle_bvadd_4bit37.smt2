...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvneg (bvand (bvor s #b1000000000000000000000000000000000000) (bvnot (bvand s t)))))
(define-fun l ((x (_ BitVec 37))) Bool  (bvsle (bvadd (inv s t) s) t))
