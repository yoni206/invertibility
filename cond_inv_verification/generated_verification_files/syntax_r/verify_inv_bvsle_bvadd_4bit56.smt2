...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) (bvneg (bvand (bvor s #b10000000000000000000000000000000000000000000000000000000) (bvnot (bvand s t)))))
(define-fun l ((x (_ BitVec 56))) Bool  (bvsle (bvadd (inv s t) s) t))
