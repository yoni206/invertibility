...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvor s (bvor #b011111111111111111111111111111111111111111111111111 (bvneg (bvnot (bvneg s))))))
(define-fun l ((x (_ BitVec 51))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 51)) s) t) (bvsgt (udivtotal max s) t)))
