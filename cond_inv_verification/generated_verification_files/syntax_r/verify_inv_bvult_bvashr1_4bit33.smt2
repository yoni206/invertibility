...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvnot (bvor s #b011111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 33))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 33)))) (not (= t (_ bv0 33)))))
