...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvor (bvand s #b1000000000000000000000000000000000000000000000000000) (bvnot (bvor s #b1000000000000000000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 52))) Bool  (bvsgt (bvadd (inv s t) s) t))
