...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvnot (bvor #b01111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 47))) Bool  (bvslt (uremtotal (inv s t) s) t))
