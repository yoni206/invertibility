...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 34))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 34))) (not (= s (_ bv0 34)))) (or (not (= t (bvnot (_ bv0 34)))) (not (= s (bvnot (_ bv0 34)))))))
