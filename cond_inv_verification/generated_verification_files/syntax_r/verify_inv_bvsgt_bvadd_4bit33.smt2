...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvor (bvand s #b100000000000000000000000000000000) (bvnot (bvor s #b100000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 33))) Bool  (bvsgt (bvadd (inv s t) s) t))
