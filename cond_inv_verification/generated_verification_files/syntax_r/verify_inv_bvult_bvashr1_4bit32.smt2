...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvnot (bvor s #b01111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 32))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 32)))) (not (= t (_ bv0 32)))))
