...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 54))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 54))) (not (= s (_ bv0 54)))) (or (not (= t (bvnot (_ bv0 54)))) (not (= s (bvnot (_ bv0 54)))))))
