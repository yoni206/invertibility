...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 37))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 37))) (not (= s (_ bv0 37)))) (or (not (= t (bvnot (_ bv0 37)))) (not (= s (bvnot (_ bv0 37)))))))
