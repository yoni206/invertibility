...
(define-fun inv ((s (_ BitVec 63)) (t (_ BitVec 63))) (_ BitVec 63) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 63))) Bool  (bvsge (bvadd (inv s t) s) t))
