...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvneg (bvand (bvor s #b10000000000000) (bvnot (bvand s #b10000000000000)))))
(define-fun l ((x (_ BitVec 14))) Bool  (bvslt (bvadd (inv s t) s) t))
