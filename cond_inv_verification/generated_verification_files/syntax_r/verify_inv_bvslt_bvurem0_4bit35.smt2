...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvnot (bvor #b01111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 35))) Bool  (bvslt (uremtotal (inv s t) s) t))
