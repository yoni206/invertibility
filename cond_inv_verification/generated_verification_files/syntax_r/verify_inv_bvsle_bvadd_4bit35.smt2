...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvneg (bvand (bvor s #b10000000000000000000000000000000000) (bvnot (bvand s t)))))
(define-fun l ((x (_ BitVec 35))) Bool  (bvsle (bvadd (inv s t) s) t))
