...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvand s #b100000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 39))) Bool  (bvsge (bvashr s (inv s t)) t))
