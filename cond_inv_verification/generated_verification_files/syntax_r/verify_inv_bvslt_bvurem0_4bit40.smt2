...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvnot (bvor #b0111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 40))) Bool  (bvslt (uremtotal (inv s t) s) t))
