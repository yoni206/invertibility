...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvneg (bvand (bvor s #b100000000000000000000000000000000000000000) (bvnot (bvand s t)))))
(define-fun l ((x (_ BitVec 42))) Bool  (bvsle (bvadd (inv s t) s) t))
