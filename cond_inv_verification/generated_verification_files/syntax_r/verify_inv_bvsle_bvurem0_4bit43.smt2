...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvand t #b1000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 43))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 43)) (bvand (bvneg s) t)))
