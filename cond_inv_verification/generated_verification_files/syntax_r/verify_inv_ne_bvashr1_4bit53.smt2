...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 53))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 53))) (not (= s (_ bv0 53)))) (or (not (= t (bvnot (_ bv0 53)))) (not (= s (bvnot (_ bv0 53)))))))
