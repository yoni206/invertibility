...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvneg (bvand (bvor s #b10000000000000000000000000000000000000000) (bvnot (bvand s #b10000000000000000000000000000000000000000)))))
(define-fun l ((x (_ BitVec 41))) Bool  (bvslt (bvadd (inv s t) s) t))
