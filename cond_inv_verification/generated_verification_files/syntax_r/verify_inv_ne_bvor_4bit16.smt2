...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvnot t))
(define-fun l ((x (_ BitVec 16))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 16))) (distinct t (bvnot (_ bv0 16)))))
