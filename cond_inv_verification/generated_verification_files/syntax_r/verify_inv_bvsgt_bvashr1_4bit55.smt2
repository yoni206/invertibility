...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvand s #b1000000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 55))) Bool  (bvsgt (bvashr s (inv s t)) t))
