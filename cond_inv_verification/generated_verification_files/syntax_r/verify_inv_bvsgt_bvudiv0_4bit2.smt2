...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvor s (bvor #b01 (bvneg (bvnot (bvneg s))))))
(define-fun l ((x (_ BitVec 2))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 2)) s) t) (bvsgt (udivtotal max s) t)))
