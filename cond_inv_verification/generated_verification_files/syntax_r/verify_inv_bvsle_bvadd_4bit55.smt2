...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvneg (bvand (bvor s #b1000000000000000000000000000000000000000000000000000000) (bvnot (bvand s t)))))
(define-fun l ((x (_ BitVec 55))) Bool  (bvsle (bvadd (inv s t) s) t))
