...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvor (bvand s #b1000000000000000000) (bvnot (bvor s #b1000000000000000000))))
(define-fun l ((x (_ BitVec 19))) Bool  (bvsgt (bvadd (inv s t) s) t))
