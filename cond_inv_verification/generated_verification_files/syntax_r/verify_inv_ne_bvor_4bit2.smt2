...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvnot t))
(define-fun l ((x (_ BitVec 2))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 2))) (distinct t (bvnot (_ bv0 2)))))
