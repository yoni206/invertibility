...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvand (bvor s t) (bvnot (bvand s #b0111111111))))
(define-fun l ((x (_ BitVec 10))) Bool  (bvsge (bvadd (inv s t) s) t))
