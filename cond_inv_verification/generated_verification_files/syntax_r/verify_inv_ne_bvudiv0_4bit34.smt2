...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 34))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 34)) (distinct t (bvnot (_ bv0 34)))))
