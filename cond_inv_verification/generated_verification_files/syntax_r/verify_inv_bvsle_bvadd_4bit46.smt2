...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvneg (bvand (bvor s #b1000000000000000000000000000000000000000000000) (bvnot (bvand s t)))))
(define-fun l ((x (_ BitVec 46))) Bool  (bvsle (bvadd (inv s t) s) t))
