...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) #b0000000000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 52))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 52) s) (bvult (_ bv0 52) t)))
