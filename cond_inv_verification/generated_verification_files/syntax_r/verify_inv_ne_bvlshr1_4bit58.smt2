...
(define-fun inv ((s (_ BitVec 58)) (t (_ BitVec 58))) (_ BitVec 58) (bvneg t))
(define-fun l ((x (_ BitVec 58))) Bool  (distinct (bvlshr s (inv s t)) t))
(define-fun SC () Bool (or (distinct s (_ bv0 58)) (distinct t (_ bv0 58))))
