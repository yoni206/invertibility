...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvneg (bvand (bvor s #b100000000000000000000) (bvnot (bvand s #b100000000000000000000)))))
(define-fun l ((x (_ BitVec 21))) Bool  (bvslt (bvadd (inv s t) s) t))
