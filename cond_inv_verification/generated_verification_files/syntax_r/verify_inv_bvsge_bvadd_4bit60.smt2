...
(define-fun inv ((s (_ BitVec 60)) (t (_ BitVec 60))) (_ BitVec 60) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 60))) Bool  (bvsge (bvadd (inv s t) s) t))
