...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvnot (bvor #b01111111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 50))) Bool  (bvslt (uremtotal (inv s t) s) t))
