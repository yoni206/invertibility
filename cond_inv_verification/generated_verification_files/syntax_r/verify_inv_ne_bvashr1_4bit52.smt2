...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 52))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 52))) (not (= s (_ bv0 52)))) (or (not (= t (bvnot (_ bv0 52)))) (not (= s (bvnot (_ bv0 52)))))))
