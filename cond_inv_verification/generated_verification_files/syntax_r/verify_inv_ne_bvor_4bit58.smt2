...
(define-fun inv ((s (_ BitVec 58)) (t (_ BitVec 58))) (_ BitVec 58) (bvnot t))
(define-fun l ((x (_ BitVec 58))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 58))) (distinct t (bvnot (_ bv0 58)))))
