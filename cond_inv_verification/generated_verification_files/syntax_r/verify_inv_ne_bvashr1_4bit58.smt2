...
(define-fun inv ((s (_ BitVec 58)) (t (_ BitVec 58))) (_ BitVec 58) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 58))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 58))) (not (= s (_ bv0 58)))) (or (not (= t (bvnot (_ bv0 58)))) (not (= s (bvnot (_ bv0 58)))))))
