...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvor (bvand s #b10000000000000000000000000000000000000000000000) (bvnot (bvor s #b10000000000000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 47))) Bool  (bvsgt (bvadd (inv s t) s) t))
