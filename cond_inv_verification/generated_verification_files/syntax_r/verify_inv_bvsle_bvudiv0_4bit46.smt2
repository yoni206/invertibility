...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) t)
(define-fun l ((x (_ BitVec 46))) Bool  (bvsle (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (= (udivtotal (bvmul s t) s) t) (=> (bvsle t (_ bv0 46)) (bvslt (udivtotal min s) t))))
