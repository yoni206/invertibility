...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvand (bvor s t) (bvnot (bvand s #b0111111111111))))
(define-fun l ((x (_ BitVec 13))) Bool  (bvsge (bvadd (inv s t) s) t))
