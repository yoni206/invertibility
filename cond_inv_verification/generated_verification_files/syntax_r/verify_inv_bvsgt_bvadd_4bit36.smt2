...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvor (bvand s #b100000000000000000000000000000000000) (bvnot (bvor s #b100000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 36))) Bool  (bvsgt (bvadd (inv s t) s) t))
