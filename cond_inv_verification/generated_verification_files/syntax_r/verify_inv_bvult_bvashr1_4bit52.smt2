...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvnot (bvor s #b0111111111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 52))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 52)))) (not (= t (_ bv0 52)))))
