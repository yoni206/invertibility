...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvneg s))
(define-fun l ((x (_ BitVec 53))) Bool  (bvult (bvadd (inv s t) s) t))
(define-fun SC () Bool (distinct t (_ bv0 53)))
