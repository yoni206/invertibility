...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 41))) Bool  (bvsge (bvadd (inv s t) s) t))
