...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) #b00)
(define-fun l ((x (_ BitVec 2))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 2) s) (bvult (_ bv0 2) t)))
