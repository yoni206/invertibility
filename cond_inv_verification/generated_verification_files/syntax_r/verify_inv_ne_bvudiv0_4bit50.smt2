...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 50))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 50)) (distinct t (bvnot (_ bv0 50)))))
