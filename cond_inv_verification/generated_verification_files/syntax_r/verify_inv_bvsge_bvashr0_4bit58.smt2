...
(define-fun inv ((s (_ BitVec 58)) (t (_ BitVec 58))) (_ BitVec 58) #b0111111111111111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 58))) Bool  (bvsge (bvashr (inv s t) s) t))
