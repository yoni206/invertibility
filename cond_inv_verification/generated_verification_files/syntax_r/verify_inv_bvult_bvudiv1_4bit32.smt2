...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvnot #b00000000000000000000000000000000))
(define-fun l ((x (_ BitVec 32))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 32) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 32) t)))
