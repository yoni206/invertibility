...
(define-fun inv ((s (_ BitVec 57)) (t (_ BitVec 57))) (_ BitVec 57) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 57))) Bool  (bvsge (bvadd (inv s t) s) t))
