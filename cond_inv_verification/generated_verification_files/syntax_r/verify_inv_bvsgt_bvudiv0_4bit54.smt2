...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) (bvor s (bvor #b011111111111111111111111111111111111111111111111111111 (bvneg (bvnot (bvneg s))))))
(define-fun l ((x (_ BitVec 54))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 54)) s) t) (bvsgt (udivtotal max s) t)))
