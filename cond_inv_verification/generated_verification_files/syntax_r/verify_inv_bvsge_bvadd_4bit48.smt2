...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 48))) Bool  (bvsge (bvadd (inv s t) s) t))
