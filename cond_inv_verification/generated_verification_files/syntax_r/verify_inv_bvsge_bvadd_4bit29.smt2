...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111111111))))
(define-fun l ((x (_ BitVec 29))) Bool  (bvsge (bvadd (inv s t) s) t))
