...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvnot (bvor #b01111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 38))) Bool  (bvslt (uremtotal (inv s t) s) t))
