...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvor (bvand s #b10000000000000000000000000000000000000000000000000) (bvnot (bvor s #b10000000000000000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 50))) Bool  (bvsgt (bvadd (inv s t) s) t))
