...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 47))) Bool  (bvsge (bvadd (inv s t) s) t))
