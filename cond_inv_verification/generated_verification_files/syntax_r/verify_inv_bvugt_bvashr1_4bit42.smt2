...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvand s #b100000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 42))) Bool  (bvugt (bvashr s (inv s t)) t))
