...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvor s (bvor #b01111111111111111111111111111111111111111 (bvneg (bvnot (bvneg s))))))
(define-fun l ((x (_ BitVec 41))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 41)) s) t) (bvsgt (udivtotal max s) t)))
