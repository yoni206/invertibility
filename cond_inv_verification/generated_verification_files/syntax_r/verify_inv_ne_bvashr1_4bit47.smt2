...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 47))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 47))) (not (= s (_ bv0 47)))) (or (not (= t (bvnot (_ bv0 47)))) (not (= s (bvnot (_ bv0 47)))))))
