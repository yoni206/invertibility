...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 36))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 36))) (not (= s (_ bv0 36)))) (or (not (= t (bvnot (_ bv0 36)))) (not (= s (bvnot (_ bv0 36)))))))
