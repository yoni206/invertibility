...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvand s #b100000000000000000000000000000))
(define-fun l ((x (_ BitVec 30))) Bool  (bvugt (bvashr s (inv s t)) t))
