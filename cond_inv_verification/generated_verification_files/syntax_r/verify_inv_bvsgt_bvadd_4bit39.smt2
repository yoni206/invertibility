...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvor (bvand s #b100000000000000000000000000000000000000) (bvnot (bvor s #b100000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 39))) Bool  (bvsgt (bvadd (inv s t) s) t))
