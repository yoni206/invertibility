...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvneg (bvand (bvor s #b10000000000000000000000000000000000000000000) (bvnot (bvand s t)))))
(define-fun l ((x (_ BitVec 44))) Bool  (bvsle (bvadd (inv s t) s) t))
