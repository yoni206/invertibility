...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 49))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 49)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 49)) (distinct t max))) (or (distinct t (_ bv0 49)) (distinct s (_ bv1 49)))))
