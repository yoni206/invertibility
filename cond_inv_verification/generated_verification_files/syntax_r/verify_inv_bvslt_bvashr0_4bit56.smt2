...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) #b10000000000000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 56))) Bool  (bvslt (bvashr (inv s t) s) t))
