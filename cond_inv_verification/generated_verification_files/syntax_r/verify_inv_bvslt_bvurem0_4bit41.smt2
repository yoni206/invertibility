...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvnot (bvor #b01111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 41))) Bool  (bvslt (uremtotal (inv s t) s) t))
