...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111111))))
(define-fun l ((x (_ BitVec 26))) Bool  (bvsge (bvadd (inv s t) s) t))
