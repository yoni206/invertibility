...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvand t #b10000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 41))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 41)) (bvand (bvneg s) t)))
