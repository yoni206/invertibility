...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvnot t))
(define-fun l ((x (_ BitVec 30))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 30))) (distinct t (bvnot (_ bv0 30)))))
