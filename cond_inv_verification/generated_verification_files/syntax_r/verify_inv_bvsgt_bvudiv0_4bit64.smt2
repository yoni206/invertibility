...
(define-fun inv ((s (_ BitVec 64)) (t (_ BitVec 64))) (_ BitVec 64) (bvor s (bvor #b0111111111111111111111111111111111111111111111111111111111111111 (bvneg (bvnot (bvneg s))))))
