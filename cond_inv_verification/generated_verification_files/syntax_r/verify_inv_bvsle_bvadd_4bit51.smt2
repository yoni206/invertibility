...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvneg (bvand (bvor s #b100000000000000000000000000000000000000000000000000) (bvnot (bvand s t)))))
(define-fun l ((x (_ BitVec 51))) Bool  (bvsle (bvadd (inv s t) s) t))
