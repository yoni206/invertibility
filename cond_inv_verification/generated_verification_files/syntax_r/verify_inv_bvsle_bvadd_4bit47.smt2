...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvneg (bvand (bvor s #b10000000000000000000000000000000000000000000000) (bvnot (bvand s t)))))
(define-fun l ((x (_ BitVec 47))) Bool  (bvsle (bvadd (inv s t) s) t))
