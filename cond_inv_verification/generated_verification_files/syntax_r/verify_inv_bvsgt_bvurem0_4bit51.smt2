...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 51))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 51)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 51)) (distinct t max))) (or (distinct t (_ bv0 51)) (distinct s (_ bv1 51)))))
