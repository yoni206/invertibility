...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvor (bvand s #b1000000000000000000000000) (bvnot (bvor s #b1000000000000000000000000))))
(define-fun l ((x (_ BitVec 25))) Bool  (bvsgt (bvadd (inv s t) s) t))
