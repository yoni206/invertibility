...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvneg (bvand (bvor s #b10000000000000000000) (bvnot (bvand s #b10000000000000000000)))))
(define-fun l ((x (_ BitVec 20))) Bool  (bvslt (bvadd (inv s t) s) t))
