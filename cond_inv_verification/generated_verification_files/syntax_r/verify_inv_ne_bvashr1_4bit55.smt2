...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 55))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 55))) (not (= s (_ bv0 55)))) (or (not (= t (bvnot (_ bv0 55)))) (not (= s (bvnot (_ bv0 55)))))))
