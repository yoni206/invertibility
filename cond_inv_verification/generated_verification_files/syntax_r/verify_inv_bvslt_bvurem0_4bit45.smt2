...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvnot (bvor #b011111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 45))) Bool  (bvslt (uremtotal (inv s t) s) t))
