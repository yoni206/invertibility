...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvnot (bvor #b011111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 36))) Bool  (bvslt (uremtotal (inv s t) s) t))
