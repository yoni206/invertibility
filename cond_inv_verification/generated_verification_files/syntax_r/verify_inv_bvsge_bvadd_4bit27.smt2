...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111111))))
(define-fun l ((x (_ BitVec 27))) Bool  (bvsge (bvadd (inv s t) s) t))
