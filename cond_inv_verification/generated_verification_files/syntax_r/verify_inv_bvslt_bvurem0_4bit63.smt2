...
(define-fun inv ((s (_ BitVec 63)) (t (_ BitVec 63))) (_ BitVec 63) (bvnot (bvor #b011111111111111111111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 63))) Bool  (bvslt (uremtotal (inv s t) s) t))
