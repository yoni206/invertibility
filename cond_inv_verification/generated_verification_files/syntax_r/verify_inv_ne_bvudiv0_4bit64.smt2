...
(define-fun inv ((s (_ BitVec 64)) (t (_ BitVec 64))) (_ BitVec 64) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 64))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 64)) (distinct t (bvnot (_ bv0 64)))))
