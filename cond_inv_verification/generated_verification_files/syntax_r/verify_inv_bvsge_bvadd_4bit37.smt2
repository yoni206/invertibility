...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 37))) Bool  (bvsge (bvadd (inv s t) s) t))
