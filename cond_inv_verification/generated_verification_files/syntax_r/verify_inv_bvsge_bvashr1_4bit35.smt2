...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvand s #b10000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 35))) Bool  (bvsge (bvashr s (inv s t)) t))
