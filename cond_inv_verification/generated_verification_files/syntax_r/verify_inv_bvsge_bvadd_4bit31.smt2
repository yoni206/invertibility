...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 31))) Bool  (bvsge (bvadd (inv s t) s) t))
