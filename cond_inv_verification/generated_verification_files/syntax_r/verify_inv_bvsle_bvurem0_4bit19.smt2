...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvand t #b1000000000000000000))
(define-fun l ((x (_ BitVec 19))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 19)) (bvand (bvneg s) t)))
