...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvneg (bvand (bvor s #b100000000000000000000000000000000000000) (bvnot (bvand s #b100000000000000000000000000000000000000)))))
(define-fun l ((x (_ BitVec 39))) Bool  (bvslt (bvadd (inv s t) s) t))
