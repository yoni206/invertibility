...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvneg (bvand (bvor s #b100000000000000000000000000000000) (bvnot (bvand s #b100000000000000000000000000000000)))))
(define-fun l ((x (_ BitVec 33))) Bool  (bvslt (bvadd (inv s t) s) t))
