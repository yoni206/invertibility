...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvand t #b100000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 45))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 45)) (bvand (bvneg s) t)))
