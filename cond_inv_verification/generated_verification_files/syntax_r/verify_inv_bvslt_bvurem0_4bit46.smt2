...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvnot (bvor #b0111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 46))) Bool  (bvslt (uremtotal (inv s t) s) t))
