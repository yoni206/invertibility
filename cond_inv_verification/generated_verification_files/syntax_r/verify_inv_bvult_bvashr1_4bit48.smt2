...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvnot (bvor s #b011111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 48))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 48)))) (not (= t (_ bv0 48)))))
