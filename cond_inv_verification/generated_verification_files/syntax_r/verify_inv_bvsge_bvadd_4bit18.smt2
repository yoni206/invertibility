...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111))))
(define-fun l ((x (_ BitVec 18))) Bool  (bvsge (bvadd (inv s t) s) t))
