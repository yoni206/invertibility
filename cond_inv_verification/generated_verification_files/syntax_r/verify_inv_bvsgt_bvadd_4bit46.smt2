...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvor (bvand s #b1000000000000000000000000000000000000000000000) (bvnot (bvor s #b1000000000000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 46))) Bool  (bvsgt (bvadd (inv s t) s) t))
