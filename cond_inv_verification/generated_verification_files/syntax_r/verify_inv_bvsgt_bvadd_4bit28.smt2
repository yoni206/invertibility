...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvor (bvand s #b1000000000000000000000000000) (bvnot (bvor s #b1000000000000000000000000000))))
(define-fun l ((x (_ BitVec 28))) Bool  (bvsgt (bvadd (inv s t) s) t))
