...
(define-fun inv ((s (_ BitVec 59)) (t (_ BitVec 59))) (_ BitVec 59) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 59))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 59)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 59)) (distinct t max))) (or (distinct t (_ bv0 59)) (distinct s (_ bv1 59)))))
