...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvneg (bvand (bvor s #b100000000000000000000000000000) (bvnot (bvand s #b100000000000000000000000000000)))))
(define-fun l ((x (_ BitVec 30))) Bool  (bvslt (bvadd (inv s t) s) t))
