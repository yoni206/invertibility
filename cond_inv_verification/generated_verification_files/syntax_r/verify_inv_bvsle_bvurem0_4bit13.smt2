...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvand t #b1000000000000))
(define-fun l ((x (_ BitVec 13))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 13)) (bvand (bvneg s) t)))
