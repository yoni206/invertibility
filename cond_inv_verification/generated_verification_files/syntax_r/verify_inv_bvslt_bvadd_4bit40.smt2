...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvneg (bvand (bvor s #b1000000000000000000000000000000000000000) (bvnot (bvand s #b1000000000000000000000000000000000000000)))))
(define-fun l ((x (_ BitVec 40))) Bool  (bvslt (bvadd (inv s t) s) t))
