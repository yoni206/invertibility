...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111))))
(define-fun l ((x (_ BitVec 23))) Bool  (bvsge (bvadd (inv s t) s) t))
