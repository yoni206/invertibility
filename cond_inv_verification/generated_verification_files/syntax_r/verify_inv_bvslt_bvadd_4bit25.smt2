...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvneg (bvand (bvor s #b1000000000000000000000000) (bvnot (bvand s #b1000000000000000000000000)))))
(define-fun l ((x (_ BitVec 25))) Bool  (bvslt (bvadd (inv s t) s) t))
