...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) #b0111111111111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 55))) Bool  (bvsge (bvashr (inv s t) s) t))
