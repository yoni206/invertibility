...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 33))) Bool  (bvsge (bvadd (inv s t) s) t))
