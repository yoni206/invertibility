...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvor (bvand s #b1000000000000000000000000000000000000) (bvnot (bvor s #b1000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 37))) Bool  (bvsgt (bvadd (inv s t) s) t))
