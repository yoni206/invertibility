...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111))))
(define-fun l ((x (_ BitVec 24))) Bool  (bvsge (bvadd (inv s t) s) t))
