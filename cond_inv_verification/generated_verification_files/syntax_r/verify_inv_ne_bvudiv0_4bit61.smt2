...
(define-fun inv ((s (_ BitVec 61)) (t (_ BitVec 61))) (_ BitVec 61) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 61))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 61)) (distinct t (bvnot (_ bv0 61)))))
