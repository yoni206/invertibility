...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvneg (bvand (bvor s #b100000000000000000000000000000000000) (bvnot (bvand s t)))))
(define-fun l ((x (_ BitVec 36))) Bool  (bvsle (bvadd (inv s t) s) t))
