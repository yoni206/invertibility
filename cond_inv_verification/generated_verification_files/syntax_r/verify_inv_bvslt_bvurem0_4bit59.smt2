...
(define-fun inv ((s (_ BitVec 59)) (t (_ BitVec 59))) (_ BitVec 59) (bvnot (bvor #b01111111111111111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 59))) Bool  (bvslt (uremtotal (inv s t) s) t))
