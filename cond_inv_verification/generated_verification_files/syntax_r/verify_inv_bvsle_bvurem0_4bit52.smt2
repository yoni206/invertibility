...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvand t #b1000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 52))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 52)) (bvand (bvneg s) t)))
