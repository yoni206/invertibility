...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) #b01111111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 50))) Bool  (bvsgt (bvashr (inv s t) s) t))
