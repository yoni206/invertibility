...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 44))) Bool  (bvsge (bvadd (inv s t) s) t))
