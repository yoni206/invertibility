...
(define-fun inv ((s (_ BitVec 63)) (t (_ BitVec 63))) (_ BitVec 63) (bvnot t))
(define-fun l ((x (_ BitVec 63))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 63))) (distinct t (bvnot (_ bv0 63)))))
