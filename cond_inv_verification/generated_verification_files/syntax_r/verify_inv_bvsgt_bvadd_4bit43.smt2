...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvor (bvand s #b1000000000000000000000000000000000000000000) (bvnot (bvor s #b1000000000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 43))) Bool  (bvsgt (bvadd (inv s t) s) t))
