...
(define-fun inv ((s (_ BitVec 64)) (t (_ BitVec 64))) (_ BitVec 64) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 64))) Bool  (bvsge (bvadd (inv s t) s) t))
