...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 41))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 41)) (distinct t (bvnot (_ bv0 41)))))
