...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvand t #b10000000000000000000000000000000))
(define-fun l ((x (_ BitVec 32))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 32)) (bvand (bvneg s) t)))
