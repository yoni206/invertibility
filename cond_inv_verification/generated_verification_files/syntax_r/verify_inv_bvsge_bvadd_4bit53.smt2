...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 53))) Bool  (bvsge (bvadd (inv s t) s) t))
