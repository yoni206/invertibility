...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111))))
(define-fun l ((x (_ BitVec 25))) Bool  (bvsge (bvadd (inv s t) s) t))
