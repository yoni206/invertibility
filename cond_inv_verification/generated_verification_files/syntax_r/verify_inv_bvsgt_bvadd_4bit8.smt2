...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvor (bvand s #b10000000) (bvnot (bvor s #b10000000))))
(define-fun l ((x (_ BitVec 8))) Bool  (bvsgt (bvadd (inv s t) s) t))
