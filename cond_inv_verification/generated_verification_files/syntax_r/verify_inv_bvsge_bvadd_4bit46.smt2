...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 46))) Bool  (bvsge (bvadd (inv s t) s) t))
