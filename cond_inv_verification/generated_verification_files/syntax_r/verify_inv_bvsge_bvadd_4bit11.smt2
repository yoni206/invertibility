...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvand (bvor s t) (bvnot (bvand s #b01111111111))))
(define-fun l ((x (_ BitVec 11))) Bool  (bvsge (bvadd (inv s t) s) t))
