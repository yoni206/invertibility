...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvand t #b1000000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 55))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 55)) (bvand (bvneg s) t)))
