...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvnot (bvor #b01111111111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 53))) Bool  (bvslt (uremtotal (inv s t) s) t))
