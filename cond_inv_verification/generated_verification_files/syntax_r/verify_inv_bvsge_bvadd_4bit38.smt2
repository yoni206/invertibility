...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 38))) Bool  (bvsge (bvadd (inv s t) s) t))
