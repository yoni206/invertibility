...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvnot t))
(define-fun l ((x (_ BitVec 46))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 46))) (distinct t (bvnot (_ bv0 46)))))
