...
(define-fun inv ((s (_ BitVec 61)) (t (_ BitVec 61))) (_ BitVec 61) (bvnot (bvor s #b0111111111111111111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 61))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 61)))) (not (= t (_ bv0 61)))))
