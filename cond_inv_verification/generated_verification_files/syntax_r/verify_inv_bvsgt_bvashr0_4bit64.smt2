...
(define-fun inv ((s (_ BitVec 64)) (t (_ BitVec 64))) (_ BitVec 64) #b0111111111111111111111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 64))) Bool  (bvsgt (bvashr (inv s t) s) t))
