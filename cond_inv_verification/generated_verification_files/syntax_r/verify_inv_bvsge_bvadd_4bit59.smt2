...
(define-fun inv ((s (_ BitVec 59)) (t (_ BitVec 59))) (_ BitVec 59) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 59))) Bool  (bvsge (bvadd (inv s t) s) t))
