...
(define-fun inv ((s (_ BitVec 61)) (t (_ BitVec 61))) (_ BitVec 61) #b0111111111111111111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 61))) Bool  (bvsgt (bvashr (inv s t) s) t))
