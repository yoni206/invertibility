...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvnot (bvor #b0111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 43))) Bool  (bvslt (uremtotal (inv s t) s) t))
