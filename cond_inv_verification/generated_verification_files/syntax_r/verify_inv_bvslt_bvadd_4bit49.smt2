...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvneg (bvand (bvor s #b1000000000000000000000000000000000000000000000000) (bvnot (bvand s #b1000000000000000000000000000000000000000000000000)))))
(define-fun l ((x (_ BitVec 49))) Bool  (bvslt (bvadd (inv s t) s) t))
