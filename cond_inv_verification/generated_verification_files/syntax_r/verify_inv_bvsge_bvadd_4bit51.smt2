...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 51))) Bool  (bvsge (bvadd (inv s t) s) t))
