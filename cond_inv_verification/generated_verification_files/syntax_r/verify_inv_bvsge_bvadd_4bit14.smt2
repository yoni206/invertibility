...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvand (bvor s t) (bvnot (bvand s #b01111111111111))))
(define-fun l ((x (_ BitVec 14))) Bool  (bvsge (bvadd (inv s t) s) t))
