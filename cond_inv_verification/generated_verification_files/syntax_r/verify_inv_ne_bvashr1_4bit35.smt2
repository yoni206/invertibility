...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 35))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 35))) (not (= s (_ bv0 35)))) (or (not (= t (bvnot (_ bv0 35)))) (not (= s (bvnot (_ bv0 35)))))))
