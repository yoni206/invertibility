...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvand (bvor s t) (bvnot (bvand s #b011111111111))))
(define-fun l ((x (_ BitVec 12))) Bool  (bvsge (bvadd (inv s t) s) t))
