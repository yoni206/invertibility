...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111))))
(define-fun l ((x (_ BitVec 21))) Bool  (bvsge (bvadd (inv s t) s) t))
