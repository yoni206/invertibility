...
(define-fun inv ((s (_ BitVec 1)) (t (_ BitVec 1))) (_ BitVec 1) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 1))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 1))) (not (= s (_ bv0 1)))) (or (not (= t (bvnot (_ bv0 1)))) (not (= s (bvnot (_ bv0 1)))))))
