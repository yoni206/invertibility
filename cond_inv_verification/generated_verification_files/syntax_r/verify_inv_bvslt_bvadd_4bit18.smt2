...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvneg (bvand (bvor s #b100000000000000000) (bvnot (bvand s #b100000000000000000)))))
(define-fun l ((x (_ BitVec 18))) Bool  (bvslt (bvadd (inv s t) s) t))
