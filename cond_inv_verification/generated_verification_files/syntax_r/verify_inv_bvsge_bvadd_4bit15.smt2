...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvand (bvor s t) (bvnot (bvand s #b011111111111111))))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsge (bvadd (inv s t) s) t))
