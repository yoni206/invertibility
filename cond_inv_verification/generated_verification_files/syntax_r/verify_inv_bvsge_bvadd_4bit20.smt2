...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111))))
(define-fun l ((x (_ BitVec 20))) Bool  (bvsge (bvadd (inv s t) s) t))
