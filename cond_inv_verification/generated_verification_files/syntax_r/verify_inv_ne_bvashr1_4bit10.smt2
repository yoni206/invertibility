...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 10))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 10))) (not (= s (_ bv0 10)))) (or (not (= t (bvnot (_ bv0 10)))) (not (= s (bvnot (_ bv0 10)))))))
