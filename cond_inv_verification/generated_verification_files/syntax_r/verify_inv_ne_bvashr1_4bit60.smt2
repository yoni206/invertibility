...
(define-fun inv ((s (_ BitVec 60)) (t (_ BitVec 60))) (_ BitVec 60) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 60))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 60))) (not (= s (_ bv0 60)))) (or (not (= t (bvnot (_ bv0 60)))) (not (= s (bvnot (_ bv0 60)))))))
