...
(define-fun inv ((s (_ BitVec 61)) (t (_ BitVec 61))) (_ BitVec 61) t)
(define-fun l ((x (_ BitVec 61))) Bool  (bvsle (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (= (udivtotal (bvmul s t) s) t) (=> (bvsle t (_ bv0 61)) (bvslt (udivtotal min s) t))))
