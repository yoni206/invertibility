...
(define-fun inv ((s (_ BitVec 64)) (t (_ BitVec 64))) (_ BitVec 64) (bvnot (bvor #b0111111111111111111111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 64))) Bool  (bvslt (uremtotal (inv s t) s) t))
