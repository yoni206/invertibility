...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvor (bvand s #b1000000000000000000000000000000000000000) (bvnot (bvor s #b1000000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 40))) Bool  (bvsgt (bvadd (inv s t) s) t))
