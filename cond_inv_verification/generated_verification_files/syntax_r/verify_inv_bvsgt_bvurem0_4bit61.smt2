...
(define-fun inv ((s (_ BitVec 61)) (t (_ BitVec 61))) (_ BitVec 61) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 61))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 61)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 61)) (distinct t max))) (or (distinct t (_ bv0 61)) (distinct s (_ bv1 61)))))
