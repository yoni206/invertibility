...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111))))
(define-fun l ((x (_ BitVec 22))) Bool  (bvsge (bvadd (inv s t) s) t))
