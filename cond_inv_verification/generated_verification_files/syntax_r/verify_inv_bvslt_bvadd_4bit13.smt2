...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvneg (bvand (bvor s #b1000000000000) (bvnot (bvand s #b1000000000000)))))
(define-fun l ((x (_ BitVec 13))) Bool  (bvslt (bvadd (inv s t) s) t))
