...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvneg (bvand (bvor s #b1000000000000000000000000000000000) (bvnot (bvand s t)))))
(define-fun l ((x (_ BitVec 34))) Bool  (bvsle (bvadd (inv s t) s) t))
