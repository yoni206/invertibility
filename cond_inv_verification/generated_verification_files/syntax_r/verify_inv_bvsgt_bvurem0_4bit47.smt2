...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 47))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 47)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 47)) (distinct t max))) (or (distinct t (_ bv0 47)) (distinct s (_ bv1 47)))))
