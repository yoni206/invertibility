...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvneg (bvand (bvor s #b100000000000000000000000000000000000000000000000) (bvnot (bvand s #b100000000000000000000000000000000000000000000000)))))
(define-fun l ((x (_ BitVec 48))) Bool  (bvslt (bvadd (inv s t) s) t))
