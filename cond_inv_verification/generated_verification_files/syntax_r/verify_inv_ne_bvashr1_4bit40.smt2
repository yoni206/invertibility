...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 40))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 40))) (not (= s (_ bv0 40)))) (or (not (= t (bvnot (_ bv0 40)))) (not (= s (bvnot (_ bv0 40)))))))
