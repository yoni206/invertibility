...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvneg (bvand (bvor s #b100000000000000) (bvnot (bvand s #b100000000000000)))))
(define-fun l ((x (_ BitVec 15))) Bool  (bvslt (bvadd (inv s t) s) t))
