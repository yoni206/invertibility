...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvand t #b100000000000000000000000000000000))
(define-fun l ((x (_ BitVec 33))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 33)) (bvand (bvneg s) t)))
