...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 42))) Bool  (bvsge (bvadd (inv s t) s) t))
