...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvor (bvand s #b10000000000000000000000000000000000000000000) (bvnot (bvor s #b10000000000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 44))) Bool  (bvsgt (bvadd (inv s t) s) t))
