...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvor (bvand s #b10000000000000000000000000000000) (bvnot (bvor s #b10000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 32))) Bool  (bvsgt (bvadd (inv s t) s) t))
