...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvor (bvand s #b100000000) (bvnot (bvor s #b100000000))))
(define-fun l ((x (_ BitVec 9))) Bool  (bvsgt (bvadd (inv s t) s) t))
