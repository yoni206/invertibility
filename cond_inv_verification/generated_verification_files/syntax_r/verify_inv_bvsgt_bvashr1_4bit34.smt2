...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvand s #b1000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 34))) Bool  (bvsgt (bvashr s (inv s t)) t))
