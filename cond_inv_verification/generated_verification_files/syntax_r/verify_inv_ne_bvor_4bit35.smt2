...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvnot t))
(define-fun l ((x (_ BitVec 35))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 35))) (distinct t (bvnot (_ bv0 35)))))
