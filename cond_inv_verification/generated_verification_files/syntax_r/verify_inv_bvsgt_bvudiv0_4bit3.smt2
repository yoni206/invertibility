...
(define-fun inv ((s (_ BitVec 3)) (t (_ BitVec 3))) (_ BitVec 3) (bvor s (bvor #b011 (bvneg (bvnot (bvneg s))))))
(define-fun l ((x (_ BitVec 3))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 3)) s) t) (bvsgt (udivtotal max s) t)))
