...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 18))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 18))) (not (= s (_ bv0 18)))) (or (not (= t (bvnot (_ bv0 18)))) (not (= s (bvnot (_ bv0 18)))))))
