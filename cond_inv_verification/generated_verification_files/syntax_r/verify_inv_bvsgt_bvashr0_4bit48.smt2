...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) #b011111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 48))) Bool  (bvsgt (bvashr (inv s t) s) t))
