...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvand t #b100000000000000000))
(define-fun l ((x (_ BitVec 18))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 18)) (bvand (bvneg s) t)))
