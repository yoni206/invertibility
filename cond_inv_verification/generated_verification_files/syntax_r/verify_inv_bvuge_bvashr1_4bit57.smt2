...
(define-fun inv ((s (_ BitVec 57)) (t (_ BitVec 57))) (_ BitVec 57) (bvand s #b100000000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 57))) Bool  (bvuge (bvashr s (inv s t)) t))
