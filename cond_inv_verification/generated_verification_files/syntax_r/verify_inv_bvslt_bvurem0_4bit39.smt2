...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvnot (bvor #b011111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 39))) Bool  (bvslt (uremtotal (inv s t) s) t))
