...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvor s (bvor t (bvneg (bvnot (bvneg s))))))
(define-fun l ((x (_ BitVec 2))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 2)) s) t) (bvsge (udivtotal max s) t)))
