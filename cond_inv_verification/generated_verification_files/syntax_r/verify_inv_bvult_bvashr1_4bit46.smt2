...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvnot (bvor s #b0111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 46))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 46)))) (not (= t (_ bv0 46)))))
