...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 2))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 2)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 2)) (distinct t max))) (or (distinct t (_ bv0 2)) (distinct s (_ bv1 2)))))
