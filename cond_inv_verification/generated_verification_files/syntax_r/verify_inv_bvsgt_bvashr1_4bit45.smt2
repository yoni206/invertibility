...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvand s #b100000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 45))) Bool  (bvsgt (bvashr s (inv s t)) t))
