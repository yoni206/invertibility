...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvor (bvand s #b100000000000000000000000000000000000000000000000000) (bvnot (bvor s #b100000000000000000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 51))) Bool  (bvsgt (bvadd (inv s t) s) t))
