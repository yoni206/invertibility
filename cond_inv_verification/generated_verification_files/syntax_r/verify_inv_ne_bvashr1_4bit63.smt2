...
(define-fun inv ((s (_ BitVec 63)) (t (_ BitVec 63))) (_ BitVec 63) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 63))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 63))) (not (= s (_ bv0 63)))) (or (not (= t (bvnot (_ bv0 63)))) (not (= s (bvnot (_ bv0 63)))))))
