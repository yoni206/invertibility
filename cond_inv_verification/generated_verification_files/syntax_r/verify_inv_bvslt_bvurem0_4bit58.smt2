...
(define-fun inv ((s (_ BitVec 58)) (t (_ BitVec 58))) (_ BitVec 58) (bvnot (bvor #b0111111111111111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 58))) Bool  (bvslt (uremtotal (inv s t) s) t))
