...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 39))) Bool  (bvsge (bvadd (inv s t) s) t))
