...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) #b00000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 35))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 35) s) (bvult (_ bv0 35) t)))
