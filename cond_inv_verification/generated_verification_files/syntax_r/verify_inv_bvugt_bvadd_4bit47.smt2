...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvnot s))
(define-fun l ((x (_ BitVec 47))) Bool  (bvugt (bvadd (inv s t) s) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 47))))
