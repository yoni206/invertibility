...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvnot (bvor s #b011111111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 51))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 51)))) (not (= t (_ bv0 51)))))
