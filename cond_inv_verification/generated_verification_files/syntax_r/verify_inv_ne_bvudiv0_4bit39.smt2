...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 39))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 39)) (distinct t (bvnot (_ bv0 39)))))
