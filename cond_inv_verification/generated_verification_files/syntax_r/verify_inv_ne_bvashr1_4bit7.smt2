...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 7))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 7))) (not (= s (_ bv0 7)))) (or (not (= t (bvnot (_ bv0 7)))) (not (= s (bvnot (_ bv0 7)))))))
