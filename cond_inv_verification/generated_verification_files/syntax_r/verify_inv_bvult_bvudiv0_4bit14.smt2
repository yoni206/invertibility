...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) #b00000000000000)
(define-fun l ((x (_ BitVec 14))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 14) s) (bvult (_ bv0 14) t)))
