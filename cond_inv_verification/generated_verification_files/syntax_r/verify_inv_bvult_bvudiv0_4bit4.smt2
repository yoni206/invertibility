...
(define-fun inv ((s (_ BitVec 4)) (t (_ BitVec 4))) (_ BitVec 4) #b0000)
(define-fun l ((x (_ BitVec 4))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 4) s) (bvult (_ bv0 4) t)))
