...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvnot t))
(define-fun l ((x (_ BitVec 42))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 42))) (distinct t (bvnot (_ bv0 42)))))
