...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvor s (bvor #b01111111111111111111111111111111111111111111111111111 (bvneg (bvnot (bvneg s))))))
(define-fun l ((x (_ BitVec 53))) Bool  (bvsgt (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsgt (udivtotal (bvnot (_ bv0 53)) s) t) (bvsgt (udivtotal max s) t)))
