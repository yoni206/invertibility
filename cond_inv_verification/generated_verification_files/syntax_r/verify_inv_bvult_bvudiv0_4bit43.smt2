...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) #b0000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 43))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 43) s) (bvult (_ bv0 43) t)))
