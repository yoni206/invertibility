...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 55))) Bool  (bvsge (bvadd (inv s t) s) t))
