...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvnot (bvor #b0111111111111111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 52))) Bool  (bvslt (uremtotal (inv s t) s) t))
