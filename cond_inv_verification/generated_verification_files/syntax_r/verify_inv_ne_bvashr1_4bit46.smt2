...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 46))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 46))) (not (= s (_ bv0 46)))) (or (not (= t (bvnot (_ bv0 46)))) (not (= s (bvnot (_ bv0 46)))))))
