...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvor (bvand s #b10000000000000000000000000000000000000) (bvnot (bvor s #b10000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 38))) Bool  (bvsgt (bvadd (inv s t) s) t))
