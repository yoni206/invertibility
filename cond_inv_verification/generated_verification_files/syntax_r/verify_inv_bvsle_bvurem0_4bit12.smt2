...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvand t #b100000000000))
(define-fun l ((x (_ BitVec 12))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 12)) (bvand (bvneg s) t)))
