...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvnot (bvor #b0111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 34))) Bool  (bvslt (uremtotal (inv s t) s) t))
