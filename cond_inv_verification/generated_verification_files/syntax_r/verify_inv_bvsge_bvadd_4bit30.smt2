...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvand (bvor s t) (bvnot (bvand s #b011111111111111111111111111111))))
(define-fun l ((x (_ BitVec 30))) Bool  (bvsge (bvadd (inv s t) s) t))
