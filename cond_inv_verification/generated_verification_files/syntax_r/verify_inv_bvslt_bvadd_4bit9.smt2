...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvneg (bvand (bvor s #b100000000) (bvnot (bvand s #b100000000)))))
(define-fun l ((x (_ BitVec 9))) Bool  (bvslt (bvadd (inv s t) s) t))
