...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvnot t))
(define-fun l ((x (_ BitVec 53))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 53))) (distinct t (bvnot (_ bv0 53)))))
