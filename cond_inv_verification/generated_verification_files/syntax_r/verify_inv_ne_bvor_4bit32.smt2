...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvnot t))
(define-fun l ((x (_ BitVec 32))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 32))) (distinct t (bvnot (_ bv0 32)))))
