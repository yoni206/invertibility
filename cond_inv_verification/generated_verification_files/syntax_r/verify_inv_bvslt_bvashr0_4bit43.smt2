...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) #b1000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 43))) Bool  (bvslt (bvashr (inv s t) s) t))
