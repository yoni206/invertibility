...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) #b01111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 38))) Bool  (bvsge (bvashr (inv s t) s) t))
