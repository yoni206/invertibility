...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 50))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 50)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 50)) (distinct t max))) (or (distinct t (_ bv0 50)) (distinct s (_ bv1 50)))))
