...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvand s #b1000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 46))) Bool  (bvuge (bvashr s (inv s t)) t))
