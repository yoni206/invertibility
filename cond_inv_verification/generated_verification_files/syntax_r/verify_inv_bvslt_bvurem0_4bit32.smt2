...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvnot (bvor #b01111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 32))) Bool  (bvslt (uremtotal (inv s t) s) t))
