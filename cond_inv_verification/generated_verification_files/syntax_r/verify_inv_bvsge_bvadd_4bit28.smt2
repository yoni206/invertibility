...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111111))))
(define-fun l ((x (_ BitVec 28))) Bool  (bvsge (bvadd (inv s t) s) t))
