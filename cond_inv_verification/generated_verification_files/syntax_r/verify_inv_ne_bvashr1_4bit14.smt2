...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 14))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 14))) (not (= s (_ bv0 14)))) (or (not (= t (bvnot (_ bv0 14)))) (not (= s (bvnot (_ bv0 14)))))))
