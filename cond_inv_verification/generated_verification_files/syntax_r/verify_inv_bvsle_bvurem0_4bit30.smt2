...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvand t #b100000000000000000000000000000))
(define-fun l ((x (_ BitVec 30))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 30)) (bvand (bvneg s) t)))
