...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvor (bvand s #b10000000000) (bvnot (bvor s #b10000000000))))
(define-fun l ((x (_ BitVec 11))) Bool  (bvsgt (bvadd (inv s t) s) t))
