...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) (bvor (bvand s #b10000000000000000000000000000000000000000000000000000000) (bvnot (bvor s #b10000000000000000000000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 56))) Bool  (bvsgt (bvadd (inv s t) s) t))
