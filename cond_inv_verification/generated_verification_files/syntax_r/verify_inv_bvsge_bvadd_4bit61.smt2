...
(define-fun inv ((s (_ BitVec 61)) (t (_ BitVec 61))) (_ BitVec 61) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 61))) Bool  (bvsge (bvadd (inv s t) s) t))
