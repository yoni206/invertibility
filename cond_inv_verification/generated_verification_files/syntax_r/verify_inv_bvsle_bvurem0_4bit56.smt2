...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) (bvand t #b10000000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 56))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 56)) (bvand (bvneg s) t)))
