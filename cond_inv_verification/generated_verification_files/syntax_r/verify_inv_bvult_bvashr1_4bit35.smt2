...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvnot (bvor s #b01111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 35))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 35)))) (not (= t (_ bv0 35)))))
