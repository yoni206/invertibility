...
(define-fun inv ((s (_ BitVec 60)) (t (_ BitVec 60))) (_ BitVec 60) #b011111111111111111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 60))) Bool  (bvsge (bvashr (inv s t) s) t))
