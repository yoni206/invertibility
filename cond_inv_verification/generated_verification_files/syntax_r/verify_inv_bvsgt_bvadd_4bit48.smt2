...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvor (bvand s #b100000000000000000000000000000000000000000000000) (bvnot (bvor s #b100000000000000000000000000000000000000000000000))))
(define-fun l ((x (_ BitVec 48))) Bool  (bvsgt (bvadd (inv s t) s) t))
