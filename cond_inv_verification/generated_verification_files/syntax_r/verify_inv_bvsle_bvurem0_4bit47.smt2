...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvand t #b10000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 47))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 47)) (bvand (bvneg s) t)))
