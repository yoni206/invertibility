...
(define-fun inv ((s (_ BitVec 58)) (t (_ BitVec 58))) (_ BitVec 58) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 58))) Bool  (bvsge (bvadd (inv s t) s) t))
