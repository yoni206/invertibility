...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvneg (bvand (bvor s #b1000000000) (bvnot (bvand s #b1000000000)))))
(define-fun l ((x (_ BitVec 10))) Bool  (bvslt (bvadd (inv s t) s) t))
