...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvand (bvor s t) (bvnot (bvand s #b0111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 43))) Bool  (bvsge (bvadd (inv s t) s) t))
