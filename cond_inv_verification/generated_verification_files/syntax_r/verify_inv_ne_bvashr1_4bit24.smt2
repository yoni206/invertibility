...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 24))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 24))) (not (= s (_ bv0 24)))) (or (not (= t (bvnot (_ bv0 24)))) (not (= s (bvnot (_ bv0 24)))))))
