...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111))))
(define-fun l ((x (_ BitVec 17))) Bool  (bvsge (bvadd (inv s t) s) t))
