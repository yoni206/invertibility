...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvand s #b100000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 36))) Bool  (bvugt (bvashr s (inv s t)) t))
