...
(define-fun inv ((s (_ BitVec 62)) (t (_ BitVec 62))) (_ BitVec 62) (bvand (bvor s t) (bvnot (bvand s #b01111111111111111111111111111111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 62))) Bool  (bvsge (bvadd (inv s t) s) t))
