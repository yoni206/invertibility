...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 2))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 2))) (not (= s (_ bv0 2)))) (or (not (= t (bvnot (_ bv0 2)))) (not (= s (bvnot (_ bv0 2)))))))
