...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvand s #b1000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 52))) Bool  (bvugt (bvashr s (inv s t)) t))
