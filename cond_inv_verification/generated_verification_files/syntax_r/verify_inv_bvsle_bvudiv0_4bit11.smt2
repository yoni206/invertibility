...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) t)
(define-fun l ((x (_ BitVec 11))) Bool  (bvsle (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (= (udivtotal (bvmul s t) s) t) (=> (bvsle t (_ bv0 11)) (bvslt (udivtotal min s) t))))
