...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvneg (bvand (bvneg t) (bvneg (bvnot t)))))
(define-fun l ((x (_ BitVec 13))) Bool  (distinct (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (or (not (= t (_ bv0 13))) (not (= s (_ bv0 13)))) (or (not (= t (bvnot (_ bv0 13)))) (not (= s (bvnot (_ bv0 13)))))))
