...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) (bvand t #b100000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 54))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 54)) (bvand (bvneg s) t)))
