...
(define-fun inv ((s (_ BitVec 62)) (t (_ BitVec 62))) (_ BitVec 62) (bvneg s))
(define-fun l ((x (_ BitVec 62))) Bool  (bvult (bvadd (inv s t) s) t))
(define-fun SC () Bool (distinct t (_ bv0 62)))
