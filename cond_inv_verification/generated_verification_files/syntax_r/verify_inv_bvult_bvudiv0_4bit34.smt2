...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) #b0000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 34))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 34) s) (bvult (_ bv0 34) t)))
