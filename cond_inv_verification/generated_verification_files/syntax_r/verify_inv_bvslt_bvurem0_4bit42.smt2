...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvnot (bvor #b011111111111111111111111111111111111111111 (bvneg s))))
(define-fun l ((x (_ BitVec 42))) Bool  (bvslt (uremtotal (inv s t) s) t))
