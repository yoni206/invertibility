...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 37))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 37)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 37)) (distinct t max))) (or (distinct t (_ bv0 37)) (distinct s (_ bv1 37)))))
