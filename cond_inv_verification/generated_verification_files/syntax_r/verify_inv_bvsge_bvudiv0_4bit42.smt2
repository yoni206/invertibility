...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvor s (bvor t (bvneg (bvnot (bvneg s))))))
(define-fun l ((x (_ BitVec 42))) Bool  (bvsge (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (bvsge (udivtotal (bvnot (_ bv0 42)) s) t) (bvsge (udivtotal max s) t)))
