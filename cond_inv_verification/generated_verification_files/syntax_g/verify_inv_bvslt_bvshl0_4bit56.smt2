...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) (bvlshr #b10000000000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 56))) Bool  (bvslt (bvshl (inv s t) s) t))
