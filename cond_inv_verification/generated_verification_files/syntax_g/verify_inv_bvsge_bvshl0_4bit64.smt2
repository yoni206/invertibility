...
(define-fun inv ((s (_ BitVec 64)) (t (_ BitVec 64))) (_ BitVec 64) (bvlshr #b0111111111111111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 64))) Bool  (bvsge (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvsge (bvand (bvshl max s) max) t))
