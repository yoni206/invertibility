...
(define-fun l ((x (_ BitVec 23))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 23)) (bvsgt s t)) (=> (bvslt s (_ bv0 23)) (bvsgt (bvlshr s (_ bv1 23)) t))))
