...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvsub (bvor s #b10000000000000000000000000000000000000) (bvand t #b01111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 38))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 38)) (bvsge s t)) (=> (and (bvslt s (_ bv0 38)) (bvsge t (_ bv0 38))) (bvugt (bvsub s t) t))))
