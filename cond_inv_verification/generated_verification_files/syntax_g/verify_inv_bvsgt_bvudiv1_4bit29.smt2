...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvneg (bvnot (bvlshr s (bvlshr #b01111111111111111111111111111 (bvsub #b10000000000000000000000000000 #b01111111111111111111111111111))))))
(define-fun l ((x (_ BitVec 29))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 29)) (bvsgt s t)) (=> (bvslt s (_ bv0 29)) (bvsgt (bvlshr s (_ bv1 29)) t))))
