...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvand t #b100000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 48))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 48)) (bvand (bvneg s) t)))
