...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) #b01111111111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 53))) Bool  (bvsgt (bvashr (inv s t) s) t))
