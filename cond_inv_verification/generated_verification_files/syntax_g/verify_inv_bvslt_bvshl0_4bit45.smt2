...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvlshr #b100000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 45))) Bool  (bvslt (bvshl (inv s t) s) t))
