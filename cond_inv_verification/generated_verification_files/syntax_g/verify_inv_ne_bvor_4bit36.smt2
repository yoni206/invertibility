...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvnot t))
(define-fun l ((x (_ BitVec 36))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 36))) (distinct t (bvnot (_ bv0 36)))))
