...
(define-fun l ((x (_ BitVec 43))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 43)) (bvsge s t)) (=> (bvslt s (_ bv0 43)) (bvsge (bvlshr s (_ bv1 43)) t))))
