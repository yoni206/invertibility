...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvlshr #b10000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 50))) Bool  (bvslt (bvshl (inv s t) s) t))
