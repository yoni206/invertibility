...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvlshr s (bvlshr #b01111111111111 (bvsub #b10000000000000 #b01111111111111))))
(define-fun l ((x (_ BitVec 14))) Bool  (bvsgt (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 14)) (bvsgt (bvlshr s (_ bv1 14)) t)) (=> (bvsge s (_ bv0 14)) (bvsgt s t))))
