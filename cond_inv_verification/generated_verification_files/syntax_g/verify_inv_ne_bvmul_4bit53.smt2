...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvshl #b01111111111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 53))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 53)) (distinct s (_ bv0 53))))
