...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvsub (bvor s #b1000000) (bvand #b0111111 (bvsub t #b0111111))))
(define-fun l ((x (_ BitVec 7))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 7)) (bvsgt s t)) (=> (bvslt s (_ bv0 7)) (bvsgt (bvlshr (bvsub s (_ bv1 7)) (_ bv1 7)) t))))
