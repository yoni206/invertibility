...
(define-fun inv ((s (_ BitVec 3)) (t (_ BitVec 3))) (_ BitVec 3) (bvnot s))
(define-fun l ((x (_ BitVec 3))) Bool  (bvugt (bvadd (inv s t) s) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 3))))
