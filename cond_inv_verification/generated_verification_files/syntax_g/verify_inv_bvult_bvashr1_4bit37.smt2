...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvnot (bvor s #b0111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 37))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 37)))) (not (= t (_ bv0 37)))))
