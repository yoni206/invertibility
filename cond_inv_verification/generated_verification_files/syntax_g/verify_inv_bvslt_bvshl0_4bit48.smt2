...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvlshr #b100000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 48))) Bool  (bvslt (bvshl (inv s t) s) t))
