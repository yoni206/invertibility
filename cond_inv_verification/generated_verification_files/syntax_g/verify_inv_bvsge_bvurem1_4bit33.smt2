...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvsub (bvor s #b100000000000000000000000000000000) (bvand t #b011111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 33))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 33)) (bvsge s t)) (=> (and (bvslt s (_ bv0 33)) (bvsge t (_ bv0 33))) (bvugt (bvsub s t) t))))
