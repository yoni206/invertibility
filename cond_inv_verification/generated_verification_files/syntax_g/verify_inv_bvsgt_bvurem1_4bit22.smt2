...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvsub (bvor s #b1000000000000000000000) (bvand #b0111111111111111111111 (bvsub t #b0111111111111111111111))))
(define-fun l ((x (_ BitVec 22))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 22)) (bvsgt s t)) (=> (bvslt s (_ bv0 22)) (bvsgt (bvlshr (bvsub s (_ bv1 22)) (_ bv1 22)) t))))
