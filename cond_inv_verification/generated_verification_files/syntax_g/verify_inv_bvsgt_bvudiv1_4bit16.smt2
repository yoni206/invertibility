...
(define-fun l ((x (_ BitVec 16))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 16)) (bvsgt s t)) (=> (bvslt s (_ bv0 16)) (bvsgt (bvlshr s (_ bv1 16)) t))))
