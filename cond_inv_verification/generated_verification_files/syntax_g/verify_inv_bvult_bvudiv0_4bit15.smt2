...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) #b000000000000000)
(define-fun l ((x (_ BitVec 15))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 15) s) (bvult (_ bv0 15) t)))
