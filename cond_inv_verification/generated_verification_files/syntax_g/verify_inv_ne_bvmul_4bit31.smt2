...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvshl #b0111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 31))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 31)) (distinct s (_ bv0 31))))
