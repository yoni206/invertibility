...
(define-fun inv ((s (_ BitVec 61)) (t (_ BitVec 61))) (_ BitVec 61) (bvlshr #b0111111111111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 61))) Bool  (bvsge (bvshl (inv s t) s) t))
