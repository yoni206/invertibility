...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvlshr #b011111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 33))) Bool  (bvsge (bvshl (inv s t) s) t))
