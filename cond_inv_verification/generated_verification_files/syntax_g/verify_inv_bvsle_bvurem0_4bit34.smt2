...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvand t #b1000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 34))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 34)) (bvand (bvneg s) t)))
