...
(define-fun inv ((s (_ BitVec 57)) (t (_ BitVec 57))) (_ BitVec 57) (bvand t #b100000000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 57))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 57)) (bvand (bvneg s) t)))
