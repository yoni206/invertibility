...
(define-fun inv ((s (_ BitVec 62)) (t (_ BitVec 62))) (_ BitVec 62) (bvshl #b01111111111111111111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 62))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 62)) (distinct s (_ bv0 62))))
