...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) #b100000000000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 54))) Bool  (bvslt (bvashr (inv s t) s) t))
