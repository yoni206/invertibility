...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvand s #b1000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 49))) Bool  (bvsge (bvashr s (inv s t)) t))
