...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvand s #b100000000000000000000000000000000))
(define-fun l ((x (_ BitVec 33))) Bool  (bvugt (bvashr s (inv s t)) t))
