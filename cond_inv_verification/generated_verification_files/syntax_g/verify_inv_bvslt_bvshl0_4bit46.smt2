...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvlshr #b1000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 46))) Bool  (bvslt (bvshl (inv s t) s) t))
