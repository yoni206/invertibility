...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvnot t))
(define-fun l ((x (_ BitVec 20))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 20))) (distinct t (bvnot (_ bv0 20)))))
