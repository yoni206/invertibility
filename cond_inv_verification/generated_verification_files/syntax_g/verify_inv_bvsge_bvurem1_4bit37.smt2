...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvsub (bvor s #b1000000000000000000000000000000000000) (bvand t #b0111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 37))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 37)) (bvsge s t)) (=> (and (bvslt s (_ bv0 37)) (bvsge t (_ bv0 37))) (bvugt (bvsub s t) t))))
