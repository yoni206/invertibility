...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvshl #b011111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 42))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 42)) (distinct s (_ bv0 42))))
