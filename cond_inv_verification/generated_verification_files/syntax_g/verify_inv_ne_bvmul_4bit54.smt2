...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) (bvshl #b011111111111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 54))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 54)) (distinct s (_ bv0 54))))
