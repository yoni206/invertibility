...
(define-fun inv ((s (_ BitVec 1)) (t (_ BitVec 1))) (_ BitVec 1) #b0)
(define-fun l ((x (_ BitVec 1))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 1) s) (bvult (_ bv0 1) t)))
