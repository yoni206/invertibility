...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvneg (bvnot (bvlshr s (bvlshr #b01111111111111111111111 (bvsub #b10000000000000000000000 #b01111111111111111111111))))))
(define-fun l ((x (_ BitVec 23))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 23)) (bvsge s t)) (=> (bvslt s (_ bv0 23)) (bvsge (bvlshr s (_ bv1 23)) t))))
