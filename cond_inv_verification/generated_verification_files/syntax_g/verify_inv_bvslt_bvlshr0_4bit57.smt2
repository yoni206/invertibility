...
(define-fun inv ((s (_ BitVec 57)) (t (_ BitVec 57))) (_ BitVec 57) (bvshl #b100000000000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 57))) Bool  (bvslt (bvlshr (inv s t) s) t))
