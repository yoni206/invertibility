...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvshl #b011111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 36))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 36)) (distinct s (_ bv0 36))))
