...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvlshr s (bvlshr #b01 (bvsub #b10 #b01))))
(define-fun l ((x (_ BitVec 2))) Bool  (bvsgt (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 2)) (bvsgt (bvlshr s (_ bv1 2)) t)) (=> (bvsge s (_ bv0 2)) (bvsgt s t))))
