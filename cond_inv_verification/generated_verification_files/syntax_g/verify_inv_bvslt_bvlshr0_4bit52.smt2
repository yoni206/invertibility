...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvshl #b1000000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 52))) Bool  (bvslt (bvlshr (inv s t) s) t))
