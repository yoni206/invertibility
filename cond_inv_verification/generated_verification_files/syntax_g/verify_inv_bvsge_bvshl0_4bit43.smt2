...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvlshr #b0111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 43))) Bool  (bvsge (bvshl (inv s t) s) t))
