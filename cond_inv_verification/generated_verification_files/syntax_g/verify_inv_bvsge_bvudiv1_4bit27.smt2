...
(define-fun l ((x (_ BitVec 27))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 27)) (bvsge s t)) (=> (bvslt s (_ bv0 27)) (bvsge (bvlshr s (_ bv1 27)) t))))
