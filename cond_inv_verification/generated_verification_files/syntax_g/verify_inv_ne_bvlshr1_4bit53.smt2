...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvneg t))
(define-fun l ((x (_ BitVec 53))) Bool  (distinct (bvlshr s (inv s t)) t))
(define-fun SC () Bool (or (distinct s (_ bv0 53)) (distinct t (_ bv0 53))))
