...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvshl #b0111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 37))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 37)) (distinct s (_ bv0 37))))
