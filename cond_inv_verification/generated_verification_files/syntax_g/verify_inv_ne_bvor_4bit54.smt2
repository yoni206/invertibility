...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) (bvnot t))
(define-fun l ((x (_ BitVec 54))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 54))) (distinct t (bvnot (_ bv0 54)))))
