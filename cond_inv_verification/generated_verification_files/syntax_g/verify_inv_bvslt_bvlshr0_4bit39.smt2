...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvshl #b100000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 39))) Bool  (bvslt (bvlshr (inv s t) s) t))
