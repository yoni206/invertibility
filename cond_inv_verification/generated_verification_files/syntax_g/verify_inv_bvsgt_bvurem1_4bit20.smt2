...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvsub (bvor s #b10000000000000000000) (bvand #b01111111111111111111 (bvsub t #b01111111111111111111))))
(define-fun l ((x (_ BitVec 20))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 20)) (bvsgt s t)) (=> (bvslt s (_ bv0 20)) (bvsgt (bvlshr (bvsub s (_ bv1 20)) (_ bv1 20)) t))))
