...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvlshr #b011111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 30))) Bool  (bvsge (bvshl (inv s t) s) t))
