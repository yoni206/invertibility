...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvnot t))
(define-fun l ((x (_ BitVec 34))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 34))) (distinct t (bvnot (_ bv0 34)))))
