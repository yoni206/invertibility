...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) #b100000000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 51))) Bool  (bvslt (bvashr (inv s t) s) t))
