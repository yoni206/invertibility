...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvsub (bvor s #b10000000000000) (bvand t #b01111111111111)))
(define-fun l ((x (_ BitVec 14))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 14)) (bvsge s t)) (=> (and (bvslt s (_ bv0 14)) (bvsge t (_ bv0 14))) (bvugt (bvsub s t) t))))
