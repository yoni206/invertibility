...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) (bvlshr #b011111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 54))) Bool  (bvsge (bvshl (inv s t) s) t))
