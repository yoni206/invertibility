...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvneg (bvnot (bvlshr s (bvlshr #b011111111111 (bvsub #b100000000000 #b011111111111))))))
(define-fun l ((x (_ BitVec 12))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 12)) (bvsge s t)) (=> (bvslt s (_ bv0 12)) (bvsge (bvlshr s (_ bv1 12)) t))))
