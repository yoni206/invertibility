...
(define-fun inv ((s (_ BitVec 3)) (t (_ BitVec 3))) (_ BitVec 3) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 3))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 3)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 3)) (distinct t max))) (or (distinct t (_ bv0 3)) (distinct s (_ bv1 3)))))
