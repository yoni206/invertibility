...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 34))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 34)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 34)) (distinct t max))) (or (distinct t (_ bv0 34)) (distinct s (_ bv1 34)))))
