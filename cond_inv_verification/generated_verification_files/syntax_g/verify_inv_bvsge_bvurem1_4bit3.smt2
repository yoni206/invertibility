...
(define-fun inv ((s (_ BitVec 3)) (t (_ BitVec 3))) (_ BitVec 3) (bvsub (bvor s #b100) (bvand t #b011)))
(define-fun l ((x (_ BitVec 3))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 3)) (bvsge s t)) (=> (and (bvslt s (_ bv0 3)) (bvsge t (_ bv0 3))) (bvugt (bvsub s t) t))))
