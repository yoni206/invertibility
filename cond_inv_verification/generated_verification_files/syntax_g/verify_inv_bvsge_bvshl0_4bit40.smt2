...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvlshr #b0111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 40))) Bool  (bvsge (bvshl (inv s t) s) t))
