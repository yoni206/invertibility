...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvand t #b10000000000000000))
(define-fun l ((x (_ BitVec 17))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 17)) (bvand (bvneg s) t)))
