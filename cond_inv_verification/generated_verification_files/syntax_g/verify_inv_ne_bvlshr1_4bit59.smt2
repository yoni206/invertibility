...
(define-fun inv ((s (_ BitVec 59)) (t (_ BitVec 59))) (_ BitVec 59) (bvneg t))
(define-fun l ((x (_ BitVec 59))) Bool  (distinct (bvlshr s (inv s t)) t))
(define-fun SC () Bool (or (distinct s (_ bv0 59)) (distinct t (_ bv0 59))))
