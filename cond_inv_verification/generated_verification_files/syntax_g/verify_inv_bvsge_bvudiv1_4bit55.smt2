...
(define-fun l ((x (_ BitVec 55))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 55)) (bvsge s t)) (=> (bvslt s (_ bv0 55)) (bvsge (bvlshr s (_ bv1 55)) t))))
