...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvshl #b10000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 35))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 35)) (bvult s (_ bv35 35))))
