...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvand s #b100000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 51))) Bool  (bvugt (bvashr s (inv s t)) t))
