...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvlshr #b011111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 48))) Bool  (bvsge (bvshl (inv s t) s) t))
