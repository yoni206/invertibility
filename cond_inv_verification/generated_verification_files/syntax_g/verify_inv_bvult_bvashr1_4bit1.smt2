...
(define-fun inv ((s (_ BitVec 1)) (t (_ BitVec 1))) (_ BitVec 1) (bvnot (bvor s #b0)))
(define-fun l ((x (_ BitVec 1))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 1)))) (not (= t (_ bv0 1)))))
