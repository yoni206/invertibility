...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvshl #b1000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 43))) Bool  (bvslt (bvlshr (inv s t) s) t))
