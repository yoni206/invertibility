...
(define-fun inv ((s (_ BitVec 3)) (t (_ BitVec 3))) (_ BitVec 3) (bvshl #b011 t))
(define-fun l ((x (_ BitVec 3))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 3)) (distinct s (_ bv0 3))))
