...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvnot #b0000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 40))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 40) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 40) t)))
