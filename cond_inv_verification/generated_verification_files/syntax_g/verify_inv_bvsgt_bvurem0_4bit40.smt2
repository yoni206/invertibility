...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 40))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 40)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 40)) (distinct t max))) (or (distinct t (_ bv0 40)) (distinct s (_ bv1 40)))))
