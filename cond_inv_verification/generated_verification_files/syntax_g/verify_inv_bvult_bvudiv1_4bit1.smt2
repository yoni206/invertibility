...
(define-fun inv ((s (_ BitVec 1)) (t (_ BitVec 1))) (_ BitVec 1) (bvnot #b0))
(define-fun l ((x (_ BitVec 1))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 1) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 1) t)))
