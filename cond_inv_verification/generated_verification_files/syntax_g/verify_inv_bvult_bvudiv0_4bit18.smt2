...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) #b000000000000000000)
(define-fun l ((x (_ BitVec 18))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 18) s) (bvult (_ bv0 18) t)))
