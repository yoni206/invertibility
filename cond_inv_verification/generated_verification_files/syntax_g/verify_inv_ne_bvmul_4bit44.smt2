...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvshl #b01111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 44))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 44)) (distinct s (_ bv0 44))))
