...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvshl #b100000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 42))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 42)) (bvult s (_ bv42 42))))
