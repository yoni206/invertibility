...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvneg (bvnot (bvlshr s (bvlshr #b01111111111111111111 (bvsub #b10000000000000000000 #b01111111111111111111))))))
(define-fun l ((x (_ BitVec 20))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 20)) (bvsgt s t)) (=> (bvslt s (_ bv0 20)) (bvsgt (bvlshr s (_ bv1 20)) t))))
