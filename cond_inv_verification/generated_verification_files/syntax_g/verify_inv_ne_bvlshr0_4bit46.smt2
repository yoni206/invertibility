...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvshl #b1000000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 46))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 46)) (bvult s (_ bv46 46))))
