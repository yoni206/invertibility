...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvshl #b10000000000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 50))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 50)) (bvult s (_ bv50 50))))
