...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvlshr s (bvlshr #b011111111111111111 (bvsub #b100000000000000000 #b011111111111111111))))
(define-fun l ((x (_ BitVec 18))) Bool  (bvsge (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 18)) (bvsge (bvlshr s (_ bv1 18)) t)) (=> (bvsge s (_ bv0 18)) (bvsge s t))))
