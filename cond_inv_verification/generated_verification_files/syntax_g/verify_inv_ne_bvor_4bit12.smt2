...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvnot t))
(define-fun l ((x (_ BitVec 12))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 12))) (distinct t (bvnot (_ bv0 12)))))
