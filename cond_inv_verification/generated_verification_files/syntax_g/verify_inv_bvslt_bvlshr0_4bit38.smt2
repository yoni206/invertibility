...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvshl #b10000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 38))) Bool  (bvslt (bvlshr (inv s t) s) t))
