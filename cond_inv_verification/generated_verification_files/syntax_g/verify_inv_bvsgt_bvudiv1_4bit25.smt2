...
(define-fun l ((x (_ BitVec 25))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 25)) (bvsgt s t)) (=> (bvslt s (_ bv0 25)) (bvsgt (bvlshr s (_ bv1 25)) t))))
