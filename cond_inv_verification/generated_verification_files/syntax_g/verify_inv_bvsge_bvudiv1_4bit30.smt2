...
(define-fun l ((x (_ BitVec 30))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 30)) (bvsge s t)) (=> (bvslt s (_ bv0 30)) (bvsge (bvlshr s (_ bv1 30)) t))))
