...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvshl #b011111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 30))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 30)) (distinct s (_ bv0 30))))
