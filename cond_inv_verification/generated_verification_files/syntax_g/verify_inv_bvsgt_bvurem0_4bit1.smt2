...
(define-fun inv ((s (_ BitVec 1)) (t (_ BitVec 1))) (_ BitVec 1) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 1))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 1)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 1)) (distinct t max))) (or (distinct t (_ bv0 1)) (distinct s (_ bv1 1)))))
