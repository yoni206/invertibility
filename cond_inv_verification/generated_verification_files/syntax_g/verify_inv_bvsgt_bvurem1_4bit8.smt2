...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvsub (bvor s #b10000000) (bvand #b01111111 (bvsub t #b01111111))))
(define-fun l ((x (_ BitVec 8))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 8)) (bvsgt s t)) (=> (bvslt s (_ bv0 8)) (bvsgt (bvlshr (bvsub s (_ bv1 8)) (_ bv1 8)) t))))
