...
(define-fun inv ((s (_ BitVec 59)) (t (_ BitVec 59))) (_ BitVec 59) (bvshl #b01111111111111111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 59))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 59)) (distinct s (_ bv0 59))))
