...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvlshr t s))
(define-fun l ((x (_ BitVec 35))) Bool  (bvsle (bvshl (inv s t) s) t))
(define-fun SC () Bool (bvult (bvlshr t (bvlshr t s)) min))
