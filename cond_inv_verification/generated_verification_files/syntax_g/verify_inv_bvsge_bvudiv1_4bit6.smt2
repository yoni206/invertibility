...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvneg (bvnot (bvlshr s (bvlshr #b011111 (bvsub #b100000 #b011111))))))
(define-fun l ((x (_ BitVec 6))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 6)) (bvsge s t)) (=> (bvslt s (_ bv0 6)) (bvsge (bvlshr s (_ bv1 6)) t))))
