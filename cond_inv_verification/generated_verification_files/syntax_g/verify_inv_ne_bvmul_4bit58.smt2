...
(define-fun inv ((s (_ BitVec 58)) (t (_ BitVec 58))) (_ BitVec 58) (bvshl #b0111111111111111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 58))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 58)) (distinct s (_ bv0 58))))
