...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvlshr #b10000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 41))) Bool  (bvslt (bvshl (inv s t) s) t))
