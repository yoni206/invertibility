...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvand s #b1000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 37))) Bool  (bvsgt (bvashr s (inv s t)) t))
