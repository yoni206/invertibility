...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvshl #b0111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 46))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 46)) (distinct s (_ bv0 46))))
