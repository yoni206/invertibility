...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvand t #b10000000000))
(define-fun l ((x (_ BitVec 11))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 11)) (bvand (bvneg s) t)))
