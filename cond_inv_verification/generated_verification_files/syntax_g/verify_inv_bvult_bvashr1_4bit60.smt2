...
(define-fun inv ((s (_ BitVec 60)) (t (_ BitVec 60))) (_ BitVec 60) (bvnot (bvor s #b011111111111111111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 60))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 60)))) (not (= t (_ bv0 60)))))
