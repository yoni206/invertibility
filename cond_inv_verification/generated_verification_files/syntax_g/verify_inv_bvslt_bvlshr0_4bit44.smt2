...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvshl #b10000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 44))) Bool  (bvslt (bvlshr (inv s t) s) t))
