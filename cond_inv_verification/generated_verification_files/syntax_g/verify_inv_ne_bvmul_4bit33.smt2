...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvshl #b011111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 33))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 33)) (distinct s (_ bv0 33))))
