...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) #b000000000000)
(define-fun l ((x (_ BitVec 12))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 12) s) (bvult (_ bv0 12) t)))
