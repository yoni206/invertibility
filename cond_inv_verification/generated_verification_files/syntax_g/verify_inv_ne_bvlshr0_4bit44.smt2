...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvshl #b10000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 44))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 44)) (bvult s (_ bv44 44))))
