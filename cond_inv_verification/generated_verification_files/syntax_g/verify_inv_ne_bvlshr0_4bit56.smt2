...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) (bvshl #b10000000000000000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 56))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 56)) (bvult s (_ bv56 56))))
