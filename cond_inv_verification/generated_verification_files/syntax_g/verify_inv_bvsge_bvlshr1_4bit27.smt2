...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvlshr s (bvlshr #b011111111111111111111111111 (bvsub #b100000000000000000000000000 #b011111111111111111111111111))))
(define-fun l ((x (_ BitVec 27))) Bool  (bvsge (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 27)) (bvsge (bvlshr s (_ bv1 27)) t)) (=> (bvsge s (_ bv0 27)) (bvsge s t))))
