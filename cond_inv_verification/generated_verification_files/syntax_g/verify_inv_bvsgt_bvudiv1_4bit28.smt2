...
(define-fun l ((x (_ BitVec 28))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 28)) (bvsgt s t)) (=> (bvslt s (_ bv0 28)) (bvsgt (bvlshr s (_ bv1 28)) t))))
