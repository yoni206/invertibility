...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvshl #b100000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 45))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 45)) (bvult s (_ bv45 45))))
