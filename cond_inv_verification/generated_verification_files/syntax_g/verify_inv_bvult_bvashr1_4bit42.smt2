...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvnot (bvor s #b011111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 42))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 42)))) (not (= t (_ bv0 42)))))
