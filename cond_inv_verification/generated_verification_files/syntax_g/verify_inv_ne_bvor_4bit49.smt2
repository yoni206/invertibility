...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvnot t))
(define-fun l ((x (_ BitVec 49))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 49))) (distinct t (bvnot (_ bv0 49)))))
