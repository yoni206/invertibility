...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 41))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 41)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 41)) (distinct t max))) (or (distinct t (_ bv0 41)) (distinct s (_ bv1 41)))))
