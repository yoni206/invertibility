...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) (bvlshr #b01111111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 56))) Bool  (bvsge (bvshl (inv s t) s) t))
