...
(define-fun l ((x (_ BitVec 32))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 32)) (bvsgt s t)) (=> (bvslt s (_ bv0 32)) (bvsgt (bvlshr s (_ bv1 32)) t))))
