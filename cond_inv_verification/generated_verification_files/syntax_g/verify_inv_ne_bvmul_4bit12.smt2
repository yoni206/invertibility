...
(define-fun inv ((s (_ BitVec 12)) (t (_ BitVec 12))) (_ BitVec 12) (bvshl #b011111111111 t))
(define-fun l ((x (_ BitVec 12))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 12)) (distinct s (_ bv0 12))))
