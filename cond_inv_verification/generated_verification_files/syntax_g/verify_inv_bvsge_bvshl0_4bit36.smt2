...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvlshr #b011111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 36))) Bool  (bvsge (bvshl (inv s t) s) t))
