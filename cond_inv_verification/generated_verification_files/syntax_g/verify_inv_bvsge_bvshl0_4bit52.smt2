...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvlshr #b0111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 52))) Bool  (bvsge (bvshl (inv s t) s) t))
