...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) #b00000000000000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 56))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 56) s) (bvult (_ bv0 56) t)))
