...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvsub (bvor s #b1000000000000000000000000000000000000000000) (bvand t #b0111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 43))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 43)) (bvsge s t)) (=> (and (bvslt s (_ bv0 43)) (bvsge t (_ bv0 43))) (bvugt (bvsub s t) t))))
