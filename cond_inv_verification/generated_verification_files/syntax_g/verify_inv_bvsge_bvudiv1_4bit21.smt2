...
(define-fun l ((x (_ BitVec 21))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 21)) (bvsge s t)) (=> (bvslt s (_ bv0 21)) (bvsge (bvlshr s (_ bv1 21)) t))))
