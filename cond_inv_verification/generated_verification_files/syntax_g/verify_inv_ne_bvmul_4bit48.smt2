...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvshl #b011111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 48))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 48)) (distinct s (_ bv0 48))))
