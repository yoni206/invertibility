...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) #b0000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 46))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 46) s) (bvult (_ bv0 46) t)))
