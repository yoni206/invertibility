...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvshl #b1000000000000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 52))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 52)) (bvult s (_ bv52 52))))
