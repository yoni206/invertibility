...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvshl #b100000000000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 51))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 51)) (bvult s (_ bv51 51))))
