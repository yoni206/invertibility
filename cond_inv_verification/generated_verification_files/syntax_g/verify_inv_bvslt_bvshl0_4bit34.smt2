...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvlshr #b1000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 34))) Bool  (bvslt (bvshl (inv s t) s) t))
