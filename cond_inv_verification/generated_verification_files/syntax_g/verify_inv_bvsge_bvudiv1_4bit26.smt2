...
(define-fun l ((x (_ BitVec 26))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 26)) (bvsge s t)) (=> (bvslt s (_ bv0 26)) (bvsge (bvlshr s (_ bv1 26)) t))))
