...
(define-fun inv ((s (_ BitVec 57)) (t (_ BitVec 57))) (_ BitVec 57) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 57))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 57)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 57)) (distinct t max))) (or (distinct t (_ bv0 57)) (distinct s (_ bv1 57)))))
