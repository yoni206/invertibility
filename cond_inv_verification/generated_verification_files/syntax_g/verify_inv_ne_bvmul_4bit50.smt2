...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvshl #b01111111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 50))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 50)) (distinct s (_ bv0 50))))
