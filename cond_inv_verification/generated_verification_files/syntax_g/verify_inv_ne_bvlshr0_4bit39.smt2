...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvshl #b100000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 39))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 39)) (bvult s (_ bv39 39))))
