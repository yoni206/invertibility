...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvnot #b00000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 47))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 47) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 47) t)))
