...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvshl #b011111111111111111111 t))
(define-fun l ((x (_ BitVec 21))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 21)) (distinct s (_ bv0 21))))
