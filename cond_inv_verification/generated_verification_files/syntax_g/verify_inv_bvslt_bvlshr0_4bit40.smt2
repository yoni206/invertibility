...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvshl #b1000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 40))) Bool  (bvslt (bvlshr (inv s t) s) t))
