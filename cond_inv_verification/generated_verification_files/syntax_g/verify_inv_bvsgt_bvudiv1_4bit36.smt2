...
(define-fun l ((x (_ BitVec 36))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 36)) (bvsgt s t)) (=> (bvslt s (_ bv0 36)) (bvsgt (bvlshr s (_ bv1 36)) t))))
