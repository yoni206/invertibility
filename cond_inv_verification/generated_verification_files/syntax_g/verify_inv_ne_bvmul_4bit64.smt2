...
(define-fun inv ((s (_ BitVec 64)) (t (_ BitVec 64))) (_ BitVec 64) (bvshl #b0111111111111111111111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 64))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 64)) (distinct s (_ bv0 64))))
