...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvlshr #b01111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 53))) Bool  (bvsge (bvshl (inv s t) s) t))
