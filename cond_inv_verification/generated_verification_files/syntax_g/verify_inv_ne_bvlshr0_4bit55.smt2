...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvshl #b1000000000000000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 55))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 55)) (bvult s (_ bv55 55))))
