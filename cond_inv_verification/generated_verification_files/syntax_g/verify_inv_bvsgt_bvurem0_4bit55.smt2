...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 55))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 55)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 55)) (distinct t max))) (or (distinct t (_ bv0 55)) (distinct s (_ bv1 55)))))
