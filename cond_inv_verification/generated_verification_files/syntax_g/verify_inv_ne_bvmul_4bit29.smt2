...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvshl #b01111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 29))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 29)) (distinct s (_ bv0 29))))
