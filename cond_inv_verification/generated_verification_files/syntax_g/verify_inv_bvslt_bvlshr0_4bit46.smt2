...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvshl #b1000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 46))) Bool  (bvslt (bvlshr (inv s t) s) t))
