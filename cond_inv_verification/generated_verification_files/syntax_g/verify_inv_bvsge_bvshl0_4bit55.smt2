...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvlshr #b0111111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 55))) Bool  (bvsge (bvshl (inv s t) s) t))
