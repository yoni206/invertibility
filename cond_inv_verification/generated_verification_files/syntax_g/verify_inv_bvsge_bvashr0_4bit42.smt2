...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) #b011111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 42))) Bool  (bvsge (bvashr (inv s t) s) t))
