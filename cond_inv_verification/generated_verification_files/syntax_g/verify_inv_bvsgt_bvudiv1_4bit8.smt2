...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvneg (bvnot (bvlshr s (bvlshr #b01111111 (bvsub #b10000000 #b01111111))))))
(define-fun l ((x (_ BitVec 8))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 8)) (bvsgt s t)) (=> (bvslt s (_ bv0 8)) (bvsgt (bvlshr s (_ bv1 8)) t))))
