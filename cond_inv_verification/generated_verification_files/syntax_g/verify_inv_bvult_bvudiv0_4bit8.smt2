...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) #b00000000)
(define-fun l ((x (_ BitVec 8))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 8) s) (bvult (_ bv0 8) t)))
