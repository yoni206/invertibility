...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvshl #b10000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 47))) Bool  (bvslt (bvlshr (inv s t) s) t))
