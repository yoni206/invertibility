...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) #b0000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 37))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 37) s) (bvult (_ bv0 37) t)))
