...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvlshr #b0111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 37))) Bool  (bvsge (bvshl (inv s t) s) t))
