...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) #b011111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 39))) Bool  (bvsgt (bvashr (inv s t) s) t))
