...
(define-fun inv ((s (_ BitVec 58)) (t (_ BitVec 58))) (_ BitVec 58) (bvlshr #b0111111111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 58))) Bool  (bvsge (bvshl (inv s t) s) t))
