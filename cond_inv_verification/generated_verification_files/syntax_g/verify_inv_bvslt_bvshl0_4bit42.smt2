...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvlshr #b100000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 42))) Bool  (bvslt (bvshl (inv s t) s) t))
