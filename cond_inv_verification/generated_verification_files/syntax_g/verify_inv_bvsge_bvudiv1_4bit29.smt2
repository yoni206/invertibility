...
(define-fun l ((x (_ BitVec 29))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 29)) (bvsge s t)) (=> (bvslt s (_ bv0 29)) (bvsge (bvlshr s (_ bv1 29)) t))))
