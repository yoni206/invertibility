...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvlshr #b100000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 51))) Bool  (bvslt (bvshl (inv s t) s) t))
