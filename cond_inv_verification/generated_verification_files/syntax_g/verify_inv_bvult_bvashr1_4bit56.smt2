...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) (bvnot (bvor s #b01111111111111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 56))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 56)))) (not (= t (_ bv0 56)))))
