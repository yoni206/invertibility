...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvshl #b01111 t))
(define-fun l ((x (_ BitVec 5))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 5)) (distinct s (_ bv0 5))))
