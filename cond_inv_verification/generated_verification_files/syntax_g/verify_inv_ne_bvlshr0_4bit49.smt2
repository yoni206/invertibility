...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvshl #b1000000000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 49))) Bool  (distinct (bvlshr (inv s t) s) t))
