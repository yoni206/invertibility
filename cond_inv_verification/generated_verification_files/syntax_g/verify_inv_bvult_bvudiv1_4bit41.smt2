...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvnot #b00000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 41))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 41) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 41) t)))
