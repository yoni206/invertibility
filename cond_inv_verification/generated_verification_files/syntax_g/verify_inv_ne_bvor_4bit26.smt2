...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvnot t))
(define-fun l ((x (_ BitVec 26))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 26))) (distinct t (bvnot (_ bv0 26)))))
