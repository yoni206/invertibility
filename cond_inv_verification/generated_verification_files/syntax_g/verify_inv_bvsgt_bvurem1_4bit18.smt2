...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvsub (bvor s #b100000000000000000) (bvand #b011111111111111111 (bvsub t #b011111111111111111))))
(define-fun l ((x (_ BitVec 18))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 18)) (bvsgt s t)) (=> (bvslt s (_ bv0 18)) (bvsgt (bvlshr (bvsub s (_ bv1 18)) (_ bv1 18)) t))))
