...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvsub (bvor s #b1000000000000000) (bvand t #b0111111111111111)))
(define-fun l ((x (_ BitVec 16))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 16)) (bvsge s t)) (=> (and (bvslt s (_ bv0 16)) (bvsge t (_ bv0 16))) (bvugt (bvsub s t) t))))
