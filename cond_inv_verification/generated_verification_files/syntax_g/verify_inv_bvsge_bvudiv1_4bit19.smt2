...
(define-fun l ((x (_ BitVec 19))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 19)) (bvsge s t)) (=> (bvslt s (_ bv0 19)) (bvsge (bvlshr s (_ bv1 19)) t))))
