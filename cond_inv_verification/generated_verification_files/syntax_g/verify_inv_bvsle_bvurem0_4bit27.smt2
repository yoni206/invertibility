...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvand t #b100000000000000000000000000))
(define-fun l ((x (_ BitVec 27))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 27)) (bvand (bvneg s) t)))
