...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvshl #b0111111111111 t))
(define-fun l ((x (_ BitVec 13))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 13)) (distinct s (_ bv0 13))))
