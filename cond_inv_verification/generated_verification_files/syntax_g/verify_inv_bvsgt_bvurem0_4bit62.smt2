...
(define-fun l ((x (_ BitVec 62))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 62)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 62)) (distinct t max))) (or (distinct t (_ bv0 62)) (distinct s (_ bv1 62)))))
