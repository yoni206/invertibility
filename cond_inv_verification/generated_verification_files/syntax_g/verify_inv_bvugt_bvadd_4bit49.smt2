...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvnot s))
(define-fun l ((x (_ BitVec 49))) Bool  (bvugt (bvadd (inv s t) s) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 49))))
