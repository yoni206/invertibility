...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvnot t))
(define-fun l ((x (_ BitVec 7))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 7))) (distinct t (bvnot (_ bv0 7)))))
