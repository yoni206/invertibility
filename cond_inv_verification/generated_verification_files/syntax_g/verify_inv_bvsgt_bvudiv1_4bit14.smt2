...
(define-fun l ((x (_ BitVec 14))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 14)) (bvsgt s t)) (=> (bvslt s (_ bv0 14)) (bvsgt (bvlshr s (_ bv1 14)) t))))
