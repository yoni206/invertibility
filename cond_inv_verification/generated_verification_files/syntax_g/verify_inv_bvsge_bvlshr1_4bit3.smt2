...
(define-fun inv ((s (_ BitVec 3)) (t (_ BitVec 3))) (_ BitVec 3) (bvlshr s (bvlshr #b011 (bvsub #b100 #b011))))
(define-fun l ((x (_ BitVec 3))) Bool  (bvsge (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 3)) (bvsge (bvlshr s (_ bv1 3)) t)) (=> (bvsge s (_ bv0 3)) (bvsge s t))))
