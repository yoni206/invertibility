...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvand t #b100000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 42))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 42)) (bvand (bvneg s) t)))
