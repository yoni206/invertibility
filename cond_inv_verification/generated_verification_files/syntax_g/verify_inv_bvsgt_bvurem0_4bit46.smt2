...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 46))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 46)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 46)) (distinct t max))) (or (distinct t (_ bv0 46)) (distinct s (_ bv1 46)))))
