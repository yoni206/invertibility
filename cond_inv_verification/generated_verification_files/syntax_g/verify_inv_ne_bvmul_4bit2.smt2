...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvshl #b01 t))
(define-fun l ((x (_ BitVec 2))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 2)) (distinct s (_ bv0 2))))
