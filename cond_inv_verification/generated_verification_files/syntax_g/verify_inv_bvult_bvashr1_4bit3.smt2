...
(define-fun inv ((s (_ BitVec 3)) (t (_ BitVec 3))) (_ BitVec 3) (bvnot (bvor s #b011)))
(define-fun l ((x (_ BitVec 3))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 3)))) (not (= t (_ bv0 3)))))
