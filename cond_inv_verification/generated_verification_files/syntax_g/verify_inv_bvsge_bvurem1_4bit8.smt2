...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvsub (bvor s #b10000000) (bvand t #b01111111)))
(define-fun l ((x (_ BitVec 8))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 8)) (bvsge s t)) (=> (and (bvslt s (_ bv0 8)) (bvsge t (_ bv0 8))) (bvugt (bvsub s t) t))))
