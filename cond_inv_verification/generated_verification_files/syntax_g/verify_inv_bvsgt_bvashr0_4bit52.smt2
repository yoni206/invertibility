...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) #b0111111111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 52))) Bool  (bvsgt (bvashr (inv s t) s) t))
