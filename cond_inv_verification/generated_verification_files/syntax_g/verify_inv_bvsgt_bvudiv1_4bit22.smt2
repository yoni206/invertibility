...
(define-fun l ((x (_ BitVec 22))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 22)) (bvsgt s t)) (=> (bvslt s (_ bv0 22)) (bvsgt (bvlshr s (_ bv1 22)) t))))
