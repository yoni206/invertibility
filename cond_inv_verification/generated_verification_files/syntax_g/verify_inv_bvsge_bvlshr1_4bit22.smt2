...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvlshr s (bvlshr #b0111111111111111111111 (bvsub #b1000000000000000000000 #b0111111111111111111111))))
(define-fun l ((x (_ BitVec 22))) Bool  (bvsge (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 22)) (bvsge (bvlshr s (_ bv1 22)) t)) (=> (bvsge s (_ bv0 22)) (bvsge s t))))
