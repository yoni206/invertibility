...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvnot #b0000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 46))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 46) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 46) t)))
