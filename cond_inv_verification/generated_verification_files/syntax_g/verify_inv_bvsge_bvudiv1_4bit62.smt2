...
(define-fun l ((x (_ BitVec 62))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 62)) (bvsge s t)) (=> (bvslt s (_ bv0 62)) (bvsge (bvlshr s (_ bv1 62)) t))))
