...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvand t #b10000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 44))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 44)) (bvand (bvneg s) t)))
