...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvshl #b100000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 33))) Bool  (bvslt (bvlshr (inv s t) s) t))
