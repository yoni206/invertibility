...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvneg (bvnot (bvlshr s (bvlshr #b011111111111111 (bvsub #b100000000000000 #b011111111111111))))))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 15)) (bvsgt s t)) (=> (bvslt s (_ bv0 15)) (bvsgt (bvlshr s (_ bv1 15)) t))))
