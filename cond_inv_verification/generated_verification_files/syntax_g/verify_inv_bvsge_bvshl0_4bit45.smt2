...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvlshr #b011111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 45))) Bool  (bvsge (bvshl (inv s t) s) t))
