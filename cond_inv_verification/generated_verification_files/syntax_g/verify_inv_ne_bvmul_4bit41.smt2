...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvshl #b01111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 41))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 41)) (distinct s (_ bv0 41))))
