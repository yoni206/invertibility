...
(define-fun inv ((s (_ BitVec 3)) (t (_ BitVec 3))) (_ BitVec 3) (bvsub (bvor s #b100) (bvand #b011 (bvsub t #b011))))
(define-fun l ((x (_ BitVec 3))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 3)) (bvsgt s t)) (=> (bvslt s (_ bv0 3)) (bvsgt (bvlshr (bvsub s (_ bv1 3)) (_ bv1 3)) t))))
