...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvsub (bvor s #b100000000000000000000000000) (bvand #b011111111111111111111111111 (bvsub t #b011111111111111111111111111))))
(define-fun l ((x (_ BitVec 27))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 27)) (bvsgt s t)) (=> (bvslt s (_ bv0 27)) (bvsgt (bvlshr (bvsub s (_ bv1 27)) (_ bv1 27)) t))))
