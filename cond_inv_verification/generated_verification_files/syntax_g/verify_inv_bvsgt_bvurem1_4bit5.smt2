...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvsub (bvor s #b10000) (bvand #b01111 (bvsub t #b01111))))
(define-fun l ((x (_ BitVec 5))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 5)) (bvsgt s t)) (=> (bvslt s (_ bv0 5)) (bvsgt (bvlshr (bvsub s (_ bv1 5)) (_ bv1 5)) t))))
