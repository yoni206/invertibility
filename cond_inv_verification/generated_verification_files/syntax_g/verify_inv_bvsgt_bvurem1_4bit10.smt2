...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvsub (bvor s #b1000000000) (bvand #b0111111111 (bvsub t #b0111111111))))
(define-fun l ((x (_ BitVec 10))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 10)) (bvsgt s t)) (=> (bvslt s (_ bv0 10)) (bvsgt (bvlshr (bvsub s (_ bv1 10)) (_ bv1 10)) t))))
