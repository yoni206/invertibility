...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) #b0111111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 49))) Bool  (bvsge (bvashr (inv s t) s) t))
