...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvsub (bvor s #b10000000000000000000000000000000000000000) (bvand t #b01111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 41))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 41)) (bvsge s t)) (=> (and (bvslt s (_ bv0 41)) (bvsge t (_ bv0 41))) (bvugt (bvsub s t) t))))
