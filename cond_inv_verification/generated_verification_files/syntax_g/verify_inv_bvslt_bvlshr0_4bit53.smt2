...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvshl #b10000000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 53))) Bool  (bvslt (bvlshr (inv s t) s) t))
