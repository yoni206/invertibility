...
(define-fun inv ((s (_ BitVec 62)) (t (_ BitVec 62))) (_ BitVec 62) (bvnot s))
(define-fun l ((x (_ BitVec 62))) Bool  (bvugt (bvadd (inv s t) s) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 62))))
