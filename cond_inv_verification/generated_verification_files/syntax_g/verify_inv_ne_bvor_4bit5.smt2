...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvnot t))
(define-fun l ((x (_ BitVec 5))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 5))) (distinct t (bvnot (_ bv0 5)))))
