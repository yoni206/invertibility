...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvlshr #b0111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 34))) Bool  (bvsge (bvshl (inv s t) s) t))
