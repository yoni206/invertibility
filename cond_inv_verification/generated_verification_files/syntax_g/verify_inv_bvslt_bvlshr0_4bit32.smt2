...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvshl #b10000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 32))) Bool  (bvslt (bvlshr (inv s t) s) t))
