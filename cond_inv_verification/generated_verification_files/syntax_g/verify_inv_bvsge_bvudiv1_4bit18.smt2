...
(define-fun l ((x (_ BitVec 18))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 18)) (bvsge s t)) (=> (bvslt s (_ bv0 18)) (bvsge (bvlshr s (_ bv1 18)) t))))
