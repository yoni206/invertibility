...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvand t #b100000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 51))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 51)) (bvand (bvneg s) t)))
