...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvnot #b0000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 34))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 34) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 34) t)))
