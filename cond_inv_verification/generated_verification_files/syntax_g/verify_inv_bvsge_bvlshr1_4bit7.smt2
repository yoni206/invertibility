...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvlshr s (bvlshr #b0111111 (bvsub #b1000000 #b0111111))))
(define-fun l ((x (_ BitVec 7))) Bool  (bvsge (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 7)) (bvsge (bvlshr s (_ bv1 7)) t)) (=> (bvsge s (_ bv0 7)) (bvsge s t))))
