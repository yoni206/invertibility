...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvlshr #b1000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 37))) Bool  (bvslt (bvshl (inv s t) s) t))
