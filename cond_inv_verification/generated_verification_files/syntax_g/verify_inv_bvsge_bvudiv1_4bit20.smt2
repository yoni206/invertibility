...
(define-fun l ((x (_ BitVec 20))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 20)) (bvsge s t)) (=> (bvslt s (_ bv0 20)) (bvsge (bvlshr s (_ bv1 20)) t))))
