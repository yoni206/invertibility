...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvsub (bvor s #b100000000000000000000000000000000000000) (bvand t #b011111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 39))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 39)) (bvsge s t)) (=> (and (bvslt s (_ bv0 39)) (bvsge t (_ bv0 39))) (bvugt (bvsub s t) t))))
