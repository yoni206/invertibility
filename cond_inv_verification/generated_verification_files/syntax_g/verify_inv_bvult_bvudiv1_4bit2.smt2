...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvnot #b00))
(define-fun l ((x (_ BitVec 2))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 2) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 2) t)))
