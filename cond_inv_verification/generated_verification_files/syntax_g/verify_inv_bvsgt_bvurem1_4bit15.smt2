...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvsub (bvor s #b100000000000000) (bvand #b011111111111111 (bvsub t #b011111111111111))))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 15)) (bvsgt s t)) (=> (bvslt s (_ bv0 15)) (bvsgt (bvlshr (bvsub s (_ bv1 15)) (_ bv1 15)) t))))
