...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvand s #b1000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 40))) Bool  (bvugt (bvashr s (inv s t)) t))
