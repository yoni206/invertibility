...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvlshr #b10000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 38))) Bool  (bvslt (bvshl (inv s t) s) t))
