...
(define-fun l ((x (_ BitVec 56))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 56)) (bvsge s t)) (=> (bvslt s (_ bv0 56)) (bvsge (bvlshr s (_ bv1 56)) t))))
