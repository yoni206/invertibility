...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvshl #b0111111111111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 55))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 55)) (distinct s (_ bv0 55))))
