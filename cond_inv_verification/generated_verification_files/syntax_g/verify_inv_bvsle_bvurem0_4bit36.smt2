...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvand t #b100000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 36))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 36)) (bvand (bvneg s) t)))
