...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvlshr #b1000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 49))) Bool  (bvslt (bvshl (inv s t) s) t))
