...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvlshr #b01111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 44))) Bool  (bvsge (bvshl (inv s t) s) t))
