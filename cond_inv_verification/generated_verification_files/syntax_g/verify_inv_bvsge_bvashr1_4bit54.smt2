...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) (bvand s #b100000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 54))) Bool  (bvsge (bvashr s (inv s t)) t))
