...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) #b000000000000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 54))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 54) s) (bvult (_ bv0 54) t)))
