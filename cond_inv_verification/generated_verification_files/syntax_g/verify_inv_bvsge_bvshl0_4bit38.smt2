...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvlshr #b01111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 38))) Bool  (bvsge (bvshl (inv s t) s) t))
