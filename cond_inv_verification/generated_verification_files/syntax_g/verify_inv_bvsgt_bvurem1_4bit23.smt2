...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvsub (bvor s #b10000000000000000000000) (bvand #b01111111111111111111111 (bvsub t #b01111111111111111111111))))
(define-fun l ((x (_ BitVec 23))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 23)) (bvsgt s t)) (=> (bvslt s (_ bv0 23)) (bvsgt (bvlshr (bvsub s (_ bv1 23)) (_ bv1 23)) t))))
