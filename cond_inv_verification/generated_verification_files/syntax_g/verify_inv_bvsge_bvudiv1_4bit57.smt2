...
(define-fun l ((x (_ BitVec 57))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 57)) (bvsge s t)) (=> (bvslt s (_ bv0 57)) (bvsge (bvlshr s (_ bv1 57)) t))))
