...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvshl #b100000000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 48))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 48)) (bvult s (_ bv48 48))))
