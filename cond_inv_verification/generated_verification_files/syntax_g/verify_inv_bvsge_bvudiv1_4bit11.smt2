...
(define-fun l ((x (_ BitVec 11))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 11)) (bvsge s t)) (=> (bvslt s (_ bv0 11)) (bvsge (bvlshr s (_ bv1 11)) t))))
