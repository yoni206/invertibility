...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvshl #b1000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 37))) Bool  (bvslt (bvlshr (inv s t) s) t))
