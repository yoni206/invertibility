...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvlshr #b01111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 47))) Bool  (bvsge (bvshl (inv s t) s) t))
