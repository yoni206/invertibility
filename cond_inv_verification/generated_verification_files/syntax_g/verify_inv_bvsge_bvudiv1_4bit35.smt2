...
(define-fun l ((x (_ BitVec 35))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 35)) (bvsge s t)) (=> (bvslt s (_ bv0 35)) (bvsge (bvlshr s (_ bv1 35)) t))))
