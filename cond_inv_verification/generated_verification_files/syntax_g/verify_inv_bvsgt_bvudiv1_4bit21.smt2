...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvneg (bvnot (bvlshr s (bvlshr #b011111111111111111111 (bvsub #b100000000000000000000 #b011111111111111111111))))))
(define-fun l ((x (_ BitVec 21))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 21)) (bvsgt s t)) (=> (bvslt s (_ bv0 21)) (bvsgt (bvlshr s (_ bv1 21)) t))))
