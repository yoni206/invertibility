...
(define-fun inv ((s (_ BitVec 63)) (t (_ BitVec 63))) (_ BitVec 63) (bvshl #b011111111111111111111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 63))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 63)) (distinct s (_ bv0 63))))
