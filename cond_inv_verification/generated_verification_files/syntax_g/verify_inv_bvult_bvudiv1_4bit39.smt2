...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvnot #b000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 39))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 39) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 39) t)))
