...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvshl #b1000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 43))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 43)) (bvult s (_ bv43 43))))
