...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvshl #b0111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 40))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 40)) (distinct s (_ bv0 40))))
