...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvlshr #b1000000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 52))) Bool  (bvslt (bvshl (inv s t) s) t))
