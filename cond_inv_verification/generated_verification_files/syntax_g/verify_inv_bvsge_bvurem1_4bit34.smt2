...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvsub (bvor s #b1000000000000000000000000000000000) (bvand t #b0111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 34))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 34)) (bvsge s t)) (=> (and (bvslt s (_ bv0 34)) (bvsge t (_ bv0 34))) (bvugt (bvsub s t) t))))
