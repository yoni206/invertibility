...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvshl #b011111111111111111111111111 t))
(define-fun l ((x (_ BitVec 27))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 27)) (distinct s (_ bv0 27))))
