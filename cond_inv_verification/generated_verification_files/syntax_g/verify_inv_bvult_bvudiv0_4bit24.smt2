...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) #b000000000000000000000000)
(define-fun l ((x (_ BitVec 24))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 24) s) (bvult (_ bv0 24) t)))
