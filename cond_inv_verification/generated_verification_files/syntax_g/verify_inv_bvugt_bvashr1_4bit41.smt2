...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvand s #b10000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 41))) Bool  (bvugt (bvashr s (inv s t)) t))
