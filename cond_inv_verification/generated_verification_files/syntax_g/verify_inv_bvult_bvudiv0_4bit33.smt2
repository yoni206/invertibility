...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) #b000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 33))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 33) s) (bvult (_ bv0 33) t)))
