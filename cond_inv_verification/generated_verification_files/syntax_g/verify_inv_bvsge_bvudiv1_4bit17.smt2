...
(define-fun l ((x (_ BitVec 17))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 17)) (bvsge s t)) (=> (bvslt s (_ bv0 17)) (bvsge (bvlshr s (_ bv1 17)) t))))
