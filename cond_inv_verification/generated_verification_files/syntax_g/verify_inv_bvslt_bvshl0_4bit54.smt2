...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) (bvlshr #b100000000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 54))) Bool  (bvslt (bvshl (inv s t) s) t))
