...
(define-fun l ((x (_ BitVec 15))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 15)) (bvsge s t)) (=> (bvslt s (_ bv0 15)) (bvsge (bvlshr s (_ bv1 15)) t))))
