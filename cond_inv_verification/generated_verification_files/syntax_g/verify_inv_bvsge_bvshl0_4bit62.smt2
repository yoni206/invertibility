...
(define-fun inv ((s (_ BitVec 62)) (t (_ BitVec 62))) (_ BitVec 62) (bvlshr #b01111111111111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 62))) Bool  (bvsge (bvshl (inv s t) s) t))
