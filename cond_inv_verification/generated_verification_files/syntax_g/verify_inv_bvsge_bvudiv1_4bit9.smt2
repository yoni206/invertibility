...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvneg (bvnot (bvlshr s (bvlshr #b011111111 (bvsub #b100000000 #b011111111))))))
(define-fun l ((x (_ BitVec 9))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 9)) (bvsge s t)) (=> (bvslt s (_ bv0 9)) (bvsge (bvlshr s (_ bv1 9)) t))))
