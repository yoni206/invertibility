...
(define-fun l ((x (_ BitVec 41))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 41)) (bvsge s t)) (=> (bvslt s (_ bv0 41)) (bvsge (bvlshr s (_ bv1 41)) t))))
