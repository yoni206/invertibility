...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvsub (bvor s #b1000000000000000000000000000000000000000) (bvand t #b0111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 40))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 40)) (bvsge s t)) (=> (and (bvslt s (_ bv0 40)) (bvsge t (_ bv0 40))) (bvugt (bvsub s t) t))))
