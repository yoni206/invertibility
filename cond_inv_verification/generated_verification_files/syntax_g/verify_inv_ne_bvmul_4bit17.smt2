...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvshl #b01111111111111111 t))
(define-fun l ((x (_ BitVec 17))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 17)) (distinct s (_ bv0 17))))
