...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvlshr #b01111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 50))) Bool  (bvsge (bvshl (inv s t) s) t))
