...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvand t #b100000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 39))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 39)) (bvand (bvneg s) t)))
