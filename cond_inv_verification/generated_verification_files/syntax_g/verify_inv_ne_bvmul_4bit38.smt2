...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvshl #b01111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 38))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 38)) (distinct s (_ bv0 38))))
