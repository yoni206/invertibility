...
(define-fun inv ((s (_ BitVec 1)) (t (_ BitVec 1))) (_ BitVec 1) (bvneg (bvnot (bvlshr s (bvlshr #b0 (bvsub #b1 #b0))))))
(define-fun l ((x (_ BitVec 1))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 1)) (bvsge s t)) (=> (bvslt s (_ bv0 1)) (bvsge (bvlshr s (_ bv1 1)) t))))
