...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvlshr #b1000000000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 55))) Bool  (bvslt (bvshl (inv s t) s) t))
