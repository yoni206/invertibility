...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvshl #b10000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 41))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 41)) (bvult s (_ bv41 41))))
