...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 36))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 36)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 36)) (distinct t max))) (or (distinct t (_ bv0 36)) (distinct s (_ bv1 36)))))
