...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvnot #b00000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 38))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 38) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 38) t)))
