...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvshl #b1000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 34))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 34)) (bvult s (_ bv34 34))))
