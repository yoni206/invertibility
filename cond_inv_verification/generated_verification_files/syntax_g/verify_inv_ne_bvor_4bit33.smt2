...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvnot t))
(define-fun l ((x (_ BitVec 33))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 33))) (distinct t (bvnot (_ bv0 33)))))
