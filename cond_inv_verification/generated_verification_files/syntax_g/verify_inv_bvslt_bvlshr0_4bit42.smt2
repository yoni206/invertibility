...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvshl #b100000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 42))) Bool  (bvslt (bvlshr (inv s t) s) t))
