...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvsub (bvor s #b10) (bvand #b01 (bvsub t #b01))))
(define-fun l ((x (_ BitVec 2))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 2)) (bvsgt s t)) (=> (bvslt s (_ bv0 2)) (bvsgt (bvlshr (bvsub s (_ bv1 2)) (_ bv1 2)) t))))
