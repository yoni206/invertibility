...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvshl #b01111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 47))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 47)) (distinct s (_ bv0 47))))
