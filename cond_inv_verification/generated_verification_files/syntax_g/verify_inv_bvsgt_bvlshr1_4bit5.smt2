...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvlshr s (bvlshr #b01111 (bvsub #b10000 #b01111))))
(define-fun l ((x (_ BitVec 5))) Bool  (bvsgt (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 5)) (bvsgt (bvlshr s (_ bv1 5)) t)) (=> (bvsge s (_ bv0 5)) (bvsgt s t))))
