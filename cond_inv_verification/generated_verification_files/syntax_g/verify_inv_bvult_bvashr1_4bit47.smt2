...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvnot (bvor s #b01111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 47))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 47)))) (not (= t (_ bv0 47)))))
