...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvneg (bvnot (bvlshr s (bvlshr #b01 (bvsub #b10 #b01))))))
(define-fun l ((x (_ BitVec 2))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 2)) (bvsge s t)) (=> (bvslt s (_ bv0 2)) (bvsge (bvlshr s (_ bv1 2)) t))))
