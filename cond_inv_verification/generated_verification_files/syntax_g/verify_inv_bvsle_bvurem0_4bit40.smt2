...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvand t #b1000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 40))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 40)) (bvand (bvneg s) t)))
