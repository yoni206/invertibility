...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvnot t))
(define-fun l ((x (_ BitVec 29))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 29))) (distinct t (bvnot (_ bv0 29)))))
