...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvlshr s (bvlshr #b0111111111111111111111111111111111 (bvsub #b1000000000000000000000000000000000 #b0111111111111111111111111111111111))))
(define-fun l ((x (_ BitVec 34))) Bool  (bvsge (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 34)) (bvsge (bvlshr s (_ bv1 34)) t)) (=> (bvsge s (_ bv0 34)) (bvsge s t))))
