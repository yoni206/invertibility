...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvshl #b011111111111111 t))
(define-fun l ((x (_ BitVec 15))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 15)) (distinct s (_ bv0 15))))
