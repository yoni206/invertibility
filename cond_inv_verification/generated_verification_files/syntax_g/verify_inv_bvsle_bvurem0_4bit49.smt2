...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvand t #b1000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 49))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 49)) (bvand (bvneg s) t)))
