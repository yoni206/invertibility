...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvsub (bvor s #b10) (bvand t #b01)))
(define-fun l ((x (_ BitVec 2))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 2)) (bvsge s t)) (=> (and (bvslt s (_ bv0 2)) (bvsge t (_ bv0 2))) (bvugt (bvsub s t) t))))
