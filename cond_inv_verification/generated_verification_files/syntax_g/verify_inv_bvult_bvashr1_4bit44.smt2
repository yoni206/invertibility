...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvnot (bvor s #b01111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 44))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 44)))) (not (= t (_ bv0 44)))))
