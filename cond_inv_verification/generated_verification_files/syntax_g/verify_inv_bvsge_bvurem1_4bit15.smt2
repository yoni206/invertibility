...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvsub (bvor s #b100000000000000) (bvand t #b011111111111111)))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 15)) (bvsge s t)) (=> (and (bvslt s (_ bv0 15)) (bvsge t (_ bv0 15))) (bvugt (bvsub s t) t))))
