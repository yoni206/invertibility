...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvnot t))
(define-fun l ((x (_ BitVec 14))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 14))) (distinct t (bvnot (_ bv0 14)))))
