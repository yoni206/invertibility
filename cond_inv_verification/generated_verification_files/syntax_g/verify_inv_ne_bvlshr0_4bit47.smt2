...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvshl #b10000000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 47))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 47)) (bvult s (_ bv47 47))))
