...
(define-fun l ((x (_ BitVec 64))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 64)) (bvsgt s t)) (=> (bvslt s (_ bv0 64)) (bvsgt (bvlshr s (_ bv1 64)) t))))
