...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvlshr s t))
(define-fun l ((x (_ BitVec 37))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 37)) (distinct t (bvnot (_ bv0 37)))))
