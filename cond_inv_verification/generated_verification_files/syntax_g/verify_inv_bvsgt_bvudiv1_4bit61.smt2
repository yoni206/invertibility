...
(define-fun l ((x (_ BitVec 61))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 61)) (bvsgt s t)) (=> (bvslt s (_ bv0 61)) (bvsgt (bvlshr s (_ bv1 61)) t))))
