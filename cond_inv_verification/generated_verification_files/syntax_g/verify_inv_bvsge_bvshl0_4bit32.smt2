...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvlshr #b01111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 32))) Bool  (bvsge (bvshl (inv s t) s) t))
