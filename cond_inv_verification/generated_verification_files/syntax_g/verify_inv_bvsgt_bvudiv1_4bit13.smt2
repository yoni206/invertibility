...
(define-fun l ((x (_ BitVec 13))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 13)) (bvsgt s t)) (=> (bvslt s (_ bv0 13)) (bvsgt (bvlshr s (_ bv1 13)) t))))
