...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvsub (bvor s #b100000) (bvand t #b011111)))
(define-fun l ((x (_ BitVec 6))) Bool  (bvsge (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 6)) (bvsge s t)) (=> (and (bvslt s (_ bv0 6)) (bvsge t (_ bv0 6))) (bvugt (bvsub s t) t))))
