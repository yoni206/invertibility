...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) (bvnot t))
(define-fun l ((x (_ BitVec 11))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 11))) (distinct t (bvnot (_ bv0 11)))))
