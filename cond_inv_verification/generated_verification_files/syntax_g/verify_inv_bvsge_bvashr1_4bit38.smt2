...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvand s #b10000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 38))) Bool  (bvsge (bvashr s (inv s t)) t))
