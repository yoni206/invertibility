...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvshl #b01111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 35))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 35)) (distinct s (_ bv0 35))))
