...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvnot #b000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 51))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 51) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 51) t)))
