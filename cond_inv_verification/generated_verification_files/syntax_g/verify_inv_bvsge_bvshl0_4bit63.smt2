...
(define-fun inv ((s (_ BitVec 63)) (t (_ BitVec 63))) (_ BitVec 63) (bvlshr #b011111111111111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 63))) Bool  (bvsge (bvshl (inv s t) s) t))
