...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvlshr #b0111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 49))) Bool  (bvsge (bvshl (inv s t) s) t))
