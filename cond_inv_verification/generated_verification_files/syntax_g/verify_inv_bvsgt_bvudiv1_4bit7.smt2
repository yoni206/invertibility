...
(define-fun inv ((s (_ BitVec 7)) (t (_ BitVec 7))) (_ BitVec 7) (bvneg (bvnot (bvlshr s (bvlshr #b0111111 (bvsub #b1000000 #b0111111))))))
(define-fun l ((x (_ BitVec 7))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 7)) (bvsgt s t)) (=> (bvslt s (_ bv0 7)) (bvsgt (bvlshr s (_ bv1 7)) t))))
