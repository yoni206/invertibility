...
(define-fun l ((x (_ BitVec 24))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 24)) (bvsgt s t)) (=> (bvslt s (_ bv0 24)) (bvsgt (bvlshr s (_ bv1 24)) t))))
