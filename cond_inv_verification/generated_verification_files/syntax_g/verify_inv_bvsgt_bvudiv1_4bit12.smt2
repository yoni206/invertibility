...
(define-fun l ((x (_ BitVec 12))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 12)) (bvsgt s t)) (=> (bvslt s (_ bv0 12)) (bvsgt (bvlshr s (_ bv1 12)) t))))
