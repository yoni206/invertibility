...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvand s #b10000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 47))) Bool  (bvuge (bvashr s (inv s t)) t))
