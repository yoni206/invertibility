...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvlshr #b011111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 39))) Bool  (bvsge (bvshl (inv s t) s) t))
