...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvneg (bvnot (bvlshr s (bvlshr #b0111111111 (bvsub #b1000000000 #b0111111111))))))
(define-fun l ((x (_ BitVec 10))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 10)) (bvsge s t)) (=> (bvslt s (_ bv0 10)) (bvsge (bvlshr s (_ bv1 10)) t))))
