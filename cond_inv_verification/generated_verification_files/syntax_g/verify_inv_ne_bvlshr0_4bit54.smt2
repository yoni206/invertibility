...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) (bvshl #b100000000000000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 54))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 54)) (bvult s (_ bv54 54))))
