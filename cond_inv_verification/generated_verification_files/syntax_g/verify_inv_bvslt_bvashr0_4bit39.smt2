...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) #b100000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 39))) Bool  (bvslt (bvashr (inv s t) s) t))
