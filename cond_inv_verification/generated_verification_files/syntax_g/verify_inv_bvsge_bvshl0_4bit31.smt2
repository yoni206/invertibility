...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvlshr #b0111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 31))) Bool  (bvsge (bvshl (inv s t) s) t))
