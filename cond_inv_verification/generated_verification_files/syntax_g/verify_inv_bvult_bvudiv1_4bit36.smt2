...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvnot #b000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 36))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 36) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 36) t)))
