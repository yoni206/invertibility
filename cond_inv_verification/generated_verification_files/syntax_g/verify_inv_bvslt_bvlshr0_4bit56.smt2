...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) (bvshl #b10000000000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 56))) Bool  (bvslt (bvlshr (inv s t) s) t))
