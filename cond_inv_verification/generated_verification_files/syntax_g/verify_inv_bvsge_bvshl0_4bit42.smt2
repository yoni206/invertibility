...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvlshr #b011111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 42))) Bool  (bvsge (bvshl (inv s t) s) t))
