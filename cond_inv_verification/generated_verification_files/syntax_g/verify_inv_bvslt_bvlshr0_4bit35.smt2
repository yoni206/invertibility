...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvshl #b10000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 35))) Bool  (bvslt (bvlshr (inv s t) s) t))
