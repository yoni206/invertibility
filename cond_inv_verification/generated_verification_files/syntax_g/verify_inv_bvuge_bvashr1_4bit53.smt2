...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvand s #b10000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 53))) Bool  (bvuge (bvashr s (inv s t)) t))
