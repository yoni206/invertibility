...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvshl #b10000000000000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 53))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 53)) (bvult s (_ bv53 53))))
