...
(define-fun inv ((s (_ BitVec 57)) (t (_ BitVec 57))) (_ BitVec 57) (bvlshr #b011111111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 57))) Bool  (bvsge (bvshl (inv s t) s) t))
