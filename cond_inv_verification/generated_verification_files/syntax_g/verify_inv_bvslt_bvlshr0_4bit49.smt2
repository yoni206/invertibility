...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvshl #b1000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 49))) Bool  (bvslt (bvlshr (inv s t) s) t))
