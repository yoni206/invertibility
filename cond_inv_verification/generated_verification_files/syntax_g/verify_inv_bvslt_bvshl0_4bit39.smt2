...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvlshr #b100000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 39))) Bool  (bvslt (bvshl (inv s t) s) t))
