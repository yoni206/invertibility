...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvshl #b011111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 39))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 39)) (distinct s (_ bv0 39))))
