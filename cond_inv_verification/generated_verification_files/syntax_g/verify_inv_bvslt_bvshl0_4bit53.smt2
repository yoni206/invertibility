...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvlshr #b10000000000000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 53))) Bool  (bvslt (bvshl (inv s t) s) t))
