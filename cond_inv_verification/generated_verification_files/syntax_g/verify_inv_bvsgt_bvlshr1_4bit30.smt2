...
(define-fun inv ((s (_ BitVec 30)) (t (_ BitVec 30))) (_ BitVec 30) (bvlshr s (bvlshr #b011111111111111111111111111111 (bvsub #b100000000000000000000000000000 #b011111111111111111111111111111))))
(define-fun l ((x (_ BitVec 30))) Bool  (bvsgt (bvlshr s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvslt s (_ bv0 30)) (bvsgt (bvlshr s (_ bv1 30)) t)) (=> (bvsge s (_ bv0 30)) (bvsgt s t))))
