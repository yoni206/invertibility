...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) #b01111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 44))) Bool  (bvsge (bvashr (inv s t) s) t))
