...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvlshr #b01111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 35))) Bool  (bvsge (bvshl (inv s t) s) t))
