...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvlshr #b1000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 40))) Bool  (bvslt (bvshl (inv s t) s) t))
