...
(define-fun inv ((s (_ BitVec 60)) (t (_ BitVec 60))) (_ BitVec 60) (bvlshr #b011111111111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 60))) Bool  (bvsge (bvshl (inv s t) s) t))
