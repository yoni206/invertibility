...
(define-fun inv ((s (_ BitVec 61)) (t (_ BitVec 61))) (_ BitVec 61) (bvshl #b0111111111111111111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 61))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 61)) (distinct s (_ bv0 61))))
