...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvshl #b0111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 43))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 43)) (distinct s (_ bv0 43))))
