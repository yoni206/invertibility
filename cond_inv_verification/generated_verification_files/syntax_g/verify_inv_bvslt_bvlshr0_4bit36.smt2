...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvshl #b100000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 36))) Bool  (bvslt (bvlshr (inv s t) s) t))
