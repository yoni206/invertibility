...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvneg (bvnot (bvlshr s (bvlshr #b0111111111111 (bvsub #b1000000000000 #b0111111111111))))))
(define-fun l ((x (_ BitVec 13))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 13)) (bvsge s t)) (=> (bvslt s (_ bv0 13)) (bvsge (bvlshr s (_ bv1 13)) t))))
