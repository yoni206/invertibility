...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvshl #b100000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 36))) Bool  (distinct (bvlshr (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 36)) (bvult s (_ bv36 36))))
