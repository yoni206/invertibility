...
(define-fun inv ((s (_ BitVec 1)) (t (_ BitVec 1))) (_ BitVec 1) (bvshl #b0 t))
(define-fun l ((x (_ BitVec 1))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 1)) (distinct s (_ bv0 1))))
