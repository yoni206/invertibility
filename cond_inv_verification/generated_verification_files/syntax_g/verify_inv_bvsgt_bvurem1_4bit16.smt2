...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvsub (bvor s #b1000000000000000) (bvand #b0111111111111111 (bvsub t #b0111111111111111))))
(define-fun l ((x (_ BitVec 16))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 16)) (bvsgt s t)) (=> (bvslt s (_ bv0 16)) (bvsgt (bvlshr (bvsub s (_ bv1 16)) (_ bv1 16)) t))))
