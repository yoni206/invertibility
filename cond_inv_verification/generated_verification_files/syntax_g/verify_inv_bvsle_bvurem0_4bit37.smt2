...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvand t #b1000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 37))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 37)) (bvand (bvneg s) t)))
