...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) #b011111111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 51))) Bool  (bvsge (bvashr (inv s t) s) t))
