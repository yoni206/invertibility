...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvand s #b10000000000000000000000000000000))
(define-fun l ((x (_ BitVec 32))) Bool  (bvsge (bvashr s (inv s t)) t))
