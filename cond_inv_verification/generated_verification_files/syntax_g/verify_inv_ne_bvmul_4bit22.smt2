...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvshl #b0111111111111111111111 t))
(define-fun l ((x (_ BitVec 22))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 22)) (distinct s (_ bv0 22))))
