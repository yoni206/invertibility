...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvshl #b011111111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 51))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 51)) (distinct s (_ bv0 51))))
