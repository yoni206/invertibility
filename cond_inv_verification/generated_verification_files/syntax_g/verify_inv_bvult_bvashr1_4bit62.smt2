...
(define-fun inv ((s (_ BitVec 62)) (t (_ BitVec 62))) (_ BitVec 62) (bvnot (bvor s #b01111111111111111111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 62))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 62)))) (not (= t (_ bv0 62)))))
