...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvshl #b0111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 28))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 28)) (distinct s (_ bv0 28))))
