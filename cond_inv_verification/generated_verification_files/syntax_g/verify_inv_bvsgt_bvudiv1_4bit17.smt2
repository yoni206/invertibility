...
(define-fun inv ((s (_ BitVec 17)) (t (_ BitVec 17))) (_ BitVec 17) (bvneg (bvnot (bvlshr s (bvlshr #b01111111111111111 (bvsub #b10000000000000000 #b01111111111111111))))))
(define-fun l ((x (_ BitVec 17))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 17)) (bvsgt s t)) (=> (bvslt s (_ bv0 17)) (bvsgt (bvlshr s (_ bv1 17)) t))))
