...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvnot (bvor s #b01111111111111111111111111111111111111111111111111)))
(define-fun l ((x (_ BitVec 50))) Bool  (bvult (bvashr s (inv s t)) t))
(define-fun SC () Bool (and (not (and (not (bvult s t)) (bvslt s (_ bv0 50)))) (not (= t (_ bv0 50)))))
