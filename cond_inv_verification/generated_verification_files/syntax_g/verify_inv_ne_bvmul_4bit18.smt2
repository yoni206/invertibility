...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvshl #b011111111111111111 t))
(define-fun l ((x (_ BitVec 18))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 18)) (distinct s (_ bv0 18))))
