...
(define-fun inv ((s (_ BitVec 60)) (t (_ BitVec 60))) (_ BitVec 60) (bvshl #b011111111111111111111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 60))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 60)) (distinct s (_ bv0 60))))
