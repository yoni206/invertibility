...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvshl #b100000000000000000000000000000000000000000000 s))
(define-fun l ((x (_ BitVec 45))) Bool  (bvslt (bvlshr (inv s t) s) t))
