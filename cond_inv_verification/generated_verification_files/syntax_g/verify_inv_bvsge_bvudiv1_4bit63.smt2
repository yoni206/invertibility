...
(define-fun l ((x (_ BitVec 63))) Bool  (bvsge (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 63)) (bvsge s t)) (=> (bvslt s (_ bv0 63)) (bvsge (bvlshr s (_ bv1 63)) t))))
