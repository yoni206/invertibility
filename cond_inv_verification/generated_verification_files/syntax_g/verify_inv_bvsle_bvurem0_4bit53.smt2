...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvand t #b10000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 53))) Bool  (bvsle (uremtotal (inv s t) s) t))
(define-fun SC () Bool (bvslt (bvnot (_ bv0 53)) (bvand (bvneg s) t)))
