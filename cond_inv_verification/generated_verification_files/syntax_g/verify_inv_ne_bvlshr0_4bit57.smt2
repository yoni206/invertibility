...
(define-fun inv ((s (_ BitVec 57)) (t (_ BitVec 57))) (_ BitVec 57) (bvshl #b100000000000000000000000000000000000000000000000000000000 t))
(define-fun l ((x (_ BitVec 57))) Bool  (distinct (bvlshr (inv s t) s) t))
