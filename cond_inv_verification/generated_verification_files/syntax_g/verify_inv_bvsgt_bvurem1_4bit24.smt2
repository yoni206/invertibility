...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvsub (bvor s #b100000000000000000000000) (bvand #b011111111111111111111111 (bvsub t #b011111111111111111111111))))
(define-fun l ((x (_ BitVec 24))) Bool  (bvsgt (uremtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 24)) (bvsgt s t)) (=> (bvslt s (_ bv0 24)) (bvsgt (bvlshr (bvsub s (_ bv1 24)) (_ bv1 24)) t))))
