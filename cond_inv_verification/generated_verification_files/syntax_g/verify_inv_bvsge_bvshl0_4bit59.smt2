...
(define-fun inv ((s (_ BitVec 59)) (t (_ BitVec 59))) (_ BitVec 59) (bvlshr #b01111111111111111111111111111111111111111111111111111111111 s))
(define-fun l ((x (_ BitVec 59))) Bool  (bvsge (bvshl (inv s t) s) t))
