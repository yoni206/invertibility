...
(define-fun inv ((s (_ BitVec 6)) (t (_ BitVec 6))) (_ BitVec 6) (bvnot t))
(define-fun l ((x (_ BitVec 6))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 6))) (distinct t (bvnot (_ bv0 6)))))
