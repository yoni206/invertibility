...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvshl #b0111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 34))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 34)) (distinct s (_ bv0 34))))
