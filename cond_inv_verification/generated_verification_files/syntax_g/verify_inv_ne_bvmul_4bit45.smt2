...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvshl #b011111111111111111111111111111111111111111111 t))
(define-fun l ((x (_ BitVec 45))) Bool  (distinct (bvmul (inv s t) s) t))
(define-fun SC () Bool (or (distinct t (_ bv0 45)) (distinct s (_ bv0 45))))
