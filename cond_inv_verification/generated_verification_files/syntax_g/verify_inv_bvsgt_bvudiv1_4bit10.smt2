...
(define-fun l ((x (_ BitVec 10))) Bool  (bvsgt (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (=> (bvsge s (_ bv0 10)) (bvsgt s t)) (=> (bvslt s (_ bv0 10)) (bvsgt (bvlshr s (_ bv1 10)) t))))
