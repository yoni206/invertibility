...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) (bvnot t))
(define-fun l ((x (_ BitVec 23))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 23))) (distinct t (bvnot (_ bv0 23)))))
