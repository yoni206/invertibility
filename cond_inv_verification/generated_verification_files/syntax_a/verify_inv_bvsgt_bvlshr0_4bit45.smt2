...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvadd s (bvadd #b011111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 45))) Bool  (bvsgt (bvlshr (inv s t) s) t))
