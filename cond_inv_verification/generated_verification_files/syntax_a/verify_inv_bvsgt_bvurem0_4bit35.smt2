...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 35))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 35)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 35)) (distinct t max))) (or (distinct t (_ bv0 35)) (distinct s (_ bv1 35)))))
