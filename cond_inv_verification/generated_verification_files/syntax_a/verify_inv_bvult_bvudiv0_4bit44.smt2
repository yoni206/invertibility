...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) #b00000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 44))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 44) s) (bvult (_ bv0 44) t)))
