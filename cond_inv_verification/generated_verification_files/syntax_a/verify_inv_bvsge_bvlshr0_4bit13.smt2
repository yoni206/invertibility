...
(define-fun inv ((s (_ BitVec 13)) (t (_ BitVec 13))) (_ BitVec 13) (bvadd #b0111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 13))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 13))) (bvsge (bvlshr (bvnot (_ bv0 13)) s) t)))
