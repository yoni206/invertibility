...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvadd #b01111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 26))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 26))) (bvsge (bvlshr (bvnot (_ bv0 26)) s) t)))
