...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvnot #b000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 42))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 42) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 42) t)))
