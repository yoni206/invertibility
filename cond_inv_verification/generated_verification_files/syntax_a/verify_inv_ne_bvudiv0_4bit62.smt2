...
(define-fun inv ((s (_ BitVec 62)) (t (_ BitVec 62))) (_ BitVec 62) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 62))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 62)) (distinct t (bvnot (_ bv0 62)))))
