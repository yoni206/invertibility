...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvadd s (bvadd #b011111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 21))) Bool  (bvsgt (bvlshr (inv s t) s) t))
