...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvnot #b00000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 50))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 50) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 50) t)))
