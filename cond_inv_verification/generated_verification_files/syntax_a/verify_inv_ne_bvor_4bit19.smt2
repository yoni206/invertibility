...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvnot t))
(define-fun l ((x (_ BitVec 19))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 19))) (distinct t (bvnot (_ bv0 19)))))
