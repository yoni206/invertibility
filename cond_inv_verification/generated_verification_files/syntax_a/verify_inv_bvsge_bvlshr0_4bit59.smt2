...
(define-fun inv ((s (_ BitVec 59)) (t (_ BitVec 59))) (_ BitVec 59) (bvadd #b01111111111111111111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 59))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 59))) (bvsge (bvlshr (bvnot (_ bv0 59)) s) t)))
