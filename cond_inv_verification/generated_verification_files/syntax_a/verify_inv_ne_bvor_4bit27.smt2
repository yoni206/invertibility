...
(define-fun inv ((s (_ BitVec 27)) (t (_ BitVec 27))) (_ BitVec 27) (bvnot t))
(define-fun l ((x (_ BitVec 27))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 27))) (distinct t (bvnot (_ bv0 27)))))
