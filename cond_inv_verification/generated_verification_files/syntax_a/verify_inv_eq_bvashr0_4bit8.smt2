...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 8))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv8 8)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv8 8)) (or (= t (bvnot (_ bv0 8))) (= t (_ bv0 8))))))
