...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) #b100000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 48))) Bool  (bvslt (bvashr (inv s t) s) t))
