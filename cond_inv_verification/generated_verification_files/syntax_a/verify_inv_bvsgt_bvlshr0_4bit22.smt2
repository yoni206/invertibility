...
(define-fun inv ((s (_ BitVec 22)) (t (_ BitVec 22))) (_ BitVec 22) (bvadd s (bvadd #b0111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 22))) Bool  (bvsgt (bvlshr (inv s t) s) t))
