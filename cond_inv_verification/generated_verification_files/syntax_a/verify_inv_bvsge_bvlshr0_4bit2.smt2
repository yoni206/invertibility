...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvadd #b01 (bvmul s t)))
(define-fun l ((x (_ BitVec 2))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 2))) (bvsge (bvlshr (bvnot (_ bv0 2)) s) t)))
