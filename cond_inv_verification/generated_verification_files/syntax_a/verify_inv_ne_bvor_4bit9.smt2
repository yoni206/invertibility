...
(define-fun inv ((s (_ BitVec 9)) (t (_ BitVec 9))) (_ BitVec 9) (bvnot t))
(define-fun l ((x (_ BitVec 9))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 9))) (distinct t (bvnot (_ bv0 9)))))
