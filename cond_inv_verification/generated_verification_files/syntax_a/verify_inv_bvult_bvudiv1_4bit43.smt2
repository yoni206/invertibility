...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvnot #b0000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 43))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 43) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 43) t)))
