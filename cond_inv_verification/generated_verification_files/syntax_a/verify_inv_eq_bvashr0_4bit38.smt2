...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 38))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv38 38)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv38 38)) (or (= t (bvnot (_ bv0 38))) (= t (_ bv0 38))))))
