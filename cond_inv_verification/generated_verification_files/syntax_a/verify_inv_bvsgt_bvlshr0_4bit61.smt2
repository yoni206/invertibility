...
(define-fun inv ((s (_ BitVec 61)) (t (_ BitVec 61))) (_ BitVec 61) (bvadd s (bvadd #b0111111111111111111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 61))) Bool  (bvsgt (bvlshr (inv s t) s) t))
