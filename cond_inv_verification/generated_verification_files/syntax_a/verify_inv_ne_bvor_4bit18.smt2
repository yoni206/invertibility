...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvnot t))
(define-fun l ((x (_ BitVec 18))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 18))) (distinct t (bvnot (_ bv0 18)))))
