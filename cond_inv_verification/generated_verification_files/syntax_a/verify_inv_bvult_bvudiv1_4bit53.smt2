...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvnot #b00000000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 53))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 53) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 53) t)))
