...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvadd #b0111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 34))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 34))) (bvsge (bvlshr (bvnot (_ bv0 34)) s) t)))
