...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvadd #b01111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 44))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 44))) (bvsge (bvlshr (bvnot (_ bv0 44)) s) t)))
