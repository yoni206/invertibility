...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) (bvadd #b01111111111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 50))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 50))) (bvsge (bvlshr (bvnot (_ bv0 50)) s) t)))
