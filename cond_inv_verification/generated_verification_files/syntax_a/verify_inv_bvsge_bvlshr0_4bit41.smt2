...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvadd #b01111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 41))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 41))) (bvsge (bvlshr (bvnot (_ bv0 41)) s) t)))
