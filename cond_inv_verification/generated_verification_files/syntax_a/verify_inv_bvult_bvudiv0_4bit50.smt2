...
(define-fun inv ((s (_ BitVec 50)) (t (_ BitVec 50))) (_ BitVec 50) #b00000000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 50))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 50) s) (bvult (_ bv0 50) t)))
