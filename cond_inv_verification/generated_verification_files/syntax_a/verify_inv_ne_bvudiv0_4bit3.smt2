...
(define-fun inv ((s (_ BitVec 3)) (t (_ BitVec 3))) (_ BitVec 3) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 3))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 3)) (distinct t (bvnot (_ bv0 3)))))
