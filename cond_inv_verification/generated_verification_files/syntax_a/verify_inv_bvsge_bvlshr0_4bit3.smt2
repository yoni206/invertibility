...
(define-fun inv ((s (_ BitVec 3)) (t (_ BitVec 3))) (_ BitVec 3) (bvadd #b011 (bvmul s t)))
(define-fun l ((x (_ BitVec 3))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 3))) (bvsge (bvlshr (bvnot (_ bv0 3)) s) t)))
