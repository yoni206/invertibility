...
(define-fun inv ((s (_ BitVec 3)) (t (_ BitVec 3))) (_ BitVec 3) (bvnot #b000))
(define-fun l ((x (_ BitVec 3))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 3) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 3) t)))
