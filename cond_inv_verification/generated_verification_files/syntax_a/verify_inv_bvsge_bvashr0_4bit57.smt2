...
(define-fun inv ((s (_ BitVec 57)) (t (_ BitVec 57))) (_ BitVec 57) #b011111111111111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 57))) Bool  (bvsge (bvashr (inv s t) s) t))
