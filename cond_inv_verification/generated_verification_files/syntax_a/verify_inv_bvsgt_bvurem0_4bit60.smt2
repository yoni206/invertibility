...
(define-fun inv ((s (_ BitVec 60)) (t (_ BitVec 60))) (_ BitVec 60) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 60))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 60)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 60)) (distinct t max))) (or (distinct t (_ bv0 60)) (distinct s (_ bv1 60)))))
