...
(define-fun inv ((s (_ BitVec 59)) (t (_ BitVec 59))) (_ BitVec 59) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 59))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 59)) (distinct t (bvnot (_ bv0 59)))))
