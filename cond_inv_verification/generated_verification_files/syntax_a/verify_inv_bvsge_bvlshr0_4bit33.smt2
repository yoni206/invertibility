...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvadd #b011111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 33))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 33))) (bvsge (bvlshr (bvnot (_ bv0 33)) s) t)))
