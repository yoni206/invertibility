...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvadd s (bvadd #b01111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 47))) Bool  (bvsgt (bvlshr (inv s t) s) t))
