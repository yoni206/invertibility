...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvadd s (bvadd #b0111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 40))) Bool  (bvsgt (bvlshr (inv s t) s) t))
