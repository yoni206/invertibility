...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvadd s (bvadd #b01111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 38))) Bool  (bvsgt (bvlshr (inv s t) s) t))
