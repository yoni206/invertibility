...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvadd #b011111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 21))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 21))) (bvsge (bvlshr (bvnot (_ bv0 21)) s) t)))
