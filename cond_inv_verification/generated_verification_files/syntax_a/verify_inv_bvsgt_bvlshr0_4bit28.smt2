...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) (bvadd s (bvadd #b0111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 28))) Bool  (bvsgt (bvlshr (inv s t) s) t))
