...
(define-fun inv ((s (_ BitVec 23)) (t (_ BitVec 23))) (_ BitVec 23) #b00000000000000000000000)
(define-fun l ((x (_ BitVec 23))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 23) s) (bvult (_ bv0 23) t)))
