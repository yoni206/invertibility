...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvnot t))
(define-fun l ((x (_ BitVec 44))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 44))) (distinct t (bvnot (_ bv0 44)))))
