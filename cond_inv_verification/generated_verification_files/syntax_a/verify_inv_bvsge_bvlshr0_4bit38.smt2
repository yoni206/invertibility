...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvadd #b01111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 38))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 38))) (bvsge (bvlshr (bvnot (_ bv0 38)) s) t)))
