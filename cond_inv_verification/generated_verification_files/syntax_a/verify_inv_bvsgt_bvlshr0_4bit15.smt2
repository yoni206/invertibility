...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) (bvadd s (bvadd #b011111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 15))) Bool  (bvsgt (bvlshr (inv s t) s) t))
