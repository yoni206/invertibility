...
(define-fun inv ((s (_ BitVec 60)) (t (_ BitVec 60))) (_ BitVec 60) (bvadd s (bvadd #b011111111111111111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 60))) Bool  (bvsgt (bvlshr (inv s t) s) t))
