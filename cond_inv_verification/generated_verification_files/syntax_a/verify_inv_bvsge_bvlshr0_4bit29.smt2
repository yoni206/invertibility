...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) (bvadd #b01111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 29))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 29))) (bvsge (bvlshr (bvnot (_ bv0 29)) s) t)))
