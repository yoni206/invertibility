...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) #b0111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 46))) Bool  (bvsgt (bvashr (inv s t) s) t))
