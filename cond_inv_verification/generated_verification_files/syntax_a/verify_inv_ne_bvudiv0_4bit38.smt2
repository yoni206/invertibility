...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 38))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 38)) (distinct t (bvnot (_ bv0 38)))))
