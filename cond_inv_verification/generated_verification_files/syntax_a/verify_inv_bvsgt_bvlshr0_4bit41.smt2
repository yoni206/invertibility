...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvadd s (bvadd #b01111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 41))) Bool  (bvsgt (bvlshr (inv s t) s) t))
