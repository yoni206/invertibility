...
(define-fun inv ((s (_ BitVec 54)) (t (_ BitVec 54))) (_ BitVec 54) (bvadd s (bvadd #b011111111111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 54))) Bool  (bvsgt (bvlshr (inv s t) s) t))
