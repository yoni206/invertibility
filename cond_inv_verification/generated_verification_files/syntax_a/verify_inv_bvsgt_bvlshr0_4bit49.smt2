...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvadd s (bvadd #b0111111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 49))) Bool  (bvsgt (bvlshr (inv s t) s) t))
