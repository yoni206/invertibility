...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 56))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv56 56)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv56 56)) (or (= t (bvnot (_ bv0 56))) (= t (_ bv0 56))))))
