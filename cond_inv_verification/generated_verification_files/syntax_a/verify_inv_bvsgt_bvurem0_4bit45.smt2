...
(define-fun l ((x (_ BitVec 45))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 45)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 45)) (distinct t max))) (or (distinct t (_ bv0 45)) (distinct s (_ bv1 45)))))
