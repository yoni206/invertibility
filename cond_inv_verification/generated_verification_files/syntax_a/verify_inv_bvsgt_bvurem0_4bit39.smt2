...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 39))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 39)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 39)) (distinct t max))) (or (distinct t (_ bv0 39)) (distinct s (_ bv1 39)))))
