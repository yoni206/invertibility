...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvadd #b0111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 37))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 37))) (bvsge (bvlshr (bvnot (_ bv0 37)) s) t)))
