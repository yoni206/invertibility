...
(define-fun inv ((s (_ BitVec 20)) (t (_ BitVec 20))) (_ BitVec 20) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 20))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv20 20)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv20 20)) (or (= t (bvnot (_ bv0 20))) (= t (_ bv0 20))))))
