...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvadd #b0111111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 46))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 46))) (bvsge (bvlshr (bvnot (_ bv0 46)) s) t)))
