...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 43))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv43 43)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv43 43)) (or (= t (bvnot (_ bv0 43))) (= t (_ bv0 43))))))
