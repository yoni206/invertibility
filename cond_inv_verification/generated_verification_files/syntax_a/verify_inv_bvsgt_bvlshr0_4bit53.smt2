...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvadd s (bvadd #b01111111111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 53))) Bool  (bvsgt (bvlshr (inv s t) s) t))
