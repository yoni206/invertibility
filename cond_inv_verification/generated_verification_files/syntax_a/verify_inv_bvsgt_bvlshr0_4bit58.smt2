...
(define-fun inv ((s (_ BitVec 58)) (t (_ BitVec 58))) (_ BitVec 58) (bvadd s (bvadd #b0111111111111111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 58))) Bool  (bvsgt (bvlshr (inv s t) s) t))
