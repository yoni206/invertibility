...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 51))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 51)) (distinct t (bvnot (_ bv0 51)))))
