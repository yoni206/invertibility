...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 44))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv44 44)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv44 44)) (or (= t (bvnot (_ bv0 44))) (= t (_ bv0 44))))))
