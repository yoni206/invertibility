...
(define-fun inv ((s (_ BitVec 29)) (t (_ BitVec 29))) (_ BitVec 29) #b00000000000000000000000000000)
(define-fun l ((x (_ BitVec 29))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 29) s) (bvult (_ bv0 29) t)))
