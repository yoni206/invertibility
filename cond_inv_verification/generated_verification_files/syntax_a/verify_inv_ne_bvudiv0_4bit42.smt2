...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 42))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 42)) (distinct t (bvnot (_ bv0 42)))))
