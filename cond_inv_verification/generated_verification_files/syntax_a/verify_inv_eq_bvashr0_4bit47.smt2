...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 47))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv47 47)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv47 47)) (or (= t (bvnot (_ bv0 47))) (= t (_ bv0 47))))))
