...
(define-fun inv ((s (_ BitVec 4)) (t (_ BitVec 4))) (_ BitVec 4) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 4))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv4 4)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv4 4)) (or (= t (bvnot (_ bv0 4))) (= t (_ bv0 4))))))
