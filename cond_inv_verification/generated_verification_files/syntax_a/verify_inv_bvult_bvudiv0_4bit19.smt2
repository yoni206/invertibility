...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) #b0000000000000000000)
(define-fun l ((x (_ BitVec 19))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 19) s) (bvult (_ bv0 19) t)))
