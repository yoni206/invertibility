...
(define-fun inv ((s (_ BitVec 25)) (t (_ BitVec 25))) (_ BitVec 25) (bvadd #b0111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 25))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 25))) (bvsge (bvlshr (bvnot (_ bv0 25)) s) t)))
