...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 52))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 52)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 52)) (distinct t max))) (or (distinct t (_ bv0 52)) (distinct s (_ bv1 52)))))
