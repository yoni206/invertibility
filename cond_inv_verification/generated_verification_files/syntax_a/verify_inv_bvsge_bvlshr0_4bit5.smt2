...
(define-fun inv ((s (_ BitVec 5)) (t (_ BitVec 5))) (_ BitVec 5) (bvadd #b01111 (bvmul s t)))
(define-fun l ((x (_ BitVec 5))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 5))) (bvsge (bvlshr (bvnot (_ bv0 5)) s) t)))
