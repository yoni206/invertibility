...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 32))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 32)) (distinct t (bvnot (_ bv0 32)))))
