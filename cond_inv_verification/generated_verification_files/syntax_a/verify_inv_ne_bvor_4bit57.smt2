...
(define-fun inv ((s (_ BitVec 57)) (t (_ BitVec 57))) (_ BitVec 57) (bvnot t))
(define-fun l ((x (_ BitVec 57))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 57))) (distinct t (bvnot (_ bv0 57)))))
