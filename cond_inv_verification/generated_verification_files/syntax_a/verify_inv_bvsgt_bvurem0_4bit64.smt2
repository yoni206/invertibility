...
(define-fun inv ((s (_ BitVec 64)) (t (_ BitVec 64))) (_ BitVec 64) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 64))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 64)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 64)) (distinct t max))) (or (distinct t (_ bv0 64)) (distinct s (_ bv1 64)))))
