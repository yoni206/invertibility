...
(define-fun inv ((s (_ BitVec 58)) (t (_ BitVec 58))) (_ BitVec 58) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 58))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 58)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 58)) (distinct t max))) (or (distinct t (_ bv0 58)) (distinct s (_ bv1 58)))))
