...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 46))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv46 46)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv46 46)) (or (= t (bvnot (_ bv0 46))) (= t (_ bv0 46))))))
