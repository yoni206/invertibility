...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvadd #b01111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 35))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 35))) (bvsge (bvlshr (bvnot (_ bv0 35)) s) t)))
