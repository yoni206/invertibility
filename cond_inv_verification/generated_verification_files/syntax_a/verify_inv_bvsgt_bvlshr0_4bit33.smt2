...
(define-fun inv ((s (_ BitVec 33)) (t (_ BitVec 33))) (_ BitVec 33) (bvadd s (bvadd #b011111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 33))) Bool  (bvsgt (bvlshr (inv s t) s) t))
