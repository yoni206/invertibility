...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) #b1000000000000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 55))) Bool  (bvslt (bvashr (inv s t) s) t))
