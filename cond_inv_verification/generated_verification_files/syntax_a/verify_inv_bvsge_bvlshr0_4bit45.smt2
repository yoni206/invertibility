...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) (bvadd #b011111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 45))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 45))) (bvsge (bvlshr (bvnot (_ bv0 45)) s) t)))
