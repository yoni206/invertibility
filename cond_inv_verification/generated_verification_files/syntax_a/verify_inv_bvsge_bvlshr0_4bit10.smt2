...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvadd #b0111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 10))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 10))) (bvsge (bvlshr (bvnot (_ bv0 10)) s) t)))
