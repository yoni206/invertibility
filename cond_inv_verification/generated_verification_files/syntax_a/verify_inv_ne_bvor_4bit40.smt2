...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvnot t))
(define-fun l ((x (_ BitVec 40))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 40))) (distinct t (bvnot (_ bv0 40)))))
