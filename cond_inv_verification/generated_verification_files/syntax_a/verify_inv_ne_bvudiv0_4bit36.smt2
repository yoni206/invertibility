...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 36))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 36)) (distinct t (bvnot (_ bv0 36)))))
