...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 52))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv52 52)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv52 52)) (or (= t (bvnot (_ bv0 52))) (= t (_ bv0 52))))))
