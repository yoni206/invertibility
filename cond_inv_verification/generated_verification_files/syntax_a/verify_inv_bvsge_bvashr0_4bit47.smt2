...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) #b01111111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 47))) Bool  (bvsge (bvashr (inv s t) s) t))
