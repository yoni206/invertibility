...
(define-fun inv ((s (_ BitVec 45)) (t (_ BitVec 45))) (_ BitVec 45) #b000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 45))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 45) s) (bvult (_ bv0 45) t)))
