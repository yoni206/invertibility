...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvadd #b01111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 32))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 32))) (bvsge (bvlshr (bvnot (_ bv0 32)) s) t)))
