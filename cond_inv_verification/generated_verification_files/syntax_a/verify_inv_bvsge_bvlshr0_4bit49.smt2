...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) (bvadd #b0111111111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 49))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 49))) (bvsge (bvlshr (bvnot (_ bv0 49)) s) t)))
