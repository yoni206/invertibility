...
(define-fun inv ((s (_ BitVec 49)) (t (_ BitVec 49))) (_ BitVec 49) #b1000000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 49))) Bool  (bvslt (bvashr (inv s t) s) t))
