...
(define-fun inv ((s (_ BitVec 19)) (t (_ BitVec 19))) (_ BitVec 19) (bvadd #b0111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 19))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 19))) (bvsge (bvlshr (bvnot (_ bv0 19)) s) t)))
