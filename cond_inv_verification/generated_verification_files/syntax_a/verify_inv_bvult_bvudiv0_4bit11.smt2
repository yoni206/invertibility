...
(define-fun inv ((s (_ BitVec 11)) (t (_ BitVec 11))) (_ BitVec 11) #b00000000000)
(define-fun l ((x (_ BitVec 11))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 11) s) (bvult (_ bv0 11) t)))
