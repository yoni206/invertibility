...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) (bvadd s (bvadd #b011111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 36))) Bool  (bvsgt (bvlshr (inv s t) s) t))
