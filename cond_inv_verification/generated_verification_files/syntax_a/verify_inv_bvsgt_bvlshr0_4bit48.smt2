...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvadd s (bvadd #b011111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 48))) Bool  (bvsgt (bvlshr (inv s t) s) t))
