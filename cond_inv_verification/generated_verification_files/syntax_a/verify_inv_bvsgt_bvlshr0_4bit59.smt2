...
(define-fun inv ((s (_ BitVec 59)) (t (_ BitVec 59))) (_ BitVec 59) (bvadd s (bvadd #b01111111111111111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 59))) Bool  (bvsgt (bvlshr (inv s t) s) t))
