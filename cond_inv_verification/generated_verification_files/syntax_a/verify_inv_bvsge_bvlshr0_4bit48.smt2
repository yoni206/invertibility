...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvadd #b011111111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 48))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 48))) (bvsge (bvlshr (bvnot (_ bv0 48)) s) t)))
