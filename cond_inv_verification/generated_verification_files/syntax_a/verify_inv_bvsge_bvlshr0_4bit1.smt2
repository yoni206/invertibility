...
(define-fun inv ((s (_ BitVec 1)) (t (_ BitVec 1))) (_ BitVec 1) (bvadd #b0 (bvmul s t)))
(define-fun l ((x (_ BitVec 1))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 1))) (bvsge (bvlshr (bvnot (_ bv0 1)) s) t)))
