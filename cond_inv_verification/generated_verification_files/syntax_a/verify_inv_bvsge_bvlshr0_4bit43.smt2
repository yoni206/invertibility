...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvadd #b0111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 43))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 43))) (bvsge (bvlshr (bvnot (_ bv0 43)) s) t)))
