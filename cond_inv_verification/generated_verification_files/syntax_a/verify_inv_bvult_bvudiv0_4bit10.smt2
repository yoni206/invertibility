...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) #b0000000000)
(define-fun l ((x (_ BitVec 10))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 10) s) (bvult (_ bv0 10) t)))
