...
(define-fun inv ((s (_ BitVec 14)) (t (_ BitVec 14))) (_ BitVec 14) (bvadd #b01111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 14))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 14))) (bvsge (bvlshr (bvnot (_ bv0 14)) s) t)))
