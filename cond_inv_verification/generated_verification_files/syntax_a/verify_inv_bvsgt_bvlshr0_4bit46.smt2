...
(define-fun inv ((s (_ BitVec 46)) (t (_ BitVec 46))) (_ BitVec 46) (bvadd s (bvadd #b0111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 46))) Bool  (bvsgt (bvlshr (inv s t) s) t))
