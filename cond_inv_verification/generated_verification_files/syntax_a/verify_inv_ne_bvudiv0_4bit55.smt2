...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 55))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 55)) (distinct t (bvnot (_ bv0 55)))))
