...
(define-fun inv ((s (_ BitVec 38)) (t (_ BitVec 38))) (_ BitVec 38) #b10000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 38))) Bool  (bvslt (bvashr (inv s t) s) t))
