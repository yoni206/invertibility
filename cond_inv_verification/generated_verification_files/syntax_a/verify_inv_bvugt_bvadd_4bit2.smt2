...
(define-fun inv ((s (_ BitVec 2)) (t (_ BitVec 2))) (_ BitVec 2) (bvnot s))
(define-fun l ((x (_ BitVec 2))) Bool  (bvugt (bvadd (inv s t) s) t))
(define-fun SC () Bool (distinct t (bvnot (_ bv0 2))))
