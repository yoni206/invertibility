...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) #b000000000000000000000)
(define-fun l ((x (_ BitVec 21))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 21) s) (bvult (_ bv0 21) t)))
