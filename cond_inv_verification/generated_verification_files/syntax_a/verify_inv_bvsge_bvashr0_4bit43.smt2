...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) #b0111111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 43))) Bool  (bvsge (bvashr (inv s t) s) t))
