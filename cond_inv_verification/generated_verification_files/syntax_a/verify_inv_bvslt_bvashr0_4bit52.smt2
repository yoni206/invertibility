...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) #b1000000000000000000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 52))) Bool  (bvslt (bvashr (inv s t) s) t))
