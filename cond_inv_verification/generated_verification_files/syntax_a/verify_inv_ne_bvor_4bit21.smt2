...
(define-fun inv ((s (_ BitVec 21)) (t (_ BitVec 21))) (_ BitVec 21) (bvnot t))
(define-fun l ((x (_ BitVec 21))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 21))) (distinct t (bvnot (_ bv0 21)))))
