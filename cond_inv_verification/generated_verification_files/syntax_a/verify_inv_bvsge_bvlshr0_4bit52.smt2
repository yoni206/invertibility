...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvadd #b0111111111111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 52))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 52))) (bvsge (bvlshr (bvnot (_ bv0 52)) s) t)))
