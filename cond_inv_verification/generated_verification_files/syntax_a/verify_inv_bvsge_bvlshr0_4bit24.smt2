...
(define-fun inv ((s (_ BitVec 24)) (t (_ BitVec 24))) (_ BitVec 24) (bvadd #b011111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 24))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 24))) (bvsge (bvlshr (bvnot (_ bv0 24)) s) t)))
