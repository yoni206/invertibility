...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 39))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv39 39)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv39 39)) (or (= t (bvnot (_ bv0 39))) (= t (_ bv0 39))))))
