...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 43))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 43)) (distinct t (bvnot (_ bv0 43)))))
