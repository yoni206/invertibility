...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvadd s (bvadd #b011111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 18))) Bool  (bvsgt (bvlshr (inv s t) s) t))
