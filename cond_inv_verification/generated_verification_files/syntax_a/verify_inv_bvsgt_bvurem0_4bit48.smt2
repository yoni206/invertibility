...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 48))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 48)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 48)) (distinct t max))) (or (distinct t (_ bv0 48)) (distinct s (_ bv1 48)))))
