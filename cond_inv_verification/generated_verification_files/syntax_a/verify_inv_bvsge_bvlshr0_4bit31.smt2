...
(define-fun inv ((s (_ BitVec 31)) (t (_ BitVec 31))) (_ BitVec 31) (bvadd #b0111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 31))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 31))) (bvsge (bvlshr (bvnot (_ bv0 31)) s) t)))
