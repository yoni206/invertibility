...
(define-fun inv ((s (_ BitVec 41)) (t (_ BitVec 41))) (_ BitVec 41) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 41))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv41 41)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv41 41)) (or (= t (bvnot (_ bv0 41))) (= t (_ bv0 41))))))
