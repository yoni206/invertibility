...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) (bvadd #b01111111111111111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 56))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 56))) (bvsge (bvlshr (bvnot (_ bv0 56)) s) t)))
