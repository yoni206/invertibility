...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) (bvadd #b0111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 40))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 40))) (bvsge (bvlshr (bvnot (_ bv0 40)) s) t)))
