...
(define-fun inv ((s (_ BitVec 56)) (t (_ BitVec 56))) (_ BitVec 56) (bvnot t))
(define-fun l ((x (_ BitVec 56))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 56))) (distinct t (bvnot (_ bv0 56)))))
