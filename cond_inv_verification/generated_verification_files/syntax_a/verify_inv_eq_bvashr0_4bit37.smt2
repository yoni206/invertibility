...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 37))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv37 37)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv37 37)) (or (= t (bvnot (_ bv0 37))) (= t (_ bv0 37))))))
