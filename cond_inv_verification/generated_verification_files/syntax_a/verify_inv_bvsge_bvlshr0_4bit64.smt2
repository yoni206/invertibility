...
(define-fun inv ((s (_ BitVec 64)) (t (_ BitVec 64))) (_ BitVec 64) (bvadd #b0111111111111111111111111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 64))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 64))) (bvsge (bvlshr (bvnot (_ bv0 64)) s) t)))
