...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvadd #b011111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 42))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 42))) (bvsge (bvlshr (bvnot (_ bv0 42)) s) t)))
