...
(define-fun inv ((s (_ BitVec 34)) (t (_ BitVec 34))) (_ BitVec 34) (bvadd s (bvadd #b0111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 34))) Bool  (bvsgt (bvlshr (inv s t) s) t))
