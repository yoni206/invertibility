...
(define-fun inv ((s (_ BitVec 35)) (t (_ BitVec 35))) (_ BitVec 35) (bvadd s (bvadd #b01111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 35))) Bool  (bvsgt (bvlshr (inv s t) s) t))
