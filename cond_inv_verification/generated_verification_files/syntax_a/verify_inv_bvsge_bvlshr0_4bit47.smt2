...
(define-fun inv ((s (_ BitVec 47)) (t (_ BitVec 47))) (_ BitVec 47) (bvadd #b01111111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 47))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 47))) (bvsge (bvlshr (bvnot (_ bv0 47)) s) t)))
