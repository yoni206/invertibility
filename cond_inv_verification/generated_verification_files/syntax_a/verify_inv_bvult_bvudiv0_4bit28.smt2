...
(define-fun inv ((s (_ BitVec 28)) (t (_ BitVec 28))) (_ BitVec 28) #b0000000000000000000000000000)
(define-fun l ((x (_ BitVec 28))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 28) s) (bvult (_ bv0 28) t)))
