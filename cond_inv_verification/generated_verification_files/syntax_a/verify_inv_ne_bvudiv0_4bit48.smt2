...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 48))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 48)) (distinct t (bvnot (_ bv0 48)))))
