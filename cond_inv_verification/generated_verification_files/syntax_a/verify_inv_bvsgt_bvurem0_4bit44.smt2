...
(define-fun inv ((s (_ BitVec 44)) (t (_ BitVec 44))) (_ BitVec 44) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 44))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 44)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 44)) (distinct t max))) (or (distinct t (_ bv0 44)) (distinct s (_ bv1 44)))))
