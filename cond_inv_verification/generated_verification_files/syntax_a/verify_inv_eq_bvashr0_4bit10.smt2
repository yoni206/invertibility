...
(define-fun inv ((s (_ BitVec 10)) (t (_ BitVec 10))) (_ BitVec 10) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 10))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv10 10)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv10 10)) (or (= t (bvnot (_ bv0 10))) (= t (_ bv0 10))))))
