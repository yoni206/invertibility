...
(define-fun inv ((s (_ BitVec 43)) (t (_ BitVec 43))) (_ BitVec 43) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 43))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 43)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 43)) (distinct t max))) (or (distinct t (_ bv0 43)) (distinct s (_ bv1 43)))))
