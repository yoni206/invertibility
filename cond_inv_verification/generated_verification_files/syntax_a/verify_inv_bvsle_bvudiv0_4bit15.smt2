...
(define-fun inv ((s (_ BitVec 15)) (t (_ BitVec 15))) (_ BitVec 15) t)
(define-fun l ((x (_ BitVec 15))) Bool  (bvsle (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (= (udivtotal (bvmul s t) s) t) (=> (bvsle t (_ bv0 15)) (bvslt (udivtotal min s) t))))
