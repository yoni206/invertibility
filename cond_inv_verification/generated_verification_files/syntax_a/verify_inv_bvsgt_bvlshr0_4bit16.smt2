...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvadd s (bvadd #b0111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 16))) Bool  (bvsgt (bvlshr (inv s t) s) t))
