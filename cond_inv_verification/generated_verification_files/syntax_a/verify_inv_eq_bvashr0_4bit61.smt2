...
(define-fun inv ((s (_ BitVec 61)) (t (_ BitVec 61))) (_ BitVec 61) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 61))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv61 61)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv61 61)) (or (= t (bvnot (_ bv0 61))) (= t (_ bv0 61))))))
