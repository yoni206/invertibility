...
(define-fun inv ((s (_ BitVec 40)) (t (_ BitVec 40))) (_ BitVec 40) #b0111111111111111111111111111111111111111)
(define-fun l ((x (_ BitVec 40))) Bool  (bvsgt (bvashr (inv s t) s) t))
