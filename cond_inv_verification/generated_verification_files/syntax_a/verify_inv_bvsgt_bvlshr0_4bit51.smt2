...
(define-fun inv ((s (_ BitVec 51)) (t (_ BitVec 51))) (_ BitVec 51) (bvadd s (bvadd #b011111111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 51))) Bool  (bvsgt (bvlshr (inv s t) s) t))
