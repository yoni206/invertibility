...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvneg (bvnot t)))
(define-fun l ((x (_ BitVec 42))) Bool  (bvsgt (uremtotal (inv s t) s) t))
(define-fun SC () Bool (and (and (=> (bvsgt s (_ bv0 42)) (bvslt t (bvnot (bvneg s)))) (=> (bvsle s (_ bv0 42)) (distinct t max))) (or (distinct t (_ bv0 42)) (distinct s (_ bv1 42)))))
