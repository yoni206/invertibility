...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvadd s (bvadd #b0111111111111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 55))) Bool  (bvsgt (bvlshr (inv s t) s) t))
