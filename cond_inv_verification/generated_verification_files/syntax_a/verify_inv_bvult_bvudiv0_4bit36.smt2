...
(define-fun inv ((s (_ BitVec 36)) (t (_ BitVec 36))) (_ BitVec 36) #b000000000000000000000000000000000000)
(define-fun l ((x (_ BitVec 36))) Bool  (bvult (udivtotal (inv s t) s) t))
(define-fun SC () Bool (and (bvult (_ bv0 36) s) (bvult (_ bv0 36) t)))
