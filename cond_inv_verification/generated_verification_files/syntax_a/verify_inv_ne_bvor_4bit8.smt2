...
(define-fun inv ((s (_ BitVec 8)) (t (_ BitVec 8))) (_ BitVec 8) (bvnot t))
(define-fun l ((x (_ BitVec 8))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 8))) (distinct t (bvnot (_ bv0 8)))))
