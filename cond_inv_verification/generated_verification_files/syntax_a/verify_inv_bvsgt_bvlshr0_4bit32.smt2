...
(define-fun inv ((s (_ BitVec 32)) (t (_ BitVec 32))) (_ BitVec 32) (bvadd s (bvadd #b01111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 32))) Bool  (bvsgt (bvlshr (inv s t) s) t))
