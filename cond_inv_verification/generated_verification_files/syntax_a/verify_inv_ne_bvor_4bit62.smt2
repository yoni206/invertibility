...
(define-fun inv ((s (_ BitVec 62)) (t (_ BitVec 62))) (_ BitVec 62) (bvnot t))
(define-fun l ((x (_ BitVec 62))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 62))) (distinct t (bvnot (_ bv0 62)))))
