...
(define-fun inv ((s (_ BitVec 55)) (t (_ BitVec 55))) (_ BitVec 55) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 55))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv55 55)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv55 55)) (or (= t (bvnot (_ bv0 55))) (= t (_ bv0 55))))))
