...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 53))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv53 53)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv53 53)) (or (= t (bvnot (_ bv0 53))) (= t (_ bv0 53))))))
