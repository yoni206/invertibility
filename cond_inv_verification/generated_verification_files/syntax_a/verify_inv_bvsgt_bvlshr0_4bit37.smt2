...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvadd s (bvadd #b0111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 37))) Bool  (bvsgt (bvlshr (inv s t) s) t))
