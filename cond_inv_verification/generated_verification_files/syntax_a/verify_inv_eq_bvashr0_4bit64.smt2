...
(define-fun inv ((s (_ BitVec 64)) (t (_ BitVec 64))) (_ BitVec 64) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 64))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv64 64)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv64 64)) (or (= t (bvnot (_ bv0 64))) (= t (_ bv0 64))))))
