...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 52))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 52)) (distinct t (bvnot (_ bv0 52)))))
