...
(define-fun inv ((s (_ BitVec 52)) (t (_ BitVec 52))) (_ BitVec 52) (bvadd s (bvadd #b0111111111111111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 52))) Bool  (bvsgt (bvlshr (inv s t) s) t))
