...
(define-fun inv ((s (_ BitVec 37)) (t (_ BitVec 37))) (_ BitVec 37) (bvnot t))
(define-fun l ((x (_ BitVec 37))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 37))) (distinct t (bvnot (_ bv0 37)))))
