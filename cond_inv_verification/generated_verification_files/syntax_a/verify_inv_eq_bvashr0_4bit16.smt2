...
(define-fun inv ((s (_ BitVec 16)) (t (_ BitVec 16))) (_ BitVec 16) (bvmul t (bvsub s (bvnot (bvmul s (bvmul t (bvmul t t)))))))
(define-fun l ((x (_ BitVec 16))) Bool  (= (bvashr (inv s t) s) t))
(define-fun SC () Bool (and (=> (bvult s (_ bv16 16)) (= (bvashr (bvshl t s) s) t)) (=> (bvuge s (_ bv16 16)) (or (= t (bvnot (_ bv0 16))) (= t (_ bv0 16))))))
