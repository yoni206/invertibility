...
(define-fun inv ((s (_ BitVec 26)) (t (_ BitVec 26))) (_ BitVec 26) (bvadd s (bvadd #b01111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 26))) Bool  (bvsgt (bvlshr (inv s t) s) t))
