...
(define-fun inv ((s (_ BitVec 42)) (t (_ BitVec 42))) (_ BitVec 42) (bvadd s (bvadd #b011111111111111111111111111111111111111111 (bvmul s t))))
(define-fun l ((x (_ BitVec 42))) Bool  (bvsgt (bvlshr (inv s t) s) t))
