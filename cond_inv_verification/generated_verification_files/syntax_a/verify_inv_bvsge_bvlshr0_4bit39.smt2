...
(define-fun inv ((s (_ BitVec 39)) (t (_ BitVec 39))) (_ BitVec 39) (bvadd #b011111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 39))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 39))) (bvsge (bvlshr (bvnot (_ bv0 39)) s) t)))
