...
(define-fun inv ((s (_ BitVec 63)) (t (_ BitVec 63))) (_ BitVec 63) (bvadd #b011111111111111111111111111111111111111111111111111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 63))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 63))) (bvsge (bvlshr (bvnot (_ bv0 63)) s) t)))
