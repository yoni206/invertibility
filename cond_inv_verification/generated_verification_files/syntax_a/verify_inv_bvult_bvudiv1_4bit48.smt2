...
(define-fun inv ((s (_ BitVec 48)) (t (_ BitVec 48))) (_ BitVec 48) (bvnot #b000000000000000000000000000000000000000000000000))
(define-fun l ((x (_ BitVec 48))) Bool  (bvult (udivtotal s (inv s t)) t))
(define-fun SC () Bool (and (bvult (_ bv0 48) (bvnot (bvand (bvneg t) s))) (bvult (_ bv0 48) t)))
