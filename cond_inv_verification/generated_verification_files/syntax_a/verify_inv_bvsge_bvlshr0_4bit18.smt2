...
(define-fun inv ((s (_ BitVec 18)) (t (_ BitVec 18))) (_ BitVec 18) (bvadd #b011111111111111111 (bvmul s t)))
(define-fun l ((x (_ BitVec 18))) Bool  (bvsge (bvlshr (inv s t) s) t))
(define-fun SC () Bool (=> (not (= s (_ bv0 18))) (bvsge (bvlshr (bvnot (_ bv0 18)) s) t)))
