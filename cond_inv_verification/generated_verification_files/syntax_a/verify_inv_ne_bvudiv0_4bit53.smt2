...
(define-fun inv ((s (_ BitVec 53)) (t (_ BitVec 53))) (_ BitVec 53) (bvnot (bvneg t)))
(define-fun l ((x (_ BitVec 53))) Bool  (distinct (udivtotal (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (_ bv0 53)) (distinct t (bvnot (_ bv0 53)))))
