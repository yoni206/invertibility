...
(define-fun inv ((s (_ BitVec 60)) (t (_ BitVec 60))) (_ BitVec 60) (bvnot t))
(define-fun l ((x (_ BitVec 60))) Bool  (distinct (bvor (inv s t) s) t))
(define-fun SC () Bool (or (distinct s (bvnot (_ bv0 60))) (distinct t (bvnot (_ bv0 60)))))
