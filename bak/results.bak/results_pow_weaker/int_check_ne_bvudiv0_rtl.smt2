...
(define-fun pow_is_ok ((a Int) (b Int)) Bool (and (>= a 0) (>= b 0) (= (pow a 0) 1) (forall ((i Int))  (=> (and (> i 0) (<= i b)) (>= (pow a i) 0)))  ) )
...
(define-fun l ((k Int) (x Int) (s Int) (t Int)) Bool (distinct (mod (divtotal k x s) (pow 2 k)) t))
(define-fun SC ((k Int) (s Int) (t Int)) Bool (or (distinct s 0) (distinct t (- (pow 2 k) 1)))
...
(check-sat-assuming ((pow_is_ok 2 k) (pow_is_ok 2 s) (pow_is_ok 2 t)))
